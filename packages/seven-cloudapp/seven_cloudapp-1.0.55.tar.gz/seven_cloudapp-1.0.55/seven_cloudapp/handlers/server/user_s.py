...
@LastEditTime: 2020-11-26 10:21:54
...
class UserBlackListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        if act_id <= 0:
            return self.reponse_json_error("error", "参数错误!")

        user_black_dict_list = UserBlacklistModel().get_dict_list("act_id=%s", "", "create_date desc", "", params=act_id)
