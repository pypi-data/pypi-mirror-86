...
@LastEditTime: 2020-11-26 09:01:09
...
class RecommendGoodsHandler(SevenBaseHandler):
    ...
    def post_async(self):
        ...
        if recommend_goods:
            ...
            recommend_goods.goods_list = self.json_dumps(goods_list)
...
class RecommendGoodsListHandler(SevenBaseHandler):
    """
    获取爆品推荐列表
    """
    ...
    def get_async(self):
        ...
        recommend_goods_list = RecommendGoodsModel().get_dict_list("act_id=%s", "", "id asc", "", params=act_id)

        self.reponse_json_success(recommend_goods_list)