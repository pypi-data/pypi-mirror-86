...
@LastEditTime: 2020-11-25 15:02:57
...
class PrizeListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        for page in page_list:
            page["prize_detail"] = json.loads(page["prize_detail"]) if page["prize_detail"] else []
            page["goods_code_list"] = json.loads(page["goods_code_list"]) if page["goods_code_list"] else []
            page["sku_detail"] = json.loads(page["sku_detail"]) if page["sku_detail"] else []
