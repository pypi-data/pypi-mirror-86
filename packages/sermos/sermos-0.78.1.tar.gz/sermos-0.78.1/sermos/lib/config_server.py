...
@api.route(PREFIX + '/schedules/<string:deployment_id>', methods=['GET'])
...
@api.route(PREFIX + '/schedules/<string:deployment_id>', methods=['POST'])
...
@api.route(PREFIX + '/pipelines/<string:deployment_id>', methods=['GET'])
