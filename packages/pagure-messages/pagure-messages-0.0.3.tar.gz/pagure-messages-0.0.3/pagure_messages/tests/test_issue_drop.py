...
from ..issue_schema import IssueDropV1
...
def test_missing_fields():
    ...
    message = IssueDropV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "Issue deleted: fedora-infra/fedocal-messages#9311\nBy: dummy-user"
    message = IssueDropV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = (
        "dummy-user deleted issue fedora-infra/fedocal-messages#9311: aws: "
