...
from ..pull_requests_schema import PullRequestReopenedV1
...
def test_missing_fields():
    ...
    message = PullRequestReopenedV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "Pull-request pagure#5014 was re-opened\nBy: dummy-user"
    message = PullRequestReopenedV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy-user re-opened the pull-request pagure#5014"
    message = PullRequestReopenedV1(body=body)
    message.validate()
