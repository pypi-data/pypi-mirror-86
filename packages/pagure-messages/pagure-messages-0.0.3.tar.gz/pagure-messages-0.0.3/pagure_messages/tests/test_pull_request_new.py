...
from ..pull_requests_schema import PullRequestNewV1
...
def test_minimal():
    ...
    message = PullRequestNewV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = PullRequestNewV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "New Pull-Request: pagure#5014\nBy: dummy-user"
    message = PullRequestNewV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = (
        "dummy-user opened a pull-request pagure#5014: Reverse "
        "out of order instructions for new repos"
    )
    message = PullRequestNewV1(body=body)
    message.validate()
