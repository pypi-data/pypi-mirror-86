...
from ..pull_requests_schema import PullRequestTagAddedV1
...
def test_minimal():
    ...
    message = PullRequestTagAddedV1(body=body)
    message.validate()
    assert (
        message.url
...
def test_missing_fields():
    ...
    message = PullRequestTagAddedV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "Pull-request pagure#5014 was tagged\nBy: dummy-user"
    message = PullRequestTagAddedV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy-user tagged the pull-request pagure#5014 with blue, red"
    message = PullRequestTagAddedV1(body=body)
    message.validate()
