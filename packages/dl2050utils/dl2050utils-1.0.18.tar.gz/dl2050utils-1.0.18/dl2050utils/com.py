...
class Notify():
    ...
    def __call__(self, who, how='mail', subject=None, msg=None, html=None, files=[]):
        ...
        if how == 'email_async': return self.send_mail_async(to, subject=subject, msg=msg, html=html, files=files):
        if how == 'email': return self.send_mail(to, subject=subject, msg=msg, html=html, files=files)
        if how=='sms':
