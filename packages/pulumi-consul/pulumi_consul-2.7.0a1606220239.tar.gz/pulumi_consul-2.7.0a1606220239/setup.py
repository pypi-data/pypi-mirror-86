...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.7.0-alpha.1606220239+15d0a6ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.7.0-alpha.1606220239+15d0a6ff`
                """)
            else:
                raise
