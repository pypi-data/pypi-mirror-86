...
from judo.functions.fractalai import cross_fai_iteration
import numpy
...
class BestWalker(ExportedWalkers):
    ...
    def __init__(self, minimize: bool = False):
        ...
        self.rewards[:] = numpy.inf if self.minimize else numpy.NINF
...
class ExportSwarm(SwarmWrapper):
    ...
    def _get_export_index(self) -> Tensor:
    ...
    def _create_export_walkers(self, indexes: Tensor) -> ExportedWalkers:
