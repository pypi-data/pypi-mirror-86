...
class CommonAPIHandler(object):
    ...
    def api_call(self, class_name, encode_type):
        ...
        if self.__content_type is not None and (
                self.__http_method == Constants.REQUEST_METHOD_POST or self.__http_method == Constants.REQUEST_METHOD_PUT or self.__http_method == Constants.REQUEST_METHOD_PATCH):
            try:
