...
class PersonIdType1Sub(supermod.PersonIdType1):
    def __init__(self, valueOf_=None, **kwargs_):
        super(PersonIdType1Sub, self).__init__(valueOf_,  **kwargs_)
supermod.PersonIdType1.subclass = PersonIdType1Sub
# end class PersonIdType1Sub
