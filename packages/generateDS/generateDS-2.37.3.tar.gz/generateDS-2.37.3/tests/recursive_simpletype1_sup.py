...
class PersonType(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('personId', 'PersonIdType1', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'personId', 'ref': 'personId', 'type': 'personId'}, None),
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'personId':
            obj_ = PersonIdType1.factory(parent_object_=self)
...
class PersonIdType1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('valueOf_', ['PersonIdType', 'eitc:IdType'], 0),
    ]
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PersonIdType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PersonIdType1.subclass:
            return PersonIdType1.subclass(*args_, **kwargs_)
        else:
            return PersonIdType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonIdType1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PersonIdType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PersonIdType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonIdType1')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonIdType1', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonIdType1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonIdType1', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class PersonIdType1


GDSClassesMapping = {
    'person': PersonType,
    'personId': PersonIdType1,
}
