...
# Connection probability >= {min_score}
...
'''
            ...
            adata.uns["cluster_graph"].to_csv(ouput_path+f"{output_name}_tp{timepoint}_CellStatesConnectionProbabilities.txt",mode='a',sep="\t")
...
'''
        ...
        self.cluster_graph.to_csv(ouput_path+f"{output_name}_BetweenTimePoints_CellStatesConnectionProbabilities.txt",mode='a',sep="\t")
