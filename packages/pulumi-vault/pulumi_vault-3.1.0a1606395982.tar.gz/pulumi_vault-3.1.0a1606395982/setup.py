...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.1.0-alpha.1606395982+29bbd0ad'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.1.0-alpha.1606395982+29bbd0ad`
                """)
            else:
                raise
