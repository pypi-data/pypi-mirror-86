...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.1.0-alpha.1606152068+37efd8c3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.1.0-alpha.1606152068+37efd8c3`
                """)
            else:
                raise
