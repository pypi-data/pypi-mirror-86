...
class AttributeTypeDTO(object):
    ...
    allowable_values = [STRING, BYTE, INT, LONG, FLOAT, DOUBLE, BOOLEAN, POINT, LINE, POLYGON, MULTIPOINT, MULTILINE, MULTIPOLYGON, POINTZ, LINEZ, POLYGONZ, MULTIPOINTZ, MULTILINEZ, MULTIPOLYGONZ, SURFACE]  # noqa: E501
