...
class SpatialApi(object):
    ...
    def by_ids_spatial_items(self, project, spatial_ids_dto, **kwargs):  # noqa: E501
        ...
        Retrieves spatial items by internal ids or external ids. It is possible to retrieve up to 25 items per request. Notice that this endpoint only returns simple item's attributes which are either of type string or are not of type array.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_spatial(self, project, spatial_ids_dto, **kwargs):  # noqa: E501
        ...
        :param project: The project name. (required)
        :type project: str
        :param spatial_ids_dto: List of spatial items to be deleted. It is possible to post a maximum of 25 spatial items per request. (required)
        :type spatial_ids_dto: SpatialIdsDTO
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_spatial_coverage(self, project, spatial_coverage_request_dto, **kwargs):  # noqa: E501
        ...
        Get the coverage of the items. It is possible to get the coverages of a maximum of 25 spatial items per request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
