...
setup(
  ...
  version = '0.0.2.4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ayush4921/ayushbot/archive/0.0.2.4.tar.gz',    # I explain this later on
