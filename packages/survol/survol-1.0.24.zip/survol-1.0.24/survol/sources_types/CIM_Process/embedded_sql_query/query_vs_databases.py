...
#
# http://127.0.0.1:8000/survol/entity.py?xid=sql/query.Query=CglzZWxlY3Q1MQoJ,Pid=0,File=
#
...
#
# http://127.0.0.1:8000/survol/entity.py?xid=sql/query/CIM_Process.Query=CglzZWxlY3Q1MQoJ,Pid=1234
#
# http://127.0.0.1:8000/survol/entity.py?xid=sql/query/CIM_DataFile.Query=CglzZWxlY3Q1MQoJ,Name="toto.sql"
#
# http://127.0.0.1:8000/survol/entity.py?xid=sql/query/oracle/db.Query=CglzZWxlY3Q1MQoJ,Db="XE"
#
...
#
# http://127.0.0.1:8000/survol/entity.py?xid=oracle/db/SUBCLASSES/sql/query.Db=XE,Query=CglzZWxlY3Q1MQoJ
# http://127.0.0.1:8000/survol/entity.py?xid=sqlserver/dsn/SUBCLASSES/sql/query.Dsn=XE,Query=CglzZWxlY3Q1MQoJ
# http://127.0.0.1:8000/survol/entity.py?xid=CIM_Processes/SUBCLASSES/sql/query.Pid=1234,Query=CglzZWxlY3Q1MQoJ
#
