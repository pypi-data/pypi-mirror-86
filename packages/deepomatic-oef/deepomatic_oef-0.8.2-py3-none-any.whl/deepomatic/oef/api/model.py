...
class TensorflowModelInterface(ModelInterface):
    ...
    @staticmethod
    @abstractmethod
    def get_min_number_of_proposals():
        """
        This is a big hack for now: it should return the minimum size of the proposals per image
        ...
        For detection we need to put max_number_of_boxes at least 100
