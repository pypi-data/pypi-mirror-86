...
from platform_agent.wireguard.helpers import check_if_wireguard_installled, check_udp_connection
...
class WebSocketClient(threading.Thread):
    ...
    def __init__(self, host, api_key, ssl="wss"):
        ...
        if not check_if_wireguard_installled():
            status = 'WG_ERROR'
        elif not check_udp_connection():
              
            status = 'UDP_CONNECTION_ERROR'
        else:
            status = 'OK'
