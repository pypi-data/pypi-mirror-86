...
class ReportsApi(object):
    ...
    def get_archives(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_archives_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_email_details_with_http_info(self, email_id, **kwargs):  # noqa: E501
        ...
        if 'email_id' in params and not re.search(r'[a-fA-F0-9]{24}', params['email_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `email_id` when calling `get_email_details`, must conform to the pattern `/[a-fA-F0-9]{24}/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_file_matches(self, file_hash, **kwargs):  # noqa: E501
        """Retrieve the MAGIC matches for a binary.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_matches(file_hash, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_file_matches_with_http_info(file_hash, **kwargs)  # noqa: E501
        else:
            (data) = self.list_file_matches_with_http_info(file_hash, **kwargs)  # noqa: E501
            return data

    def list_file_matches_with_http_info(self, file_hash, **kwargs):  # noqa: E501
        """Retrieve the MAGIC matches for a binary.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_matches_with_http_info(file_hash, async_req=True)
        >>> result = thread.get()
