...
class ArchiveReport(object):
    ...
    swagger_types = {
        ...
        'children': 'list[EmailObjectAttachmentFiles]'
    }
    ...
    def __init__(self, sha1=None, sha256=None, sha512=None, md5=None, first_seen=None, filename=None, object_class=None, unix_filetype=None, children=None):  # noqa: E501
