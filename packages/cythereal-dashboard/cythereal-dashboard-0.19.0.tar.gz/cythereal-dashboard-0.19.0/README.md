...
*ReportsApi* | [**get_email_details**](docs/ReportsApi.md#get_email_details) | **GET** /reports/{email_id}/email/ | Retrieve the MAGIC matches for a binary.
...
## Documentation For Models
 ...
 - [EmailObjectAttachmentFiles](docs/EmailObjectAttachmentFiles.md)
