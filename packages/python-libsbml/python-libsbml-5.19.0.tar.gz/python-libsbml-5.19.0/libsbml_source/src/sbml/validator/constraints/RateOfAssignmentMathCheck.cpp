 ...
 *
 * @file    RateOfAssignmentMathCheck.cpp
 ...
 */
RateOfAssignmentMathCheck::RateOfAssignmentMathCheck (unsigned int id, Validator& v) : MathMLBase(id, v)
{
}
 ...
 */
RateOfAssignmentMathCheck::~RateOfAssignmentMathCheck ()
{
}
 ...
 */
const char*
RateOfAssignmentMathCheck::getPreamble ()
{
  return PREAMBLE;
}
...
/*
  ...
  */
void
RateOfAssignmentMathCheck::checkMath (const Model& m, const ASTNode& node, const SBase & sb)
{
...
/*
  ...
  */
void 
RateOfAssignmentMathCheck::checkCiElement (const Model& m, 
                                        const ASTNode& node, 
                                        const SBase & sb)
{
  ...
  const AssignmentRule * ar = m.getAssignmentRuleByVariable(name);
 ...
 */
const string
RateOfAssignmentMathCheck::getMessage (const ASTNode& node, const SBase& object)
{
  ...
  oss_msg << "' that is also referenced as the variable in an assignmentRule.";
  safe_free(formula);
...
void 
RateOfAssignmentMathCheck::logAlgebraicRuleDependency (const ASTNode & node, 
                                             const SBase & sb)
{
  char * formula = SBML_formulaToString(&node);
  msg = "The formula '"; 
  ...
  msg += "' that is also assigned via an algebraicRule.";
  safe_free(formula);
