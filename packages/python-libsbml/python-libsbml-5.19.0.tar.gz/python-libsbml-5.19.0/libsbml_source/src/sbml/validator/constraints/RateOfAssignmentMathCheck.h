 ...
 *
 * @file    RateOfAssignmentMathCheck.h
...
#ifndef RateOfAssignmentMathCheck_h
#define RateOfAssignmentMathCheck_h
...
class RateOfAssignmentMathCheck: public MathMLBase
{
public:
   ...
   */
  RateOfAssignmentMathCheck (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~RateOfAssignmentMathCheck ();
...
#endif  /* __cplusplus */
#endif  /* RateOfAssignmentMathCheck_h */
/** @endcond */
