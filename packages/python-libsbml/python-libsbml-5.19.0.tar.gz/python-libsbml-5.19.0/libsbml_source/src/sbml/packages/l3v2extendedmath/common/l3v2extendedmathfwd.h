/**
 * @file l3v2extendedmathfwd.h
 * @brief Definition of l3v2extendedmathfwd.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
#ifndef l3v2extendedmathfwd_H__
#define l3v2extendedmathfwd_H__
...
typedef CLASS_OR_STRUCT L3v2extendedmathASTPlugin L3v2extendedmathASTPlugin_t;
