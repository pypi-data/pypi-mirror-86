...
/**
 * @file L3v2extendedmathMathMLConsistencyValidator.cpp
 ...
 */
void
L3v2extendedmathMathMLConsistencyValidator::init()
{
#define  AddingConstraintsToValidator 1
#include "constraints/L3v2extendedmathMathMLConsistencyConstraintsDeclared.cxx"
}
