 ...
 * @brief Definition of the ArraysSBMLDocumentPlugin class.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------ -->
 *
 * @class ArraysSBMLDocumentPlugin
 * @sbmlbrief{arrays} Extension of SBMLDocument.
 */
...
public:
   ...
   */
  ArraysSBMLDocumentPlugin(const std::string& uri,
   ...
   *
   * @param rhs the ArraysSBMLDocumentPlugin object whose values are to be used
   ...
   *
   * @return @c true if this ArraysSBMLDocumentPlugin's attribute
