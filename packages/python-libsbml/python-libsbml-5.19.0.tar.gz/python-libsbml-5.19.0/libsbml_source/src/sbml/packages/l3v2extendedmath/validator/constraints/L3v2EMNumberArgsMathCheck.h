 ...
 *
 * @file    L3v2EMNumberArgsMathCheck.h
...
class L3v2EMNumberArgsMathCheck: public MathMLBase
{
public:
   ...
   */
  L3v2EMNumberArgsMathCheck (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~L3v2EMNumberArgsMathCheck ();
...
#endif  /* __cplusplus */
#endif  /* L3v2EMNumberArgsMathCheck_h */
/** @endcond */
