/**
 * \file    TestRunner.cpp
 * \brief   Runs all unit tests in the arrays util module
...
Suite *create_suite_TestDistribAnnotationConverter  (void);
...
{ 
  ...
  SRunner *runner = srunner_create( create_suite_TestDistribAnnotationConverter() );
