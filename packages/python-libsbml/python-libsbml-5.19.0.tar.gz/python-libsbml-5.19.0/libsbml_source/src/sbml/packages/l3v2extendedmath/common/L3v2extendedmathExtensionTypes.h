/**
 * @file L3v2extendedmathExtensionTypes.h
 * @brief Definition of L3v2extendedmathExtensionTypes.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
#ifndef L3v2extendedmathExtensionTypes_H__
#define L3v2extendedmathExtensionTypes_H__
...
#endif /* !L3v2extendedmathExtensionTypes_H__ */
