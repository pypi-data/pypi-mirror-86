#################################################
 ...
 # @brief Src CMake file for distrib package
 # @author SBMLTeam
 #
 # <!--------------------------------------------------------------------------
...
foreach(dir common extension sbml util validator validator/constraints)
  ...
  file(GLOB distrib_headers ${CMAKE_CURRENT_SOURCE_DIR}/sbml/packages/distrib/${dir}/*.h)

  install(FILES ${distrib_headers} DESTINATION include/sbml/packages/distrib/${dir} )
...
if (WITH_CHECK)
	...
	add_subdirectory(sbml/packages/distrib/extension/test)
	add_subdirectory(sbml/packages/distrib/sbml/test)
	add_subdirectory(sbml/packages/distrib/util/test)
	add_subdirectory(sbml/packages/distrib/validator/test)
