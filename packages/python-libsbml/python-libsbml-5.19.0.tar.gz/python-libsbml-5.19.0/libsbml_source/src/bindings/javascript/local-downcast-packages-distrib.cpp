 ...
 * @brief Casting to most specific packages object for javascript
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
else if (pkgName == "distrib")
{
  switch ( sb->getTypeCode() )
  {
    ...
    case SBML_DISTRIB_UNCERTPARAMETER:
      return SWIGTYPE_p_UncertParameter;

    case SBML_DISTRIB_UNCERTAINTY:
      return SWIGTYPE_p_Uncertainty;

    case SBML_DISTRIB_UNCERTSTATISTICSPAN:
      return SWIGTYPE_p_UncertSpan;

    case SBML_DISTRIB_DISTRIBBASE:
      return SWIGTYPE_p_DistribBase;
