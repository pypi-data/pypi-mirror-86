/**
 * Filename    : qual.i
 * Description : qual swig file for bindings.
 *
 * <!--------------------------------------------------------------------------
...
%newobject removeFunctionTerm;
%newobject removeInput;
%newobject removeOutput;
%newobject removeQualitativeSpecies;
%newobject removeTransition;

%template(QualPkgNamespaces) SBMLExtensionNamespaces<QualExtension>;
