 ...
 * SBML Flux Balance Constraints (&ldquo;fbc&rdquo;) package.
 * <p>
 * <em style='color: #555'>
 ...
 * &ldquo;fbc&rdquo; package, the object class is {@link FbcPkgNamespaces}.
 ...
 * <p>
 * Objects of class {@link FbcPkgNamespaces} can be passed to constructors of
 * SBML components defined by &ldquo;fbc&rdquo; in order to ensure that the
 ...
 */
public class FbcPkgNamespaces {

    /**
     * Creates a new {@link FbcPkgNamespaces} object.
     * <p>
     ...
     * <p>
     * If a caller created this list using the {@link #FbcPkgNamespaces()}
     ...
     * Flux Balance Constraints package implemented by the libSBML
     * extension.
     */
