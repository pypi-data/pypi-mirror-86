 ...
 * SBML Multistate, Multicomponent and Multicompartment Species
 * (&ldquo;multi&rdquo;) package.
 * <p>
 * <em style='color: #555'>
 ...
 * &ldquo;multi&rdquo; package, the object class is {@link MultiPkgNamespaces}.
 ...
 * <p>
 * Objects of class {@link MultiPkgNamespaces} can be passed to constructors 
 * of SBML components defined by &ldquo;multi&rdquo; in order to ensure that 
 ...
 * (For example, later editions of a package may introduce new attributes
 * on a component that are not present in earlier editions of the package
 * specification.)
 * <p>
 ...
 */
public class MultiPkgNamespaces {

    /**
     * Creates a new {@link MultiPkgNamespaces} object.
     * <p>
     ...
     */
    public MultiPkgNamespaces() { }


    /**
     * Creates and returns a deep copy of this {@link MultiPkgNamespaces}.
     * <p>
     * @return a (deep) copy of this {@link MultiPkgNamespaces}.
     */ 
    public MultiPkgNamespaces cloneObject() {}


    /**
     * Destroys this object.
     * <p>
     * If a caller created this list using the {@link #MultiPkgNamespaces()}
     ...
     * implemented by the libSBML extension.
     */
     ...
     * this case, will be &ldquo;multi&rdquo;.
     */ 
