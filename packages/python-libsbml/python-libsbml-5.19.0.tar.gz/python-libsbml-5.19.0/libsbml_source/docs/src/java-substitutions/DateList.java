...
/**
 * Class for managing lists of {@link Date} objects.
 * <p>
 * <em style='color: #555'>
 ...
 * lists returned by libSBML (e.g., lists of {@link Date} objects, lists
 * of {@link Date} objects, etc.).  However, this is currently impossible
 ...
 * a list; that is, {@link DateList} for {@link Date} objects,
 * {@link DateList} for {@link Date} objects, and a few others.
...
public class DateList {
     ...
     * <p>
     * In most circumstances, callers will obtain an {@link DateList}
    ...
    /**
     * Adds the given {@link Date} object <code>item</code> to this
     * list.
     * <p>
     * @param item the {@link Date} object to add to add
     */
     ...
     * <p>
     * @return the nth item in this {@link DateList} items.
     * <p>
     * @see #getSize()
     */
    ...
    /**
     * Adds the {@link Date} object <code>item</code> to the beginning
     * of this list.
     * <p>
    ...
    /**
     * Removes the <em>n</em>th {@link Date} object from this list and
     * returns it.
     * <p>
