class CVTermList(_object):
    ...
    lists returned by libSBML (e.g., lists of CVTerm objects, lists of
    ...
    is, CVTermList for CVTerm objects, CVTermList for CVTerm objects, and
    ...
    def __init__(self):
          ...
          In most circumstances, callers will obtain an CVTermList object
    ...
    def add(self, *args):
        ...
        Adds the given CVTerm object <code>item</code> to this list.
        
        @param item the CVTerm object to add to add
        """
        pass
    ...
    def get(self, *args):
        ...
        @return the nth item in this CVTermList items.
    ...
    def prepend(self, *args):
        ...
        Adds the CVTerm object <code>item</code> to the beginning of this list.
    ...
    def remove(self, *args):
        """
        remove(long n) -> CVTerm

        Removes the <em>n</em>th CVTerm object from this list and
        returns it.
