class LayoutPkgNamespaces(SBMLNamespaces):
    ...
    &ldquo;layout&rdquo; package, the object class is LayoutPkgNamespaces.
    ...
    Objects of class LayoutPkgNamespaces can be passed to constructors of SBML
    components defined by &ldquo;layout&rdquo; in order to ensure that the
