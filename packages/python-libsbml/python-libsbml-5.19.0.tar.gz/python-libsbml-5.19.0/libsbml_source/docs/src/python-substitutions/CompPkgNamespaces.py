class CompPkgNamespaces(SBMLNamespaces):
    ...
    &ldquo;comp&rdquo; package, the object class is CompPkgNamespaces.
    ...
    Objects of class CompPkgNamespaces can be passed to constructors of SBML
    components defined by &ldquo;comp&rdquo; in order to ensure that the
    ...
    def clone(self):
        """
        clone(CompPkgNamespaces self) -> CompPkgNamespaces
    ...
    def getURI(self):
        """
        getURI(CompPkgNamespaces self) -> string
    ...
    def getPackageName(self):
        """
        getPackageName(CompPkgNamespaces self) -> string
