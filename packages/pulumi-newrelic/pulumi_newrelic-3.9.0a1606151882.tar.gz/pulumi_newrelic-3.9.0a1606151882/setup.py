...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.9.0-alpha.1606151882+f123dfc5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.9.0-alpha.1606151882+f123dfc5`
                """)
            else:
                raise
