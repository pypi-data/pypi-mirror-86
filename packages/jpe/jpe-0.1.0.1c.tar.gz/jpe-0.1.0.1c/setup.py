...
setup(
  ...
  packages = ['jpe'],   # Chose the same as "name"
  version = '0.1.0.1c',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JulianWww/jpe/archive/v0.1.0.1.tar.gz',    # I explain this later on
