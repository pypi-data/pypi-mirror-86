...
class GenomeApi(object):
    ...
    def check_assembly_availability_with_http_info(self, accessions, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'include_tsv' in local_var_params and local_var_params['include_tsv'] is not None:  # noqa: E501
            query_params.append(('include_tsv', local_var_params['include_tsv']))  # noqa: E501
