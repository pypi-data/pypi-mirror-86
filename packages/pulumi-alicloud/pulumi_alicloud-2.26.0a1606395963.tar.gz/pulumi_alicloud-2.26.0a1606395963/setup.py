...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.26.0-alpha.1606395963+8a9528ad'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.26.0-alpha.1606395963+8a9528ad`
                """)
            else:
                raise
