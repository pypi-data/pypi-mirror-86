...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.26.0-alpha.1606239610+a9a9c8e8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.26.0-alpha.1606239610+a9a9c8e8`
                """)
            else:
                raise
