...
if __name__ == '__main__':
    ...
    matam_16s_parser.add_argument('-pct',            required=True,  type=str, default='0.1,0.5,1,5,10,25,50,75,100',   help='subsample percentage, deafault: 0.1,0.5,1,5,10,25,50,75,100')
