...
class TSInsertStringRecordsReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i220 in range(_size216):
                        ...
                        self.deviceIds.append(_elem221)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i250 in range(_size246):
                        ...
                        self.timestamps.append(_elem251)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.measurementsList is not None:
            oprot.writeFieldBegin('measurementsList', TType.LIST, 3)
            oprot.writeListBegin(TType.LIST, len(self.measurementsList))
            for iter253 in self.measurementsList:
        ...
        if self.valuesList is not None:
            ...
            for iter255 in self.valuesList:
                oprot.writeListBegin(TType.STRING, len(iter255))
        ...
        if self.timestamps is not None:
            oprot.writeFieldBegin('timestamps', TType.LIST, 5)
            oprot.writeListBegin(TType.I64, len(self.timestamps))
            for iter257 in self.timestamps:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i262 in range(_size258):
                        _elem263 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.paths.append(_elem263)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class TSCreateTimeseriesReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i283 in range(_size279):
                        ...
                        self.attributes[_key284] = _val285
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
    ...
    def write(self, oprot):
        ...
        if self.props is not None:
            ...
            for kiter286, viter287 in self.props.items():
        ...
        if self.tags is not None:
            ...
            for kiter288, viter289 in self.tags.items():
        ...
        if self.attributes is not None:
            ...
            for kiter290, viter291 in self.attributes.items():
...
class TSCreateMultiTimeseriesReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i309 in range(_size305):
                        ...
                        self.dataTypes.append(_elem310)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i315 in range(_size311):
                        ...
                        self.encodings.append(_elem316)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i321 in range(_size317):
                        ...
                        self.compressors.append(_elem322)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i327 in range(_size323):
                        ...
                        for _i333 in range(_size329):
                            ...
                            _elem328[_key334] = _val335
                        iprot.readMapEnd()
                        self.propsList.append(_elem328)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i353 in range(_size349):
                        ...
                        for _i359 in range(_size355):
                            ...
                            _elem354[_key360] = _val361
                        iprot.readMapEnd()
                        self.attributesList.append(_elem354)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i366 in range(_size362):
                        ...
                        self.measurementAliasList.append(_elem367)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.compressors is not None:
            ...
            for iter371 in self.compressors:
                oprot.writeI32(iter371)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.propsList is not None:
            ...
            for iter372 in self.propsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter372))
                for kiter373, viter374 in iter372.items():
                    oprot.writeString(kiter373.encode('utf-8') if sys.version_info[0] == 2 else kiter373)
                    oprot.writeString(viter374.encode('utf-8') if sys.version_info[0] == 2 else viter374)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tagsList is not None:
            ...
            for iter375 in self.tagsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter375))
                for kiter376, viter377 in iter375.items():
                    oprot.writeString(kiter376.encode('utf-8') if sys.version_info[0] == 2 else kiter376)
                    oprot.writeString(viter377.encode('utf-8') if sys.version_info[0] == 2 else viter377)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.attributesList is not None:
            ...
            for iter378 in self.attributesList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter378))
                for kiter379, viter380 in iter378.items():
        ...
        if self.measurementAliasList is not None:
            ...
            for iter381 in self.measurementAliasList:
...
class ServerProperties(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i386 in range(_size382):
                        ...
                        self.supportedTimeAggregationOperations.append(_elem387)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.supportedTimeAggregationOperations is not None:
            ...
            for iter388 in self.supportedTimeAggregationOperations:
