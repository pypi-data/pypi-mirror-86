...
class haxe_ds_ListSort:
    _hx_class_name = "haxe.ds.ListSort"
    __slots__ = ()
    _hx_statics = ["sort", "sortSingleLinked"]

    @staticmethod
    def sort(_hx_list,cmp):
        if (_hx_list is None):
            return None
        insize = 1
        nmerges = None
    ...
    @staticmethod
    def sortSingleLinked(_hx_list,cmp):
        if (_hx_list is None):
            return None
        insize = 1
        nmerges = None
        ...
        while True:
            ...
            insize = (insize * 2)
        return _hx_list
haxe_ds_ListSort._hx_class = haxe_ds_ListSort
...
class maglev_MagLev:
    _hx_class_name = "maglev.MagLev"
    __slots__ = ("_methods", "_listeners")
    _hx_fields = ["_methods", "_listeners"]
    _hx_methods = ["register", "call", "listen", "emit"]
    _hx_statics = ["_instances", "getInstance"]
    ...
    def listen(self,event,callback):
        if (not (event in self._listeners.h)):
            this1 = self._listeners
            v = list()
            this1.h[event] = v
        _this = self._listeners.h.get(event,None)
        _this.append(callback)

    def emit(self,event,args):
        if (event in self._listeners.h):
            listeners = self._listeners.h.get(event,None)
            _g = 0
    ...
    @staticmethod
    def getInstance(key):
        if (not (key in maglev_MagLev._instances.h)):
            this1 = maglev_MagLev._instances
            v = maglev_MagLev()
            this1.h[key] = v
        return maglev_MagLev._instances.h.get(key,None)

    @staticmethod
    def _hx_empty_init(_hx_o):
        _hx_o._methods = None
        _hx_o._listeners = None
maglev_MagLev._hx_class = maglev_MagLev
...
class maglev_MagLevError:
    ...
    _hx_statics = ["create", "getStaticType"]
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o.message = None
        _hx_o.data = None
maglev_MagLevError._hx_class = maglev_MagLevError
...
class maglev_MagLevAny:
    ...
    @staticmethod
    def _hx_empty_init(_hx_o):        pass
maglev_MagLevAny._hx_class = maglev_MagLevAny
...
class maglev_MagLevFunction(maglev_MagLevAny):
    ...
    _hx_statics = ["fromFunction", "fromNamedFunction", "getStaticType"]
    _hx_interfaces = []
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.name = None
        _hx_o.value = None
maglev_MagLevFunction._hx_class = maglev_MagLevFunction
...
class maglev_MagLevObject(maglev_MagLevAny):
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.values = None
maglev_MagLevObject._hx_class = maglev_MagLevObject
...
class maglev_MagLevArray(maglev_MagLevAny):
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.values = None
maglev_MagLevArray._hx_class = maglev_MagLevArray
...
class maglev_MagLevNumber(maglev_MagLevAny):
    ...
    _hx_statics = ["fromFloat", "fromInt", "getStaticType"]
    _hx_interfaces = []
    _hx_super = maglev_MagLevAny
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.value = None
maglev_MagLevNumber._hx_class = maglev_MagLevNumber
...
class maglev_MagLevString(maglev_MagLevAny):
    ...
    _hx_statics = ["fromString", "getStaticType"]
    _hx_interfaces = []
    _hx_super = maglev_MagLevAny
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.value = None
maglev_MagLevString._hx_class = maglev_MagLevString
...
class maglev_MagLevBoolean(maglev_MagLevAny):
    ...
    _hx_statics = ["fromBool", "getStaticType"]
    _hx_interfaces = []
    _hx_super = maglev_MagLevAny
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.value = None
maglev_MagLevBoolean._hx_class = maglev_MagLevBoolean
...
class maglev_MagLevNull(maglev_MagLevAny):
    ...
    _hx_statics = ["create", "getStaticType", "wrap"]
    _hx_interfaces = []
    _hx_super = maglev_MagLevAny
    ...
    @staticmethod
    def _hx_empty_init(_hx_o):        pass
maglev_MagLevNull._hx_class = maglev_MagLevNull
...
class maglev_MagLevOld:
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.maglev = None
maglev_MagLevOld._hx_class = maglev_MagLevOld
