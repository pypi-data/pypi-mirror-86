...
OPTIONS_HUB = {
    "args": ["--hub", "-hub"],
    "kwargs": dict(type=str, help="The component hub name, e.g. 'kaniko' or 'acme/kaniko'."),
}

OPTIONS_REGISTRY = {
    "args": ["--registry", "-r"],
    "kwargs": dict(type=str, help="The component hub name, e.g. 'model-a' or 'acme/model-a'."),
}
