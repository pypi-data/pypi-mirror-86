...
class Praetorian:
    ...
    def send_registration_email(
        ...
        flask.current_app.logger.debug(f"FUCKING CONFIRMATION SENDER IS {sender}")
    ...
    def send_token_email(
        ...
        flask.current_app.logger.debug("EXTENSIONS: {flask.current_app.extensions}")
        PraetorianError.require_condition(
            hasattr(flask.current_app.extensions, 'mail'),
