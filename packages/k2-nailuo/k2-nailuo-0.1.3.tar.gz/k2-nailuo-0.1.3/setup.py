...
packages = \
['k2', 'k2.docs.source', 'k2.python', 'k2.python.k2', 'k2.python.k2.ragged']
...
setup_kwargs = {
    ...
    'url': 'https://github.com/open-speech/sequeender',
    'packages': packages,
