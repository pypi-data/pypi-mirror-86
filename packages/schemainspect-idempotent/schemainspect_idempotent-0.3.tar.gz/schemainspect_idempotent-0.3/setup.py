...
packages = \
['schemainspect_idempotent',
 'schemainspect_idempotent.graphlib',
 'schemainspect_idempotent.pg']

package_data = \
{'': ['*'], 'schemainspect_idempotent.pg': ['sql/*']}
...
setup_kwargs = {
    ...
    'url': 'https://github.com/kahuang/schemainspect',
    'packages': packages,
