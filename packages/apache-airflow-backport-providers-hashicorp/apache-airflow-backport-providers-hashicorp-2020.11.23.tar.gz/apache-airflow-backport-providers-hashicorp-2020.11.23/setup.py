...
"""Setup.py for the apache-airflow-backport-providers-hashicorp package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/hashicorp/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-hashicorp setup."""
    setup(
        name='apache-airflow-backport-providers-hashicorp',
        description='Backport provider package '
        'apache-airflow-backport-providers-hashicorp for Apache Airflow',
        ...
        install_requires=['apache-airflow~=1.10', 'hvac~=0.10'],
