...
class Activity(models.Model):
    ...
    status_update = models.BooleanField(default=False, help_text="Automatic update status''s object executing "
                                                                 "obj.wf_update_status(activity) ")
    status_new = models.CharField(max_length=100, null=True, blank=True,
                                  help_text="New status of object associated with this WF, in a dict format. "
                                            "Ex.: {'status': 'A'}")
