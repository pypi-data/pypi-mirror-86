...
class ActivityAdmin(admin.ModelAdmin):
    save_as = True
    list_display = ('process', 'title', 'description', 'kind', 'application',
                    'join_mode', 'split_mode', 'autostart', 'autofinish','graph_order')
    ...
    fieldsets = (
        ...
        ('Execution modes', {'fields': (('autostart', 'autofinish', 'sendmail', 'approve', 'ratify',
                                         'enabled', 'readonly'),)}),
        ('Object Status Update', {'fields': (('status_update', 'status_new'),)}),
