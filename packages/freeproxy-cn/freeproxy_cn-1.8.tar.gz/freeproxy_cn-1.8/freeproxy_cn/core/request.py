...
class HttpHandler(object):
    ...
    def auto_handle_header(self, json: Union[str, None, dict],
                           data: Union[str, None, dict], kwargs: dict):
        """
...
class AsyncHttpHandler(HttpHandler):
    ...
    async def get_response(self, session, url: str, params, timeout: int,
                           headers: dict, raw: bool, **kwargs):
    ...
    async def post_response(self, session, url, data, json, timeout, headers,
                            raw, **kwargs):
