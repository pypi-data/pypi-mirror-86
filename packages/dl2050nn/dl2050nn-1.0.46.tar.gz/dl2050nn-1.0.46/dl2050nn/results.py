...
#     def show_best(self, n=8, **kwargs):  self.show_set(self.ds2, self.probs_sorted[:n], **kwargs)
#     def show_worst(self, n=8, **kwargs): self.show_set(self.ds2, self.probs_sorted[-n:][::-1], **kwargs)
