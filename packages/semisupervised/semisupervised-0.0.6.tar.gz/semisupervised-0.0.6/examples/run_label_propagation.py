...
import sys
sys.path.append(r'F:\研究生\github项目\python半监督包')
...
# import os
# os.chdir(r'F:\研究生\github项目\python半监督包')
from semisupervised.semisupervised.TSVM import SKTSVM
from semisupervised.semisupervised.qns3vm import QN_S3VM
from semisupervised.semisupervised.SklearnLabelPropagation import LabelPropagation
