...
setup(name='mindaffectBCI',
      ...
      package_data={'mindaffectBCI':glob.glob('mindaffectBCI/*.txt'), 'mindaffectBCI':glob.glob('mindaffectBCI/*.png'), 'mindaffectBCI':glob.glob('mindaffectBCI/*.json'), 'mindaffectBCI.hub':glob.glob('mindaffectBCI/hub/*'), 'mindaffectBCI.decoder':glob.glob('mindaffectBCI/decoder/*.pk')},
      data_files=[('mindaffectBCI',glob.glob('mindaffectBCI/*.png')), ('mindaffectBCI',glob.glob('mindaffectBCI/*.txt')), ('mindaffectBCI',glob.glob('mindaffectBCI/*.json')), ('mindaffectBCI/hub',glob.glob('mindaffectBCI/hub/*')), ('mindaffectBCI/decoder',glob.glob('mindaffectBCI/decoder/*.pk'))],
      classifiers=[
