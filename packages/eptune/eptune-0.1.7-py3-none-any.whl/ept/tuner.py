# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_tuner.ipynb (unless otherwise specified).

__all__ = ['eaSimpleWithExtraLog', 'eaMuPlusLambdaWithExtraLog', 'eaMuCommaLambdaWithExtraLog',
           'eaGenerateUpdateWithExtraLog', 'ScikitLearner']
...
# Cell
def eaGenerateUpdateWithExtraLog(toolbox, ngen, halloffame=None, stats=None,
                     verbose=__debug__):
    """Simply modified version of `eaGenerateUpdate` to accept additional return from evaluate function,
    check `eaGenerateUpdate` for documentation.
    """
    logbook = tools.Logbook()
    logbook.header = ['gen', 'nevals'] + (stats.fields if stats else [])
...
class ScikitLearner:
    "Helper class to use eaSimpleWithExtraLog, feel free to implement your own version."
