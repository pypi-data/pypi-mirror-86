...
# TODO: possibly depreciating this model
class ActionGroupFrequency(Model):
...
class ActionGroup(Model):
    ...
    theme = models.ForeignKey(Theme, null=True, verbose_name=u"Type d'action", on_delete=models.SET_NULL)
    description = models.TextField(blank=True, null=True, verbose_name=u"Description")
    frequency = models.ForeignKey(ActionGroupFrequency, null=True, verbose_name=u"Fréquence", on_delete=models.SET_NULL)
    ...
    class Meta:
        ...
        serializer_fields = ['@id', 'name', 'author', 'pressreleasetitle', 'pressreleasecontent', 'jugementmaj',
                             ...
                             'endactiondate', 'actioninfolink', 'description', 'theme', 'frequency', 'linkcollabtext',
