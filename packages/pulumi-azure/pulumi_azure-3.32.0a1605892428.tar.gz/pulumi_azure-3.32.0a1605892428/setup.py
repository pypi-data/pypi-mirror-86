...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.32.0-alpha.1605892428+02ee722c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.32.0-alpha.1605892428+02ee722c`
                """)
            else:
                raise
