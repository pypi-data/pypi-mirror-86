...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.32.0-alpha.1606321167+6e81bf4f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.32.0-alpha.1606321167+6e81bf4f`
                """)
            else:
                raise
