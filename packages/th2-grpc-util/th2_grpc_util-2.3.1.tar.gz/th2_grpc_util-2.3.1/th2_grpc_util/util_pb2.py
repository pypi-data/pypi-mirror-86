...
_MESSAGECOMPARATORSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='util.MessageComparatorService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='util.MessageComparatorService.compareFilterVsMessages',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='util.MessageComparatorService.compareMessageVsMessage',
    index=1,
    containing_service=None,
