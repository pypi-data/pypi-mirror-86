...
class MessageComparatorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.compareFilterVsMessages = channel.unary_unary(
                '/util.MessageComparatorService/compareFilterVsMessages',
        ...
        self.compareMessageVsMessage = channel.unary_unary(
                '/util.MessageComparatorService/compareMessageVsMessage',
...
def add_MessageComparatorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'util.MessageComparatorService', rpc_method_handlers)
...
class MessageComparatorService(object):
    ...
    def compareFilterVsMessages(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/util.MessageComparatorService/compareFilterVsMessages',
    ...
    def compareMessageVsMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/util.MessageComparatorService/compareMessageVsMessage',
