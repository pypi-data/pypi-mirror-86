...
required_packages.append('labelGlandula')
...
setup(
    ...
    name=NAME,
    version="0.3.0",
    description="labelGlandula is a graphical tool for using and creating detection models",
    long_description="labelGlandula is a graphical tool for using and creating detection models",
    author="Angela Casado",
    author_email='angela.casado@unirioja.es',
    url='https://github.com/ancasag/labelGlandula',
    python_requires=REQUIRES_PYTHON,
    package_dir={'labelGlandula': '.'},
    packages=required_packages,
    entry_points={
        'console_scripts': [
            'labelGlandula=labelGlandula.labelGlandula:main'
        ]
    },
    ...
    license="MIT license",
    zip_safe=False,
    keywords='labelGlandula detection deeplearning',
    classifiers=[
