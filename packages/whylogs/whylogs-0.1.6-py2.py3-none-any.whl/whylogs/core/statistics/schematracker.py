...
class SchemaTracker:
    ...
    def __init__(self, type_counts: dict = None):
        ...
        if not isinstance(type_counts, dict):
            ...
            type_counts = {k: v for k, v in list(type_counts.items())}
    ...
    def _get_most_popular_type(self, total_count):
        ...
        type_counts = self._non_null_type_counts()
        count = -1
        for candidate_type, candidate_count in list(type_counts.items()):
    ...
    def to_summary(self):
        ...
        type_counts_with_names = {Type.Name(k): v for k, v in list(type_counts.items())}
