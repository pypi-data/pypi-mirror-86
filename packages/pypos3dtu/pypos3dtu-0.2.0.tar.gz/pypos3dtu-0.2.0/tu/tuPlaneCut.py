...
#                              fillHole=False, filledHoleMat=None)
  ...
  def testFaceCut(self):
    ...
    self.assertEquals(3, len(lstFace))
    self.assertEquals(Point3d(-1.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(0.0,0.0,0.0), lstEdges[0][1])

    lstFace, lstEdges, multi = FaceCut( ToEdges(carre), vnorm, False, False, 0.0)
    self.assertEquals(4, len(lstFace))
    self.assertEquals(Point3d(-1.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(1.0,0.0,0.0), lstEdges[0][1])
    ...
    self.assertEquals(2, len(lstFace))
    self.assertEquals(4, len(lstFace[0]))
    self.assertEquals(4, len(lstFace[1]))
    self.assertEquals(Point3d(-1.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(1.0,0.0,0.0), lstEdges[1][1])
    ...
    self.assertTrue(multi)
    self.assertEquals(2, len(lstFace))
    self.assertEquals(5, len(lstFace[0]))
    self.assertEquals(3, len(lstFace[1]))
    self.assertEquals(Point3d(-1.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(1.0,0.0,0.0), lstEdges[1][1])
    ...
    self.assertEquals(4, len(lstFace[0]))
    self.assertEquals(4, len(lstFace[1]))
    self.assertEquals(3, len(lstFace[2]))
    self.assertEquals(Point3d(-2.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(0.0,0.0,0.0), lstEdges[1][1])
    self.assertEquals(Point3d(1.0,0.0,0.0), lstEdges[2][1])
    ...
    self.assertTrue(multi)
    self.assertEquals(3, len(lstFace))
    self.assertEquals(3, len(lstFace[0]))
    self.assertEquals(5, len(lstFace[1]))
    self.assertEquals(3, len(lstFace[2]))
    self.assertEquals(Point3d(-2.0,0.0,0.0), lstEdges[0][0])
    self.assertEquals(Point3d(0.0,0.0,0.0), lstEdges[1][1])
    self.assertEquals(Point3d(2.5,0.0,0.0), lstEdges[2][1])
