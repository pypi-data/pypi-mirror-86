...
class MagicReport(object):
    ...
    def __init__(self, sha1=None, sha256=None, sha512=None, md5=None, unix_file_type=None, object_class=None, filename=None, first_seen=None, is_owned=None, categories=None, labels=None, tags=None, tokens=None, detection_stats=None, av_names=None, campaign_id=None):  # noqa: E501
