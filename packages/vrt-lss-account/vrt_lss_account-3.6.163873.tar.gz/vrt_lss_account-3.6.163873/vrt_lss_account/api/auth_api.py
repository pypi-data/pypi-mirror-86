...
class AuthApi(object):
    ...
    def change_password(self, **kwargs):  # noqa: E501
        ...
        :param PasswordRequest password_request: Password change request data.
    ...
    def token(self, token_request, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param TokenRequest token_request: Token request. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def token_with_http_info(self, token_request, **kwargs):  # noqa: E501
        """Obtaining a token.  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('token_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `token_request` when calling `token`")  # noqa: E501
