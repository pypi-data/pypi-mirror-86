...
def iter_pages(account: str, request_fn: RequestFunction, cookie_locale) -> Iterator[Page]:
    start_url = utils.urljoin(FB_MOBILE_BASE_URL, f'/{account}/posts/')
    return generic_iter_pages(start_url, PageParser, request_fn, cookie_locale)
