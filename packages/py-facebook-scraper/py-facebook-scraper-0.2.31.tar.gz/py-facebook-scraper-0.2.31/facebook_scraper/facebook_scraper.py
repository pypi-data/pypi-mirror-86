...
class FacebookScraper:
    ...
    def get_posts(self, account: str, **kwargs) -> Iterator[Post]:
        cookie_locale = kwargs['cookie_locale'] if 'cookie_locale' in kwargs else None
        self.update_locale_header(cookie_locale)
    ...
    def update_locale_header(self, cookie_locale):
