...
def argument_parser():
    ...
    p.add_argument("-X", "--x-range", type=utils.parse_range,
                   help="birth time of the pair")
    p.add_argument("-Y", "--y-range", type=utils.parse_range,
    ...
    p.add_argument("--draw-vertices", default=False, type=utils.parse_bool,
