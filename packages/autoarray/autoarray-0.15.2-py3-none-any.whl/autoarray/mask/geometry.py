...
class Geometry:
    ...
    def central_scaled_coordinates(self):
        ...
        return geometry.central_scaled_coordinate_2d_from(
    ...
    def pixel_coordinates_2d_from(self, scaled_coordinates):

        return geometry.pixel_coordinates_2d_from(
            scaled_coordinates_2d=scaled_coordinates,
            shape_2d=self.mask.shape,
            pixel_scales=self.mask.pixel_scales,
            origins=self.origin,
        )

    def scaled_coordinates_2d_from(self, pixel_coordinates):

        return geometry.scaled_coordinates_2d_from(
            pixel_coordinates_2d=pixel_coordinates,
            shape_2d=self.mask.shape,
            pixel_scales=self.mask.pixel_scales,
            origins=self.origin,
        )
