...
Your contributions are welcome!  Simply fork the
`GitHub repository <https://github.com/nodedge/nodedge.git>`_
and send a `pull request`_.

.. _pull request: https://github.com/nodedge/nodedge/pulls
