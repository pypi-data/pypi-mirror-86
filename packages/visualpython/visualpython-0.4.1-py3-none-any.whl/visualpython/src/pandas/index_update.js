define([
    ...
    , 'nbextensions/visualpython/src/pandas/common/tagGenerator'
], function (requirejs, $, vpCommon, vpConst, sb, vpFuncJS, libPandas, tagGen) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "Index"
        , funcID : "pdPdo_index"  // TODO: ID 규칙 생성 필요
        , libID : 'pd003'
    }
    ...
    PandasPackage.prototype.bindOptions = function() {
        ...
        this.tagGenerator = new tagGen.TagGenerator(this, libPandas._PANDAS_FUNCTION[funcOptProp.libID]);
        this.tagGenerator.generateTags();
    ...
    PandasPackage.prototype.generateCode = function(addCell, exec) {
        ...
        // 코드 생성
        var result = ""; // TODO: pdGen.vp_codeGenerator(this.uuid, this.package);
