define([
 'jquery'
    ...
    , 'nbextensions/visualpython/src/numpy/constant_numpy_test'

    , 'nbextensions/visualpython/src/numpy/common/NumpyCodeGenerator/child/functionList/NpArrayCodeGenerator'
    , 'nbextensions/visualpython/src/numpy/common/NumpyPageRender/child/functionList/NpArrayPageRender'
    ...
    const funcOptProp = {
        stepCount : 1
        , funcName : "np.array"
        , funcID : "JY1"  // TODO: ID 규칙 생성 필요
    }
    
    /** numpy에서 사용하는 constData */
    const { VP_ID_PREFIX, VP_CLASS_PREFIX } = numpyConstData;
    ...
    var initOption = function(callback) {
        ...
        vpCommon.loadHtml(vpCommon.wrapSelector(`${VP_ID_PREFIX}${vpConst.OPTION_GREEN_ROOM}`), htmlUrlPath, optionLoadCallback, callback);
    }
