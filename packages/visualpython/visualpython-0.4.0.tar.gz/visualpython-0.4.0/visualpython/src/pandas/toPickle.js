define([
    ...
    var PandasPackage = function(uuid) {
        ...
        this.state = {
            ...
            fileExtension: "pickle" // 확장자
        };
        this.fileResultState = {
            pathInputId : this.wrapSelector('#path'),
    ...
    PandasPackage.prototype.bindOptions = function() {
        ...
        $(this.fileResultState.pathInputId).parent().html(
            `<input type="text" class="input-single" id="path" index="0" placeholder="" value="" title="">
            <input type="button" value="파일 경로" class="vp-navi-btn black w100" id="vp_openFileNavigationBtn"><span id="fileName"></span>`
        );
