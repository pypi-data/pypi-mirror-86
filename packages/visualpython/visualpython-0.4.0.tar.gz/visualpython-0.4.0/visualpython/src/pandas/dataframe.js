define([
...
], function (requirejs, $, vpCommon, vpConst, sb, vpFuncJS, libPandas, pdGen, md) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "DataFrame"
        , funcID : "pdPdo_dataframe"
        , libID : "pd002"
    }
    ...
    PandasPackage.prototype.bindOptions = function() {
        ...
        // TEST: load metadata
        // this.mdHandler = new md.MdHandler('pdPdo_dataframe');
        // this.mdHandler.loadMdAsTag(this);
    };
    ...
    PandasPackage.prototype.generateCode = function(addCell, exec) {
        ...
        // this.mdHandler.generateMetadata(this, inputIdList);
