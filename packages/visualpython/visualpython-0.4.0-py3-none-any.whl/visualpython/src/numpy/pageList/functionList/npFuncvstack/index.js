define([
    ...
    , 'nbextensions/visualpython/src/numpy/constData'
              ...
              vpNumpyConst, numpyStateApi, numpyRouteMapApi, numpyValidatorApi, numpyConstData ) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "np.vstack"
        , funcID : "JY32"  // TODO: ID 규칙 생성 필요
    }
    ...
    */
    ImportPackage.prototype.optionValidation = function() {
        // numpyPageRender안에 numpyStateGenerator의 this를 데이터로 담아 있는 상태에서
        // numpyStateGenerator의 getStateAll 메소드를 호출하여 state를 가져온다음
    ...
    ImportPackage.prototype.initHtml = function() {
        var { numpyCodeGenerator
            // , numpyCodeValidator
            , numpyPageRender
            , numpyStateGenerator } = newMapFuncIdToNumpyFuncData(funcOptProp.funcID, funcOptProp.funcName);
