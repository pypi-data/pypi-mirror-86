...
static PyMethodDef methods_wxFloatProperty[] = {
    {SIP_MLNAME_CAST(sipName_AddSpinStepValue), SIP_MLMETH_CAST(meth_wxFloatProperty_AddSpinStepValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_AddSpinStepValue)},
    ...
    {SIP_MLNAME_CAST(sipName_DoSetAttribute), SIP_MLMETH_CAST(meth_wxFloatProperty_DoSetAttribute), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_DoSetAttribute)},
    ...
    {SIP_MLNAME_CAST(sipName_StringToValue), SIP_MLMETH_CAST(meth_wxFloatProperty_StringToValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_StringToValue)},
    {SIP_MLNAME_CAST(sipName_ValidateValue), SIP_MLMETH_CAST(meth_wxFloatProperty_ValidateValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_ValidateValue)},
    {SIP_MLNAME_CAST(sipName_ValueToString), SIP_MLMETH_CAST(meth_wxFloatProperty_ValueToString), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_ValueToString)}
};
