...
extern "C" {static void assign_wxBoolProperty(void *, SIP_SSIZE_T, void *);}
static void assign_wxBoolProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::wxBoolProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::wxBoolProperty *>(sipSrc);
}


extern "C" {static void *copy_wxBoolProperty(const void *, SIP_SSIZE_T);}
static void *copy_wxBoolProperty(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static PyMethodDef methods_wxBoolProperty[] = {
    {SIP_MLNAME_CAST(sipName_DoSetAttribute), SIP_MLMETH_CAST(meth_wxBoolProperty_DoSetAttribute), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBoolProperty_DoSetAttribute)},
    {SIP_MLNAME_CAST(sipName_IntToValue), SIP_MLMETH_CAST(meth_wxBoolProperty_IntToValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBoolProperty_IntToValue)},
    {SIP_MLNAME_CAST(sipName_StringToValue), SIP_MLMETH_CAST(meth_wxBoolProperty_StringToValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBoolProperty_StringToValue)},
    {SIP_MLNAME_CAST(sipName_ValueToString), SIP_MLMETH_CAST(meth_wxBoolProperty_ValueToString), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBoolProperty_ValueToString)}
};
