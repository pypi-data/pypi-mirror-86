...
PURPOSE:   set of functions that help determine geometry for QUAD4M analyses
           functions transform DXF file to dataframes with node and elemen info for QUAD4M
           ASSUMES VERTICAL SOIL COLUMNS!!!
