from Multiprocessor.CacheCoherence import protocols, simulation_parameters, Ops
...
# Simulation(instruction_sizes=[5, 10, 25, 50, 100], n_processors=5, memory_content=2)
Simulation(instruction_sizes=[100, 100, 100, 100, 100], n_processors=5, memory_content=2)
