...
[boto3.CostandUsageReportService 1.16.23](https://boto3.amazonaws.com/v1/documentation/api/1.16.23/reference/services/cur.html#CostandUsageReportService) service
compatible with
