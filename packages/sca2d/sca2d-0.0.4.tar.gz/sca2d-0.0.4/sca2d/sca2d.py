...
class Analyser:
    ...
    def parse_file(self, file_reference):
        ...
        Analyzer for future use. The input can either be a string containing the file path or
        a UseIncStatment object created when a scad file parses a use or include statment.
        '''
