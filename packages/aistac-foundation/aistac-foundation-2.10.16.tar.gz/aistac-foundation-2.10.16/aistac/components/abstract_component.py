...
class AbstractComponent(ABC):
    ...
    @classmethod
    def from_memory(cls, uri_pm_repo: str=None, default_save_intent: bool=None, default_intent_level: bool=None,
        ...
        return cls.from_env(task_name=task_name, default_save=False, uri_pm_repo=uri_pm_repo, has_contract=False,
