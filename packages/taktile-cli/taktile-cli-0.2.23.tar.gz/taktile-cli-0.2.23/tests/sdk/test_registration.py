...
def test_custom_kind():
    ...
    with pytest.raises(ValueError):
        # Must define either payload or X, y
    ...
    schema = tktl.endpoints[1].input_schema.pydantic.schema()
    assert schema["title"] == "DataFrame__predict_typed__input"
...
def test_missing():
    ...
    with pytest.warns(UserWarning):
        tktl.endpoints[0].get_input_and_output_for_profiling()
