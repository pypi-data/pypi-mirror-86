...
class BitfinexSymbolMapper(System.Object, QuantConnect.Brokerages.ISymbolMapper):
    ...
    def GetLeanSymbol(self, brokerageSymbol: str, securityType: QuantConnect.SecurityType, market: str, expirationDate: datetime.datetime = ..., strike: float = 0, optionRight: QuantConnect.OptionRight = 0) -> QuantConnect.Symbol:
        ...
        :param brokerageSymbol: The Bitfinex symbol
    ...
    def IsKnownBrokerageSymbol(self, brokerageSymbol: str) -> bool:
        ...
        :param brokerageSymbol: The Bitfinex symbol
        :returns: True if Bitfinex supports the symbol
        """
        ...
...
class BitfinexSubscriptionManager(QuantConnect.Data.DataQueueHandlerSubscriptionManager):
    ...
    def __init__(self, brokerage: QuantConnect.Brokerages.Bitfinex.BitfinexBrokerage, wssUrl: str, symbolMapper: QuantConnect.Brokerages.Bitfinex.BitfinexSymbolMapper) -> None:
