...
class GDAXBrokerage(QuantConnect.Brokerages.BaseWebsocketsBrokerage):
    ...
    @staticmethod
    def ConvertProductId(productId: str) -> QuantConnect.Symbol:
        """
        Converts a product id to a symbol
        
        :param productId: gdax format product id
        :returns: Symbol
        """
        ...

    @staticmethod
    def ConvertSymbol(symbol: typing.Union[QuantConnect.Symbol, str]) -> str:
        """
        Converts a symbol to a product id
        
        This method is protected.
        
        :param symbol: Th symbol
        :returns: gdax product id
        """
        ...
