...
class BinanceSymbolMapper(System.Object, QuantConnect.Brokerages.ISymbolMapper):
    ...
    def GetLeanSymbol(self, brokerageSymbol: str, securityType: QuantConnect.SecurityType, market: str, expirationDate: datetime.datetime = ..., strike: float = 0, optionRight: QuantConnect.OptionRight = 0) -> QuantConnect.Symbol:
        ...
        :param brokerageSymbol: The Binance symbol
    ...
    def IsKnownBrokerageSymbol(self, brokerageSymbol: str) -> bool:
        ...
        :param brokerageSymbol: The Binance symbol
        :returns: True if Binance supports the symbol
        """
        ...
...
class BinanceRestApiClient(System.Object, System.IDisposable):
    ...
    def __init__(self, symbolMapper: QuantConnect.Brokerages.Binance.BinanceSymbolMapper, securityProvider: QuantConnect.Securities.ISecurityProvider, apiKey: str, apiSecret: str) -> None:
        """
