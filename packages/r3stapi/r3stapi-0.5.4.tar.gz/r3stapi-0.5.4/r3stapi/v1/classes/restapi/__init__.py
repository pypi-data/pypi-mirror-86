...
from r3stapi.v1.classes import payments, users
...
class RestAPI(object):
	...
	def get_subscriptions(self, 
		...
		try:
			...
			# success.
			print("SUBSCRIPTIONS:",json.dumps(subscriptions, indent=4))
	...
	def cancel_subscription(self, 
		...
		# get subscription id.
		print(plans)
		print(self.__plans__[plan]["plan_id"])
		print(plans[self.__plans__[plan]["plan_id"]])
		try:
