...
class QuantumClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('quantum/{}'.format(VERSION))
...
class QuantumClient(SDKClient):
    ...
    :vartype jobs: microsoft.quantum.operations.JobsOperations
    :ivar providers: Providers operations
    :vartype providers: microsoft.quantum.operations.ProvidersOperations
    :ivar storage: Storage operations
    :vartype storage: microsoft.quantum.operations.StorageOperations
