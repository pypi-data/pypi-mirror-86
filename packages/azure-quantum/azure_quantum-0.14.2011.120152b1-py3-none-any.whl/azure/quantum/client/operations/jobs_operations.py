...
class JobsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~microsoft.quantum.models.JobDetailsPaged[~microsoft.quantum.models.JobDetails]
    ...
    def get(
        ...
        :rtype: ~microsoft.quantum.models.JobDetails or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`RestErrorException<microsoft.quantum.models.RestErrorException>`
        """
        # Construct URL
    ...
    def put(
        ...
        :type job_definition: ~microsoft.quantum.models.JobDetails
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
