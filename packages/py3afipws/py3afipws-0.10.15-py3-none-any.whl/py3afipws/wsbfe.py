...
electr�nico del web service WSBFE de AFIP (Bono Fiscal Electr�nico)
"""
...
def get_param_ncm(client, token, sign, cuit):
    "Recuperador de valores referenciales de c�digos de productos"
...
def get_param_tipo_iva(client, token, sign, cuit):
    "Recuperador de valores referenciales de c�digos de IVA"
...
class ItemBF:
    ...
    def __init__(self, ncm="", sec="", ds="", qty=1, umed=7, precio=0.00, bonif=0.00, iva_id=5, imp_total=0.00, **kwargs):
        "Constructor" #TODO: revisar c�lculo de iva y totales
...
def main():
    ...
    if "--prueba" in sys.argv:
        ...
        it = ItemBF(ncm='7308.10.00', sec='', ds=u'prueba Anafe econ�mico', qty=2.0, precio=100.0, bonif=0.0, iva_id=5)
        f.add_item(it)
