...
class PyEmail:
    ...
    def AgregarDestinatario(self, destinatario):
        "Agrega una direcci�n de correo de destino"
        self.Destinatarios.append(destinatario)
        return True

    def AgregarCC(self, destinatario):
        "Agrega una direcci�n de correo de destino (copia carb�nica)"
        self.CC.append(destinatario)
        return True

    def AgregarBCC(self, destinatario):
        "Agrega una direcci�n de correo de destino (copia carb�nica invisible)"
