...
"M�dulo para Consulta de Operaciones Cambiarias"
...
import sys
import traceback
import py3simplesoap.client
from py3simplesoap.client import SoapClient, SoapFault, parse_proxy, \
    set_http_wrapper
from py3simplesoap.simplexml import SimpleXMLElement
...
class WSCOC:
    ...
    Version = "%s %s %s" % (__version__, HOMO and 'Homologaci�n' or ''py3simplesoapap.client.__file__)
    ...
    def Conectar(self, cache=None, wsdl=None, proxy="", wrapper=None, cacert=None, timeout=30):
        ...
        # corrijo ubicaci�n del servidor (http en el WSDL)
    ...
    def GenerarSolicitudCompraDivisa(self, cuit_comprador, codigo_moneda,
        ...
        "Generar una Solicitud de operaci�n cambiaria"
        if tipo and codigo:
    ...
    def InformarSolicitudCompraDivisa(self, codigo_solicitud, nuevo_estado):
        "Informar la aceptaci�n o desistir una solicitud generada con anterioridad"
    ...
    def ConsultarCUIT(self, numero_doc, tipo_doc=80, sep="|"):
        "Consultar la CUIT, CDI � CUIL, seg�n corresponda, para un determinado tipo y n�mero de documento."
        ...
        if 'consultarCUITReturn' in res:
            ...
            if 'tipoNumeroDoc' in ret:
                ...
                # devuelvo una lista de cuit/denominaci�n
    ...
    def ConsultarSolicitudCompraDivisa(self, codigo_solicitud):
        "Consultar una Solicitud de Operaci�n Cambiaria"
    ...
    def ConsultarSolicitudesCompraDivisas(self, cuit_comprador,
        ...
        solicitudes = []                    # c�digos a devolver
        ...
        for array in ret.get('arrayDetallesSolicitudes', []):
            ...
            # devuelvo solo el c�digo de solicitud
    ...
    def ConsultarDJAI(self, djai, cuit):
        "Consultar Declaraci�n Jurada Anticipada de Importaci�n"
    ...
    def ConsultarDJAS(self, djas, cuit):
        "Consultar Declaraci�n Jurada Anticipada de Servicios"
    ...
    def ConsultarReferencia(self, tipo, codigo):
        "Consultar una determinada referencia seg�n su tipo (1: DJAI, 2: DJAS, 3: DJAT)"
    ...
    def ConsultarMonedas(self, sep="|"):
        "Este m�todo retorna el universo de Monedas disponibles en el presente WS, indicando c�digo y descripci�n de cada una"
    ...
    def ConsultarTiposEstadoSolicitud(self, sep="|"):
        "Este m�todo devuelve los diferentes tipos de estado que puede tener una solicitud."
    ...
    def ConsultarMotivosExcepcionDJAI(self, sep='|'):
        "Este m�todo retorna el universo de motivos de excepciones a la Declaraci�n Jurada Anticipada de Importaci�n"
    ...
    def ConsultarDestinosCompraDJAI(self, sep='|'):
        "Este m�todo retorna el subconjunto de los destinos de compra de divisas alcanzados por las normativas de la Declaraci�n Jurada Anticipada de Importaci�n."
    ...
    def ConsultarMotivosExcepcionDJAS(self, sep='|'):
        "Este m�todo retorna el universo de motivos de excepciones a la Declaraci�n Jurada Anticipada de Servicios"
    ...
    def ConsultarDestinosCompraDJAS(self, sep='|'):
        "Este m�todo retorna el subconjunto de los destinos de compra de divisas alcanzados por las normativas de la Declaraci�n Jurada Anticipada de Servicios"
    ...
    def ConsultarTiposReferencia(self, sep='|'):
        "Este m�todo retorna el conjunto de los tipos de referencia que pueden ser utilizados en la generaci�n de una solicitud de compra de divisas seg�n corresponda."
    ...
    def ConsultarDestinosCompraTipoReferencia(self, tipo, sep='|'):
        "Este m�todo retorna el subconjunto de los destinos de compra de divisas alcanzados por algunas de las normativas vigentes seg�n el tipo de referencia requerido"
...
def main():
    ...
    if "--consultar_cuit" in sys.argv:
        ...
        try:
            ...
            while ws.LeerCUITConsultado():
                ...
                print("Denominaci�n", ws.DenominacionConsultada)
        except Exception as e:
            raise
            print("Exception", e)
            print(ws.XmlRequest)
    ...
    if "--consultar_solicitudes" in sys.argv:
        ...
        sols = ws.ConsultarSolicitudesCompraDivisas(cuit_comprador,
                                                    ...
                                                    fecha_emision_desde,
                                                    fecha_emision_hasta,)
        # muestro los resultados de la b�squeda
        print("Solicitudes consultadas:")
        for sol in sols:
            print("C�digo de Solicitud:", sol)
            # podr�a llamar a ws.ConsultarSolicitudCompraDivisa
        print("hecho.")
