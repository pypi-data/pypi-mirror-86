...
"""M�dulo para Trazabilidad de Productos M�dicos ANMAT - Disp. 2303/2014
seg�n Especificaci�n T�cnica para Pruebas de Servicios (17/09/2015)"""
...
class TrazaProdMed(BaseWS):
    "Interfaz para el WebService de Trazabilidad de Productos M�dicos ANMAT - PAMI - INSSJP"
    ...
    def CrearTransaccion(self,
        ...
        # creo la transacci�n con los par�metros para llamar a InformarProducto
        tx = {
    ...
    def InformarProducto(self, usuario, password):
        "Realiza el registro de una transacci�n de producto. "
        # El usuario (titular del registro/distribuidor/m�dico/establecimiento
