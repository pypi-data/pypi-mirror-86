...
if 'py2exe' in sys.argv:
    ...
    if 'py3afipws' in globals():
        kwargs['com_server'] += ["py3afipws"]
    ...
    if 'pyrece' in globals():
        ...
        if os.path.exists("logo-py3afipws.png"):
            data_files.append((".", ['logo-py3afipws.png', 'logo-sistemasagiles.png']))
    ...
    kwargs['package_dir'] = {'py3afipws': '.'}
    kwargs['packages'] = ['py3afipws']
    opts = {}
    data_files = []
...
setup(name="PyAfipWs",
      ...
      url="https://github.com/reingart/py3afipws" if not 'py2exe' in sys.argv 
