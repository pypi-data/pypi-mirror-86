...
class ColorHandler(logging.Handler):
    ...
    def __build_color_msg_with_background_color(self, record_level, assist_msg, effective_information_msg):
    ...
    def __build_color_msg_with_no_background_color(self, record_level, assist_msg, effective_information_msg):
    ...
    def emit(self, record: logging.LogRecord):
        ...
        try:
            ...
            if nb_log_config_default.DISPLAY_BACKGROUD_COLOR_IN_CONSOLE:
                msg_color = self.__build_color_msg_with_background_color(record.levelno, assist_msg,
                                                                         effective_information_msg)
            else:
                msg_color = self.__build_color_msg_with_no_background_color(record.levelno, assist_msg,
                                                                            effective_information_msg)
