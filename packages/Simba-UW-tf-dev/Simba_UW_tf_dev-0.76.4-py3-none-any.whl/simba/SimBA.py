...
class loadprojectini:
    def __init__(self,configini):
        ...
        button_directionality = Button(processmovementdupLabel, text='Analyze directionality between animals', command = lambda: directing_to_other_animals(self.projectconfigini))
        button_directionality_visualize = Button(processmovementdupLabel, text='Visualize directionality between animals', command=lambda: ROI_directionality_other_animals_visualize(self.projectconfigini))
        ...
        button_directionality.grid(row=4)
        button_directionality_visualize.grid(row=5)
    ...
    def run_roiAnalysisSettings(self,master,noofanimal,appendornot):
        ...
        runButton = Button(self.secondMenu,text='Run',command =lambda:self.run_analyze_roi(noofanimal.get(), animalVarList, appendornot))
