...
class TaskResult:
    def __init__(self, result, error_message, stack_trace):
        self.result = result
        self.error_message = error_message
        self.stack_trace = stack_trace

    @staticmethod
    def create_from_request_entity(self, entity):
        result, error_message, stack = None
        if 'Result' in entity:
        ...
        return TaskResult(result, error, trace)
