...
EXTRAS = {
    'MINIMAL': ['numpy', 'dill', 'UnitTesterSG', 'CiteSoft'],# 'uncertainties': ['uncertainties'], #pymc...

    'COMPLETE': ['numpy', 'kiwi-gtk', 'dill', 'pycairo==1.11.1', 'pygobject==3.30', 'UnitTesterSG', 'CiteSoft']# 'uncertainties': ['uncertainties'], #pymc...
}
