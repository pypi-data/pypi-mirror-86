...
#
#  $ bin/test -s library.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src library.theme.testing.LIBRARY_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/library/theme/tests/robot/test_example.robot
#
