...
class KubedevConfig:
  ...
  @staticmethod
  def get_docker_run_volumes(volumes: dict, file_accessor, shell_executor) -> str:
    args = KubedevConfig.get_docker_run_volumes_list(volumes, file_accessor, shell_executor)
