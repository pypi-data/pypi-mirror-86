...
[boto3.ServiceDiscovery 1.16.25](https://boto3.amazonaws.com/v1/documentation/api/1.16.25/reference/services/servicediscovery.html#ServiceDiscovery) service
compatible with
