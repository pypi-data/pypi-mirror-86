...
[boto3.ServiceDiscovery 1.16.22](https://boto3.amazonaws.com/v1/documentation/api/1.16.22/reference/services/servicediscovery.html#ServiceDiscovery) service
compatible with
