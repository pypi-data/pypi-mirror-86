...
{
    HRESULT __stdcall GetParentProviderId(::IUnknown* provider, HSTRING* value) noexcept final
    {
        try
        {
    ...
    HRESULT __stdcall GetProviderId(::IUnknown* provider, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
