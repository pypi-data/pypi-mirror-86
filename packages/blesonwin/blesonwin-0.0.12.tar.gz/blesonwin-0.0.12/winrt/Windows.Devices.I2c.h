...
template <typename D> int32_t consume_Windows_Devices_I2c_II2cConnectionSettings<D>::SlaveAddress() const noexcept
{
    int32_t value{};
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->get_SlaveAddress(&value));
    return value;
}

template <typename D> void consume_Windows_Devices_I2c_II2cConnectionSettings<D>::SlaveAddress(int32_t value) const noexcept
{
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->put_SlaveAddress(value));
}

template <typename D> Windows::Devices::I2c::I2cBusSpeed consume_Windows_Devices_I2c_II2cConnectionSettings<D>::BusSpeed() const noexcept
{
    Windows::Devices::I2c::I2cBusSpeed value{};
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->get_BusSpeed(put_abi(value)));
    return value;
}

template <typename D> void consume_Windows_Devices_I2c_II2cConnectionSettings<D>::BusSpeed(Windows::Devices::I2c::I2cBusSpeed const& value) const noexcept
{
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->put_BusSpeed(get_abi(value)));
}

template <typename D> Windows::Devices::I2c::I2cSharingMode consume_Windows_Devices_I2c_II2cConnectionSettings<D>::SharingMode() const noexcept
{
    Windows::Devices::I2c::I2cSharingMode value{};
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->get_SharingMode(put_abi(value)));
    return value;
}

template <typename D> void consume_Windows_Devices_I2c_II2cConnectionSettings<D>::SharingMode(Windows::Devices::I2c::I2cSharingMode const& value) const noexcept
{
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->put_SharingMode(get_abi(value)));
}
...
template <typename D> hstring consume_Windows_Devices_I2c_II2cDevice<D>::DeviceId() const noexcept
{
    hstring value{};
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->get_DeviceId(put_abi(value)));
    return value;
}

template <typename D> Windows::Devices::I2c::I2cConnectionSettings consume_Windows_Devices_I2c_II2cDevice<D>::ConnectionSettings() const noexcept
{
    Windows::Devices::I2c::I2cConnectionSettings value{ nullptr };
    check_terminate(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->get_ConnectionSettings(put_abi(value)));
    return value;
}
...
struct produce<D, Windows::Devices::I2c::II2cConnectionSettings> : produce_base<D, Windows::Devices::I2c::II2cConnectionSettings>
{
    ...
    HRESULT __stdcall get_BusSpeed(Windows::Devices::I2c::I2cBusSpeed* value) noexcept final
    {
        typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall put_BusSpeed(Windows::Devices::I2c::I2cBusSpeed value) noexcept final
    {
        typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall get_SharingMode(Windows::Devices::I2c::I2cSharingMode* value) noexcept final
    {
        typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall put_SharingMode(Windows::Devices::I2c::I2cSharingMode value) noexcept final
    {
        typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall Create(int32_t slaveAddress, ::IUnknown** value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
struct produce<D, Windows::Devices::I2c::II2cDeviceStatics> : produce_base<D, Windows::Devices::I2c::II2cDeviceStatics>
{
    ...
    HRESULT __stdcall FromIdAsync(HSTRING deviceId, ::IUnknown* settings, ::IUnknown** operation) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
