...
{
    HRESULT __stdcall GetStringForUri(::IUnknown* uri, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall CreateResourceLoaderByName(HSTRING name, ::IUnknown** loader) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall GetStringForReference(::IUnknown* uri, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
struct produce<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics2> : produce_base<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics2>
{
    ...
    HRESULT __stdcall GetForCurrentViewWithName(HSTRING name, ::IUnknown** loader) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall GetForViewIndependentUseWithName(HSTRING name, ::IUnknown** loader) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
