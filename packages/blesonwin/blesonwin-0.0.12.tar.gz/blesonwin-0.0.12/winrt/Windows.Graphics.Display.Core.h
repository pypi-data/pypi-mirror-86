...
template <typename D> uint32_t consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::ResolutionWidthInRawPixels() const noexcept
{
    uint32_t value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_ResolutionWidthInRawPixels(&value));
    return value;
}

template <typename D> uint32_t consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::ResolutionHeightInRawPixels() const noexcept
{
    uint32_t value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_ResolutionHeightInRawPixels(&value));
    return value;
}

template <typename D> double consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::RefreshRate() const noexcept
{
    double value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_RefreshRate(&value));
    return value;
}

template <typename D> bool consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::StereoEnabled() const noexcept
{
    bool value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_StereoEnabled(&value));
    return value;
}

template <typename D> uint16_t consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::BitsPerPixel() const noexcept
{
    uint16_t value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_BitsPerPixel(&value));
    return value;
}
...
template <typename D> Windows::Graphics::Display::Core::HdmiDisplayColorSpace consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::ColorSpace() const noexcept
{
    Windows::Graphics::Display::Core::HdmiDisplayColorSpace value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_ColorSpace(put_abi(value)));
    return value;
}

template <typename D> Windows::Graphics::Display::Core::HdmiDisplayPixelEncoding consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::PixelEncoding() const noexcept
{
    Windows::Graphics::Display::Core::HdmiDisplayPixelEncoding value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_PixelEncoding(put_abi(value)));
    return value;
}

template <typename D> bool consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::IsSdrLuminanceSupported() const noexcept
{
    bool value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_IsSdrLuminanceSupported(&value));
    return value;
}

template <typename D> bool consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::IsSmpte2084Supported() const noexcept
{
    bool value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_IsSmpte2084Supported(&value));
    return value;
}

template <typename D> bool consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::Is2086MetadataSupported() const noexcept
{
    bool value{};
    check_terminate(WINRT_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_Is2086MetadataSupported(&value));
    return value;
}
...
{
    HRESULT __stdcall GetSupportedDisplayModes(::IUnknown** result) noexcept final
    {
        try
        {
    ...
    HRESULT __stdcall GetCurrentDisplayMode(::IUnknown** result) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall SetDefaultDisplayModeAsync(::IUnknown** operation) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RequestSetCurrentDisplayModeAsync(::IUnknown* mode, ::IUnknown** operation) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RequestSetCurrentDisplayModeWithHdrAsync(::IUnknown* mode, Windows::Graphics::Display::Core::HdmiDisplayHdrOption hdrOption, ::IUnknown** operation) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall RequestSetCurrentDisplayModeWithHdrAndMetadataAsync(::IUnknown* mode, Windows::Graphics::Display::Core::HdmiDisplayHdrOption hdrOption, struct_of<24> hdrMetadata, ::IUnknown** operation) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall add_DisplayModesChanged(::IUnknown* value, event_token* token) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
struct produce<D, Windows::Graphics::Display::Core::IHdmiDisplayMode> : produce_base<D, Windows::Graphics::Display::Core::IHdmiDisplayMode>
{
    ...
    HRESULT __stdcall IsEqual(::IUnknown* mode, bool* result) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
