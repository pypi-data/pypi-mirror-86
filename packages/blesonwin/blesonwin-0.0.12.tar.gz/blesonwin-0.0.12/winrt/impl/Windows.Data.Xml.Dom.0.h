...
{
    Windows::Foundation::IInspectable PublicId() const noexcept;
    Windows::Foundation::IInspectable SystemId() const noexcept;
    Windows::Foundation::IInspectable NotationName() const noexcept;
};
...
{
    Windows::Data::Xml::Dom::XmlDocumentType Doctype() const noexcept;
    Windows::Data::Xml::Dom::XmlDomImplementation Implementation() const noexcept;
    Windows::Data::Xml::Dom::XmlElement DocumentElement() const noexcept;
    ...
    hstring DocumentUri() const noexcept;
...
{
    hstring Name() const noexcept;
    Windows::Data::Xml::Dom::XmlNamedNodeMap Entities() const noexcept;
    Windows::Data::Xml::Dom::XmlNamedNodeMap Notations() const noexcept;
};
...
{
    hstring TagName() const noexcept;
...
{
    uint32_t MaxElementDepth() const noexcept;
    void MaxElementDepth(uint32_t value) const noexcept;
    bool ProhibitDtd() const noexcept;
    void ProhibitDtd(bool value) const noexcept;
    bool ResolveExternals() const noexcept;
    void ResolveExternals(bool value) const noexcept;
    bool ValidateOnParse() const noexcept;
    void ValidateOnParse(bool value) const noexcept;
    bool ElementContentWhiteSpace() const noexcept;
    void ElementContentWhiteSpace(bool value) const noexcept;
};
...
{
    Windows::Foundation::IInspectable NodeValue() const noexcept;
    void NodeValue(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::Data::Xml::Dom::NodeType NodeType() const noexcept;
    hstring NodeName() const noexcept;
    Windows::Data::Xml::Dom::IXmlNode ParentNode() const noexcept;
    Windows::Data::Xml::Dom::XmlNodeList ChildNodes() const noexcept;
    Windows::Data::Xml::Dom::IXmlNode FirstChild() const noexcept;
    Windows::Data::Xml::Dom::IXmlNode LastChild() const noexcept;
    Windows::Data::Xml::Dom::IXmlNode PreviousSibling() const noexcept;
    Windows::Data::Xml::Dom::IXmlNode NextSibling() const noexcept;
    Windows::Data::Xml::Dom::XmlNamedNodeMap Attributes() const noexcept;
    bool HasChildNodes() const;
    Windows::Data::Xml::Dom::XmlDocument OwnerDocument() const noexcept;
    ...
    Windows::Foundation::IInspectable NamespaceUri() const noexcept;
    Windows::Foundation::IInspectable LocalName() const noexcept;
    Windows::Foundation::IInspectable Prefix() const noexcept;
    void Normalize() const;
    void Prefix(Windows::Foundation::IInspectable const& value) const noexcept;
};
...
struct consume_Windows_Data_Xml_Dom_IXmlNodeSerializer
{
    ...
    hstring InnerText() const noexcept;
    void InnerText(param::hstring const& value) const noexcept;
};
...
template <> struct abi<Windows::Data::Xml::Dom::IXmlNode>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_NodeType(Windows::Data::Xml::Dom::NodeType* value) = 0;
