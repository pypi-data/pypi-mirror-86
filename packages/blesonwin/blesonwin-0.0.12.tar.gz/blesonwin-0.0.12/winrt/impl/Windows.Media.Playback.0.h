...
enum class [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] MediaPlayerState : int32_t
{
    Closed = 0,
    Opening = 1,
    Buffering = 2,
...
template <> struct guid<Windows::Media::Playback::IMediaPlaybackSessionBufferingStartedEventArgs>{ static constexpr GUID value{ 0xCD6AAFED,0x74E2,0x43B5,{ 0xB1,0x15,0x76,0x23,0x6C,0x33,0x79,0x1A } }; };
...
template <> struct guid<Windows::Media::Playback::IMediaPlayer6>{ static constexpr GUID value{ 0xE0CAA086,0xAE65,0x414C,{ 0xB0,0x10,0x8B,0xC5,0x5F,0x00,0xE6,0x92 } }; };
...
{
    [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] Windows::Media::Playback::MediaPlayer Current() const noexcept;
...
{
    Windows::Media::Playback::MediaPlaybackItem NewItem() const noexcept;
    Windows::Media::Playback::MediaPlaybackItem OldItem() const noexcept;
};
...
{
    Windows::Media::Playback::MediaPlaybackItemChangedReason Reason() const noexcept;
};
...
{
    Windows::Media::Playback::MediaPlaybackList PlaybackList() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> PresentationPosition() const noexcept;
    Windows::Media::Playback::MediaBreakInsertionMethod InsertionMethod() const noexcept;
    Windows::Foundation::Collections::ValueSet CustomProperties() const noexcept;
    bool CanStart() const noexcept;
    void CanStart(bool value) const noexcept;
};
...
{
    Windows::Media::Playback::MediaBreak MediaBreak() const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaBreakManager
{
    ...
    Windows::Media::Playback::MediaBreak CurrentBreak() const noexcept;
    Windows::Media::Playback::MediaPlaybackSession PlaybackSession() const noexcept;
...
struct consume_Windows_Media_Playback_IMediaBreakSchedule
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Media::Playback::MediaBreak> MidrollBreaks() const noexcept;
    void PrerollBreak(Windows::Media::Playback::MediaBreak const& value) const noexcept;
    Windows::Media::Playback::MediaBreak PrerollBreak() const noexcept;
    void PostrollBreak(Windows::Media::Playback::MediaBreak const& value) const noexcept;
    Windows::Media::Playback::MediaBreak PostrollBreak() const noexcept;
    Windows::Media::Playback::MediaPlaybackItem PlaybackItem() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Media::Playback::MediaBreak> SeekedOverBreaks() const noexcept;
    Windows::Foundation::TimeSpan OldPosition() const noexcept;
    Windows::Foundation::TimeSpan NewPosition() const noexcept;
};
...
{
    [[deprecated("Use MediaPlayer instead of MediaEngine. For more info, see MSDN.")]] Windows::Media::Playback::MediaPlaybackItem CurrentItem() const noexcept;
...
{
    Windows::Media::MediaPlaybackType Type() const noexcept;
    void Type(Windows::Media::MediaPlaybackType const& value) const noexcept;
    Windows::Media::MusicDisplayProperties MusicProperties() const noexcept;
    Windows::Media::VideoDisplayProperties VideoProperties() const noexcept;
...
struct consume_Windows_Media_Playback_IMediaPlaybackCommandManager
{
    ...
    Windows::Media::Playback::MediaPlayer MediaPlayer() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior PlayBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior PauseBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior NextBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior PreviousBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior FastForwardBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior RewindBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior ShuffleBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior AutoRepeatModeBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior PositionBehavior() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior RateBehavior() const noexcept;
...
struct consume_Windows_Media_Playback_IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs
{
    ...
    Windows::Media::MediaPlaybackAutoRepeatMode AutoRepeatMode() const noexcept;
...
{
    Windows::Media::Playback::MediaPlaybackCommandManager CommandManager() const noexcept;
    bool IsEnabled() const noexcept;
    Windows::Media::Playback::MediaCommandEnablingRule EnablingRule() const noexcept;
    void EnablingRule(Windows::Media::Playback::MediaCommandEnablingRule const& value) const noexcept;
...
struct consume_Windows_Media_Playback_IMediaPlaybackCommandManagerPositionReceivedEventArgs
{
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::Foundation::TimeSpan Position() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackCommandManagerShuffleReceivedEventArgs
{
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    bool IsShuffleRequested() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackItem
{
    ...
    Windows::Media::Core::MediaSource Source() const noexcept;
    Windows::Media::Playback::MediaPlaybackAudioTrackList AudioTracks() const noexcept;
    Windows::Media::Playback::MediaPlaybackVideoTrackList VideoTracks() const noexcept;
    Windows::Media::Playback::MediaPlaybackTimedMetadataTrackList TimedMetadataTracks() const noexcept;
};
...
{
    Windows::Media::Playback::MediaBreakSchedule BreakSchedule() const noexcept;
    Windows::Foundation::TimeSpan StartTime() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> DurationLimit() const noexcept;
    bool CanSkip() const noexcept;
    void CanSkip(bool value) const noexcept;
...
{
    bool IsDisabledInPlaybackList() const noexcept;
    void IsDisabledInPlaybackList(bool value) const noexcept;
    double TotalDownloadProgress() const noexcept;
    Windows::Media::Playback::AutoLoadedDisplayPropertyKind AutoLoadedDisplayProperties() const noexcept;
    void AutoLoadedDisplayProperties(Windows::Media::Playback::AutoLoadedDisplayPropertyKind const& value) const noexcept;
};
...
{
    Windows::Media::Playback::MediaPlaybackItemErrorCode ErrorCode() const noexcept;
...
{
    Windows::Media::Playback::MediaPlaybackItem Item() const noexcept;
    Windows::Media::Playback::MediaPlaybackItemError Error() const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackList
{
    ...
    Windows::Foundation::Collections::IObservableVector<Windows::Media::Playback::MediaPlaybackItem> Items() const noexcept;
    bool AutoRepeatEnabled() const noexcept;
    void AutoRepeatEnabled(bool value) const noexcept;
    bool ShuffleEnabled() const noexcept;
    void ShuffleEnabled(bool value) const noexcept;
    Windows::Media::Playback::MediaPlaybackItem CurrentItem() const noexcept;
    uint32_t CurrentItemIndex() const noexcept;
...
{
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> MaxPrefetchTime() const noexcept;
    void MaxPrefetchTime(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
    Windows::Media::Playback::MediaPlaybackItem StartingItem() const noexcept;
    void StartingItem(Windows::Media::Playback::MediaPlaybackItem const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Playback::MediaPlaybackItem> ShuffledItems() const noexcept;
...
{
    Windows::Foundation::IReference<uint32_t> MaxPlayedItemsToKeepOpen() const noexcept;
    void MaxPlayedItemsToKeepOpen(optional<uint32_t> const& value) const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackSession
{
    ...
    Windows::Media::Playback::MediaPlayer MediaPlayer() const noexcept;
    Windows::Foundation::TimeSpan NaturalDuration() const noexcept;
    Windows::Foundation::TimeSpan Position() const noexcept;
    void Position(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Media::Playback::MediaPlaybackState PlaybackState() const noexcept;
    bool CanSeek() const noexcept;
    bool CanPause() const noexcept;
    bool IsProtected() const noexcept;
    double PlaybackRate() const noexcept;
    void PlaybackRate(double value) const noexcept;
    double BufferingProgress() const noexcept;
    double DownloadProgress() const noexcept;
    uint32_t NaturalVideoHeight() const noexcept;
    uint32_t NaturalVideoWidth() const noexcept;
    Windows::Foundation::Rect NormalizedSourceRect() const noexcept;
    void NormalizedSourceRect(Windows::Foundation::Rect const& value) const noexcept;
    Windows::Media::MediaProperties::StereoscopicVideoPackingMode StereoscopicVideoPackingMode() const noexcept;
    void StereoscopicVideoPackingMode(Windows::Media::MediaProperties::StereoscopicVideoPackingMode const& value) const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackSession2
{
    ...
    Windows::Media::Playback::MediaPlaybackSphericalVideoProjection SphericalVideoProjection() const noexcept;
    bool IsMirroring() const noexcept;
    void IsMirroring(bool value) const noexcept;
...
{
    bool IsPlaybackInterruption() const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlaybackSphericalVideoProjection
{
    bool IsEnabled() const noexcept;
    void IsEnabled(bool value) const noexcept;
    Windows::Media::MediaProperties::SphericalVideoFrameFormat FrameFormat() const noexcept;
    void FrameFormat(Windows::Media::MediaProperties::SphericalVideoFrameFormat const& value) const noexcept;
    double HorizontalFieldOfViewInDegrees() const noexcept;
    void HorizontalFieldOfViewInDegrees(double value) const noexcept;
    Windows::Foundation::Numerics::quaternion ViewOrientation() const noexcept;
    void ViewOrientation(Windows::Foundation::Numerics::quaternion const& value) const noexcept;
    Windows::Media::Playback::SphericalVideoProjectionMode ProjectionMode() const noexcept;
    void ProjectionMode(Windows::Media::Playback::SphericalVideoProjectionMode const& value) const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlayer
{
    ...
    void AutoPlay(bool value) const noexcept;
    [[deprecated("Use PlaybackSession.NaturalDuration instead of NaturalDuration.  For more info, see MSDN.")]] Windows::Foundation::TimeSpan NaturalDuration() const noexcept;
    [[deprecated("Use PlaybackSession.Position instead of Position.  For more info, see MSDN.")]] Windows::Foundation::TimeSpan Position() const noexcept;
    [[deprecated("Use PlaybackSession.Position instead of Position.  For more info, see MSDN.")]] void Position(Windows::Foundation::TimeSpan const& value) const noexcept;
    [[deprecated("Use PlaybackSession.BufferingProgress instead of BufferingProgress.  For more info, see MSDN.")]] double BufferingProgress() const noexcept;
    [[deprecated("Use PlaybackSession.State instead of CurrentState.  For more info, see MSDN.")]] Windows::Media::Playback::MediaPlayerState CurrentState() const noexcept;
    [[deprecated("Use PlaybackSession.CanSeek instead of CanSeek.  For more info, see MSDN.")]] bool CanSeek() const noexcept;
    [[deprecated("Use PlaybackSession.CanPause instead of CanPause.  For more info, see MSDN.")]] bool CanPause() const noexcept;
    bool IsLoopingEnabled() const noexcept;
    void IsLoopingEnabled(bool value) const noexcept;
    [[deprecated("Use PlaybackSession.IsProtected instead of IsProtected.  For more info, see MSDN.")]] bool IsProtected() const noexcept;
    bool IsMuted() const noexcept;
    void IsMuted(bool value) const noexcept;
    [[deprecated("Use PlaybackSession.PlaybackRate instead of PlaybackRate.  For more info, see MSDN.")]] double PlaybackRate() const noexcept;
    [[deprecated("Use PlaybackSession.PlaybackRate instead of PlaybackRate.  For more info, see MSDN.")]] void PlaybackRate(double value) const noexcept;
    double Volume() const noexcept;
    void Volume(double value) const noexcept;
    [[deprecated("Use media tracks on MediaPlaybackItem instead of PlaybackMediaMarkers.  For more info, see MSDN.")]] Windows::Media::Playback::PlaybackMediaMarkerSequence PlaybackMediaMarkers() const noexcept;
...
{
    Windows::Media::SystemMediaTransportControls SystemMediaTransportControls() const noexcept;
    Windows::Media::Playback::MediaPlayerAudioCategory AudioCategory() const noexcept;
    void AudioCategory(Windows::Media::Playback::MediaPlayerAudioCategory const& value) const noexcept;
    Windows::Media::Playback::MediaPlayerAudioDeviceType AudioDeviceType() const noexcept;
    void AudioDeviceType(Windows::Media::Playback::MediaPlayerAudioDeviceType const& value) const noexcept;
};
...
struct consume_Windows_Media_Playback_IMediaPlayer3
{
    ...
    double AudioBalance() const noexcept;
    void AudioBalance(double value) const noexcept;
    bool RealTimePlayback() const noexcept;
    void RealTimePlayback(bool value) const noexcept;
    Windows::Media::Playback::StereoscopicVideoRenderMode StereoscopicVideoRenderMode() const noexcept;
    void StereoscopicVideoRenderMode(Windows::Media::Playback::StereoscopicVideoRenderMode const& value) const noexcept;
    Windows::Media::Playback::MediaBreakManager BreakManager() const noexcept;
    Windows::Media::Playback::MediaPlaybackCommandManager CommandManager() const noexcept;
    Windows::Devices::Enumeration::DeviceInformation AudioDevice() const noexcept;
    void AudioDevice(Windows::Devices::Enumeration::DeviceInformation const& value) const noexcept;
    Windows::Media::MediaTimelineController TimelineController() const noexcept;
    void TimelineController(Windows::Media::MediaTimelineController const& value) const noexcept;
    Windows::Foundation::TimeSpan TimelineControllerPositionOffset() const noexcept;
    void TimelineControllerPositionOffset(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Media::Playback::MediaPlaybackSession PlaybackSession() const noexcept;
...
struct consume_Windows_Media_Playback_IMediaPlayer5
{
    ...
    bool IsVideoFrameServerEnabled() const noexcept;
    void IsVideoFrameServerEnabled(bool value) const noexcept;
...
{
    event_token SubtitleFrameChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Playback::MediaPlayer, Windows::Foundation::IInspectable> const& handler) const;
    using SubtitleFrameChanged_revoker = event_revoker<Windows::Media::Playback::IMediaPlayer6>;
    ...
    void SubtitleFrameChanged(event_token const& token) const;
...
{
    Windows::Foundation::Collections::ValueSet Data() const noexcept;
};
...
{
    Windows::Media::Playback::MediaPlayerError Error() const noexcept;
    HRESULT ExtendedErrorCode() const noexcept;
    hstring ErrorMessage() const noexcept;
};
...
{
    Windows::Media::Protection::MediaProtectionManager ProtectionManager() const noexcept;
    void ProtectionManager(Windows::Media::Protection::MediaProtectionManager const& value) const noexcept;
...
{
    Windows::Media::Playback::IMediaPlaybackSource Source() const noexcept;
    void Source(Windows::Media::Playback::IMediaPlaybackSource const& value) const noexcept;
};
...
{
    Windows::UI::Composition::ICompositionSurface CompositionSurface() const noexcept;
...
struct consume_Windows_Media_Playback_IPlaybackMediaMarker
{
    ...
    hstring MediaMarkerType() const noexcept;
...
{
    Windows::Media::Playback::PlaybackMediaMarker PlaybackMediaMarker() const noexcept;
};
...
{
    Windows::Media::Core::TimedMetadataTrack Track() const noexcept;
    Windows::Media::Playback::TimedMetadataTrackPresentationMode OldPresentationMode() const noexcept;
    Windows::Media::Playback::TimedMetadataTrackPresentationMode NewPresentationMode() const noexcept;
};
...
template <> struct abi<Windows::Media::Playback::IBackgroundMediaPlayerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_MessageReceivedFromBackground(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MessageReceivedFromBackground(event_token token) = 0;
    virtual HRESULT __stdcall add_MessageReceivedFromForeground(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Media::Playback::MediaPlaybackItemChangedReason* value) = 0;
};};
...
template <> struct abi<Windows::Media::Playback::IMediaBreak>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_InsertionMethod(Windows::Media::Playback::MediaBreakInsertionMethod* value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Media::Playback::MediaBreakInsertionMethod insertionMethod, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall CreateWithPresentationPosition(Windows::Media::Playback::MediaBreakInsertionMethod insertionMethod, Windows::Foundation::TimeSpan presentationPosition, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::Media::Playback::IMediaBreakManager>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_BreaksSeekedOver(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BreaksSeekedOver(event_token token) = 0;
    virtual HRESULT __stdcall add_BreakStarted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BreakStarted(event_token token) = 0;
    virtual HRESULT __stdcall add_BreakEnded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BreakEnded(event_token token) = 0;
    virtual HRESULT __stdcall add_BreakSkipped(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_ScheduleChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Type(Windows::Media::MediaPlaybackType* value) = 0;
    virtual HRESULT __stdcall put_Type(Windows::Media::MediaPlaybackType value) = 0;
...
template <> struct abi<Windows::Media::Playback::IMediaPlaybackCommandManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_PlayReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlayReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_PauseReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PauseReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_NextReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_NextReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_PreviousReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PreviousReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_FastForwardReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_FastForwardReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_RewindReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RewindReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_ShuffleReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ShuffleReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_AutoRepeatModeReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_AutoRepeatModeReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_PositionReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PositionReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_RateReceived(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Playback::IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AutoRepeatMode(Windows::Media::MediaPlaybackAutoRepeatMode* value) = 0;
...
template <> struct abi<Windows::Media::Playback::IMediaPlaybackCommandManagerCommandBehavior>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsEnabled(bool* value) = 0;
    virtual HRESULT __stdcall get_EnablingRule(Windows::Media::Playback::MediaCommandEnablingRule* value) = 0;
    virtual HRESULT __stdcall put_EnablingRule(Windows::Media::Playback::MediaCommandEnablingRule value) = 0;
    virtual HRESULT __stdcall add_IsEnabledChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_AudioTracksChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_AudioTracksChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VideoTracksChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_VideoTracksChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_TimedMetadataTracksChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Playback::IMediaPlaybackItem3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AutoLoadedDisplayProperties(Windows::Media::Playback::AutoLoadedDisplayPropertyKind* value) = 0;
    virtual HRESULT __stdcall put_AutoLoadedDisplayProperties(Windows::Media::Playback::AutoLoadedDisplayPropertyKind value) = 0;
};};

template <> struct abi<Windows::Media::Playback::IMediaPlaybackItemError>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ErrorCode(Windows::Media::Playback::MediaPlaybackItemErrorCode* value) = 0;
...
{
    virtual HRESULT __stdcall CreateWithStartTime(::IUnknown* source, Windows::Foundation::TimeSpan startTime, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall CreateWithStartTimeAndDurationLimit(::IUnknown* source, Windows::Foundation::TimeSpan startTime, Windows::Foundation::TimeSpan durationLimit, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall add_ItemFailed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ItemFailed(event_token token) = 0;
    virtual HRESULT __stdcall add_CurrentItemChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CurrentItemChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_ItemOpened(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_PlaybackStateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlaybackStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_PlaybackRateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlaybackRateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_SeekCompleted(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SeekCompleted(event_token token) = 0;
    virtual HRESULT __stdcall add_BufferingStarted(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BufferingStarted(event_token token) = 0;
    virtual HRESULT __stdcall add_BufferingEnded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BufferingEnded(event_token token) = 0;
    virtual HRESULT __stdcall add_BufferingProgressChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BufferingProgressChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_DownloadProgressChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DownloadProgressChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_NaturalDurationChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_NaturalDurationChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_PositionChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PositionChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_NaturalVideoSizeChanged(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_PlaybackState(Windows::Media::Playback::MediaPlaybackState* value) = 0;
    ...
    virtual HRESULT __stdcall get_StereoscopicVideoPackingMode(Windows::Media::MediaProperties::StereoscopicVideoPackingMode* value) = 0;
    virtual HRESULT __stdcall put_StereoscopicVideoPackingMode(Windows::Media::MediaProperties::StereoscopicVideoPackingMode value) = 0;
};};

template <> struct abi<Windows::Media::Playback::IMediaPlaybackSession2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_BufferedRangesChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BufferedRangesChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_PlayedRangesChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlayedRangesChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_SeekableRangesChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SeekableRangesChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_SupportedPlaybackRatesChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_IsPlaybackInterruption(bool* value) = 0;
};};
...
template <> struct abi<Windows::Media::Playback::IMediaPlaybackSphericalVideoProjection>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_IsEnabled(bool* value) = 0;
    virtual HRESULT __stdcall put_IsEnabled(bool value) = 0;
    virtual HRESULT __stdcall get_FrameFormat(Windows::Media::MediaProperties::SphericalVideoFrameFormat* value) = 0;
    virtual HRESULT __stdcall put_FrameFormat(Windows::Media::MediaProperties::SphericalVideoFrameFormat value) = 0;
    ...
    virtual HRESULT __stdcall get_ProjectionMode(Windows::Media::Playback::SphericalVideoProjectionMode* value) = 0;
    virtual HRESULT __stdcall put_ProjectionMode(Windows::Media::Playback::SphericalVideoProjectionMode value) = 0;
};};

template <> struct abi<Windows::Media::Playback::IMediaPlaybackTimedMetadataTrackList>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_PresentationModeChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PresentationModeChanged(event_token token) = 0;
    virtual HRESULT __stdcall GetPresentationMode(uint32_t index, Windows::Media::Playback::TimedMetadataTrackPresentationMode* value) = 0;
    virtual HRESULT __stdcall SetPresentationMode(uint32_t index, Windows::Media::Playback::TimedMetadataTrackPresentationMode value) = 0;
};};
...
template <> struct abi<Windows::Media::Playback::IMediaPlayer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_Position(Windows::Foundation::TimeSpan value) = 0;
    virtual HRESULT __stdcall get_BufferingProgress(double* value) = 0;
    virtual HRESULT __stdcall get_CurrentState(Windows::Media::Playback::MediaPlayerState* value) = 0;
    virtual HRESULT __stdcall get_CanSeek(bool* value) = 0;
    virtual HRESULT __stdcall get_CanPause(bool* value) = 0;
    ...
    virtual HRESULT __stdcall add_MediaOpened(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MediaOpened(event_token token) = 0;
    virtual HRESULT __stdcall add_MediaEnded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MediaEnded(event_token token) = 0;
    virtual HRESULT __stdcall add_MediaFailed(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MediaFailed(event_token token) = 0;
    virtual HRESULT __stdcall add_CurrentStateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CurrentStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_PlaybackMediaMarkerReached(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlaybackMediaMarkerReached(event_token token) = 0;
    virtual HRESULT __stdcall add_MediaPlayerRateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MediaPlayerRateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VolumeChanged(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Playback::IMediaPlayer2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AudioCategory(Windows::Media::Playback::MediaPlayerAudioCategory* value) = 0;
    virtual HRESULT __stdcall put_AudioCategory(Windows::Media::Playback::MediaPlayerAudioCategory value) = 0;
    virtual HRESULT __stdcall get_AudioDeviceType(Windows::Media::Playback::MediaPlayerAudioDeviceType* value) = 0;
    virtual HRESULT __stdcall put_AudioDeviceType(Windows::Media::Playback::MediaPlayerAudioDeviceType value) = 0;
};};

template <> struct abi<Windows::Media::Playback::IMediaPlayer3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_IsMutedChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_IsMutedChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_SourceChanged(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_StereoscopicVideoRenderMode(Windows::Media::Playback::StereoscopicVideoRenderMode* value) = 0;
    virtual HRESULT __stdcall put_StereoscopicVideoRenderMode(Windows::Media::Playback::StereoscopicVideoRenderMode value) = 0;
...
{
    virtual HRESULT __stdcall SetSurfaceSize(Windows::Foundation::Size size) = 0;
...
{
    virtual HRESULT __stdcall add_VideoFrameAvailable(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall CopyFrameToVideoSurfaceWithTargetRectangle(::IUnknown* destination, Windows::Foundation::Rect targetRectangle) = 0;
...
{
    virtual HRESULT __stdcall add_SubtitleFrameChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SubtitleFrameChanged(event_token token) = 0;
    virtual HRESULT __stdcall RenderSubtitlesToSurface(::IUnknown* destination, bool* result) = 0;
    virtual HRESULT __stdcall RenderSubtitlesToSurfaceWithTargetRectangle(::IUnknown* destination, Windows::Foundation::Rect targetRectangle, bool* result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Error(Windows::Media::Playback::MediaPlayerError* value) = 0;
...
{
    virtual HRESULT __stdcall CreateFromTime(Windows::Foundation::TimeSpan value, ::IUnknown** marker) = 0;
    virtual HRESULT __stdcall Create(Windows::Foundation::TimeSpan value, HSTRING mediaMarketType, HSTRING text, ::IUnknown** marker) = 0;
};};
...
template <> struct abi<Windows::Media::Playback::ITimedMetadataPresentationModeChangedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OldPresentationMode(Windows::Media::Playback::TimedMetadataTrackPresentationMode* value) = 0;
    virtual HRESULT __stdcall get_NewPresentationMode(Windows::Media::Playback::TimedMetadataTrackPresentationMode* value) = 0;
};};
