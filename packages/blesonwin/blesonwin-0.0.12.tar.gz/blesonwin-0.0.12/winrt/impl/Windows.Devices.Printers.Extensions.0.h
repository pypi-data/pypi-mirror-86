...
struct consume_Windows_Devices_Printers_Extensions_IPrint3DWorkflow
{
    ...
    bool IsPrintReady() const noexcept;
    void IsPrintReady(bool value) const noexcept;
...
{
    Windows::Devices::Printers::Extensions::Print3DWorkflowStatus Status() const noexcept;
...
{
    hstring NewDeviceId() const noexcept;
};
...
{
    hstring PrinterName() const noexcept;
    hstring EventData() const noexcept;
    void EventData(param::hstring const& value) const noexcept;
};
...
{
    Windows::Foundation::IInspectable PrinterExtensionContext() const noexcept;
...
{
    Windows::Devices::Printers::Extensions::PrintTaskConfigurationSaveRequest Request() const noexcept;
};
...
template <> struct abi<Windows::Devices::Printers::Extensions::IPrintTaskConfiguration>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_SaveRequested(::IUnknown* eventHandler, event_token* eventCookie) = 0;
