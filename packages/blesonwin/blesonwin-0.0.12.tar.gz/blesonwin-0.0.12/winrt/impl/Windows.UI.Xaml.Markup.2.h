...
template <> struct is_struct<Windows::UI::Xaml::Markup::XamlBinaryWriterErrorInformation>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::UI::Xaml::Markup::XmlnsDefinition>
{
    static constexpr bool value{ true };
};
...
struct WINRT_EBO MarkupExtension :
