...
{
    bool AllowAutoRedirect() const noexcept;
    void AllowAutoRedirect(bool value) const noexcept;
    bool AllowUI() const noexcept;
    void AllowUI(bool value) const noexcept;
    bool AutomaticDecompression() const noexcept;
    void AutomaticDecompression(bool value) const noexcept;
    Windows::Web::Http::Filters::HttpCacheControl CacheControl() const noexcept;
    Windows::Web::Http::HttpCookieManager CookieManager() const noexcept;
    ...
    uint32_t MaxConnectionsPerServer() const noexcept;
    void MaxConnectionsPerServer(uint32_t value) const noexcept;
    ...
    bool UseProxy() const noexcept;
    void UseProxy(bool value) const noexcept;
};
...
{
    Windows::Web::Http::HttpVersion MaxVersion() const noexcept;
    void MaxVersion(Windows::Web::Http::HttpVersion const& value) const noexcept;
};
...
{
    Windows::Web::Http::Filters::HttpCookieUsageBehavior CookieUsageBehavior() const noexcept;
    void CookieUsageBehavior(Windows::Web::Http::Filters::HttpCookieUsageBehavior const& value) const noexcept;
};
...
{
    Windows::Web::Http::Filters::HttpCacheReadBehavior ReadBehavior() const noexcept;
    void ReadBehavior(Windows::Web::Http::Filters::HttpCacheReadBehavior const& value) const noexcept;
    Windows::Web::Http::Filters::HttpCacheWriteBehavior WriteBehavior() const noexcept;
    void WriteBehavior(Windows::Web::Http::Filters::HttpCacheWriteBehavior const& value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_MaxVersion(Windows::Web::Http::HttpVersion* value) = 0;
    virtual HRESULT __stdcall put_MaxVersion(Windows::Web::Http::HttpVersion value) = 0;
};};

template <> struct abi<Windows::Web::Http::Filters::IHttpBaseProtocolFilter3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_CookieUsageBehavior(Windows::Web::Http::Filters::HttpCookieUsageBehavior* value) = 0;
    virtual HRESULT __stdcall put_CookieUsageBehavior(Windows::Web::Http::Filters::HttpCookieUsageBehavior value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ReadBehavior(Windows::Web::Http::Filters::HttpCacheReadBehavior* value) = 0;
    virtual HRESULT __stdcall put_ReadBehavior(Windows::Web::Http::Filters::HttpCacheReadBehavior value) = 0;
    virtual HRESULT __stdcall get_WriteBehavior(Windows::Web::Http::Filters::HttpCacheWriteBehavior* value) = 0;
    virtual HRESULT __stdcall put_WriteBehavior(Windows::Web::Http::Filters::HttpCacheWriteBehavior value) = 0;
};};
