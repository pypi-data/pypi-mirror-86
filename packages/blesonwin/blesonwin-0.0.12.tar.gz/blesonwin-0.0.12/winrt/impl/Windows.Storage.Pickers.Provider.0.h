...
struct consume_Windows_Storage_Pickers_Provider_IFileOpenPickerUI
{
    ...
    Windows::Foundation::Collections::IVectorView<hstring> AllowedFileTypes() const noexcept;
    Windows::Storage::Pickers::Provider::FileSelectionMode SelectionMode() const noexcept;
...
{
    [[deprecated("Since Windows 10, only apps can remove files, not end users so the FileRemoved event will not be raised.")]] hstring Id() const noexcept;
};
...
{
    Windows::Storage::Pickers::Provider::PickerClosingOperation ClosingOperation() const noexcept;
...
{
    Windows::Storage::IStorageFile TargetFile() const noexcept;
    void TargetFile(Windows::Storage::IStorageFile const& value) const noexcept;
...
{
    Windows::Storage::Pickers::Provider::TargetFileRequest Request() const noexcept;
};
...
{
    virtual HRESULT __stdcall AddFile(HSTRING id, ::IUnknown* file, Windows::Storage::Pickers::Provider::AddFileResult* addResult) = 0;
    ...
    virtual HRESULT __stdcall get_SelectionMode(Windows::Storage::Pickers::Provider::FileSelectionMode* value) = 0;
    virtual HRESULT __stdcall get_SettingsIdentifier(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Title(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_Title(HSTRING value) = 0;
    virtual HRESULT __stdcall add_FileRemoved(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Storage::Pickers::Provider::IFileSavePickerUI>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TrySetFileName(HSTRING value, Windows::Storage::Pickers::Provider::SetFileNameResult* result) = 0;
    virtual HRESULT __stdcall add_FileNameChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_FileNameChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_TargetFileRequested(::IUnknown* handler, event_token* token) = 0;
