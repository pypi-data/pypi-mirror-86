...
struct consume_Windows_ApplicationModel_Store_Preview_IStoreConfigurationStatics
{
    ...
    Windows::ApplicationModel::Store::Preview::StoreHardwareManufacturerInfo HardwareManufacturerInfo() const noexcept;
...
{
    Windows::Foundation::IReference<uint32_t> PurchasePromptingPolicy() const noexcept;
    void PurchasePromptingPolicy(optional<uint32_t> const& value) const noexcept;
};
...
{
    hstring HardwareManufacturerId() const noexcept;
    hstring StoreContentModifierId() const noexcept;
...
struct consume_Windows_ApplicationModel_Store_Preview_IStorePreviewProductInfo
{
    ...
    hstring ProductType() const noexcept;
    hstring Title() const noexcept;
    hstring Description() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::StorePreviewSkuInfo> SkuInfoList() const noexcept;
};
...
{
    Windows::ApplicationModel::Store::Preview::StorePreviewProductPurchaseStatus ProductPurchaseStatus() const noexcept;
};
...
{
    hstring ProductId() const noexcept;
    hstring SkuId() const noexcept;
    hstring SkuType() const noexcept;
    hstring Title() const noexcept;
    hstring Description() const noexcept;
    hstring CustomDeveloperData() const noexcept;
    hstring CurrencyCode() const noexcept;
    hstring FormattedListPrice() const noexcept;
    hstring ExtendedData() const noexcept;
};
...
{
    virtual HRESULT __stdcall SetSystemConfiguration(HSTRING catalogHardwareManufacturerId, HSTRING catalogStoreContentModifierId, Windows::Foundation::DateTime systemConfigurationExpiration, HSTRING catalogHardwareDescriptor) = 0;
...
template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetStoreLogDataAsync(Windows::ApplicationModel::Store::Preview::StoreLogOptions options, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall get_ProductPurchaseStatus(Windows::ApplicationModel::Store::Preview::StorePreviewProductPurchaseStatus* value) = 0;
};};
