...
struct consume_Windows_ApplicationModel_Store_Preview_InstallControl_IAppInstallItem
{
    ...
    Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallType InstallType() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> Children() const noexcept;
    bool ItemOperationsMightAffectOtherItems() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> AppInstallItems() const noexcept;
    ...
    Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting AutoUpdateSetting() const noexcept;
    void AutoUpdateSetting(Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting const& value) const noexcept;
    hstring AcquisitionIdentity() const noexcept;
    void AcquisitionIdentity(param::hstring const& value) const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> AppInstallItemsWithGroupSupport() const noexcept;
};
...
{
    Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem Item() const noexcept;
};
...
{
    Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallState InstallState() const noexcept;
    uint64_t DownloadSizeInBytes() const noexcept;
    uint64_t BytesDownloaded() const noexcept;
    double PercentComplete() const noexcept;
...
struct consume_Windows_ApplicationModel_Store_Preview_InstallControl_IAppInstallStatus2
{
    ...
    bool ReadyForLaunch() const noexcept;
};
...
{
    Windows::ApplicationModel::Store::Preview::InstallControl::GetEntitlementStatus Status() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Store::Preview::InstallControl::IAppInstallItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_InstallType(Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallType* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Store::Preview::InstallControl::IAppInstallManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ItemCompleted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ItemCompleted(event_token token) = 0;
    virtual HRESULT __stdcall add_ItemStatusChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ItemStatusChanged(event_token token) = 0;
    virtual HRESULT __stdcall get_AutoUpdateSetting(Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting* value) = 0;
    virtual HRESULT __stdcall put_AutoUpdateSetting(Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting value) = 0;
...
{
    virtual HRESULT __stdcall get_InstallState(Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallState* value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Store::Preview::InstallControl::GetEntitlementStatus* value) = 0;
};};
