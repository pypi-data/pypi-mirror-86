...
{
    virtual HRESULT __stdcall GetDeviceSelector(Windows::Devices::Portable::ServiceDeviceType serviceType, HSTRING* selector) = 0;
    virtual HRESULT __stdcall GetDeviceSelectorFromServiceId(GUID serviceId, HSTRING* selector) = 0;
};};
