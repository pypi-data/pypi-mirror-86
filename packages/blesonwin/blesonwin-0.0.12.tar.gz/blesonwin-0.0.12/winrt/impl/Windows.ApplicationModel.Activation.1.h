...
struct WINRT_EBO ICommandLineActivatedEventArgs :
    Windows::Foundation::IInspectable,
    impl::consume_t<ICommandLineActivatedEventArgs>,
    impl::require<ICommandLineActivatedEventArgs, Windows::ApplicationModel::Activation::IActivatedEventArgs>
{
    ICommandLineActivatedEventArgs(std::nullptr_t = nullptr) noexcept {}
};

struct WINRT_EBO ICommandLineActivationOperation :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IStartupTaskActivatedEventArgs :
    Windows::Foundation::IInspectable,
    impl::consume_t<IStartupTaskActivatedEventArgs>,
    impl::require<IStartupTaskActivatedEventArgs, Windows::ApplicationModel::Activation::IActivatedEventArgs>
{
