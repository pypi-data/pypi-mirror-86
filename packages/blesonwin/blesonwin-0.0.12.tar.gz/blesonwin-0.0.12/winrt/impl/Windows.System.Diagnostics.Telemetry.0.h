...
{
    Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationStatus Status() const noexcept;
};
...
struct consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryRegistrationSettings
{
    ...
    void StorageSize(uint32_t value) const noexcept;
    uint32_t UploadQuotaSize() const noexcept;
    void UploadQuotaSize(uint32_t value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationStatus* value) = 0;
};};
