...
{
    hstring ErrorText() const noexcept;
...
struct consume_Windows_Management_Deployment_IPackageManager5
{
    ...
    Windows::Management::Deployment::PackageManagerDebugSettings DebugSettings() const noexcept;
};
...
{
    hstring UserSecurityId() const noexcept;
    Windows::Management::Deployment::PackageInstallState InstallState() const noexcept;
};
...
struct consume_Windows_Management_Deployment_IPackageVolume
{
    ...
    bool IsSystemVolume() const noexcept;
    hstring MountPoint() const noexcept;
    hstring Name() const noexcept;
    hstring PackageStorePath() const noexcept;
    bool SupportsHardLinks() const noexcept;
...
{
    bool IsFullTrustPackageSupported() const noexcept;
    bool IsAppxInstallSupported() const noexcept;
...
{
    virtual HRESULT __stdcall AddPackageAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall UpdatePackageAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
    ...
    virtual HRESULT __stdcall RegisterPackageAsync(::IUnknown* manifestUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
    ...
    virtual HRESULT __stdcall SetPackageState(HSTRING packageFullName, Windows::Management::Deployment::PackageState packageState) = 0;
...
{
    virtual HRESULT __stdcall RemovePackageWithOptionsAsync(HSTRING packageFullName, Windows::Management::Deployment::RemovalOptions removalOptions, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall StagePackageWithOptionsAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall RegisterPackageByFullNameAsync(HSTRING mainPackageFullName, ::IUnknown* dependencyPackageFullNames, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall FindPackagesWithPackageTypes(Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdWithPackageTypes(HSTRING userSecurityId, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByNamePublisherWithPackageTypes(HSTRING packageName, HSTRING packagePublisher, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(HSTRING userSecurityId, HSTRING packageName, HSTRING packagePublisher, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByPackageFamilyNameWithPackageTypes(HSTRING packageFamilyName, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdPackageFamilyNameWithPackageTypes(HSTRING userSecurityId, HSTRING packageFamilyName, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
...
template <> struct abi<Windows::Management::Deployment::IPackageManager3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AddPackageToVolumeAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* targetVolume, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall ClearPackageStatus(HSTRING packageFullName, Windows::Management::Deployment::PackageStatus status) = 0;
    virtual HRESULT __stdcall RegisterPackageWithAppDataVolumeAsync(::IUnknown* manifestUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* appDataVolume, ::IUnknown** deploymentOperation) = 0;
    ...
    virtual HRESULT __stdcall MovePackageToVolumeAsync(HSTRING packageFullName, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* targetVolume, ::IUnknown** deploymentOperation) = 0;
    ...
    virtual HRESULT __stdcall SetPackageStatus(HSTRING packageFullName, Windows::Management::Deployment::PackageStatus status) = 0;
    ...
    virtual HRESULT __stdcall StagePackageToVolumeAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* targetVolume, ::IUnknown** deploymentOperation) = 0;
    virtual HRESULT __stdcall StageUserDataWithOptionsAsync(HSTRING packageFullName, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown** deploymentOperation) = 0;
};};
...
{
    virtual HRESULT __stdcall AddPackageToVolumeAndOptionalPackagesAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* targetVolume, ::IUnknown* optionalPackageFamilyNames, ::IUnknown* externalPackageUris, ::IUnknown** deploymentOperation) = 0;
    ...
    virtual HRESULT __stdcall RegisterPackageByFamilyNameAndOptionalPackagesAsync(HSTRING mainPackageFamilyName, ::IUnknown* dependencyPackageFamilyNames, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* appDataVolume, ::IUnknown* optionalPackageFamilyNames, ::IUnknown** deploymentOperation) = 0;
...
{
    virtual HRESULT __stdcall ProvisionPackageForAllUsersAsync(HSTRING packageFamilyName, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AddPackageByAppInstallerFileAsync(::IUnknown* appInstallerFileUri, Windows::Management::Deployment::AddPackageByAppInstallerOptions options, ::IUnknown* targetVolume, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestAddPackageByAppInstallerFileAsync(::IUnknown* appInstallerFileUri, Windows::Management::Deployment::AddPackageByAppInstallerOptions options, ::IUnknown* targetVolume, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AddPackageToVolumeAndRelatedSetAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions options, ::IUnknown* targetVolume, ::IUnknown* optionalPackageFamilyNames, ::IUnknown* packageUrisToInstall, ::IUnknown* relatedPackageUris, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall StagePackageToVolumeAndRelatedSetAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions options, ::IUnknown* targetVolume, ::IUnknown* optionalPackageFamilyNames, ::IUnknown* packageUrisToInstall, ::IUnknown* relatedPackageUris, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestAddPackageAsync(::IUnknown* packageUri, ::IUnknown* dependencyPackageUris, Windows::Management::Deployment::DeploymentOptions deploymentOptions, ::IUnknown* targetVolume, ::IUnknown* optionalPackageFamilyNames, ::IUnknown* relatedPackageUris, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Management::Deployment::IPackageManagerDebugSettings>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall SetContentGroupStateAsync(::IUnknown* package, HSTRING contentGroupName, Windows::ApplicationModel::PackageContentGroupState state, ::IUnknown** action) = 0;
    virtual HRESULT __stdcall SetContentGroupStateWithPercentageAsync(::IUnknown* package, HSTRING contentGroupName, Windows::ApplicationModel::PackageContentGroupState state, double completionPercentage, ::IUnknown** action) = 0;
};};
...
template <> struct abi<Windows::Management::Deployment::IPackageUserInformation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_InstallState(Windows::Management::Deployment::PackageInstallState* value) = 0;
};};
...
template <> struct abi<Windows::Management::Deployment::IPackageVolume>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FindPackagesByPackageFamilyName(HSTRING packageFamilyName, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesWithPackageTypes(Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByNamePublisherWithPackagesTypes(Windows::Management::Deployment::PackageTypes packageTypes, HSTRING packageName, HSTRING packagePublisher, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByPackageFamilyNameWithPackageTypes(Windows::Management::Deployment::PackageTypes packageTypes, HSTRING packageFamilyName, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackageByPackageFullName(HSTRING packageFullName, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityId(HSTRING userSecurityId, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdNamePublisher(HSTRING userSecurityId, HSTRING packageName, HSTRING packagePublisher, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdPackageFamilyName(HSTRING userSecurityId, HSTRING packageFamilyName, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdWithPackageTypes(HSTRING userSecurityId, Windows::Management::Deployment::PackageTypes packageTypes, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(HSTRING userSecurityId, Windows::Management::Deployment::PackageTypes packageTypes, HSTRING packageName, HSTRING packagePublisher, ::IUnknown** packageCollection) = 0;
    virtual HRESULT __stdcall FindPackagesByUserSecurityIdPackageFamilyNameWithPackagesTypes(HSTRING userSecurityId, Windows::Management::Deployment::PackageTypes packageTypes, HSTRING packageFamilyName, ::IUnknown** packageCollection) = 0;
