...
enum class [[deprecated("IsoSpeedPreset may not be available in future versions of Windows Phone. Starting with Windows Phone 8.1, use SetAutoAsync, Auto, SetValueAsync, and Value instead")]] IsoSpeedPreset : int32_t
{
    Auto = 0,
    Iso50 = 1,
    Iso80 = 2,
...
{
    Windows::Media::Devices::AdvancedPhotoMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::AdvancedPhotoMode const& value) const noexcept;
};
...
struct consume_Windows_Media_Devices_IAdvancedPhotoControl
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::AdvancedPhotoMode> SupportedModes() const noexcept;
    Windows::Media::Devices::AdvancedPhotoMode Mode() const noexcept;
...
{
    Windows::Media::Devices::LowLagPhotoSequenceControl LowLagPhotoSequence() const noexcept;
    Windows::Media::Devices::LowLagPhotoControl LowLagPhoto() const noexcept;
    Windows::Media::Devices::SceneModeControl SceneModeControl() const noexcept;
    Windows::Media::Devices::TorchControl TorchControl() const noexcept;
    Windows::Media::Devices::FlashControl FlashControl() const noexcept;
    Windows::Media::Devices::WhiteBalanceControl WhiteBalanceControl() const noexcept;
    Windows::Media::Devices::ExposureControl ExposureControl() const noexcept;
    Windows::Media::Devices::FocusControl FocusControl() const noexcept;
    Windows::Media::Devices::ExposureCompensationControl ExposureCompensationControl() const noexcept;
    Windows::Media::Devices::IsoSpeedControl IsoSpeedControl() const noexcept;
    Windows::Media::Devices::RegionsOfInterestControl RegionsOfInterestControl() const noexcept;
    Windows::Media::Devices::CaptureUse PrimaryUse() const noexcept;
    void PrimaryUse(Windows::Media::Devices::CaptureUse const& value) const noexcept;
};
...
{
    Windows::Media::Devices::Core::VariablePhotoSequenceController VariablePhotoSequenceController() const noexcept;
    Windows::Media::Devices::PhotoConfirmationControl PhotoConfirmationControl() const noexcept;
    Windows::Media::Devices::ZoomControl ZoomControl() const noexcept;
};
...
{
    Windows::Media::Devices::ExposurePriorityVideoControl ExposurePriorityVideoControl() const noexcept;
    Windows::Media::Devices::MediaCaptureOptimization DesiredOptimization() const noexcept;
    void DesiredOptimization(Windows::Media::Devices::MediaCaptureOptimization const& value) const noexcept;
    Windows::Media::Devices::HdrVideoControl HdrVideoControl() const noexcept;
    Windows::Media::Devices::OpticalImageStabilizationControl OpticalImageStabilizationControl() const noexcept;
    Windows::Media::Devices::AdvancedPhotoControl AdvancedPhotoControl() const noexcept;
};
...
{
    void Muted(bool value) const noexcept;
    bool Muted() const noexcept;
    void VolumePercent(float value) const noexcept;
    float VolumePercent() const noexcept;
};
...
{
    Windows::Media::Devices::AudioDeviceModule Module() const noexcept;
    Windows::Storage::Streams::IBuffer NotificationData() const noexcept;
};
...
{
    hstring Id() const noexcept;
    Windows::Media::Devices::AudioDeviceRole Role() const noexcept;
};
...
{
    void Handled() const;
    Windows::Foundation::IInspectable Contact() const noexcept;
};
...
{
    bool Supported() const noexcept;
    bool Auto() const noexcept;
    Windows::Foundation::IAsyncAction SetAutoAsync(bool value) const;
    Windows::Foundation::TimeSpan Min() const noexcept;
    Windows::Foundation::TimeSpan Max() const noexcept;
    Windows::Foundation::TimeSpan Step() const noexcept;
    Windows::Foundation::TimeSpan Value() const noexcept;
...
struct consume_Windows_Media_Devices_IExposurePriorityVideoControl
{
    ...
    void Enabled(bool value) const noexcept;
};
...
{
    bool Supported() const noexcept;
    bool PowerSupported() const noexcept;
    bool RedEyeReductionSupported() const noexcept;
    bool Enabled() const noexcept;
    void Enabled(bool value) const noexcept;
    bool Auto() const noexcept;
    void Auto(bool value) const noexcept;
    bool RedEyeReduction() const noexcept;
    void RedEyeReduction(bool value) const noexcept;
    float PowerPercent() const noexcept;
    void PowerPercent(float value) const noexcept;
};
...
{
    bool AssistantLightSupported() const noexcept;
    bool AssistantLightEnabled() const noexcept;
    void AssistantLightEnabled(bool value) const noexcept;
};
...
{
    bool Supported() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::FocusPreset> SupportedPresets() const noexcept;
    Windows::Media::Devices::FocusPreset Preset() const noexcept;
...
{
    bool FocusChangedSupported() const noexcept;
    bool WaitForFocusSupported() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::FocusMode> SupportedFocusModes() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::ManualFocusDistance> SupportedFocusDistances() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::AutoFocusRange> SupportedFocusRanges() const noexcept;
    Windows::Media::Devices::FocusMode Mode() const noexcept;
    Windows::Media::Devices::MediaCaptureFocusState FocusState() const noexcept;
...
{
    Windows::Media::Devices::FocusMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::FocusMode const& value) const noexcept;
    Windows::Media::Devices::AutoFocusRange AutoFocusRange() const noexcept;
    void AutoFocusRange(Windows::Media::Devices::AutoFocusRange const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> Value() const noexcept;
    void Value(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Media::Devices::ManualFocusDistance> Distance() const noexcept;
    void Distance(optional<Windows::Media::Devices::ManualFocusDistance> const& value) const noexcept;
    bool WaitForFocus() const noexcept;
    void WaitForFocus(bool value) const noexcept;
    bool DisableDriverFallback() const noexcept;
    void DisableDriverFallback(bool value) const noexcept;
};
...
{
    bool Supported() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::HdrVideoMode> SupportedModes() const noexcept;
    Windows::Media::Devices::HdrVideoMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::HdrVideoMode const& value) const noexcept;
};
...
{
    bool Supported() const noexcept;
    [[deprecated("SupportedPresets may not be available in future versions of Windows Phone. Starting with Windows Phone 8.1, use SetAutoAsync, Auto, SetValueAsync, and Value instead")]] Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::IsoSpeedPreset> SupportedPresets() const noexcept;
    [[deprecated("Preset may not be available in future versions of Windows Phone. Starting with Windows Phone 8.1, use SetAutoAsync, Auto, SetValueAsync, and Value instead")]] Windows::Media::Devices::IsoSpeedPreset Preset() const noexcept;
...
{
    Windows::Media::Devices::TelephonyKey TelephonyKey() const noexcept;
};
...
struct consume_Windows_Media_Devices_ILowLagPhotoControl
{
    ...
    bool ThumbnailEnabled() const noexcept;
    void ThumbnailEnabled(bool value) const noexcept;
    Windows::Media::MediaProperties::MediaThumbnailFormat ThumbnailFormat() const noexcept;
    void ThumbnailFormat(Windows::Media::MediaProperties::MediaThumbnailFormat const& value) const noexcept;
    uint32_t DesiredThumbnailSize() const noexcept;
    void DesiredThumbnailSize(uint32_t value) const noexcept;
    uint32_t HardwareAcceleratedThumbnailSupported() const noexcept;
};
...
{
    bool Supported() const noexcept;
    uint32_t MaxPastPhotos() const noexcept;
    float MaxPhotosPerSecond() const noexcept;
    uint32_t PastPhotoLimit() const noexcept;
    void PastPhotoLimit(uint32_t value) const noexcept;
    float PhotosPerSecondLimit() const noexcept;
    void PhotosPerSecondLimit(float value) const noexcept;
    Windows::Media::MediaProperties::MediaRatio GetHighestConcurrentFrameRate(Windows::Media::MediaProperties::IMediaEncodingProperties const& captureProperties) const;
    Windows::Media::MediaProperties::MediaRatio GetCurrentFrameRate() const;
    bool ThumbnailEnabled() const noexcept;
    void ThumbnailEnabled(bool value) const noexcept;
...
{
    Windows::Media::Devices::MediaDeviceControlCapabilities Capabilities() const noexcept;
...
struct consume_Windows_Media_Devices_IMediaDeviceControlCapabilities
{
    ...
    double Default() const noexcept;
    bool AutoModeSupported() const noexcept;
};
...
{
    Windows::Media::Devices::SendCommandStatus Status() const noexcept;
    Windows::Storage::Streams::IBuffer Result() const noexcept;
};
...
{
    bool Supported() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::OpticalImageStabilizationMode> SupportedModes() const noexcept;
    Windows::Media::Devices::OpticalImageStabilizationMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::OpticalImageStabilizationMode const& value) const noexcept;
};
...
struct consume_Windows_Media_Devices_IPhotoConfirmationControl
{
    ...
    bool Enabled() const noexcept;
    void Enabled(bool value) const noexcept;
    Windows::Media::MediaProperties::MediaPixelFormat PixelFormat() const noexcept;
    void PixelFormat(Windows::Media::MediaProperties::MediaPixelFormat const& format) const noexcept;
};
...
{
    bool AutoFocusEnabled() const noexcept;
    void AutoFocusEnabled(bool value) const noexcept;
    bool AutoWhiteBalanceEnabled() const noexcept;
    void AutoWhiteBalanceEnabled(bool value) const noexcept;
    bool AutoExposureEnabled() const noexcept;
    void AutoExposureEnabled(bool value) const noexcept;
    Windows::Foundation::Rect Bounds() const noexcept;
    void Bounds(Windows::Foundation::Rect const& value) const noexcept;
};
...
{
    Windows::Media::Devices::RegionOfInterestType Type() const noexcept;
    void Type(Windows::Media::Devices::RegionOfInterestType const& value) const noexcept;
    bool BoundsNormalized() const noexcept;
    void BoundsNormalized(bool value) const noexcept;
    uint32_t Weight() const noexcept;
    void Weight(uint32_t value) const noexcept;
};
...
{
    uint32_t MaxRegions() const noexcept;
    ...
    bool AutoFocusSupported() const noexcept;
    bool AutoWhiteBalanceSupported() const noexcept;
    bool AutoExposureSupported() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::CaptureSceneMode> SupportedModes() const noexcept;
    Windows::Media::Devices::CaptureSceneMode Value() const noexcept;
...
{
    Windows::Media::Devices::MediaDeviceControl Brightness() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Contrast() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Hue() const noexcept;
    Windows::Media::Devices::MediaDeviceControl WhiteBalance() const noexcept;
    Windows::Media::Devices::MediaDeviceControl BacklightCompensation() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Pan() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Tilt() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Zoom() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Roll() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Exposure() const noexcept;
    Windows::Media::Devices::MediaDeviceControl Focus() const noexcept;
...
{
    Windows::Media::Devices::VideoDeviceControllerGetDevicePropertyStatus Status() const noexcept;
...
{
    bool Supported() const noexcept;
    Windows::Media::Devices::ColorTemperaturePreset Preset() const noexcept;
...
struct consume_Windows_Media_Devices_IZoomControl
{
    ...
    float Step() const noexcept;
    float Value() const noexcept;
    void Value(float value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::ZoomTransitionMode> SupportedModes() const noexcept;
    Windows::Media::Devices::ZoomTransitionMode Mode() const noexcept;
...
{
    Windows::Media::Devices::ZoomTransitionMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::ZoomTransitionMode const& value) const noexcept;
    float Value() const noexcept;
    void Value(float value) const noexcept;
};
...
template <> struct abi<Windows::Media::Devices::IAdvancedPhotoCaptureSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::AdvancedPhotoMode value) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IAdvancedVideoCaptureDeviceController2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PrimaryUse(Windows::Media::Devices::CaptureUse* value) = 0;
    virtual HRESULT __stdcall put_PrimaryUse(Windows::Media::Devices::CaptureUse value) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IAdvancedVideoCaptureDeviceController4>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DesiredOptimization(Windows::Media::Devices::MediaCaptureOptimization* value) = 0;
    virtual HRESULT __stdcall put_DesiredOptimization(Windows::Media::Devices::MediaCaptureOptimization value) = 0;
...
template <> struct abi<Windows::Media::Devices::IAdvancedVideoCaptureDeviceController5>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetDevicePropertyById(HSTRING propertyId, ::IUnknown* propertyValue, Windows::Media::Devices::VideoDeviceControllerSetDevicePropertyStatus* value) = 0;
    ...
    virtual HRESULT __stdcall SetDevicePropertyByExtendedId(uint32_t __extendedPropertyIdSize, uint8_t* extendedPropertyId, uint32_t __propertyValueSize, uint8_t* propertyValue, Windows::Media::Devices::VideoDeviceControllerSetDevicePropertyStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_ModuleNotificationReceived(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Devices::ICallControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_AnswerRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_AnswerRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_HangUpRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_HangUpRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_DialRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DialRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_RedialRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RedialRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_KeypadPressed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_KeypadPressed(event_token token) = 0;
    virtual HRESULT __stdcall add_AudioTransferRequested(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Id(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Role(Windows::Media::Devices::AudioDeviceRole* value) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IExposureControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetValueAsync(Windows::Foundation::TimeSpan shutterDuration, ::IUnknown** asyncInfo) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IFocusControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Preset(Windows::Media::Devices::FocusPreset* value) = 0;
    virtual HRESULT __stdcall SetPresetAsync(Windows::Media::Devices::FocusPreset preset, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall SetPresetWithCompletionOptionAsync(Windows::Media::Devices::FocusPreset preset, bool completeBeforeFocus, ::IUnknown** asyncInfo) = 0;
...
template <> struct abi<Windows::Media::Devices::IFocusControl2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::FocusMode* value) = 0;
...
{
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::FocusMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::FocusMode value) = 0;
    virtual HRESULT __stdcall get_AutoFocusRange(Windows::Media::Devices::AutoFocusRange* value) = 0;
    virtual HRESULT __stdcall put_AutoFocusRange(Windows::Media::Devices::AutoFocusRange value) = 0;
...
template <> struct abi<Windows::Media::Devices::IHdrVideoControl>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Supported(bool* value) = 0;
    virtual HRESULT __stdcall get_SupportedModes(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::HdrVideoMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::HdrVideoMode value) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IIsoSpeedControl>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Supported(bool* value) = 0;
    virtual HRESULT __stdcall get_SupportedPresets(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Preset(Windows::Media::Devices::IsoSpeedPreset* value) = 0;
    virtual HRESULT __stdcall SetPresetAsync(Windows::Media::Devices::IsoSpeedPreset preset, ::IUnknown** asyncInfo) = 0;
};};
...
{
    virtual HRESULT __stdcall get_TelephonyKey(Windows::Media::Devices::TelephonyKey* telephonyKey) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::ILowLagPhotoControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ThumbnailFormat(Windows::Media::MediaProperties::MediaThumbnailFormat* value) = 0;
    virtual HRESULT __stdcall put_ThumbnailFormat(Windows::Media::MediaProperties::MediaThumbnailFormat value) = 0;
...
{
    virtual HRESULT __stdcall GetAvailableMediaStreamProperties(Windows::Media::Capture::MediaStreamType mediaStreamType, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall GetMediaStreamProperties(Windows::Media::Capture::MediaStreamType mediaStreamType, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall SetMediaStreamPropertiesAsync(Windows::Media::Capture::MediaStreamType mediaStreamType, ::IUnknown* mediaEncodingProperties, ::IUnknown** asyncInfo) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IMediaDeviceStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDefaultAudioCaptureId(Windows::Media::Devices::AudioDeviceRole role, HSTRING* deviceId) = 0;
    virtual HRESULT __stdcall GetDefaultAudioRenderId(Windows::Media::Devices::AudioDeviceRole role, HSTRING* deviceId) = 0;
    virtual HRESULT __stdcall add_DefaultAudioCaptureDeviceChanged(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_DefaultAudioCaptureDeviceChanged(event_token cookie) = 0;
    virtual HRESULT __stdcall add_DefaultAudioRenderDeviceChanged(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Devices::SendCommandStatus* value) = 0;
...
template <> struct abi<Windows::Media::Devices::IOpticalImageStabilizationControl>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Supported(bool* value) = 0;
    virtual HRESULT __stdcall get_SupportedModes(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::OpticalImageStabilizationMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::OpticalImageStabilizationMode value) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IPhotoConfirmationControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Enabled(bool* value) = 0;
    virtual HRESULT __stdcall put_Enabled(bool value) = 0;
    virtual HRESULT __stdcall get_PixelFormat(Windows::Media::MediaProperties::MediaPixelFormat* format) = 0;
    virtual HRESULT __stdcall put_PixelFormat(Windows::Media::MediaProperties::MediaPixelFormat format) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Type(Windows::Media::Devices::RegionOfInterestType* value) = 0;
    virtual HRESULT __stdcall put_Type(Windows::Media::Devices::RegionOfInterestType value) = 0;
...
{
    virtual HRESULT __stdcall get_SupportedModes(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Value(Windows::Media::Devices::CaptureSceneMode* value) = 0;
    virtual HRESULT __stdcall SetValueAsync(Windows::Media::Devices::CaptureSceneMode sceneMode, ::IUnknown** asyncInfo) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::IVideoDeviceController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TrySetPowerlineFrequency(Windows::Media::Capture::PowerlineFrequency value, bool* succeeded) = 0;
    virtual HRESULT __stdcall TryGetPowerlineFrequency(Windows::Media::Capture::PowerlineFrequency* value, bool* succeeded) = 0;
};};

template <> struct abi<Windows::Media::Devices::IVideoDeviceControllerGetDevicePropertyResult>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Devices::VideoDeviceControllerGetDevicePropertyStatus* value) = 0;
    virtual HRESULT __stdcall get_Value(::IUnknown** value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Supported(bool* value) = 0;
    virtual HRESULT __stdcall get_Preset(Windows::Media::Devices::ColorTemperaturePreset* value) = 0;
    virtual HRESULT __stdcall SetPresetAsync(Windows::Media::Devices::ColorTemperaturePreset preset, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall get_Min(uint32_t* value) = 0;
    virtual HRESULT __stdcall get_Max(uint32_t* value) = 0;
    virtual HRESULT __stdcall get_Step(uint32_t* value) = 0;
    virtual HRESULT __stdcall get_Value(uint32_t* value) = 0;
...
{
    virtual HRESULT __stdcall get_SupportedModes(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::ZoomTransitionMode* value) = 0;
    virtual HRESULT __stdcall Configure(::IUnknown* settings) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::ZoomTransitionMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::ZoomTransitionMode value) = 0;
    virtual HRESULT __stdcall get_Value(float* value) = 0;
    virtual HRESULT __stdcall put_Value(float value) = 0;
};};
