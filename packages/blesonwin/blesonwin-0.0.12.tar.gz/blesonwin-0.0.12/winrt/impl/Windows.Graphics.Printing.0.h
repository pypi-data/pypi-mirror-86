...
{
    void MediaSize(Windows::Graphics::Printing::PrintMediaSize const& value) const noexcept;
    Windows::Graphics::Printing::PrintMediaSize MediaSize() const noexcept;
    void PageSize(Windows::Foundation::Size const& value) const noexcept;
    Windows::Foundation::Size PageSize() const noexcept;
    void DpiX(uint32_t value) const noexcept;
    uint32_t DpiX() const noexcept;
    void DpiY(uint32_t value) const noexcept;
    uint32_t DpiY() const noexcept;
    void Orientation(Windows::Graphics::Printing::PrintOrientation const& value) const noexcept;
    Windows::Graphics::Printing::PrintOrientation Orientation() const noexcept;
};
...
{
    Windows::ApplicationModel::DataTransfer::DataPackagePropertySet Properties() const noexcept;
    Windows::Graphics::Printing::IPrintDocumentSource Source() const noexcept;
    Windows::Graphics::Printing::PrintTaskOptions Options() const noexcept;
...
{
    void IsPreviewEnabled(bool value) const noexcept;
    bool IsPreviewEnabled() const noexcept;
};
...
{
    Windows::Graphics::Printing::PrintTaskCompletion Completion() const noexcept;
};
...
{
    void Bordering(Windows::Graphics::Printing::PrintBordering const& value) const noexcept;
    Windows::Graphics::Printing::PrintBordering Bordering() const noexcept;
...
struct consume_Windows_Graphics_Printing_IPrintTaskOptionsCoreProperties
{
    void MediaSize(Windows::Graphics::Printing::PrintMediaSize const& value) const noexcept;
    Windows::Graphics::Printing::PrintMediaSize MediaSize() const noexcept;
    void MediaType(Windows::Graphics::Printing::PrintMediaType const& value) const noexcept;
    Windows::Graphics::Printing::PrintMediaType MediaType() const noexcept;
    void Orientation(Windows::Graphics::Printing::PrintOrientation const& value) const noexcept;
    Windows::Graphics::Printing::PrintOrientation Orientation() const noexcept;
    void PrintQuality(Windows::Graphics::Printing::PrintQuality const& value) const noexcept;
    Windows::Graphics::Printing::PrintQuality PrintQuality() const noexcept;
    void ColorMode(Windows::Graphics::Printing::PrintColorMode const& value) const noexcept;
    Windows::Graphics::Printing::PrintColorMode ColorMode() const noexcept;
    void Duplex(Windows::Graphics::Printing::PrintDuplex const& value) const noexcept;
    Windows::Graphics::Printing::PrintDuplex Duplex() const noexcept;
    void Collation(Windows::Graphics::Printing::PrintCollation const& value) const noexcept;
    Windows::Graphics::Printing::PrintCollation Collation() const noexcept;
    void Staple(Windows::Graphics::Printing::PrintStaple const& value) const noexcept;
    Windows::Graphics::Printing::PrintStaple Staple() const noexcept;
    void HolePunch(Windows::Graphics::Printing::PrintHolePunch const& value) const noexcept;
    Windows::Graphics::Printing::PrintHolePunch HolePunch() const noexcept;
    void Binding(Windows::Graphics::Printing::PrintBinding const& value) const noexcept;
    Windows::Graphics::Printing::PrintBinding Binding() const noexcept;
    uint32_t MinCopies() const noexcept;
    uint32_t MaxCopies() const noexcept;
    void NumberOfCopies(uint32_t value) const noexcept;
    uint32_t NumberOfCopies() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> DisplayedOptions() const noexcept;
};
...
{
    uint32_t DocumentPageCount() const noexcept;
};
...
{
    Windows::Graphics::Printing::PrintTaskRequest Request() const noexcept;
};
...
{
    void IsPrinterTargetEnabled(bool value) const noexcept;
    bool IsPrinterTargetEnabled() const noexcept;
    void Is3DManufacturingTargetEnabled(bool value) const noexcept;
    bool Is3DManufacturingTargetEnabled() const noexcept;
};
...
{
    hstring MediaSize() const noexcept;
    hstring MediaType() const noexcept;
    hstring Orientation() const noexcept;
    hstring PrintQuality() const noexcept;
    hstring ColorMode() const noexcept;
    hstring Duplex() const noexcept;
    hstring Collation() const noexcept;
    hstring Staple() const noexcept;
    hstring HolePunch() const noexcept;
    hstring Binding() const noexcept;
    hstring Copies() const noexcept;
    hstring NUp() const noexcept;
    hstring InputBin() const noexcept;
};
...
{
    hstring Bordering() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_PrintTaskRequested(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall put_MediaSize(Windows::Graphics::Printing::PrintMediaSize value) = 0;
    virtual HRESULT __stdcall get_MediaSize(Windows::Graphics::Printing::PrintMediaSize* value) = 0;
    ...
    virtual HRESULT __stdcall put_Orientation(Windows::Graphics::Printing::PrintOrientation value) = 0;
    virtual HRESULT __stdcall get_Orientation(Windows::Graphics::Printing::PrintOrientation* value) = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::IPrintTask>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Previewing(::IUnknown* eventHandler, event_token* eventCookie) = 0;
    ...
    virtual HRESULT __stdcall add_Progressing(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall get_Completion(Windows::Graphics::Printing::PrintTaskCompletion* value) = 0;
};};

template <> struct abi<Windows::Graphics::Printing::IPrintTaskOptions>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_Bordering(Windows::Graphics::Printing::PrintBordering value) = 0;
    virtual HRESULT __stdcall get_Bordering(Windows::Graphics::Printing::PrintBordering* value) = 0;
...
{
    virtual HRESULT __stdcall GetPageDescription(uint32_t jobPageNumber, struct_of<32>* description) = 0;
};};
...
template <> struct abi<Windows::Graphics::Printing::IPrintTaskOptionsCoreProperties>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_MediaSize(Windows::Graphics::Printing::PrintMediaSize value) = 0;
    virtual HRESULT __stdcall get_MediaSize(Windows::Graphics::Printing::PrintMediaSize* value) = 0;
    virtual HRESULT __stdcall put_MediaType(Windows::Graphics::Printing::PrintMediaType value) = 0;
    virtual HRESULT __stdcall get_MediaType(Windows::Graphics::Printing::PrintMediaType* value) = 0;
    virtual HRESULT __stdcall put_Orientation(Windows::Graphics::Printing::PrintOrientation value) = 0;
    virtual HRESULT __stdcall get_Orientation(Windows::Graphics::Printing::PrintOrientation* value) = 0;
    virtual HRESULT __stdcall put_PrintQuality(Windows::Graphics::Printing::PrintQuality value) = 0;
    virtual HRESULT __stdcall get_PrintQuality(Windows::Graphics::Printing::PrintQuality* value) = 0;
    virtual HRESULT __stdcall put_ColorMode(Windows::Graphics::Printing::PrintColorMode value) = 0;
    virtual HRESULT __stdcall get_ColorMode(Windows::Graphics::Printing::PrintColorMode* value) = 0;
    virtual HRESULT __stdcall put_Duplex(Windows::Graphics::Printing::PrintDuplex value) = 0;
    virtual HRESULT __stdcall get_Duplex(Windows::Graphics::Printing::PrintDuplex* value) = 0;
    virtual HRESULT __stdcall put_Collation(Windows::Graphics::Printing::PrintCollation value) = 0;
    virtual HRESULT __stdcall get_Collation(Windows::Graphics::Printing::PrintCollation* value) = 0;
    virtual HRESULT __stdcall put_Staple(Windows::Graphics::Printing::PrintStaple value) = 0;
    virtual HRESULT __stdcall get_Staple(Windows::Graphics::Printing::PrintStaple* value) = 0;
    virtual HRESULT __stdcall put_HolePunch(Windows::Graphics::Printing::PrintHolePunch value) = 0;
    virtual HRESULT __stdcall get_HolePunch(Windows::Graphics::Printing::PrintHolePunch* value) = 0;
    virtual HRESULT __stdcall put_Binding(Windows::Graphics::Printing::PrintBinding value) = 0;
    virtual HRESULT __stdcall get_Binding(Windows::Graphics::Printing::PrintBinding* value) = 0;
