...
{
    Windows::Storage::Streams::IBuffer RemoteServiceInfo() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod> SupportedConfigurationMethods() const noexcept;
    bool PreferGroupOwnerMode() const noexcept;
    void PreferGroupOwnerMode(bool value) const noexcept;
    Windows::Storage::Streams::IBuffer SessionInfo() const noexcept;
    void SessionInfo(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceError ServiceError() const noexcept;
...
struct consume_Windows_Devices_WiFiDirect_Services_IWiFiDirectServiceAdvertiser
{
    ...
    Windows::Foundation::Collections::IVector<hstring> ServiceNamePrefixes() const noexcept;
    Windows::Storage::Streams::IBuffer ServiceInfo() const noexcept;
    void ServiceInfo(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    bool AutoAcceptSession() const noexcept;
    void AutoAcceptSession(bool value) const noexcept;
    bool PreferGroupOwnerMode() const noexcept;
    void PreferGroupOwnerMode(bool value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod> PreferredConfigurationMethods() const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceStatus ServiceStatus() const noexcept;
    void ServiceStatus(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceStatus const& value) const noexcept;
    uint32_t CustomServiceStatusCode() const noexcept;
    void CustomServiceStatusCode(uint32_t value) const noexcept;
    Windows::Storage::Streams::IBuffer DeferredSessionInfo() const noexcept;
    void DeferredSessionInfo(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceAdvertisementStatus AdvertisementStatus() const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceError ServiceError() const noexcept;
...
{
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSession Session() const noexcept;
    Windows::Storage::Streams::IBuffer SessionInfo() const noexcept;
};
...
{
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod SelectedConfigurationMethod() const noexcept;
    bool IsGroupFormationNeeded() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Networking::EndpointPair> EndpointPairs() const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceIPProtocol Protocol() const noexcept;
};
...
{
    hstring ServiceName() const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSessionStatus Status() const noexcept;
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSessionErrorStatus ErrorStatus() const noexcept;
    uint32_t SessionId() const noexcept;
    uint32_t AdvertisementId() const noexcept;
    hstring ServiceAddress() const noexcept;
    hstring SessionAddress() const noexcept;
...
struct consume_Windows_Devices_WiFiDirect_Services_IWiFiDirectServiceSessionRequest
{
    ...
    Windows::Devices::WiFiDirect::Services::WiFiDirectServiceProvisioningInfo ProvisioningInfo() const noexcept;
    Windows::Storage::Streams::IBuffer SessionInfo() const noexcept;
};
...
template <> struct abi<Windows::Devices::WiFiDirect::Services::IWiFiDirectService>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ServiceError(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceError* value) = 0;
    virtual HRESULT __stdcall add_SessionDeferred(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SessionDeferred(event_token token) = 0;
    virtual HRESULT __stdcall GetProvisioningInfoAsync(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod selectedConfigurationMethod, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceAdvertiser>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ServiceStatus(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceStatus* value) = 0;
    virtual HRESULT __stdcall put_ServiceStatus(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceStatus value) = 0;
    ...
    virtual HRESULT __stdcall get_AdvertisementStatus(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceAdvertisementStatus* value) = 0;
    virtual HRESULT __stdcall get_ServiceError(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceError* value) = 0;
    virtual HRESULT __stdcall add_SessionRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SessionRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_AutoAcceptSessionConnected(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_SelectedConfigurationMethod(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod* value) = 0;
...
template <> struct abi<Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceRemotePortAddedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Protocol(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceIPProtocol* value) = 0;
};};

template <> struct abi<Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceSession>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ServiceName(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Status(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSessionStatus* value) = 0;
    virtual HRESULT __stdcall get_ErrorStatus(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSessionErrorStatus* value) = 0;
    ...
    virtual HRESULT __stdcall add_RemotePortAdded(::IUnknown* handler, event_token* token) = 0;
