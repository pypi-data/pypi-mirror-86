...
struct consume_Windows_Web_Http_IHttpClient
{
    ...
    Windows::Web::Http::Headers::HttpRequestHeaderCollection DefaultRequestHeaders() const noexcept;
};
...
{
    Windows::Web::Http::Headers::HttpContentHeaderCollection Headers() const noexcept;
...
struct consume_Windows_Web_Http_IHttpCookie
{
    ...
    void HttpOnly(bool value) const noexcept;
    bool Secure() const noexcept;
    void Secure(bool value) const noexcept;
...
{
    Windows::Web::Http::HttpMethod Delete() const noexcept;
    Windows::Web::Http::HttpMethod Get() const noexcept;
    Windows::Web::Http::HttpMethod Head() const noexcept;
    Windows::Web::Http::HttpMethod Options() const noexcept;
    Windows::Web::Http::HttpMethod Patch() const noexcept;
    Windows::Web::Http::HttpMethod Post() const noexcept;
    Windows::Web::Http::HttpMethod Put() const noexcept;
};
...
{
    Windows::Web::Http::IHttpContent Content() const noexcept;
    void Content(Windows::Web::Http::IHttpContent const& value) const noexcept;
    Windows::Web::Http::Headers::HttpRequestHeaderCollection Headers() const noexcept;
    Windows::Web::Http::HttpMethod Method() const noexcept;
    void Method(Windows::Web::Http::HttpMethod const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::Foundation::IInspectable> Properties() const noexcept;
    Windows::Foundation::Uri RequestUri() const noexcept;
    void RequestUri(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Web::Http::HttpTransportInformation TransportInformation() const noexcept;
};
...
struct consume_Windows_Web_Http_IHttpResponseMessage
{
    Windows::Web::Http::IHttpContent Content() const noexcept;
    void Content(Windows::Web::Http::IHttpContent const& value) const noexcept;
    Windows::Web::Http::Headers::HttpResponseHeaderCollection Headers() const noexcept;
    bool IsSuccessStatusCode() const noexcept;
    hstring ReasonPhrase() const noexcept;
    void ReasonPhrase(param::hstring const& value) const noexcept;
    Windows::Web::Http::HttpRequestMessage RequestMessage() const noexcept;
    void RequestMessage(Windows::Web::Http::HttpRequestMessage const& value) const noexcept;
    Windows::Web::Http::HttpResponseMessageSource Source() const noexcept;
    void Source(Windows::Web::Http::HttpResponseMessageSource const& value) const noexcept;
    Windows::Web::Http::HttpStatusCode StatusCode() const noexcept;
    void StatusCode(Windows::Web::Http::HttpStatusCode const& value) const noexcept;
    Windows::Web::Http::HttpVersion Version() const noexcept;
    void Version(Windows::Web::Http::HttpVersion const& value) const noexcept;
...
template <> struct abi<Windows::Web::Http::IHttpClient>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetWithOptionAsync(::IUnknown* uri, Windows::Web::Http::HttpCompletionOption completionOption, ::IUnknown** operation) = 0;
    ...
    virtual HRESULT __stdcall SendRequestWithOptionAsync(::IUnknown* request, Windows::Web::Http::HttpCompletionOption completionOption, ::IUnknown** operation) = 0;
...
template <> struct abi<Windows::Web::Http::IHttpResponseMessage>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Source(Windows::Web::Http::HttpResponseMessageSource* value) = 0;
    virtual HRESULT __stdcall put_Source(Windows::Web::Http::HttpResponseMessageSource value) = 0;
    virtual HRESULT __stdcall get_StatusCode(Windows::Web::Http::HttpStatusCode* value) = 0;
    virtual HRESULT __stdcall put_StatusCode(Windows::Web::Http::HttpStatusCode value) = 0;
    virtual HRESULT __stdcall get_Version(Windows::Web::Http::HttpVersion* value) = 0;
    virtual HRESULT __stdcall put_Version(Windows::Web::Http::HttpVersion value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Web::Http::HttpStatusCode statusCode, ::IUnknown** httpResponseMessage) = 0;
};};
...
template <> struct abi<Windows::Web::Http::IHttpStringContentFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateFromStringWithEncoding(HSTRING content, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** stringContent) = 0;
    virtual HRESULT __stdcall CreateFromStringWithEncodingAndMediaType(HSTRING content, Windows::Storage::Streams::UnicodeEncoding encoding, HSTRING mediaType, ::IUnknown** stringContent) = 0;
};};
