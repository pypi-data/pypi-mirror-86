...
template <> struct guid<Windows::Security::EnterpriseData::IFileProtectionInfo2>{ static constexpr GUID value{ 0x82123A4C,0x557A,0x498D,{ 0x8E,0x94,0x94,0x4C,0xD5,0x83,0x64,0x32 } }; };
...
struct consume_Windows_Security_EnterpriseData_IBufferProtectUnprotectResult
{
    ...
    Windows::Security::EnterpriseData::DataProtectionInfo ProtectionInfo() const noexcept;
};
...
{
    Windows::Security::EnterpriseData::DataProtectionStatus Status() const noexcept;
    hstring Identity() const noexcept;
};
...
{
    Windows::Security::EnterpriseData::FileProtectionStatus Status() const noexcept;
    bool IsRoamable() const noexcept;
    hstring Identity() const noexcept;
};
...
{
    bool IsProtectWhileOpenSupported() const noexcept;
};
...
{
    void Audit(bool value) const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<hstring> Identities() const noexcept;
};
...
{
    Windows::Security::EnterpriseData::ProtectedImportExportStatus Status() const noexcept;
...
struct consume_Windows_Security_EnterpriseData_IProtectedFileCreateResult
{
    ...
    Windows::Security::EnterpriseData::FileProtectionInfo ProtectionInfo() const noexcept;
};
...
{
    void Action(Windows::Security::EnterpriseData::ProtectionPolicyAuditAction const& value) const noexcept;
    Windows::Security::EnterpriseData::ProtectionPolicyAuditAction Action() const noexcept;
    void DataDescription(param::hstring const& value) const noexcept;
    hstring DataDescription() const noexcept;
    void SourceDescription(param::hstring const& value) const noexcept;
    hstring SourceDescription() const noexcept;
    void TargetDescription(param::hstring const& value) const noexcept;
    hstring TargetDescription() const noexcept;
};
...
{
    void Identity(param::hstring const& value) const noexcept;
    hstring Identity() const noexcept;
};
...
{
    void ShowEnterpriseIndicator(bool value) const noexcept;
    bool ShowEnterpriseIndicator() const noexcept;
};
...
struct consume_Windows_Security_EnterpriseData_IProtectionPolicyManagerStatics2
{
    ...
    bool IsProtectionEnabled() const noexcept;
};
...
struct consume_Windows_Security_EnterpriseData_IProtectionPolicyManagerStatics4
{
    ...
    hstring PrimaryManagedIdentity() const noexcept;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Security::EnterpriseData::DataProtectionStatus* value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Security::EnterpriseData::FileProtectionStatus* value) = 0;
...
{
    virtual HRESULT __stdcall get_IsProtectWhileOpenSupported(bool* value) = 0;
};};
...
template <> struct abi<Windows::Security::EnterpriseData::IFileProtectionManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateProtectedAndOpenAsync(::IUnknown* parentFolder, HSTRING desiredName, HSTRING identity, Windows::Storage::CreationCollisionOption collisionOption, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Security::EnterpriseData::IFileProtectionManagerStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall LoadFileFromContainerWithTargetAndNameCollisionOptionAsync(::IUnknown* containerFile, ::IUnknown* target, Windows::Storage::NameCollisionOption collisionOption, ::IUnknown** result) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Security::EnterpriseData::ProtectedImportExportStatus* value) = 0;
...
{
    virtual HRESULT __stdcall put_Action(Windows::Security::EnterpriseData::ProtectionPolicyAuditAction value) = 0;
    virtual HRESULT __stdcall get_Action(Windows::Security::EnterpriseData::ProtectionPolicyAuditAction* value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Security::EnterpriseData::ProtectionPolicyAuditAction action, HSTRING dataDescription, HSTRING sourceDescription, HSTRING targetDescription, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall CreateWithActionAndDataDescription(Windows::Security::EnterpriseData::ProtectionPolicyAuditAction action, HSTRING dataDescription, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Security::EnterpriseData::IProtectionPolicyManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ProtectedAccessSuspending(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ProtectedAccessSuspending(event_token token) = 0;
    virtual HRESULT __stdcall add_ProtectedAccessResumed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ProtectedAccessResumed(event_token token) = 0;
    virtual HRESULT __stdcall add_ProtectedContentRevoked(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ProtectedContentRevoked(event_token token) = 0;
    virtual HRESULT __stdcall CheckAccess(HSTRING sourceIdentity, HSTRING targetIdentity, Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult* result) = 0;
...
{
    virtual HRESULT __stdcall HasContentBeenRevokedSince(HSTRING identity, Windows::Foundation::DateTime since, bool* result) = 0;
    virtual HRESULT __stdcall CheckAccessForApp(HSTRING sourceIdentity, HSTRING appPackageFamilyName, Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult* result) = 0;
    virtual HRESULT __stdcall RequestAccessForAppAsync(HSTRING sourceIdentity, HSTRING appPackageFamilyName, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetEnforcementLevel(HSTRING identity, Windows::Security::EnterpriseData::EnforcementLevel* value) = 0;
    ...
    virtual HRESULT __stdcall add_PolicyChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Security::EnterpriseData::IProtectionPolicyManagerStatics4>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestAccessWithBehaviorAsync(HSTRING sourceIdentity, HSTRING targetIdentity, ::IUnknown* auditInfo, HSTRING messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestAccessForAppWithBehaviorAsync(HSTRING sourceIdentity, HSTRING appPackageFamilyName, ::IUnknown* auditInfo, HSTRING messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall RequestAccessToFilesForAppWithMessageAndBehaviorAsync(::IUnknown* sourceItemList, HSTRING appPackageFamilyName, ::IUnknown* auditInfo, HSTRING messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall RequestAccessToFilesForProcessWithMessageAndBehaviorAsync(::IUnknown* sourceItemList, uint32_t processId, ::IUnknown* auditInfo, HSTRING messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, ::IUnknown** result) = 0;
