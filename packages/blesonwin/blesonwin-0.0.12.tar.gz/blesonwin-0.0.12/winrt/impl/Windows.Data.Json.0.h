...
{
    Windows::Data::Json::JsonValueType ValueType() const noexcept;
...
{
    virtual HRESULT __stdcall GetJsonStatus(int32_t hresult, Windows::Data::Json::JsonErrorStatus* status) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ValueType(Windows::Data::Json::JsonValueType* value) = 0;
