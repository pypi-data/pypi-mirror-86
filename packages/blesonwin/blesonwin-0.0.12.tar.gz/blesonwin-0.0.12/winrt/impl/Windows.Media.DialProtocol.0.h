...
template <> struct guid<Windows::Media::DialProtocol::IDialReceiverApp>{ static constexpr GUID value{ 0xFD3E7C57,0x5045,0x470E,{ 0xB3,0x04,0x4D,0xD9,0xB1,0x3E,0x7D,0x11 } }; };
template <> struct guid<Windows::Media::DialProtocol::IDialReceiverAppStatics>{ static constexpr GUID value{ 0x53183A3C,0x4C36,0x4D02,{ 0xB2,0x8A,0xF2,0xA9,0xDA,0x38,0xEC,0x52 } }; };
...
{
    Windows::Media::DialProtocol::DialAppState State() const noexcept;
    hstring FullXml() const noexcept;
};
...
{
    Windows::Media::DialProtocol::DialDevicePickerFilter Filter() const noexcept;
...
{
    Windows::Foundation::Collections::IVector<hstring> SupportedAppNames() const noexcept;
};
...
{
    Windows::Media::DialProtocol::DialDevice SelectedDialDevice() const noexcept;
};
...
{
    Windows::Media::DialProtocol::DialDevice Device() const noexcept;
};
...
{
    Windows::Media::DialProtocol::DialReceiverApp Current() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_State(Windows::Media::DialProtocol::DialAppState* value) = 0;
...
template <> struct abi<Windows::Media::DialProtocol::IDialDevicePicker>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DialDeviceSelected(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_DialDevicePickerDismissed(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall ShowWithPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement) = 0;
    virtual HRESULT __stdcall PickSingleDialDeviceAsync(Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall PickSingleDialDeviceAsyncWithPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall Hide() = 0;
    virtual HRESULT __stdcall SetDisplayStatus(::IUnknown* device, Windows::Media::DialProtocol::DialDeviceDisplayStatus status) = 0;
};};
...
{
    virtual HRESULT __stdcall GetAdditionalDataAsync(::IUnknown** operation) = 0;
    virtual HRESULT __stdcall SetAdditionalDataAsync(::IUnknown* additionalData, ::IUnknown** operation) = 0;
};};
