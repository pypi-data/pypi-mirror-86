...
struct consume_Windows_Foundation_Diagnostics_IErrorDetails
{
    ...
    hstring LongDescription() const noexcept;
    Windows::Foundation::Uri HelpUri() const noexcept;
};
...
{
    Windows::Foundation::Diagnostics::LoggingChannel Channel() const noexcept;
...
{
    GUID Group() const noexcept;
    void Group(GUID const& value) const noexcept;
};
...
{
    int64_t Keywords() const noexcept;
    void Keywords(int64_t value) const noexcept;
    int32_t Tags() const noexcept;
    void Tags(int32_t value) const noexcept;
    int16_t Task() const noexcept;
    void Task(int16_t value) const noexcept;
    Windows::Foundation::Diagnostics::LoggingOpcode Opcode() const noexcept;
    void Opcode(Windows::Foundation::Diagnostics::LoggingOpcode const& value) const noexcept;
    GUID ActivityId() const noexcept;
    void ActivityId(GUID const& value) const noexcept;
    GUID RelatedActivityId() const noexcept;
    void RelatedActivityId(GUID const& value) const noexcept;
};
...
{
    bool Enabled() const noexcept;
    Windows::Foundation::Diagnostics::CausalityTraceLevel TraceLevel() const noexcept;
};
...
{
    virtual HRESULT __stdcall TraceOperationCreation(Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel, Windows::Foundation::Diagnostics::CausalitySource source, GUID platformId, uint64_t operationId, HSTRING operationName, uint64_t relatedContext) = 0;
    virtual HRESULT __stdcall TraceOperationCompletion(Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel, Windows::Foundation::Diagnostics::CausalitySource source, GUID platformId, uint64_t operationId, Windows::Foundation::AsyncStatus status) = 0;
    virtual HRESULT __stdcall TraceOperationRelation(Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel, Windows::Foundation::Diagnostics::CausalitySource source, GUID platformId, uint64_t operationId, Windows::Foundation::Diagnostics::CausalityRelation relation) = 0;
    virtual HRESULT __stdcall TraceSynchronousWorkStart(Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel, Windows::Foundation::Diagnostics::CausalitySource source, GUID platformId, uint64_t operationId, Windows::Foundation::Diagnostics::CausalitySynchronousWork work) = 0;
    virtual HRESULT __stdcall TraceSynchronousWorkCompletion(Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel, Windows::Foundation::Diagnostics::CausalitySource source, Windows::Foundation::Diagnostics::CausalitySynchronousWork work) = 0;
    virtual HRESULT __stdcall add_TracingStatusChanged(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall SetErrorOptions(Windows::Foundation::Diagnostics::ErrorOptions value) = 0;
    virtual HRESULT __stdcall GetErrorOptions(Windows::Foundation::Diagnostics::ErrorOptions* value) = 0;
};};
...
template <> struct abi<Windows::Foundation::Diagnostics::IFileLoggingSession>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AddLoggingChannelWithLevel(::IUnknown* loggingChannel, Windows::Foundation::Diagnostics::LoggingLevel maxLevel) = 0;
    ...
    virtual HRESULT __stdcall add_LogFileGenerated(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingActivityFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateLoggingActivityWithLevel(HSTRING activityName, ::IUnknown* loggingChannel, Windows::Foundation::Diagnostics::LoggingLevel level, ::IUnknown** loggingActivity) = 0;
};};
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingChannel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Level(Windows::Foundation::Diagnostics::LoggingLevel* value) = 0;
    virtual HRESULT __stdcall LogMessage(HSTRING eventString) = 0;
    virtual HRESULT __stdcall LogMessageWithLevel(HSTRING eventString, Windows::Foundation::Diagnostics::LoggingLevel level) = 0;
    virtual HRESULT __stdcall LogValuePair(HSTRING value1, int32_t value2) = 0;
    virtual HRESULT __stdcall LogValuePairWithLevel(HSTRING value1, int32_t value2, Windows::Foundation::Diagnostics::LoggingLevel level) = 0;
    virtual HRESULT __stdcall add_LoggingEnabled(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingChannelFactory2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithOptionsAndId(HSTRING name, ::IUnknown* options, GUID id, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall Create(GUID group, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingFields>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AddEmptyWithFormat(HSTRING name, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddEmptyWithFormatAndTags(HSTRING name, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt8(HSTRING name, uint8_t value) = 0;
    virtual HRESULT __stdcall AddUInt8WithFormat(HSTRING name, uint8_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt8WithFormatAndTags(HSTRING name, uint8_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt8Array(HSTRING name, uint32_t __valueSize, uint8_t* value) = 0;
    virtual HRESULT __stdcall AddUInt8ArrayWithFormat(HSTRING name, uint32_t __valueSize, uint8_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt8ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, uint8_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt16(HSTRING name, int16_t value) = 0;
    virtual HRESULT __stdcall AddInt16WithFormat(HSTRING name, int16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt16WithFormatAndTags(HSTRING name, int16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt16Array(HSTRING name, uint32_t __valueSize, int16_t* value) = 0;
    virtual HRESULT __stdcall AddInt16ArrayWithFormat(HSTRING name, uint32_t __valueSize, int16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt16ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, int16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt16(HSTRING name, uint16_t value) = 0;
    virtual HRESULT __stdcall AddUInt16WithFormat(HSTRING name, uint16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt16WithFormatAndTags(HSTRING name, uint16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt16Array(HSTRING name, uint32_t __valueSize, uint16_t* value) = 0;
    virtual HRESULT __stdcall AddUInt16ArrayWithFormat(HSTRING name, uint32_t __valueSize, uint16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt16ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, uint16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt32(HSTRING name, int32_t value) = 0;
    virtual HRESULT __stdcall AddInt32WithFormat(HSTRING name, int32_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt32WithFormatAndTags(HSTRING name, int32_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt32Array(HSTRING name, uint32_t __valueSize, int32_t* value) = 0;
    virtual HRESULT __stdcall AddInt32ArrayWithFormat(HSTRING name, uint32_t __valueSize, int32_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt32ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, int32_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt32(HSTRING name, uint32_t value) = 0;
    virtual HRESULT __stdcall AddUInt32WithFormat(HSTRING name, uint32_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt32WithFormatAndTags(HSTRING name, uint32_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt32Array(HSTRING name, uint32_t __valueSize, uint32_t* value) = 0;
    virtual HRESULT __stdcall AddUInt32ArrayWithFormat(HSTRING name, uint32_t __valueSize, uint32_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt32ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, uint32_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt64(HSTRING name, int64_t value) = 0;
    virtual HRESULT __stdcall AddInt64WithFormat(HSTRING name, int64_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt64WithFormatAndTags(HSTRING name, int64_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddInt64Array(HSTRING name, uint32_t __valueSize, int64_t* value) = 0;
    virtual HRESULT __stdcall AddInt64ArrayWithFormat(HSTRING name, uint32_t __valueSize, int64_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddInt64ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, int64_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt64(HSTRING name, uint64_t value) = 0;
    virtual HRESULT __stdcall AddUInt64WithFormat(HSTRING name, uint64_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt64WithFormatAndTags(HSTRING name, uint64_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddUInt64Array(HSTRING name, uint32_t __valueSize, uint64_t* value) = 0;
    virtual HRESULT __stdcall AddUInt64ArrayWithFormat(HSTRING name, uint32_t __valueSize, uint64_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddUInt64ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, uint64_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddSingle(HSTRING name, float value) = 0;
    virtual HRESULT __stdcall AddSingleWithFormat(HSTRING name, float value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddSingleWithFormatAndTags(HSTRING name, float value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddSingleArray(HSTRING name, uint32_t __valueSize, float* value) = 0;
    virtual HRESULT __stdcall AddSingleArrayWithFormat(HSTRING name, uint32_t __valueSize, float* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddSingleArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, float* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddDouble(HSTRING name, double value) = 0;
    virtual HRESULT __stdcall AddDoubleWithFormat(HSTRING name, double value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddDoubleWithFormatAndTags(HSTRING name, double value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddDoubleArray(HSTRING name, uint32_t __valueSize, double* value) = 0;
    virtual HRESULT __stdcall AddDoubleArrayWithFormat(HSTRING name, uint32_t __valueSize, double* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddDoubleArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, double* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddChar16(HSTRING name, char16_t value) = 0;
    virtual HRESULT __stdcall AddChar16WithFormat(HSTRING name, char16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddChar16WithFormatAndTags(HSTRING name, char16_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddChar16Array(HSTRING name, uint32_t __valueSize, char16_t* value) = 0;
    virtual HRESULT __stdcall AddChar16ArrayWithFormat(HSTRING name, uint32_t __valueSize, char16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddChar16ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, char16_t* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddBoolean(HSTRING name, bool value) = 0;
    virtual HRESULT __stdcall AddBooleanWithFormat(HSTRING name, bool value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddBooleanWithFormatAndTags(HSTRING name, bool value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddBooleanArray(HSTRING name, uint32_t __valueSize, bool* value) = 0;
    virtual HRESULT __stdcall AddBooleanArrayWithFormat(HSTRING name, uint32_t __valueSize, bool* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddBooleanArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, bool* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddString(HSTRING name, HSTRING value) = 0;
    virtual HRESULT __stdcall AddStringWithFormat(HSTRING name, HSTRING value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddStringWithFormatAndTags(HSTRING name, HSTRING value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddStringArray(HSTRING name, uint32_t __valueSize, HSTRING* value) = 0;
    virtual HRESULT __stdcall AddStringArrayWithFormat(HSTRING name, uint32_t __valueSize, HSTRING* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddStringArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, HSTRING* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddGuid(HSTRING name, GUID value) = 0;
    virtual HRESULT __stdcall AddGuidWithFormat(HSTRING name, GUID value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddGuidWithFormatAndTags(HSTRING name, GUID value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddGuidArray(HSTRING name, uint32_t __valueSize, GUID* value) = 0;
    virtual HRESULT __stdcall AddGuidArrayWithFormat(HSTRING name, uint32_t __valueSize, GUID* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddGuidArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, GUID* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddDateTime(HSTRING name, Windows::Foundation::DateTime value) = 0;
    virtual HRESULT __stdcall AddDateTimeWithFormat(HSTRING name, Windows::Foundation::DateTime value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddDateTimeWithFormatAndTags(HSTRING name, Windows::Foundation::DateTime value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddDateTimeArray(HSTRING name, uint32_t __valueSize, Windows::Foundation::DateTime* value) = 0;
    virtual HRESULT __stdcall AddDateTimeArrayWithFormat(HSTRING name, uint32_t __valueSize, Windows::Foundation::DateTime* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddDateTimeArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, Windows::Foundation::DateTime* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddTimeSpan(HSTRING name, Windows::Foundation::TimeSpan value) = 0;
    virtual HRESULT __stdcall AddTimeSpanWithFormat(HSTRING name, Windows::Foundation::TimeSpan value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddTimeSpanWithFormatAndTags(HSTRING name, Windows::Foundation::TimeSpan value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddTimeSpanArray(HSTRING name, uint32_t __valueSize, Windows::Foundation::TimeSpan* value) = 0;
    virtual HRESULT __stdcall AddTimeSpanArrayWithFormat(HSTRING name, uint32_t __valueSize, Windows::Foundation::TimeSpan* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddTimeSpanArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, Windows::Foundation::TimeSpan* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddPoint(HSTRING name, Windows::Foundation::Point value) = 0;
    virtual HRESULT __stdcall AddPointWithFormat(HSTRING name, Windows::Foundation::Point value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddPointWithFormatAndTags(HSTRING name, Windows::Foundation::Point value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddPointArray(HSTRING name, uint32_t __valueSize, Windows::Foundation::Point* value) = 0;
    virtual HRESULT __stdcall AddPointArrayWithFormat(HSTRING name, uint32_t __valueSize, Windows::Foundation::Point* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddPointArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, Windows::Foundation::Point* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddSize(HSTRING name, Windows::Foundation::Size value) = 0;
    virtual HRESULT __stdcall AddSizeWithFormat(HSTRING name, Windows::Foundation::Size value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddSizeWithFormatAndTags(HSTRING name, Windows::Foundation::Size value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddSizeArray(HSTRING name, uint32_t __valueSize, Windows::Foundation::Size* value) = 0;
    virtual HRESULT __stdcall AddSizeArrayWithFormat(HSTRING name, uint32_t __valueSize, Windows::Foundation::Size* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddSizeArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, Windows::Foundation::Size* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddRect(HSTRING name, Windows::Foundation::Rect value) = 0;
    virtual HRESULT __stdcall AddRectWithFormat(HSTRING name, Windows::Foundation::Rect value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddRectWithFormatAndTags(HSTRING name, Windows::Foundation::Rect value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddRectArray(HSTRING name, uint32_t __valueSize, Windows::Foundation::Rect* value) = 0;
    virtual HRESULT __stdcall AddRectArrayWithFormat(HSTRING name, uint32_t __valueSize, Windows::Foundation::Rect* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format) = 0;
    virtual HRESULT __stdcall AddRectArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, Windows::Foundation::Rect* value, Windows::Foundation::Diagnostics::LoggingFieldFormat format, int32_t tags) = 0;
};};
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Opcode(Windows::Foundation::Diagnostics::LoggingOpcode* value) = 0;
    virtual HRESULT __stdcall put_Opcode(Windows::Foundation::Diagnostics::LoggingOpcode value) = 0;
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingTarget>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall IsEnabledWithLevel(Windows::Foundation::Diagnostics::LoggingLevel level, bool* result) = 0;
    virtual HRESULT __stdcall IsEnabledWithLevelAndKeywords(Windows::Foundation::Diagnostics::LoggingLevel level, int64_t keywords, bool* result) = 0;
    ...
    virtual HRESULT __stdcall LogEventWithFieldsAndLevel(HSTRING eventName, ::IUnknown* fields, Windows::Foundation::Diagnostics::LoggingLevel level) = 0;
    virtual HRESULT __stdcall LogEventWithFieldsAndOptions(HSTRING eventName, ::IUnknown* fields, Windows::Foundation::Diagnostics::LoggingLevel level, ::IUnknown* options) = 0;
    ...
    virtual HRESULT __stdcall StartActivityWithFieldsAndLevel(HSTRING startEventName, ::IUnknown* fields, Windows::Foundation::Diagnostics::LoggingLevel level, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall StartActivityWithFieldsAndOptions(HSTRING startEventName, ::IUnknown* fields, Windows::Foundation::Diagnostics::LoggingLevel level, ::IUnknown* options, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Foundation::Diagnostics::ITracingStatusChangedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TraceLevel(Windows::Foundation::Diagnostics::CausalityTraceLevel* value) = 0;
};};
