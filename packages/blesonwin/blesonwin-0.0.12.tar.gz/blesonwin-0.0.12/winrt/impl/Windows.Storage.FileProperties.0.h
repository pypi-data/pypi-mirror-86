...
struct consume_Windows_Storage_FileProperties_IBasicProperties
{
    ...
    Windows::Foundation::DateTime DateModified() const noexcept;
    Windows::Foundation::DateTime ItemDate() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> Author() const noexcept;
    hstring Title() const noexcept;
    void Title(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Keywords() const noexcept;
...
{
    uint32_t Rating() const noexcept;
    void Rating(uint32_t value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Keywords() const noexcept;
    Windows::Foundation::DateTime DateTaken() const noexcept;
    void DateTaken(Windows::Foundation::DateTime const& value) const noexcept;
    uint32_t Width() const noexcept;
    uint32_t Height() const noexcept;
    hstring Title() const noexcept;
    void Title(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<double> Latitude() const noexcept;
    Windows::Foundation::IReference<double> Longitude() const noexcept;
    hstring CameraManufacturer() const noexcept;
    void CameraManufacturer(param::hstring const& value) const noexcept;
    hstring CameraModel() const noexcept;
    void CameraModel(param::hstring const& value) const noexcept;
    Windows::Storage::FileProperties::PhotoOrientation Orientation() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> PeopleNames() const noexcept;
};
...
struct consume_Windows_Storage_FileProperties_IMusicProperties
{
    ...
    void Album(param::hstring const& value) const noexcept;
    hstring Artist() const noexcept;
    void Artist(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Genre() const noexcept;
    ...
    Windows::Foundation::Collections::IVector<hstring> Composers() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Conductors() const noexcept;
    hstring Subtitle() const noexcept;
    void Subtitle(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Producers() const noexcept;
    hstring Publisher() const noexcept;
    void Publisher(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Writers() const noexcept;
    uint32_t Year() const noexcept;
    void Year(uint32_t value) const noexcept;
};
...
{
    uint32_t OriginalWidth() const noexcept;
    uint32_t OriginalHeight() const noexcept;
    bool ReturnedSmallerCachedSize() const noexcept;
    Windows::Storage::FileProperties::ThumbnailType Type() const noexcept;
};
...
struct consume_Windows_Storage_FileProperties_IVideoProperties
{
    ...
    void Year(uint32_t value) const noexcept;
    uint32_t Bitrate() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Directors() const noexcept;
    Windows::Storage::FileProperties::VideoOrientation Orientation() const noexcept;
};
...
template <> struct abi<Windows::Storage::FileProperties::IImageProperties>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Orientation(Windows::Storage::FileProperties::PhotoOrientation* value) = 0;
...
template <> struct abi<Windows::Storage::FileProperties::IThumbnailProperties>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Type(Windows::Storage::FileProperties::ThumbnailType* value) = 0;
};};
...
template <> struct abi<Windows::Storage::FileProperties::IVideoProperties>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Orientation(Windows::Storage::FileProperties::VideoOrientation* value) = 0;
};};
