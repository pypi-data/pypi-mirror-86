...
{
    Windows::Foundation::IInspectable Current() const noexcept;
...
{
    Windows::UI::Xaml::Interop::NotifyCollectionChangedAction Action() const noexcept;
    Windows::UI::Xaml::Interop::IBindableVector NewItems() const noexcept;
    Windows::UI::Xaml::Interop::IBindableVector OldItems() const noexcept;
    int32_t NewStartingIndex() const noexcept;
    int32_t OldStartingIndex() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_VectorChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_CollectionChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Action(Windows::UI::Xaml::Interop::NotifyCollectionChangedAction* value) = 0;
...
{
    virtual HRESULT __stdcall CreateInstanceWithAllParameters(Windows::UI::Xaml::Interop::NotifyCollectionChangedAction action, ::IUnknown* newItems, ::IUnknown* oldItems, int32_t newIndex, int32_t oldIndex, ::IUnknown* outer, ::IUnknown** inner, ::IUnknown** instance) = 0;
};};
