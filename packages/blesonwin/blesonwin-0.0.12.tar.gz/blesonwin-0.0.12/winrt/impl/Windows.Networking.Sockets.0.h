...
template <> struct guid<Windows::Networking::Sockets::IMessageWebSocketControl2>{ static constexpr GUID value{ 0xE30FD791,0x080C,0x400A,{ 0xA7,0x12,0x27,0xDF,0xA9,0xE7,0x44,0xD8 } }; };
...
template <> struct guid<Windows::Networking::Sockets::IMessageWebSocketMessageReceivedEventArgs2>{ static constexpr GUID value{ 0x89CE06FD,0xDD6F,0x4A07,{ 0x87,0xF9,0xF9,0xEB,0x4D,0x89,0xD8,0x3D } }; };
...
template <> struct guid<Windows::Networking::Sockets::IStreamSocketControl4>{ static constexpr GUID value{ 0x964E2B3D,0xEC27,0x4888,{ 0xB3,0xCE,0xC7,0x4B,0x41,0x84,0x23,0xAD } }; };
...
template <> struct guid<Windows::Networking::Sockets::IStreamWebSocketControl2>{ static constexpr GUID value{ 0x215D9F7E,0xFA58,0x40DA,{ 0x9F,0x11,0xA4,0x8D,0xAF,0xE9,0x50,0x37 } }; };
...
{
    hstring ControlChannelTriggerId() const noexcept;
    uint32_t ServerKeepAliveIntervalInMinutes() const noexcept;
    void ServerKeepAliveIntervalInMinutes(uint32_t value) const noexcept;
    uint32_t CurrentKeepAliveIntervalInMinutes() const noexcept;
    Windows::Foundation::IInspectable TransportObject() const noexcept;
    Windows::ApplicationModel::Background::IBackgroundTrigger KeepAliveTrigger() const noexcept;
    Windows::ApplicationModel::Background::IBackgroundTrigger PushNotificationTrigger() const noexcept;
...
{
    bool IsWakeFromLowPowerSupported() const noexcept;
};
...
{
    Windows::Networking::Sockets::ControlChannelTrigger ControlChannelTrigger() const noexcept;
};
...
{
    Windows::Networking::Sockets::ControlChannelTriggerResetReason ResetReason() const noexcept;
    bool HardwareSlotReset() const noexcept;
    bool SoftwareSlotReset() const noexcept;
};
...
{
    Windows::Networking::Sockets::DatagramSocketControl Control() const noexcept;
    Windows::Networking::Sockets::DatagramSocketInformation Information() const noexcept;
    Windows::Storage::Streams::IOutputStream OutputStream() const noexcept;
...
{
    Windows::Networking::Sockets::SocketQualityOfService QualityOfService() const noexcept;
    void QualityOfService(Windows::Networking::Sockets::SocketQualityOfService const& value) const noexcept;
    uint8_t OutboundUnicastHopLimit() const noexcept;
    void OutboundUnicastHopLimit(uint8_t value) const noexcept;
};
...
{
    uint32_t InboundBufferSizeInBytes() const noexcept;
    void InboundBufferSizeInBytes(uint32_t value) const noexcept;
    bool DontFragment() const noexcept;
    void DontFragment(bool value) const noexcept;
};
...
{
    bool MulticastOnly() const noexcept;
    void MulticastOnly(bool value) const noexcept;
};
...
{
    Windows::Networking::HostName LocalAddress() const noexcept;
    hstring LocalPort() const noexcept;
    Windows::Networking::HostName RemoteAddress() const noexcept;
...
{
    Windows::Networking::Sockets::MessageWebSocketControl Control() const noexcept;
    Windows::Networking::Sockets::MessageWebSocketInformation Information() const noexcept;
...
struct consume_Windows_Networking_Sockets_IMessageWebSocketControl
{
    ...
    void MaxMessageSize(uint32_t value) const noexcept;
    Windows::Networking::Sockets::SocketMessageType MessageType() const noexcept;
    void MessageType(Windows::Networking::Sockets::SocketMessageType const& value) const noexcept;
};
...
{
    Windows::Foundation::TimeSpan DesiredUnsolicitedPongInterval() const noexcept;
    void DesiredUnsolicitedPongInterval(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan ActualUnsolicitedPongInterval() const noexcept;
    Windows::Networking::Sockets::MessageWebSocketReceiveMode ReceiveMode() const noexcept;
    void ReceiveMode(Windows::Networking::Sockets::MessageWebSocketReceiveMode const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate ClientCertificate() const noexcept;
    void ClientCertificate(Windows::Security::Cryptography::Certificates::Certificate const& value) const noexcept;
};
...
{
    bool IsMessageComplete() const noexcept;
};
...
struct consume_Windows_Networking_Sockets_ISocketActivityInformation
{
    ...
    Windows::Networking::Sockets::SocketActivityKind SocketKind() const noexcept;
    Windows::Networking::Sockets::SocketActivityContext Context() const noexcept;
    Windows::Networking::Sockets::DatagramSocket DatagramSocket() const noexcept;
    Windows::Networking::Sockets::StreamSocket StreamSocket() const noexcept;
    Windows::Networking::Sockets::StreamSocketListener StreamSocketListener() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::Networking::Sockets::SocketActivityInformation> AllSockets() const noexcept;
};
...
{
    Windows::Networking::Sockets::SocketActivityTriggerReason Reason() const noexcept;
    Windows::Networking::Sockets::SocketActivityInformation SocketInformation() const noexcept;
};
...
{
    Windows::Networking::Sockets::StreamSocketControl Control() const noexcept;
    Windows::Networking::Sockets::StreamSocketInformation Information() const noexcept;
...
struct consume_Windows_Networking_Sockets_IStreamSocketControl
{
    ...
    void NoDelay(bool value) const noexcept;
    bool KeepAlive() const noexcept;
    void KeepAlive(bool value) const noexcept;
    uint32_t OutboundBufferSizeInBytes() const noexcept;
    void OutboundBufferSizeInBytes(uint32_t value) const noexcept;
    Windows::Networking::Sockets::SocketQualityOfService QualityOfService() const noexcept;
    void QualityOfService(Windows::Networking::Sockets::SocketQualityOfService const& value) const noexcept;
    uint8_t OutboundUnicastHopLimit() const noexcept;
    void OutboundUnicastHopLimit(uint8_t value) const noexcept;
...
{
    Windows::Foundation::Collections::IVector<Windows::Security::Cryptography::Certificates::ChainValidationResult> IgnorableServerCertificateErrors() const noexcept;
};
...
{
    bool SerializeConnectionAttempts() const noexcept;
    void SerializeConnectionAttempts(bool value) const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate ClientCertificate() const noexcept;
    void ClientCertificate(Windows::Security::Cryptography::Certificates::Certificate const& value) const noexcept;
};
...
{
    Windows::Networking::Sockets::SocketProtectionLevel MinProtectionLevel() const noexcept;
    void MinProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel const& value) const noexcept;
};
...
struct consume_Windows_Networking_Sockets_IStreamSocketInformation
{
    ...
    Windows::Networking::HostName RemoteAddress() const noexcept;
    hstring RemoteServiceName() const noexcept;
    hstring RemotePort() const noexcept;
    Windows::Networking::Sockets::RoundTripTimeStatistics RoundTripTimeStatistics() const noexcept;
    Windows::Networking::Sockets::BandwidthStatistics BandwidthStatistics() const noexcept;
    Windows::Networking::Sockets::SocketProtectionLevel ProtectionLevel() const noexcept;
    Windows::Storage::Streams::IBuffer SessionKey() const noexcept;
};
...
{
    Windows::Networking::Sockets::SocketSslErrorSeverity ServerCertificateErrorSeverity() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::ChainValidationResult> ServerCertificateErrors() const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate ServerCertificate() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::Certificate> ServerIntermediateCertificates() const noexcept;
};
...
{
    Windows::Networking::Sockets::StreamSocketListenerControl Control() const noexcept;
    Windows::Networking::Sockets::StreamSocketListenerInformation Information() const noexcept;
    Windows::Foundation::IAsyncAction BindServiceNameAsync(param::hstring const& localServiceName) const;
    Windows::Foundation::IAsyncAction BindEndpointAsync(Windows::Networking::HostName const& localHostName, param::hstring const& localServiceName) const;
...
{
    Windows::Networking::Sockets::StreamSocket Socket() const noexcept;
};
...
{
    Windows::Networking::Sockets::StreamWebSocketControl Control() const noexcept;
    Windows::Networking::Sockets::StreamWebSocketInformation Information() const noexcept;
    Windows::Storage::Streams::IInputStream InputStream() const noexcept;
};
...
struct consume_Windows_Networking_Sockets_IWebSocketControl
{
    ...
    Windows::Foundation::Collections::IVector<hstring> SupportedProtocols() const noexcept;
};
...
struct consume_Windows_Networking_Sockets_IWebSocketInformation
{
    Windows::Networking::HostName LocalAddress() const noexcept;
    Windows::Networking::Sockets::BandwidthStatistics BandwidthStatistics() const noexcept;
    hstring Protocol() const noexcept;
};
...
template <> struct abi<Windows::Networking::Sockets::IControlChannelTrigger>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall WaitForPushEnabled(Windows::Networking::Sockets::ControlChannelTriggerStatus* channelTriggerStatus) = 0;
...
template <> struct abi<Windows::Networking::Sockets::IControlChannelTriggerFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateControlChannelTriggerEx(HSTRING channelId, uint32_t serverKeepAliveIntervalInMinutes, Windows::Networking::Sockets::ControlChannelTriggerResourceType resourceRequestType, ::IUnknown** notificationChannel) = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IControlChannelTriggerResetEventDetails>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ResetReason(Windows::Networking::Sockets::ControlChannelTriggerResetReason* value) = 0;
...
template <> struct abi<Windows::Networking::Sockets::IDatagramSocket3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall EnableTransferOwnership(GUID taskId) = 0;
    virtual HRESULT __stdcall EnableTransferOwnershipWithConnectedStandbyAction(GUID taskId, Windows::Networking::Sockets::SocketActivityConnectedStandbyAction connectedStandbyAction) = 0;
    ...
    virtual HRESULT __stdcall TransferOwnershipWithContextAndKeepAliveTime(HSTRING socketId, ::IUnknown* data, Windows::Foundation::TimeSpan keepAliveTime) = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IDatagramSocketControl>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService* value) = 0;
    virtual HRESULT __stdcall put_QualityOfService(Windows::Networking::Sockets::SocketQualityOfService value) = 0;
...
template <> struct abi<Windows::Networking::Sockets::IDatagramSocketStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetEndpointPairsWithSortOptionsAsync(::IUnknown* remoteHostName, HSTRING remoteServiceName, Windows::Networking::HostNameSortOptions sortOptions, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall add_ServerCustomValidationRequested(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
template <> struct abi<Windows::Networking::Sockets::IMessageWebSocketControl>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MessageType(Windows::Networking::Sockets::SocketMessageType* value) = 0;
    virtual HRESULT __stdcall put_MessageType(Windows::Networking::Sockets::SocketMessageType value) = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IMessageWebSocketControl2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_DesiredUnsolicitedPongInterval(Windows::Foundation::TimeSpan* value) = 0;
    virtual HRESULT __stdcall put_DesiredUnsolicitedPongInterval(Windows::Foundation::TimeSpan value) = 0;
    virtual HRESULT __stdcall get_ActualUnsolicitedPongInterval(Windows::Foundation::TimeSpan* value) = 0;
    virtual HRESULT __stdcall get_ReceiveMode(Windows::Networking::Sockets::MessageWebSocketReceiveMode* value) = 0;
    virtual HRESULT __stdcall put_ReceiveMode(Windows::Networking::Sockets::MessageWebSocketReceiveMode value) = 0;
...
{
    virtual HRESULT __stdcall get_IsMessageComplete(bool* value) = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::ISocketActivityInformation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SocketKind(Windows::Networking::Sockets::SocketActivityKind* value) = 0;
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Networking::Sockets::SocketActivityTriggerReason* value) = 0;
...
{
    virtual HRESULT __stdcall GetStatus(int32_t hresult, Windows::Networking::Sockets::SocketErrorStatus* status) = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocket>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ConnectWithEndpointPairAsync(::IUnknown* endpointPair, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ConnectAsync(::IUnknown* remoteHostName, HSTRING remoteServiceName, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ConnectWithEndpointPairAndProtectionLevelAsync(::IUnknown* endpointPair, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ConnectWithProtectionLevelAsync(::IUnknown* remoteHostName, HSTRING remoteServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall UpgradeToSslAsync(Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown* validationHostName, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Networking::Sockets::IStreamSocket2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall ConnectWithProtectionLevelAndAdapterAsync(::IUnknown* remoteHostName, HSTRING remoteServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown* adapter, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall get_MinProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel* value) = 0;
    virtual HRESULT __stdcall put_MinProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel value) = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocketInformation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RemotePort(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_RoundTripTimeStatistics(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall get_BandwidthStatistics(struct_of<40>* value) = 0;
    virtual HRESULT __stdcall get_ProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel* value) = 0;
...
{
    virtual HRESULT __stdcall get_ServerCertificateErrorSeverity(Windows::Networking::Sockets::SocketSslErrorSeverity* value) = 0;
...
template <> struct abi<Windows::Networking::Sockets::IStreamSocketListener>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall BindServiceNameAsync(HSTRING localServiceName, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall BindEndpointAsync(::IUnknown* localHostName, HSTRING localServiceName, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall add_ConnectionReceived(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall BindServiceNameWithProtectionLevelAsync(HSTRING localServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall BindServiceNameWithProtectionLevelAndAdapterAsync(HSTRING localServiceName, Windows::Networking::Sockets::SocketProtectionLevel protectionLevel, ::IUnknown* adapter, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Networking::Sockets::IWebSocket>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Closed(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall GetStatus(int32_t hresult, Windows::Web::WebErrorStatus* status) = 0;
};};
