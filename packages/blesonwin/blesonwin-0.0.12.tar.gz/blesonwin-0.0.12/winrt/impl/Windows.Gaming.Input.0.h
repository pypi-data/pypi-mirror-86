...
template <> struct guid<Windows::Gaming::Input::IRawGameController2>{ static constexpr GUID value{ 0x43C0C035,0xBB73,0x4756,{ 0xA7,0x87,0x3E,0xD6,0xBE,0xA6,0x17,0xBD } }; };
...
struct consume_Windows_Gaming_Input_IArcadeStickStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::ArcadeStick> ArcadeSticks() const noexcept;
};
...
{
    Windows::Gaming::Input::GameControllerSwitchKind HatSwitchKind() const noexcept;
...
struct consume_Windows_Gaming_Input_IFlightStickStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::FlightStick> FlightSticks() const noexcept;
...
struct consume_Windows_Gaming_Input_IGameController
{
    ...
    Windows::Gaming::Input::Headset Headset() const noexcept;
    bool IsWireless() const noexcept;
...
{
    Windows::Gaming::Input::GamepadVibration Vibration() const noexcept;
    void Vibration(Windows::Gaming::Input::GamepadVibration const& value) const noexcept;
...
struct consume_Windows_Gaming_Input_IGamepadStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::Gamepad> Gamepads() const noexcept;
};
...
{
    hstring CaptureDeviceId() const noexcept;
    hstring RenderDeviceId() const noexcept;
};
...
{
    bool HasClutch() const noexcept;
    bool HasHandbrake() const noexcept;
    bool HasPatternShifter() const noexcept;
    int32_t MaxPatternShifterGear() const noexcept;
    double MaxWheelAngle() const noexcept;
    Windows::Gaming::Input::ForceFeedback::ForceFeedbackMotor WheelMotor() const noexcept;
...
struct consume_Windows_Gaming_Input_IRacingWheelStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::RacingWheel> RacingWheels() const noexcept;
};
...
{
    int32_t AxisCount() const noexcept;
    int32_t ButtonCount() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::ForceFeedback::ForceFeedbackMotor> ForceFeedbackMotors() const noexcept;
    uint16_t HardwareProductId() const noexcept;
    uint16_t HardwareVendorId() const noexcept;
    int32_t SwitchCount() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Devices::Haptics::SimpleHapticsController> SimpleHapticsControllers() const noexcept;
...
struct consume_Windows_Gaming_Input_IRawGameControllerStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::RawGameController> RawGameControllers() const noexcept;
...
struct consume_Windows_Gaming_Input_IUINavigationControllerStatics
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Gaming::Input::UINavigationController> UINavigationControllers() const noexcept;
};
...
{
    virtual HRESULT __stdcall GetButtonLabel(Windows::Gaming::Input::ArcadeStickButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
    virtual HRESULT __stdcall GetCurrentReading(struct_of<16>* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IArcadeStickStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_ArcadeStickAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ArcadeStickAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_ArcadeStickRemoved(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_HatSwitchKind(Windows::Gaming::Input::GameControllerSwitchKind* value) = 0;
    virtual HRESULT __stdcall GetButtonLabel(Windows::Gaming::Input::FlightStickButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
    virtual HRESULT __stdcall GetCurrentReading(struct_of<48>* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IFlightStickStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_FlightStickAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_FlightStickAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_FlightStickRemoved(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_HeadsetConnected(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_HeadsetConnected(event_token token) = 0;
    virtual HRESULT __stdcall add_HeadsetDisconnected(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_HeadsetDisconnected(event_token token) = 0;
    virtual HRESULT __stdcall add_UserChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Vibration(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_Vibration(struct_of<32> value) = 0;
    virtual HRESULT __stdcall GetCurrentReading(struct_of<64>* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IGamepad2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetButtonLabel(Windows::Gaming::Input::GamepadButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IGamepadStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_GamepadAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_GamepadAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_GamepadRemoved(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Gaming::Input::IRacingWheel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetButtonLabel(Windows::Gaming::Input::RacingWheelButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
    virtual HRESULT __stdcall GetCurrentReading(struct_of<56>* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IRacingWheelStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_RacingWheelAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RacingWheelAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_RacingWheelRemoved(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Gaming::Input::IRawGameController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetButtonLabel(int32_t buttonIndex, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
    virtual HRESULT __stdcall GetCurrentReading(uint32_t __buttonArraySize, bool* buttonArray, uint32_t __switchArraySize, Windows::Gaming::Input::GameControllerSwitchPosition* switchArray, uint32_t __axisArraySize, double* axisArray, uint64_t* timestamp) = 0;
    virtual HRESULT __stdcall GetSwitchKind(int32_t switchIndex, Windows::Gaming::Input::GameControllerSwitchKind* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IRawGameController2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_SimpleHapticsControllers(::IUnknown** value) = 0;
...
{
    virtual HRESULT __stdcall add_RawGameControllerAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RawGameControllerAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_RawGameControllerRemoved(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall GetCurrentReading(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall GetOptionalButtonLabel(Windows::Gaming::Input::OptionalUINavigationButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
    virtual HRESULT __stdcall GetRequiredButtonLabel(Windows::Gaming::Input::RequiredUINavigationButtons button, Windows::Gaming::Input::GameControllerButtonLabel* value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::IUINavigationControllerStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_UINavigationControllerAdded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_UINavigationControllerAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_UINavigationControllerRemoved(::IUnknown* value, event_token* token) = 0;
