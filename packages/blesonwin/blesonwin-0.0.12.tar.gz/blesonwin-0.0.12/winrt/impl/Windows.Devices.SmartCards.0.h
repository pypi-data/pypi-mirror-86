...
template <> struct guid<Windows::Devices::SmartCards::ISmartCardCryptogramGeneratorStatics2>{ static constexpr GUID value{ 0x09BDF5E5,0xB4BD,0x4E23,{ 0xA5,0x88,0x74,0x46,0x92,0x04,0xC1,0x28 } }; };
...
template <> struct guid<Windows::Devices::SmartCards::ISmartCardEmulatorStatics3>{ static constexpr GUID value{ 0x59EA142A,0x9F09,0x43F5,{ 0x85,0x65,0xCF,0xA8,0x14,0x8E,0x4C,0xB2 } }; };
...
{
    Windows::Devices::SmartCards::SmartCard SmartCard() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardReader Reader() const noexcept;
...
struct consume_Windows_Devices_SmartCards_ISmartCardAppletIdGroup
{
    ...
    Windows::Foundation::Collections::IVector<Windows::Storage::Streams::IBuffer> AppletIds() const noexcept;
    Windows::Devices::SmartCards::SmartCardEmulationCategory SmartCardEmulationCategory() const noexcept;
    void SmartCardEmulationCategory(Windows::Devices::SmartCards::SmartCardEmulationCategory const& value) const noexcept;
    Windows::Devices::SmartCards::SmartCardEmulationType SmartCardEmulationType() const noexcept;
    void SmartCardEmulationType(Windows::Devices::SmartCards::SmartCardEmulationType const& value) const noexcept;
    bool AutomaticEnablement() const noexcept;
    void AutomaticEnablement(bool value) const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardAppletIdGroupActivationPolicy ActivationPolicy() const noexcept;
    Windows::Devices::SmartCards::SmartCardAppletIdGroup AppletIdGroup() const noexcept;
...
{
    uint16_t MaxAppletIds() const noexcept;
};
...
{
    Windows::Storage::Streams::IBuffer CommandApdu() const noexcept;
    void CommandApdu(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    Windows::Storage::Streams::IBuffer CommandApduBitMask() const noexcept;
    void CommandApduBitMask(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    bool ShouldMatchLength() const noexcept;
    void ShouldMatchLength(bool value) const noexcept;
    Windows::Storage::Streams::IBuffer AppletId() const noexcept;
    void AppletId(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    Windows::Storage::Streams::IBuffer ResponseApdu() const noexcept;
    void ResponseApdu(Windows::Storage::Streams::IBuffer const& value) const noexcept;
};
...
{
    Windows::Foundation::IReference<uint32_t> InputState() const noexcept;
    void InputState(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> OutputState() const noexcept;
    void OutputState(optional<uint32_t> const& value) const noexcept;
};
...
{
    bool AllowWhenCryptogramGeneratorNotPrepared() const noexcept;
    void AllowWhenCryptogramGeneratorNotPrepared(bool value) const noexcept;
};
...
{
    Windows::Storage::Streams::IBuffer Challenge() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialType> SupportedCryptogramMaterialTypes() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> SupportedCryptogramAlgorithms() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat> SupportedCryptogramMaterialPackageFormats() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat> SupportedCryptogramMaterialPackageConfirmationResponseFormats() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities> SupportedSmartCardCryptogramStorageKeyCapabilities() const noexcept;
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialCharacteristics> Characteristics() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageCharacteristics> Characteristics() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCharacteristics> Characteristics() const noexcept;
};
...
{
    hstring MaterialName() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> AllowedAlgorithms() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat> AllowedProofOfPossessionAlgorithms() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> AllowedValidations() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramMaterialType MaterialType() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramMaterialProtectionMethod ProtectionMethod() const noexcept;
    int32_t ProtectionVersion() const noexcept;
    int32_t MaterialLength() const noexcept;
};
...
{
    hstring PackageName() const noexcept;
    hstring StorageKeyName() const noexcept;
    Windows::Foundation::DateTime DateImported() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat PackageFormat() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const noexcept;
    Windows::Storage::Streams::IBuffer Proof() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm Algorithm() const noexcept;
    void Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm const& value) const noexcept;
    Windows::Storage::Streams::IBuffer SourceData() const noexcept;
    void SourceData(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    hstring CryptogramMaterialPackageName() const noexcept;
    void CryptogramMaterialPackageName(param::hstring const& value) const noexcept;
    hstring CryptogramMaterialName() const noexcept;
    void CryptogramMaterialName(param::hstring const& value) const noexcept;
    int32_t TemplateOffset() const noexcept;
    void TemplateOffset(int32_t value) const noexcept;
    int32_t CryptogramOffset() const noexcept;
    void CryptogramOffset(int32_t value) const noexcept;
    int32_t CryptogramLength() const noexcept;
    void CryptogramLength(int32_t value) const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions CryptogramPlacementOptions() const noexcept;
    void CryptogramPlacementOptions(Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions const& value) const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramPlacementStep ChainedOutputStep() const noexcept;
    void ChainedOutputStep(Windows::Devices::SmartCards::SmartCardCryptogramPlacementStep const& value) const noexcept;
};
...
struct consume_Windows_Devices_SmartCards_ISmartCardCryptogramStorageKeyCharacteristics
{
    ...
    Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm Algorithm() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities Capabilities() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const noexcept;
    Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType PublicKeyBlobType() const noexcept;
    Windows::Storage::Streams::IBuffer PublicKey() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptographicKeyAttestationStatus AttestationStatus() const noexcept;
    Windows::Storage::Streams::IBuffer Attestation() const noexcept;
    Windows::Storage::Streams::IBuffer AttestationCertificateChain() const noexcept;
    Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities Capabilities() const noexcept;
};
...
{
    hstring OperationalRequirements() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardEmulatorEnablementPolicy EnablementPolicy() const noexcept;
};
...
{
    Windows::Storage::Streams::IBuffer CommandApdu() const noexcept;
    Windows::Devices::SmartCards::SmartCardEmulatorConnectionProperties ConnectionProperties() const noexcept;
    Windows::Foundation::IAsyncOperation<bool> TryRespondAsync(Windows::Storage::Streams::IBuffer const& responseApdu) const;
    Windows::Devices::SmartCards::SmartCardAutomaticResponseStatus AutomaticResponseStatus() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardEmulatorConnectionProperties ConnectionProperties() const noexcept;
    Windows::Devices::SmartCards::SmartCardEmulatorConnectionDeactivatedReason Reason() const noexcept;
};
...
{
    GUID Id() const noexcept;
    Windows::Devices::SmartCards::SmartCardEmulatorConnectionSource Source() const noexcept;
};
...
struct consume_Windows_Devices_SmartCards_ISmartCardEmulatorStatics2
{
    ...
    uint16_t MaxAppletIdGroupRegistrations() const noexcept;
};
...
struct consume_Windows_Devices_SmartCards_ISmartCardPinPolicy
{
    ...
    void MinLength(uint32_t value) const noexcept;
    uint32_t MaxLength() const noexcept;
    void MaxLength(uint32_t value) const noexcept;
    Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption UppercaseLetters() const noexcept;
    void UppercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption const& value) const noexcept;
    Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption LowercaseLetters() const noexcept;
    void LowercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption const& value) const noexcept;
    Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption Digits() const noexcept;
    void Digits(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption const& value) const noexcept;
    Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption SpecialCharacters() const noexcept;
    void SpecialCharacters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption const& value) const noexcept;
};
...
struct consume_Windows_Devices_SmartCards_ISmartCardReader
{
    ...
    Windows::Devices::SmartCards::SmartCardReaderKind Kind() const noexcept;
...
{
    Windows::Devices::SmartCards::SmartCardTriggerType TriggerType() const noexcept;
    Windows::Storage::Streams::IBuffer SourceAppletId() const noexcept;
    Windows::Storage::Streams::IBuffer TriggerData() const noexcept;
};
...
{
    Windows::Devices::SmartCards::SmartCardEmulator Emulator() const noexcept;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroup>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SmartCardEmulationCategory(Windows::Devices::SmartCards::SmartCardEmulationCategory* value) = 0;
    virtual HRESULT __stdcall put_SmartCardEmulationCategory(Windows::Devices::SmartCards::SmartCardEmulationCategory value) = 0;
    virtual HRESULT __stdcall get_SmartCardEmulationType(Windows::Devices::SmartCards::SmartCardEmulationType* value) = 0;
    virtual HRESULT __stdcall put_SmartCardEmulationType(Windows::Devices::SmartCards::SmartCardEmulationType value) = 0;
...
{
    virtual HRESULT __stdcall Create(HSTRING displayName, ::IUnknown* appletIds, Windows::Devices::SmartCards::SmartCardEmulationCategory emulationCategory, Windows::Devices::SmartCards::SmartCardEmulationType emulationType, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardAppletIdGroupRegistration>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ActivationPolicy(Windows::Devices::SmartCards::SmartCardAppletIdGroupActivationPolicy* value) = 0;
    virtual HRESULT __stdcall get_AppletIdGroup(::IUnknown** value) = 0;
    virtual HRESULT __stdcall RequestActivationPolicyChangeAsync(Windows::Devices::SmartCards::SmartCardAppletIdGroupActivationPolicy policy, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardChallengeContext>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ProvisionAsyncWithNewCardId(::IUnknown* response, bool formatCard, GUID newCardId, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramGenerator>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateCryptogramMaterialStorageKeyAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING storageKeyName, Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm algorithm, Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities capabilities, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestCryptogramMaterialStorageKeyInfoAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING storageKeyName, Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType format, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ImportCryptogramMaterialPackageAsync(Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat format, HSTRING storageKeyName, HSTRING materialPackageName, ::IUnknown* cryptogramMaterialPackage, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall TryProvePossessionOfCryptogramMaterialPackageAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat responseFormat, HSTRING materialPackageName, HSTRING materialName, ::IUnknown* challenge, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestUnlockCryptogramMaterialForUseAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, ::IUnknown** result) = 0;
...
{
    virtual HRESULT __stdcall ValidateRequestApduAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, ::IUnknown* apduToValidate, ::IUnknown* cryptogramPlacementSteps, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall GetAllCryptogramMaterialCharacteristicsAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING materialPackageName, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_OperationStatus(Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus* value) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramMaterialCharacteristics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MaterialType(Windows::Devices::SmartCards::SmartCardCryptogramMaterialType* value) = 0;
    virtual HRESULT __stdcall get_ProtectionMethod(Windows::Devices::SmartCards::SmartCardCryptogramMaterialProtectionMethod* value) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramMaterialPackageCharacteristics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PackageFormat(Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm* value) = 0;
    virtual HRESULT __stdcall put_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm value) = 0;
    ...
    virtual HRESULT __stdcall get_CryptogramPlacementOptions(Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions* value) = 0;
    virtual HRESULT __stdcall put_CryptogramPlacementOptions(Windows::Devices::SmartCards::SmartCardCryptogramPlacementOptions value) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyCharacteristics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Algorithm(Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm* value) = 0;
    virtual HRESULT __stdcall get_Capabilities(Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCapabilities* value) = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyInfo>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_OperationStatus(Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus* value) = 0;
    virtual HRESULT __stdcall get_PublicKeyBlobType(Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType* value) = 0;
    virtual HRESULT __stdcall get_PublicKey(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_AttestationStatus(Windows::Devices::SmartCards::SmartCardCryptographicKeyAttestationStatus* value) = 0;
...
{
    virtual HRESULT __stdcall get_EnablementPolicy(Windows::Devices::SmartCards::SmartCardEmulatorEnablementPolicy* value) = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulator2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_ApduReceived(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ApduReceived(event_token value) = 0;
    virtual HRESULT __stdcall add_ConnectionDeactivated(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorApduReceivedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AutomaticResponseStatus(Windows::Devices::SmartCards::SmartCardAutomaticResponseStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ConnectionProperties(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Reason(Windows::Devices::SmartCards::SmartCardEmulatorConnectionDeactivatedReason* value) = 0;
};};

template <> struct abi<Windows::Devices::SmartCards::ISmartCardEmulatorConnectionProperties>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Id(GUID* value) = 0;
    virtual HRESULT __stdcall get_Source(Windows::Devices::SmartCards::SmartCardEmulatorConnectionSource* value) = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardPinPolicy>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_UppercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) = 0;
    virtual HRESULT __stdcall put_UppercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) = 0;
    virtual HRESULT __stdcall get_LowercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) = 0;
    virtual HRESULT __stdcall put_LowercaseLetters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) = 0;
    virtual HRESULT __stdcall get_Digits(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) = 0;
    virtual HRESULT __stdcall put_Digits(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) = 0;
    virtual HRESULT __stdcall get_SpecialCharacters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption* value) = 0;
    virtual HRESULT __stdcall put_SpecialCharacters(Windows::Devices::SmartCards::SmartCardPinCharacterPolicyOption value) = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioningStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestVirtualSmartCardCreationAsyncWithCardId(HSTRING friendlyName, ::IUnknown* administrativeKey, ::IUnknown* pinPolicy, GUID cardId, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardProvisioningStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestAttestedVirtualSmartCardCreationAsyncWithCardId(HSTRING friendlyName, ::IUnknown* administrativeKey, ::IUnknown* pinPolicy, GUID cardId, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardReader>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::Devices::SmartCards::SmartCardReaderKind* value) = 0;
    virtual HRESULT __stdcall GetStatusAsync(::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindAllCardsAsync(::IUnknown** result) = 0;
    virtual HRESULT __stdcall add_CardAdded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CardAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_CardRemoved(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardReaderStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDeviceSelectorWithKind(Windows::Devices::SmartCards::SmartCardReaderKind kind, HSTRING* selector) = 0;
...
{
    virtual HRESULT __stdcall get_TriggerType(Windows::Devices::SmartCards::SmartCardTriggerType* value) = 0;
...
template <> struct abi<Windows::Devices::SmartCards::ISmartCardTriggerDetails2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TryLaunchCurrentAppWithBehaviorAsync(HSTRING arguments, Windows::Devices::SmartCards::SmartCardLaunchBehavior behavior, ::IUnknown** result) = 0;
};};
