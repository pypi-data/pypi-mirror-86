...
struct consume_Windows_ApplicationModel_Calls_Provider_IPhoneCallOrigin
{
    ...
    void Category(param::hstring const& value) const noexcept;
    hstring CategoryDescription() const noexcept;
    void CategoryDescription(param::hstring const& value) const noexcept;
...
{
    Windows::Storage::StorageFile DisplayPicture() const noexcept;
    void DisplayPicture(Windows::Storage::StorageFile const& value) const noexcept;
};
...
{
    bool IsCurrentAppActiveCallOriginApp() const noexcept;
...
template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetCallOrigin(GUID requestId, ::IUnknown* callOrigin) = 0;
};};
