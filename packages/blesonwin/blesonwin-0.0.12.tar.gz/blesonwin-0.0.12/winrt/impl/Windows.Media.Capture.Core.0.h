...
{
    Windows::Media::Capture::CapturedFrame Frame() const noexcept;
    Windows::Foundation::TimeSpan CaptureTimeOffset() const noexcept;
    Windows::Foundation::IReference<uint32_t> UsedFrameControllerIndex() const noexcept;
    Windows::Media::Capture::CapturedFrameControlValues CapturedFrameControlValues() const noexcept;
};
