...
struct consume_Windows_Web_Http_Diagnostics_IHttpDiagnosticProviderRequestResponseCompletedEventArgs
{
    ...
    Windows::Web::Http::Diagnostics::HttpDiagnosticProviderRequestResponseTimestamps Timestamps() const noexcept;
    Windows::Foundation::Uri RequestedUri() const noexcept;
    uint32_t ProcessId() const noexcept;
    uint32_t ThreadId() const noexcept;
    Windows::Web::Http::Diagnostics::HttpDiagnosticRequestInitiator Initiator() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Web::Http::Diagnostics::HttpDiagnosticSourceLocation> SourceLocations() const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> CacheCheckedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ConnectionInitiatedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> NameResolvedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> SslNegotiatedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ConnectionCompletedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> RequestSentTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> RequestCompletedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ResponseReceivedTimestamp() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ResponseCompletedTimestamp() const noexcept;
};
...
struct consume_Windows_Web_Http_Diagnostics_IHttpDiagnosticProviderRequestSentEventArgs
{
    ...
    GUID ActivityId() const noexcept;
    Windows::Web::Http::HttpRequestMessage Message() const noexcept;
    uint32_t ProcessId() const noexcept;
    uint32_t ThreadId() const noexcept;
    Windows::Web::Http::Diagnostics::HttpDiagnosticRequestInitiator Initiator() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Web::Http::Diagnostics::HttpDiagnosticSourceLocation> SourceLocations() const noexcept;
...
struct consume_Windows_Web_Http_Diagnostics_IHttpDiagnosticProviderResponseReceivedEventArgs
{
    Windows::Foundation::DateTime Timestamp() const noexcept;
    GUID ActivityId() const noexcept;
    Windows::Web::Http::HttpResponseMessage Message() const noexcept;
};
...
struct consume_Windows_Web_Http_Diagnostics_IHttpDiagnosticSourceLocation
{
    ...
    uint64_t LineNumber() const noexcept;
    uint64_t ColumnNumber() const noexcept;
};
...
template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RequestSent(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RequestSent(event_token token) = 0;
    virtual HRESULT __stdcall add_ResponseReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ResponseReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_RequestResponseCompleted(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestResponseCompletedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Initiator(Windows::Web::Http::Diagnostics::HttpDiagnosticRequestInitiator* value) = 0;
