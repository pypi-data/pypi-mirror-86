...
{
    bool IsScreenLocked() const noexcept;
...
{
    bool ShowWithFocus() const noexcept;
    void ShowWithFocus(bool value) const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TrySetNoteSize(int32_t noteViewId, Windows::Foundation::Size size, bool* succeeded) = 0;
    ...
    virtual HRESULT __stdcall add_SystemLockStateChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SystemLockStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_NotePlacementChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_NotePlacementChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_NoteVisibilityChanged(::IUnknown* handler, event_token* token) = 0;
