...
struct WINRT_EBO IKeyboardAccelerator :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IKeyboardAcceleratorFactory :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IKeyboardAcceleratorInvokedEventArgs :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IKeyboardAcceleratorStatics :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IPointerRoutedEventArgs2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IProcessKeyboardAcceleratorEventArgs :
    Windows::Foundation::IInspectable,
