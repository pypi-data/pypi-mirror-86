...
{
    virtual HRESULT __stdcall add_BackPressed(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_CameraHalfPressed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CameraHalfPressed(event_token token) = 0;
    virtual HRESULT __stdcall add_CameraPressed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CameraPressed(event_token token) = 0;
    virtual HRESULT __stdcall add_CameraReleased(::IUnknown* handler, event_token* token) = 0;
