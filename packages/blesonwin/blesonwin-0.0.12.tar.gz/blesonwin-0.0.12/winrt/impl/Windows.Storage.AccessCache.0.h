...
{
    Windows::Storage::AccessCache::AccessListEntry RemovedEntry() const noexcept;
};
...
{
    Windows::Storage::AccessCache::StorageItemAccessList FutureAccessList() const noexcept;
    Windows::Storage::AccessCache::StorageItemMostRecentlyUsedList MostRecentlyUsedList() const noexcept;
};
...
struct consume_Windows_Storage_AccessCache_IStorageItemAccessList
{
    ...
    Windows::Storage::AccessCache::AccessListEntryView Entries() const noexcept;
    uint32_t MaximumItemsAllowed() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_RemovedEntry(struct_of<8,16>* value) = 0;
};};
...
template <> struct abi<Windows::Storage::AccessCache::IStorageItemAccessList>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetItemWithOptionsAsync(HSTRING token, Windows::Storage::AccessCache::AccessCacheOptions options, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetFileWithOptionsAsync(HSTRING token, Windows::Storage::AccessCache::AccessCacheOptions options, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetFolderWithOptionsAsync(HSTRING token, Windows::Storage::AccessCache::AccessCacheOptions options, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall add_ItemRemoved(::IUnknown* handler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall AddWithMetadataAndVisibility(::IUnknown* file, HSTRING metadata, Windows::Storage::AccessCache::RecentStorageItemVisibility visibility, HSTRING* token) = 0;
    virtual HRESULT __stdcall AddOrReplaceWithMetadataAndVisibility(HSTRING token, ::IUnknown* file, HSTRING metadata, Windows::Storage::AccessCache::RecentStorageItemVisibility visibility) = 0;
};};
