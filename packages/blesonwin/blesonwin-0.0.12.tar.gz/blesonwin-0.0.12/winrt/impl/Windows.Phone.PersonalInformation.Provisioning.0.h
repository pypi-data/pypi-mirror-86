...
{
    virtual HRESULT __stdcall ImportSmsToSystemAsync(bool incoming, bool read, HSTRING body, HSTRING sender, ::IUnknown* recipients, Windows::Foundation::DateTime deliveryTime, ::IUnknown** action) = 0;
    virtual HRESULT __stdcall ImportMmsToSystemAsync(bool incoming, bool read, HSTRING subject, HSTRING sender, ::IUnknown* recipients, Windows::Foundation::DateTime deliveryTime, ::IUnknown* attachments, ::IUnknown** action) = 0;
};};
