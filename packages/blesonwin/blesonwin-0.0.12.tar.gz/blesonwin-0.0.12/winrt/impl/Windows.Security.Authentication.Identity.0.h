...
{
    hstring TenantId() const noexcept;
    hstring TenantName() const noexcept;
    hstring Subject() const noexcept;
    hstring KeyId() const noexcept;
    hstring KeyName() const noexcept;
};
...
{
    Windows::Security::Authentication::Identity::EnterpriseKeyCredentialRegistrationManager Current() const noexcept;
};
