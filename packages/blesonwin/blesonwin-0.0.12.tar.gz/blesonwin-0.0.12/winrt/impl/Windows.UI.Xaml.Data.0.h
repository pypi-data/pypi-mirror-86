...
{
    Windows::UI::Xaml::PropertyPath Path() const noexcept;
    void Path(Windows::UI::Xaml::PropertyPath const& value) const noexcept;
    Windows::UI::Xaml::Data::BindingMode Mode() const noexcept;
    void Mode(Windows::UI::Xaml::Data::BindingMode const& value) const noexcept;
    Windows::Foundation::IInspectable Source() const noexcept;
    void Source(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::UI::Xaml::Data::RelativeSource RelativeSource() const noexcept;
    void RelativeSource(Windows::UI::Xaml::Data::RelativeSource const& value) const noexcept;
    hstring ElementName() const noexcept;
    void ElementName(param::hstring const& value) const noexcept;
    Windows::UI::Xaml::Data::IValueConverter Converter() const noexcept;
    void Converter(Windows::UI::Xaml::Data::IValueConverter const& value) const noexcept;
    Windows::Foundation::IInspectable ConverterParameter() const noexcept;
    void ConverterParameter(Windows::Foundation::IInspectable const& value) const noexcept;
    hstring ConverterLanguage() const noexcept;
    void ConverterLanguage(param::hstring const& value) const noexcept;
};
...
{
    Windows::Foundation::IInspectable FallbackValue() const noexcept;
    void FallbackValue(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::Foundation::IInspectable TargetNullValue() const noexcept;
    void TargetNullValue(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::UI::Xaml::Data::UpdateSourceTrigger UpdateSourceTrigger() const noexcept;
    void UpdateSourceTrigger(Windows::UI::Xaml::Data::UpdateSourceTrigger const& value) const noexcept;
};
...
{
    Windows::Foundation::IInspectable DataItem() const noexcept;
    Windows::UI::Xaml::Data::Binding ParentBinding() const noexcept;
...
{
    Windows::Foundation::IInspectable CurrentItem() const noexcept;
    int32_t CurrentPosition() const noexcept;
    bool IsCurrentAfterLast() const noexcept;
    bool IsCurrentBeforeFirst() const noexcept;
    Windows::Foundation::Collections::IObservableVector<Windows::Foundation::IInspectable> CollectionGroups() const noexcept;
    bool HasMoreItems() const noexcept;
...
{
    Windows::Foundation::IInspectable Group() const noexcept;
    Windows::Foundation::Collections::IObservableVector<Windows::Foundation::IInspectable> GroupItems() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Data_ICollectionViewSource
{
    Windows::Foundation::IInspectable Source() const noexcept;
    void Source(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::UI::Xaml::Data::ICollectionView View() const noexcept;
    bool IsSourceGrouped() const noexcept;
    void IsSourceGrouped(bool value) const noexcept;
    Windows::UI::Xaml::PropertyPath ItemsPath() const noexcept;
    void ItemsPath(Windows::UI::Xaml::PropertyPath const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty SourceProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ViewProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsSourceGroupedProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ItemsPathProperty() const noexcept;
};
...
{
    int32_t FirstIndex() const noexcept;
    uint32_t Length() const noexcept;
    int32_t LastIndex() const noexcept;
};
...
{
    Windows::UI::Xaml::Data::RelativeSourceMode Mode() const noexcept;
    void Mode(Windows::UI::Xaml::Data::RelativeSourceMode const& value) const noexcept;
};
...
template <> struct abi<Windows::UI::Xaml::Data::IBinding>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Mode(Windows::UI::Xaml::Data::BindingMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::UI::Xaml::Data::BindingMode value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Data::IBinding2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_UpdateSourceTrigger(Windows::UI::Xaml::Data::UpdateSourceTrigger* value) = 0;
    virtual HRESULT __stdcall put_UpdateSourceTrigger(Windows::UI::Xaml::Data::UpdateSourceTrigger value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Data::ICollectionView>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_CurrentChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CurrentChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_CurrentChanging(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Type(struct_of<8,16>* value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Data::ICustomPropertyProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetIndexedProperty(HSTRING name, struct_of<8,16> type, ::IUnknown** returnValue) = 0;
...
{
    virtual HRESULT __stdcall add_PropertyChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Mode(Windows::UI::Xaml::Data::RelativeSourceMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::UI::Xaml::Data::RelativeSourceMode value) = 0;
};};
...
{
    virtual HRESULT __stdcall Convert(::IUnknown* value, struct_of<8,16> targetType, ::IUnknown* parameter, HSTRING language, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall ConvertBack(::IUnknown* value, struct_of<8,16> targetType, ::IUnknown* parameter, HSTRING language, ::IUnknown** returnValue) = 0;
};};
