...
struct consume_Windows_Networking_IEndpointPair
{
    ...
    void LocalHostName(Windows::Networking::HostName const& value) const noexcept;
    hstring LocalServiceName() const noexcept;
    void LocalServiceName(param::hstring const& value) const noexcept;
    ...
    void RemoteServiceName(param::hstring const& value) const noexcept;
};
...
{
    Windows::Networking::Connectivity::IPInformation IPInformation() const noexcept;
    hstring RawName() const noexcept;
    hstring DisplayName() const noexcept;
    hstring CanonicalName() const noexcept;
    Windows::Networking::HostNameType Type() const noexcept;
...
template <> struct abi<Windows::Networking::IHostName>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Type(Windows::Networking::HostNameType* value) = 0;
