...
{
    Windows::Foundation::Collections::IVector<Windows::Storage::StorageFile> Files() const noexcept;
...
template <> struct abi<Windows::Media::Playlists::IPlaylist>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SaveAsAsync(::IUnknown* saveLocation, HSTRING desiredName, Windows::Storage::NameCollisionOption option, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall SaveAsWithFormatAsync(::IUnknown* saveLocation, HSTRING desiredName, Windows::Storage::NameCollisionOption option, Windows::Media::Playlists::PlaylistFormat playlistFormat, ::IUnknown** operation) = 0;
};};
