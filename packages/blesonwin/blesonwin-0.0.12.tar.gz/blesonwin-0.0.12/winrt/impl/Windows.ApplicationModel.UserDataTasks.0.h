...
struct consume_Windows_ApplicationModel_UserDataTasks_IUserDataTask
{
    ...
    hstring ListId() const noexcept;
    hstring RemoteId() const noexcept;
    void RemoteId(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> CompletedDate() const noexcept;
    void CompletedDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    hstring Details() const noexcept;
    void Details(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskDetailsKind DetailsKind() const noexcept;
    void DetailsKind(Windows::ApplicationModel::UserDataTasks::UserDataTaskDetailsKind const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> DueDate() const noexcept;
    void DueDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskKind Kind() const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskPriority Priority() const noexcept;
    void Priority(Windows::ApplicationModel::UserDataTasks::UserDataTaskPriority const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceProperties RecurrenceProperties() const noexcept;
    void RecurrenceProperties(Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceProperties const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationProperties RegenerationProperties() const noexcept;
    void RegenerationProperties(Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationProperties const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> Reminder() const noexcept;
    void Reminder(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskSensitivity Sensitivity() const noexcept;
    void Sensitivity(Windows::ApplicationModel::UserDataTasks::UserDataTaskSensitivity const& value) const noexcept;
    hstring Subject() const noexcept;
    void Subject(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> StartDate() const noexcept;
    void StartDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::UserDataTasks::UserDataTask> Tasks() const noexcept;
};
...
struct consume_Windows_ApplicationModel_UserDataTasks_IUserDataTaskList
{
    ...
    Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppReadAccess OtherAppReadAccess() const noexcept;
    void OtherAppReadAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppReadAccess const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppWriteAccess OtherAppWriteAccess() const noexcept;
    void OtherAppWriteAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppWriteAccess const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskListLimitedWriteOperations LimitedWriteOperations() const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskListSyncManager SyncManager() const noexcept;
...
struct consume_Windows_ApplicationModel_UserDataTasks_IUserDataTaskListSyncManager
{
    ...
    Windows::ApplicationModel::UserDataTasks::UserDataTaskListSyncStatus Status() const noexcept;
    void Status(Windows::ApplicationModel::UserDataTasks::UserDataTaskListSyncStatus const& value) const noexcept;
...
{
    Windows::ApplicationModel::UserDataTasks::UserDataTaskQuerySortProperty SortProperty() const noexcept;
    void SortProperty(Windows::ApplicationModel::UserDataTasks::UserDataTaskQuerySortProperty const& value) const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTaskQueryKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::UserDataTasks::UserDataTaskQueryKind const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceUnit Unit() const noexcept;
    void Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceUnit const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> Occurrences() const noexcept;
    void Occurrences(optional<int32_t> const& value) const noexcept;
    ...
    int32_t Interval() const noexcept;
    void Interval(int32_t value) const noexcept;
    Windows::Foundation::IReference<Windows::ApplicationModel::UserDataTasks::UserDataTaskDaysOfWeek> DaysOfWeek() const noexcept;
    void DaysOfWeek(optional<Windows::ApplicationModel::UserDataTasks::UserDataTaskDaysOfWeek> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::ApplicationModel::UserDataTasks::UserDataTaskWeekOfMonth> WeekOfMonth() const noexcept;
    void WeekOfMonth(optional<Windows::ApplicationModel::UserDataTasks::UserDataTaskWeekOfMonth> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> Month() const noexcept;
    void Month(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> Day() const noexcept;
    void Day(optional<int32_t> const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationUnit Unit() const noexcept;
    void Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationUnit const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> Occurrences() const noexcept;
    void Occurrences(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> Until() const noexcept;
    void Until(optional<Windows::Foundation::DateTime> const& value) const noexcept;
...
template <> struct abi<Windows::ApplicationModel::UserDataTasks::IUserDataTask>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DetailsKind(Windows::ApplicationModel::UserDataTasks::UserDataTaskDetailsKind* value) = 0;
    virtual HRESULT __stdcall put_DetailsKind(Windows::ApplicationModel::UserDataTasks::UserDataTaskDetailsKind value) = 0;
    virtual HRESULT __stdcall get_DueDate(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_DueDate(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::UserDataTasks::UserDataTaskKind* value) = 0;
    virtual HRESULT __stdcall get_Priority(Windows::ApplicationModel::UserDataTasks::UserDataTaskPriority* value) = 0;
    virtual HRESULT __stdcall put_Priority(Windows::ApplicationModel::UserDataTasks::UserDataTaskPriority value) = 0;
    ...
    virtual HRESULT __stdcall get_Sensitivity(Windows::ApplicationModel::UserDataTasks::UserDataTaskSensitivity* value) = 0;
    virtual HRESULT __stdcall put_Sensitivity(Windows::ApplicationModel::UserDataTasks::UserDataTaskSensitivity value) = 0;
...
template <> struct abi<Windows::ApplicationModel::UserDataTasks::IUserDataTaskList>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OtherAppReadAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppReadAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppReadAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppReadAccess value) = 0;
    virtual HRESULT __stdcall get_OtherAppWriteAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppWriteAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppWriteAccess(Windows::ApplicationModel::UserDataTasks::UserDataTaskListOtherAppWriteAccess value) = 0;
...
template <> struct abi<Windows::ApplicationModel::UserDataTasks::IUserDataTaskListSyncManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::UserDataTasks::UserDataTaskListSyncStatus* value) = 0;
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::UserDataTasks::UserDataTaskListSyncStatus value) = 0;
...
{
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::UserDataTasks::UserDataTaskStoreAccessType accessType, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall get_SortProperty(Windows::ApplicationModel::UserDataTasks::UserDataTaskQuerySortProperty* value) = 0;
    virtual HRESULT __stdcall put_SortProperty(Windows::ApplicationModel::UserDataTasks::UserDataTaskQuerySortProperty value) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::UserDataTasks::UserDataTaskQueryKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::UserDataTasks::UserDataTaskQueryKind value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceUnit* value) = 0;
    virtual HRESULT __stdcall put_Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRecurrenceUnit value) = 0;
...
{
    virtual HRESULT __stdcall get_Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationUnit* value) = 0;
    virtual HRESULT __stdcall put_Unit(Windows::ApplicationModel::UserDataTasks::UserDataTaskRegenerationUnit value) = 0;
    virtual HRESULT __stdcall get_Occurrences(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_Occurrences(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_Until(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_Until(::IUnknown* value) = 0;
