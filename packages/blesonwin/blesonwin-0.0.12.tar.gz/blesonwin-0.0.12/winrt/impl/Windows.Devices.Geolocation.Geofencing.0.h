...
struct consume_Windows_Devices_Geolocation_Geofencing_IGeofence
{
    ...
    Windows::Foundation::TimeSpan DwellTime() const noexcept;
    hstring Id() const noexcept;
    Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates MonitoredStates() const noexcept;
    Windows::Devices::Geolocation::IGeoshape Geoshape() const noexcept;
    bool SingleUse() const noexcept;
};
...
{
    Windows::Devices::Geolocation::Geofencing::GeofenceMonitorStatus Status() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Devices::Geolocation::Geofencing::Geofence> Geofences() const noexcept;
    Windows::Devices::Geolocation::Geoposition LastKnownGeoposition() const noexcept;
...
{
    Windows::Devices::Geolocation::Geofencing::GeofenceMonitor Current() const noexcept;
};
...
{
    Windows::Devices::Geolocation::Geofencing::GeofenceState NewState() const noexcept;
    Windows::Devices::Geolocation::Geofencing::Geofence Geofence() const noexcept;
    Windows::Devices::Geolocation::Geoposition Geoposition() const noexcept;
    Windows::Devices::Geolocation::Geofencing::GeofenceRemovalReason RemovalReason() const noexcept;
};
...
template <> struct abi<Windows::Devices::Geolocation::Geofencing::IGeofence>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MonitoredStates(Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates* value) = 0;
...
template <> struct abi<Windows::Devices::Geolocation::Geofencing::IGeofenceFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithMonitorStates(HSTRING id, ::IUnknown* geoshape, Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates monitoredStates, bool singleUse, ::IUnknown** geofence) = 0;
    virtual HRESULT __stdcall CreateWithMonitorStatesAndDwellTime(HSTRING id, ::IUnknown* geoshape, Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates monitoredStates, bool singleUse, Windows::Foundation::TimeSpan dwellTime, ::IUnknown** geofence) = 0;
    virtual HRESULT __stdcall CreateWithMonitorStatesDwellTimeStartTimeAndDuration(HSTRING id, ::IUnknown* geoshape, Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates monitoredStates, bool singleUse, Windows::Foundation::TimeSpan dwellTime, Windows::Foundation::DateTime startTime, Windows::Foundation::TimeSpan duration, ::IUnknown** geofence) = 0;
};};

template <> struct abi<Windows::Devices::Geolocation::Geofencing::IGeofenceMonitor>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Devices::Geolocation::Geofencing::GeofenceMonitorStatus* value) = 0;
    ...
    virtual HRESULT __stdcall add_GeofenceStateChanged(::IUnknown* eventHandler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_StatusChanged(::IUnknown* eventHandler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_NewState(Windows::Devices::Geolocation::Geofencing::GeofenceState* value) = 0;
    virtual HRESULT __stdcall get_Geofence(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Geoposition(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_RemovalReason(Windows::Devices::Geolocation::Geofencing::GeofenceRemovalReason* value) = 0;
};};
