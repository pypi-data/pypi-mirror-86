...
{
    uint32_t ResolutionWidthInRawPixels() const noexcept;
    uint32_t ResolutionHeightInRawPixels() const noexcept;
    ...
    Windows::Graphics::Display::Core::HdmiDisplayColorSpace ColorSpace() const noexcept;
    Windows::Graphics::Display::Core::HdmiDisplayPixelEncoding PixelEncoding() const noexcept;
    bool IsSdrLuminanceSupported() const noexcept;
    bool IsSmpte2084Supported() const noexcept;
    bool Is2086MetadataSupported() const noexcept;
};
...
template <> struct abi<Windows::Graphics::Display::Core::IHdmiDisplayInformation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestSetCurrentDisplayModeWithHdrAsync(::IUnknown* mode, Windows::Graphics::Display::Core::HdmiDisplayHdrOption hdrOption, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestSetCurrentDisplayModeWithHdrAndMetadataAsync(::IUnknown* mode, Windows::Graphics::Display::Core::HdmiDisplayHdrOption hdrOption, struct_of<24> hdrMetadata, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall add_DisplayModesChanged(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Graphics::Display::Core::IHdmiDisplayMode>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ColorSpace(Windows::Graphics::Display::Core::HdmiDisplayColorSpace* value) = 0;
    virtual HRESULT __stdcall get_PixelEncoding(Windows::Graphics::Display::Core::HdmiDisplayPixelEncoding* value) = 0;
