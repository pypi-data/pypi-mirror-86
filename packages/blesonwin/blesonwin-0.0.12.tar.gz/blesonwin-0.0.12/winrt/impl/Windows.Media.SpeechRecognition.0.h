...
template <> struct name<Windows::Media::SpeechRecognition::ISpeechRecognizerStatics2>{ static constexpr auto & value{ L"Windows.Media.SpeechRecognition.ISpeechRecognizerStatics2" }; };
...
template <> struct guid<Windows::Media::SpeechRecognition::ISpeechRecognizerStatics2>{ static constexpr GUID value{ 0x1D1B0D95,0x7565,0x4EF9,{ 0xA2,0xF3,0xBA,0x15,0x16,0x2A,0x96,0xCF } }; };
...
{
    Windows::Media::SpeechRecognition::SpeechRecognitionResultStatus Status() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan AutoStopSilenceTimeout() const noexcept;
    void AutoStopSilenceTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
...
struct consume_Windows_Media_SpeechRecognition_ISpeechRecognitionConstraint
{
    ...
    Windows::Media::SpeechRecognition::SpeechRecognitionConstraintType Type() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognitionConstraintProbability Probability() const noexcept;
    void Probability(Windows::Media::SpeechRecognition::SpeechRecognitionConstraintProbability const& value) const noexcept;
};
...
{
    Windows::Storage::StorageFile GrammarFile() const noexcept;
};
...
{
    Windows::Media::SpeechRecognition::SpeechRecognitionHypothesis Hypothesis() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> Commands() const noexcept;
};
...
{
    Windows::Media::SpeechRecognition::SpeechRecognitionAudioProblem Problem() const noexcept;
};
...
struct consume_Windows_Media_SpeechRecognition_ISpeechRecognitionResult
{
    Windows::Media::SpeechRecognition::SpeechRecognitionResultStatus Status() const noexcept;
    hstring Text() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognitionConfidence Confidence() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognitionSemanticInterpretation SemanticInterpretation() const noexcept;
    ...
    Windows::Media::SpeechRecognition::ISpeechRecognitionConstraint Constraint() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> RulePath() const noexcept;
    double RawConfidence() const noexcept;
};
...
{
    Windows::Foundation::DateTime PhraseStartTime() const noexcept;
    Windows::Foundation::TimeSpan PhraseDuration() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::Foundation::Collections::IVectorView<hstring>> Properties() const noexcept;
};
...
{
    Windows::Media::SpeechRecognition::SpeechRecognitionScenario Scenario() const noexcept;
    hstring TopicHint() const noexcept;
};
...
{
    Windows::Globalization::Language CurrentLanguage() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::SpeechRecognition::ISpeechRecognitionConstraint> Constraints() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognizerTimeouts Timeouts() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognizerUIOptions UIOptions() const noexcept;
...
{
    Windows::Media::SpeechRecognition::SpeechContinuousRecognitionSession ContinuousRecognitionSession() const noexcept;
    Windows::Media::SpeechRecognition::SpeechRecognizerState State() const noexcept;
...
{
    Windows::Globalization::Language SystemSpeechLanguage() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Globalization::Language> SupportedTopicLanguages() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Globalization::Language> SupportedGrammarLanguages() const noexcept;
};
...
{
    Windows::Foundation::IAsyncOperation<bool> TrySetSystemSpeechLanguageAsync(Windows::Globalization::Language const& speechLanguage) const;
};
template <> struct consume<Windows::Media::SpeechRecognition::ISpeechRecognizerStatics2> { template <typename D> using type = consume_Windows_Media_SpeechRecognition_ISpeechRecognizerStatics2<D>; };

template <typename D>
struct consume_Windows_Media_SpeechRecognition_ISpeechRecognizerTimeouts
{
    Windows::Foundation::TimeSpan InitialSilenceTimeout() const noexcept;
    void InitialSilenceTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan EndSilenceTimeout() const noexcept;
    void EndSilenceTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan BabbleTimeout() const noexcept;
    void BabbleTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
};
...
{
    hstring ExampleText() const noexcept;
    void ExampleText(param::hstring const& value) const noexcept;
    hstring AudiblePrompt() const noexcept;
    void AudiblePrompt(param::hstring const& value) const noexcept;
    bool IsReadBackEnabled() const noexcept;
    void IsReadBackEnabled(bool value) const noexcept;
    bool ShowConfirmation() const noexcept;
    void ShowConfirmation(bool value) const noexcept;
};
...
struct consume_Windows_Media_SpeechRecognition_IVoiceCommandManager
{
    ...
    Windows::Foundation::Collections::IMapView<hstring, Windows::Media::SpeechRecognition::VoiceCommandSet> InstalledCommandSets() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Media::SpeechRecognition::SpeechRecognitionResultStatus* value) = 0;
};};
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechContinuousRecognitionSession>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall StartWithModeAsync(Windows::Media::SpeechRecognition::SpeechContinuousRecognitionMode mode, ::IUnknown** value) = 0;
    ...
    virtual HRESULT __stdcall add_Completed(::IUnknown* value, event_token* returnValue) = 0;
    virtual HRESULT __stdcall remove_Completed(event_token value) = 0;
    virtual HRESULT __stdcall add_ResultGenerated(::IUnknown* value, event_token* returnValue) = 0;
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechRecognitionConstraint>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Type(Windows::Media::SpeechRecognition::SpeechRecognitionConstraintType* value) = 0;
    virtual HRESULT __stdcall get_Probability(Windows::Media::SpeechRecognition::SpeechRecognitionConstraintProbability* value) = 0;
    virtual HRESULT __stdcall put_Probability(Windows::Media::SpeechRecognition::SpeechRecognitionConstraintProbability value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Problem(Windows::Media::SpeechRecognition::SpeechRecognitionAudioProblem* value) = 0;
};};
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechRecognitionResult>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::Media::SpeechRecognition::SpeechRecognitionResultStatus* value) = 0;
    virtual HRESULT __stdcall get_Text(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Confidence(Windows::Media::SpeechRecognition::SpeechRecognitionConfidence* value) = 0;
...
{
    virtual HRESULT __stdcall get_Scenario(Windows::Media::SpeechRecognition::SpeechRecognitionScenario* value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Media::SpeechRecognition::SpeechRecognitionScenario scenario, HSTRING topicHint, ::IUnknown** constraint) = 0;
    virtual HRESULT __stdcall CreateWithTag(Windows::Media::SpeechRecognition::SpeechRecognitionScenario scenario, HSTRING topicHint, HSTRING tag, ::IUnknown** constraint) = 0;
};};
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechRecognizer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RecognitionQualityDegrading(::IUnknown* speechRecognitionQualityDegradingHandler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_RecognitionQualityDegrading(event_token cookie) = 0;
    virtual HRESULT __stdcall add_StateChanged(::IUnknown* stateChangedHandler, event_token* cookie) = 0;
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechRecognizer2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Media::SpeechRecognition::SpeechRecognizerState* value) = 0;
    virtual HRESULT __stdcall StopRecognitionAsync(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_HypothesisGenerated(::IUnknown* value, event_token* returnValue) = 0;
...
template <> struct abi<Windows::Media::SpeechRecognition::ISpeechRecognizerStatics2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall TrySetSystemSpeechLanguageAsync(::IUnknown* speechLanguage, ::IUnknown** result) = 0;
};};
