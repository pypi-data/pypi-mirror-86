...
{
    Windows::ApplicationModel::Search::Core::SearchSuggestionKind Kind() const noexcept;
    hstring Text() const noexcept;
    hstring Tag() const noexcept;
    hstring DetailText() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Image() const noexcept;
    hstring ImageAlternateText() const noexcept;
};
...
{
    bool SearchHistoryEnabled() const noexcept;
    void SearchHistoryEnabled(bool value) const noexcept;
    hstring SearchHistoryContext() const noexcept;
    void SearchHistoryContext(param::hstring const& value) const noexcept;
    ...
    Windows::Foundation::Collections::IObservableVector<Windows::ApplicationModel::Search::Core::SearchSuggestion> Suggestions() const noexcept;
...
struct consume_Windows_ApplicationModel_Search_Core_ISearchSuggestionsRequestedEventArgs
{
    ...
    Windows::ApplicationModel::Search::SearchQueryLinguisticDetails LinguisticDetails() const noexcept;
    Windows::ApplicationModel::Search::SearchSuggestionsRequest Request() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Search::Core::SearchSuggestionKind* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Search::Core::ISearchSuggestionManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RequestingFocusOnKeyboardInput(::IUnknown* handler, event_token* token) = 0;
