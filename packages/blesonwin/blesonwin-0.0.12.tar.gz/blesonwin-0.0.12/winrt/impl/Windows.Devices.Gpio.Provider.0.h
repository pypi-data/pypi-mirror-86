...
struct consume_Windows_Devices_Gpio_Provider_IGpioPinProvider
{
    ...
    Windows::Devices::Gpio::Provider::ProviderGpioSharingMode SharingMode() const noexcept;
...
{
    Windows::Devices::Gpio::Provider::ProviderGpioPinEdge Edge() const noexcept;
};
...
template <> struct abi<Windows::Devices::Gpio::Provider::IGpioControllerProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall OpenPinProvider(int32_t pin, Windows::Devices::Gpio::Provider::ProviderGpioSharingMode sharingMode, ::IUnknown** gpioPinProvider) = 0;
};};
...
template <> struct abi<Windows::Devices::Gpio::Provider::IGpioPinProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SharingMode(Windows::Devices::Gpio::Provider::ProviderGpioSharingMode* value) = 0;
    virtual HRESULT __stdcall IsDriveModeSupported(Windows::Devices::Gpio::Provider::ProviderGpioPinDriveMode driveMode, bool* supported) = 0;
    virtual HRESULT __stdcall GetDriveMode(Windows::Devices::Gpio::Provider::ProviderGpioPinDriveMode* value) = 0;
    virtual HRESULT __stdcall SetDriveMode(Windows::Devices::Gpio::Provider::ProviderGpioPinDriveMode value) = 0;
    virtual HRESULT __stdcall Write(Windows::Devices::Gpio::Provider::ProviderGpioPinValue value) = 0;
    virtual HRESULT __stdcall Read(Windows::Devices::Gpio::Provider::ProviderGpioPinValue* value) = 0;
};};

template <> struct abi<Windows::Devices::Gpio::Provider::IGpioPinProviderValueChangedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Edge(Windows::Devices::Gpio::Provider::ProviderGpioPinEdge* value) = 0;
};};

template <> struct abi<Windows::Devices::Gpio::Provider::IGpioPinProviderValueChangedEventArgsFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::Devices::Gpio::Provider::ProviderGpioPinEdge edge, ::IUnknown** value) = 0;
};};
