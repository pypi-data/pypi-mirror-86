...
{
    void TrimStartTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan TrimStartTime() const noexcept;
    void TrimStopTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan TrimStopTime() const noexcept;
    void AlwaysReencode(bool value) const noexcept;
    bool AlwaysReencode() const noexcept;
    void HardwareAccelerationEnabled(bool value) const noexcept;
    bool HardwareAccelerationEnabled() const noexcept;
...
struct consume_Windows_Media_Transcoding_IMediaTranscoder2
{
    ...
    void VideoProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm const& value) const noexcept;
    Windows::Media::Transcoding::MediaVideoProcessingAlgorithm VideoProcessingAlgorithm() const noexcept;
};
...
{
    bool CanTranscode() const noexcept;
    Windows::Media::Transcoding::TranscodeFailureReason FailureReason() const noexcept;
...
template <> struct abi<Windows::Media::Transcoding::IMediaTranscoder2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_VideoProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm value) = 0;
    virtual HRESULT __stdcall get_VideoProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm* value) = 0;
};};
...
template <> struct abi<Windows::Media::Transcoding::IPrepareTranscodeResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_FailureReason(Windows::Media::Transcoding::TranscodeFailureReason* value) = 0;
