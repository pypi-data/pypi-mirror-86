...
{
    Windows::UI::Xaml::Resources::CustomXamlResourceLoader Current() const noexcept;
    void Current(Windows::UI::Xaml::Resources::CustomXamlResourceLoader const& value) const noexcept;
};
