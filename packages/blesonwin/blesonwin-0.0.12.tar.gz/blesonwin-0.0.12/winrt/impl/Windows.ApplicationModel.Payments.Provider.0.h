...
template <> struct name<Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails>{ static constexpr auto & value{ L"Windows.ApplicationModel.Payments.Provider.IPaymentAppCanMakePaymentTriggerDetails" }; };
...
template <> struct name<Windows::ApplicationModel::Payments::Provider::PaymentAppCanMakePaymentTriggerDetails>{ static constexpr auto & value{ L"Windows.ApplicationModel.Payments.Provider.PaymentAppCanMakePaymentTriggerDetails" }; };
...
template <> struct guid<Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails>{ static constexpr GUID value{ 0x0CE201F0,0x8B93,0x4EB6,{ 0x8C,0x46,0x2E,0x4A,0x6C,0x6A,0x26,0xF6 } }; };
...
{
    Windows::ApplicationModel::Payments::PaymentRequest Request() const noexcept;
    void ReportCanMakePaymentResult(Windows::ApplicationModel::Payments::PaymentCanMakePaymentResult const& value) const;
};
template <> struct consume<Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails> { template <typename D> using type = consume_Windows_ApplicationModel_Payments_Provider_IPaymentAppCanMakePaymentTriggerDetails<D>; };
...
{
    Windows::ApplicationModel::Payments::Provider::PaymentAppManager Current() const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentRequest PaymentRequest() const noexcept;
    hstring PayerEmail() const noexcept;
    void PayerEmail(param::hstring const& value) const noexcept;
    hstring PayerName() const noexcept;
    void PayerName(param::hstring const& value) const noexcept;
    hstring PayerPhoneNumber() const noexcept;
    void PayerPhoneNumber(param::hstring const& value) const noexcept;
...
{
    Windows::ApplicationModel::Payments::PaymentRequestCompletionStatus Status() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Request(::IUnknown** result) = 0;
    virtual HRESULT __stdcall ReportCanMakePaymentResult(::IUnknown* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Payments::PaymentRequestCompletionStatus* value) = 0;
};};
