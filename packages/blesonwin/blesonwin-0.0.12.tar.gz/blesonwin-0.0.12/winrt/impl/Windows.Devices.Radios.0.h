...
struct consume_Windows_Devices_Radios_IRadio
{
    ...
    Windows::Devices::Radios::RadioState State() const noexcept;
    hstring Name() const noexcept;
    Windows::Devices::Radios::RadioKind Kind() const noexcept;
};
...
{
    virtual HRESULT __stdcall SetStateAsync(Windows::Devices::Radios::RadioState value, ::IUnknown** retval) = 0;
    virtual HRESULT __stdcall add_StateChanged(::IUnknown* handler, event_token* eventCookie) = 0;
    virtual HRESULT __stdcall remove_StateChanged(event_token eventCookie) = 0;
    virtual HRESULT __stdcall get_State(Windows::Devices::Radios::RadioState* value) = 0;
    virtual HRESULT __stdcall get_Name(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::Devices::Radios::RadioKind* value) = 0;
};};
