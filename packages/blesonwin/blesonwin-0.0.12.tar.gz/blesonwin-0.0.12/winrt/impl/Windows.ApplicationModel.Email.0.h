...
struct consume_Windows_ApplicationModel_Email_IEmailAttachment
{
    ...
    void FileName(param::hstring const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Data() const noexcept;
    void Data(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Email_IEmailAttachment2
{
    ...
    void ContentId(param::hstring const& value) const noexcept;
    hstring ContentLocation() const noexcept;
    void ContentLocation(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailAttachmentDownloadState DownloadState() const noexcept;
    void DownloadState(Windows::ApplicationModel::Email::EmailAttachmentDownloadState const& value) const noexcept;
    uint64_t EstimatedDownloadSizeInBytes() const noexcept;
    void EstimatedDownloadSizeInBytes(uint64_t value) const noexcept;
    bool IsFromBaseMessage() const noexcept;
    bool IsInline() const noexcept;
    void IsInline(bool value) const noexcept;
    hstring MimeType() const noexcept;
    void MimeType(param::hstring const& value) const noexcept;
};
...
{
    hstring Id() const noexcept;
    hstring MailboxId() const noexcept;
    Windows::ApplicationModel::Email::EmailFlagState FlagState() const noexcept;
    bool HasAttachment() const noexcept;
    Windows::ApplicationModel::Email::EmailImportance Importance() const noexcept;
    Windows::ApplicationModel::Email::EmailMessageResponseKind LastEmailResponseKind() const noexcept;
    uint32_t MessageCount() const noexcept;
    hstring MostRecentMessageId() const noexcept;
    Windows::Foundation::DateTime MostRecentMessageTime() const noexcept;
    hstring Preview() const noexcept;
    Windows::ApplicationModel::Email::EmailRecipient LatestSender() const noexcept;
    hstring Subject() const noexcept;
    uint32_t UnreadMessageCount() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Email::EmailConversation> Conversations() const noexcept;
    Windows::ApplicationModel::Email::EmailBatchStatus Status() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Email_IEmailFolder
{
    ...
    hstring MailboxId() const noexcept;
    hstring ParentFolderId() const noexcept;
    ...
    void IsSyncEnabled(bool value) const noexcept;
    ...
    Windows::ApplicationModel::Email::EmailSpecialFolderKind Kind() const noexcept;
...
struct consume_Windows_ApplicationModel_Email_IEmailIrmInfo
{
    ...
    void CanEdit(bool value) const noexcept;
    bool CanExtractData() const noexcept;
    void CanExtractData(bool value) const noexcept;
    bool CanForward() const noexcept;
    void CanForward(bool value) const noexcept;
    bool CanModifyRecipientsOnResponse() const noexcept;
    void CanModifyRecipientsOnResponse(bool value) const noexcept;
    bool CanPrintData() const noexcept;
    void CanPrintData(bool value) const noexcept;
    bool CanRemoveIrmOnResponse() const noexcept;
    void CanRemoveIrmOnResponse(bool value) const noexcept;
    bool CanReply() const noexcept;
    void CanReply(bool value) const noexcept;
    bool CanReplyAll() const noexcept;
    void CanReplyAll(bool value) const noexcept;
    Windows::Foundation::DateTime ExpirationDate() const noexcept;
    void ExpirationDate(Windows::Foundation::DateTime const& value) const noexcept;
    bool IsIrmOriginator() const noexcept;
    void IsIrmOriginator(bool value) const noexcept;
    bool IsProgramaticAccessAllowed() const noexcept;
    void IsProgramaticAccessAllowed(bool value) const noexcept;
    Windows::ApplicationModel::Email::EmailIrmTemplate Template() const noexcept;
    void Template(Windows::ApplicationModel::Email::EmailIrmTemplate const& value) const noexcept;
};
...
{
    uint32_t Flagged() const noexcept;
    uint32_t Important() const noexcept;
    uint32_t Total() const noexcept;
    uint32_t Unread() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxCapabilities Capabilities() const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxChangeTracker ChangeTracker() const noexcept;
    hstring DisplayName() const noexcept;
    void DisplayName(param::hstring const& value) const noexcept;
    hstring Id() const noexcept;
    bool IsOwnedByCurrentApp() const noexcept;
    bool IsDataEncryptedUnderLock() const noexcept;
    hstring MailAddress() const noexcept;
    void MailAddress(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> MailAddressAliases() const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess OtherAppReadAccess() const noexcept;
    void OtherAppReadAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess OtherAppWriteAccess() const noexcept;
    void OtherAppWriteAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxPolicies Policies() const noexcept;
    hstring SourceDisplayName() const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxSyncManager SyncManager() const noexcept;
...
{
    hstring LinkedMailboxId() const noexcept;
    hstring NetworkAccountId() const noexcept;
    hstring NetworkId() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxActionKind Kind() const noexcept;
    uint64_t ChangeNumber() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Email_IEmailMailboxAutoReply
{
    ...
    hstring Response() const noexcept;
    void Response(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Email_IEmailMailboxAutoReplySettings
{
    bool IsEnabled() const noexcept;
    void IsEnabled(bool value) const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind ResponseKind() const noexcept;
    void ResponseKind(Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> StartTime() const noexcept;
    void StartTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> EndTime() const noexcept;
    void EndTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxAutoReply InternalReply() const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxAutoReply KnownExternalReply() const noexcept;
    Windows::ApplicationModel::Email::EmailMailboxAutoReply UnknownExternalReply() const noexcept;
};
...
{
    bool CanForwardMeetings() const noexcept;
    bool CanGetAndSetExternalAutoReplies() const noexcept;
    bool CanGetAndSetInternalAutoReplies() const noexcept;
    bool CanUpdateMeetingResponses() const noexcept;
    bool CanServerSearchFolders() const noexcept;
    bool CanServerSearchMailbox() const noexcept;
    bool CanProposeNewTimeForMeetings() const noexcept;
    bool CanSmartSend() const noexcept;
};
...
{
    bool CanResolveRecipients() const noexcept;
    bool CanValidateCertificates() const noexcept;
    bool CanEmptyFolder() const noexcept;
    bool CanCreateFolder() const noexcept;
    bool CanDeleteFolder() const noexcept;
    bool CanMoveFolder() const noexcept;
};
...
{
    void CanForwardMeetings(bool value) const noexcept;
    void CanGetAndSetExternalAutoReplies(bool value) const noexcept;
    void CanGetAndSetInternalAutoReplies(bool value) const noexcept;
    void CanUpdateMeetingResponses(bool value) const noexcept;
    void CanServerSearchFolders(bool value) const noexcept;
    void CanServerSearchMailbox(bool value) const noexcept;
    void CanProposeNewTimeForMeetings(bool value) const noexcept;
    void CanSmartSend(bool value) const noexcept;
    void CanResolveRecipients(bool value) const noexcept;
    void CanValidateCertificates(bool value) const noexcept;
    void CanEmptyFolder(bool value) const noexcept;
    void CanCreateFolder(bool value) const noexcept;
    void CanDeleteFolder(bool value) const noexcept;
    void CanMoveFolder(bool value) const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxChangeType ChangeType() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailMailboxAction> MailboxActions() const noexcept;
    Windows::ApplicationModel::Email::EmailMessage Message() const noexcept;
    Windows::ApplicationModel::Email::EmailFolder Folder() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxCreateFolderStatus Status() const noexcept;
    Windows::ApplicationModel::Email::EmailFolder Folder() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation AllowedSmimeEncryptionAlgorithmNegotiation() const noexcept;
    bool AllowSmimeSoftCertificates() const noexcept;
    Windows::Foundation::IReference<Windows::ApplicationModel::Email::EmailMailboxSmimeEncryptionAlgorithm> RequiredSmimeEncryptionAlgorithm() const noexcept;
    Windows::Foundation::IReference<Windows::ApplicationModel::Email::EmailMailboxSmimeSigningAlgorithm> RequiredSmimeSigningAlgorithm() const noexcept;
};
...
{
    bool MustEncryptSmimeMessages() const noexcept;
    bool MustSignSmimeMessages() const noexcept;
};
...
{
    void AllowedSmimeEncryptionAlgorithmNegotiation(Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation const& value) const noexcept;
    void AllowSmimeSoftCertificates(bool value) const noexcept;
    void RequiredSmimeEncryptionAlgorithm(optional<Windows::ApplicationModel::Email::EmailMailboxSmimeEncryptionAlgorithm> const& value) const noexcept;
    void RequiredSmimeSigningAlgorithm(optional<Windows::ApplicationModel::Email::EmailMailboxSmimeSigningAlgorithm> const& value) const noexcept;
    void MustEncryptSmimeMessages(bool value) const noexcept;
    void MustSignSmimeMessages(bool value) const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailMailboxSyncStatus Status() const noexcept;
    Windows::Foundation::DateTime LastSuccessfulSyncTime() const noexcept;
...
{
    void Status(Windows::ApplicationModel::Email::EmailMailboxSyncStatus const& value) const noexcept;
    void LastSuccessfulSyncTime(Windows::Foundation::DateTime const& value) const noexcept;
...
{
    bool AllowNewTimeProposal() const noexcept;
    void AllowNewTimeProposal(bool value) const noexcept;
    hstring AppointmentRoamingId() const noexcept;
    void AppointmentRoamingId(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> AppointmentOriginalStartTime() const noexcept;
    void AppointmentOriginalStartTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::Foundation::TimeSpan Duration() const noexcept;
    void Duration(Windows::Foundation::TimeSpan const& value) const noexcept;
    bool IsAllDay() const noexcept;
    void IsAllDay(bool value) const noexcept;
    bool IsResponseRequested() const noexcept;
    void IsResponseRequested(bool value) const noexcept;
    hstring Location() const noexcept;
    void Location(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ProposedStartTime() const noexcept;
    void ProposedStartTime(optional<Windows::Foundation::DateTime> const& proposedStartTime) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> ProposedDuration() const noexcept;
    void ProposedDuration(optional<Windows::Foundation::TimeSpan> const& duration) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> RecurrenceStartTime() const noexcept;
    void RecurrenceStartTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentRecurrence Recurrence() const noexcept;
    void Recurrence(Windows::ApplicationModel::Appointments::AppointmentRecurrence const& value) const noexcept;
    uint64_t RemoteChangeNumber() const noexcept;
    void RemoteChangeNumber(uint64_t value) const noexcept;
...
{
    bool IsReportedOutOfDateByServer() const noexcept;
};
...
{
    hstring Subject() const noexcept;
    void Subject(param::hstring const& value) const noexcept;
    hstring Body() const noexcept;
    void Body(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailRecipient> To() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailRecipient> CC() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailRecipient> Bcc() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailAttachment> Attachments() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Email_IEmailMessage2
{
    ...
    void RemoteId(param::hstring const& value) const noexcept;
    hstring MailboxId() const noexcept;
    hstring ConversationId() const noexcept;
    hstring FolderId() const noexcept;
    bool AllowInternetImages() const noexcept;
    void AllowInternetImages(bool value) const noexcept;
    uint64_t ChangeNumber() const noexcept;
    Windows::ApplicationModel::Email::EmailMessageDownloadState DownloadState() const noexcept;
    void DownloadState(Windows::ApplicationModel::Email::EmailMessageDownloadState const& value) const noexcept;
    uint32_t EstimatedDownloadSizeInBytes() const noexcept;
    void EstimatedDownloadSizeInBytes(uint32_t value) const noexcept;
    Windows::ApplicationModel::Email::EmailFlagState FlagState() const noexcept;
    void FlagState(Windows::ApplicationModel::Email::EmailFlagState const& value) const noexcept;
    bool HasPartialBodies() const noexcept;
    Windows::ApplicationModel::Email::EmailImportance Importance() const noexcept;
    void Importance(Windows::ApplicationModel::Email::EmailImportance const& value) const noexcept;
    hstring InResponseToMessageId() const noexcept;
    Windows::ApplicationModel::Email::EmailIrmInfo IrmInfo() const noexcept;
    void IrmInfo(Windows::ApplicationModel::Email::EmailIrmInfo const& value) const noexcept;
    bool IsDraftMessage() const noexcept;
    bool IsRead() const noexcept;
    void IsRead(bool value) const noexcept;
    bool IsSeen() const noexcept;
    void IsSeen(bool value) const noexcept;
    bool IsServerSearchMessage() const noexcept;
    bool IsSmartSendable() const noexcept;
    hstring MessageClass() const noexcept;
    void MessageClass(param::hstring const& value) const noexcept;
    hstring NormalizedSubject() const noexcept;
    int32_t OriginalCodePage() const noexcept;
    void OriginalCodePage(int32_t value) const noexcept;
    hstring Preview() const noexcept;
    void Preview(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMessageResponseKind LastResponseKind() const noexcept;
    void LastResponseKind(Windows::ApplicationModel::Email::EmailMessageResponseKind const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailRecipient Sender() const noexcept;
    void Sender(Windows::ApplicationModel::Email::EmailRecipient const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> SentTime() const noexcept;
    void SentTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMeetingInfo MeetingInfo() const noexcept;
    void MeetingInfo(Windows::ApplicationModel::Email::EmailMeetingInfo const& value) const noexcept;
...
{
    Windows::Storage::Streams::IRandomAccessStreamReference SmimeData() const noexcept;
    void SmimeData(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailMessageSmimeKind SmimeKind() const noexcept;
    void SmimeKind(Windows::ApplicationModel::Email::EmailMessageSmimeKind const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Email::EmailRecipient> ReplyTo() const noexcept;
    Windows::ApplicationModel::Email::EmailRecipient SentRepresenting() const noexcept;
    void SentRepresenting(Windows::ApplicationModel::Email::EmailRecipient const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Email::EmailMessage> Messages() const noexcept;
    Windows::ApplicationModel::Email::EmailBatchStatus Status() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailQueryTextSearch TextSearch() const noexcept;
    Windows::ApplicationModel::Email::EmailQuerySortDirection SortDirection() const noexcept;
    void SortDirection(Windows::ApplicationModel::Email::EmailQuerySortDirection const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailQuerySortProperty SortProperty() const noexcept;
    void SortProperty(Windows::ApplicationModel::Email::EmailQuerySortProperty const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailQueryKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Email::EmailQueryKind const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> FolderIds() const noexcept;
};
...
{
    Windows::ApplicationModel::Email::EmailQuerySearchFields Fields() const noexcept;
    void Fields(Windows::ApplicationModel::Email::EmailQuerySearchFields const& value) const noexcept;
    Windows::ApplicationModel::Email::EmailQuerySearchScope SearchScope() const noexcept;
    void SearchScope(Windows::ApplicationModel::Email::EmailQuerySearchScope const& value) const noexcept;
...
{
    Windows::ApplicationModel::Email::EmailRecipientResolutionStatus Status() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::Certificate> PublicKeys() const noexcept;
};
...
{
    void Status(Windows::ApplicationModel::Email::EmailRecipientResolutionStatus const& value) const noexcept;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailAttachment2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DownloadState(Windows::ApplicationModel::Email::EmailAttachmentDownloadState* value) = 0;
    virtual HRESULT __stdcall put_DownloadState(Windows::ApplicationModel::Email::EmailAttachmentDownloadState value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailConversation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_FlagState(Windows::ApplicationModel::Email::EmailFlagState* value) = 0;
    virtual HRESULT __stdcall get_HasAttachment(bool* value) = 0;
    virtual HRESULT __stdcall get_Importance(Windows::ApplicationModel::Email::EmailImportance* value) = 0;
    virtual HRESULT __stdcall get_LastEmailResponseKind(Windows::ApplicationModel::Email::EmailMessageResponseKind* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailConversationBatch>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Email::EmailBatchStatus* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailFolder>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Email::EmailSpecialFolderKind* value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Foundation::DateTime expiration, ::IUnknown* irmTemplate, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailMailbox>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OtherAppReadAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppReadAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess value) = 0;
    virtual HRESULT __stdcall get_OtherAppWriteAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppWriteAccess(Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess value) = 0;
    ...
    virtual HRESULT __stdcall GetMessageAsync(HSTRING id, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetSpecialFolderAsync(Windows::ApplicationModel::Email::EmailSpecialFolderKind folderType, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall ChangeMessageFlagStateAsync(HSTRING messageId, Windows::ApplicationModel::Email::EmailFlagState flagState, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall CreateResponseMessageAsync(HSTRING messageId, Windows::ApplicationModel::Email::EmailMessageResponseKind responseType, HSTRING subject, Windows::ApplicationModel::Email::EmailMessageBodyKind responseHeaderType, HSTRING responseHeader, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall TryUpdateMeetingResponseAsync(::IUnknown* meeting, Windows::ApplicationModel::Email::EmailMeetingResponseType response, HSTRING subject, HSTRING comment, bool sendUpdate, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall TryForwardMeetingAsync(::IUnknown* meeting, ::IUnknown* recipients, HSTRING subject, Windows::ApplicationModel::Email::EmailMessageBodyKind forwardHeaderType, HSTRING forwardHeader, HSTRING comment, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall TryProposeNewTimeForMeetingAsync(::IUnknown* meeting, Windows::Foundation::DateTime newStartTime, Windows::Foundation::TimeSpan newDuration, HSTRING subject, HSTRING comment, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall add_MailboxChanged(::IUnknown* pHandler, event_token* pToken) = 0;
    ...
    virtual HRESULT __stdcall TryGetAutoReplySettingsAsync(Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind requestedFormat, ::IUnknown** autoReplySettings) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Email::EmailMailboxActionKind* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailMailboxAutoReplySettings>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_IsEnabled(bool* value) = 0;
    virtual HRESULT __stdcall put_IsEnabled(bool value) = 0;
    virtual HRESULT __stdcall get_ResponseKind(Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind* value) = 0;
    virtual HRESULT __stdcall put_ResponseKind(Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind value) = 0;
...
{
    virtual HRESULT __stdcall get_ChangeType(Windows::ApplicationModel::Email::EmailMailboxChangeType* value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Email::EmailMailboxCreateFolderStatus* value) = 0;
    virtual HRESULT __stdcall get_Folder(::IUnknown** value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Email::IEmailMailboxPolicies>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_AllowedSmimeEncryptionAlgorithmNegotiation(Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation* value) = 0;
...
{
    virtual HRESULT __stdcall put_AllowedSmimeEncryptionAlgorithmNegotiation(Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Email::EmailMailboxSyncStatus* value) = 0;
    virtual HRESULT __stdcall get_LastSuccessfulSyncTime(Windows::Foundation::DateTime* value) = 0;
...
{
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Email::EmailMailboxSyncStatus value) = 0;
    virtual HRESULT __stdcall put_LastSuccessfulSyncTime(Windows::Foundation::DateTime value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailManagerForUser>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Email::EmailStoreAccessType accessType, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailMessage2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ChangeNumber(uint64_t* value) = 0;
    virtual HRESULT __stdcall get_DownloadState(Windows::ApplicationModel::Email::EmailMessageDownloadState* value) = 0;
    virtual HRESULT __stdcall put_DownloadState(Windows::ApplicationModel::Email::EmailMessageDownloadState value) = 0;
    ...
    virtual HRESULT __stdcall get_FlagState(Windows::ApplicationModel::Email::EmailFlagState* value) = 0;
    virtual HRESULT __stdcall put_FlagState(Windows::ApplicationModel::Email::EmailFlagState value) = 0;
    virtual HRESULT __stdcall get_HasPartialBodies(bool* value) = 0;
    virtual HRESULT __stdcall get_Importance(Windows::ApplicationModel::Email::EmailImportance* value) = 0;
    virtual HRESULT __stdcall put_Importance(Windows::ApplicationModel::Email::EmailImportance value) = 0;
    ...
    virtual HRESULT __stdcall get_LastResponseKind(Windows::ApplicationModel::Email::EmailMessageResponseKind* value) = 0;
    virtual HRESULT __stdcall put_LastResponseKind(Windows::ApplicationModel::Email::EmailMessageResponseKind value) = 0;
    ...
    virtual HRESULT __stdcall GetBodyStream(Windows::ApplicationModel::Email::EmailMessageBodyKind type, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall SetBodyStream(Windows::ApplicationModel::Email::EmailMessageBodyKind type, ::IUnknown* stream) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailMessage3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SmimeKind(Windows::ApplicationModel::Email::EmailMessageSmimeKind* value) = 0;
    virtual HRESULT __stdcall put_SmimeKind(Windows::ApplicationModel::Email::EmailMessageSmimeKind value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailQueryOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SortDirection(Windows::ApplicationModel::Email::EmailQuerySortDirection* value) = 0;
    virtual HRESULT __stdcall put_SortDirection(Windows::ApplicationModel::Email::EmailQuerySortDirection value) = 0;
    virtual HRESULT __stdcall get_SortProperty(Windows::ApplicationModel::Email::EmailQuerySortProperty* value) = 0;
    virtual HRESULT __stdcall put_SortProperty(Windows::ApplicationModel::Email::EmailQuerySortProperty value) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Email::EmailQueryKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Email::EmailQueryKind value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Email::IEmailQueryOptionsFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithTextAndFields(HSTRING text, Windows::ApplicationModel::Email::EmailQuerySearchFields fields, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Email::IEmailQueryTextSearch>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Fields(Windows::ApplicationModel::Email::EmailQuerySearchFields* value) = 0;
    virtual HRESULT __stdcall put_Fields(Windows::ApplicationModel::Email::EmailQuerySearchFields value) = 0;
    virtual HRESULT __stdcall get_SearchScope(Windows::ApplicationModel::Email::EmailQuerySearchScope* value) = 0;
    virtual HRESULT __stdcall put_SearchScope(Windows::ApplicationModel::Email::EmailQuerySearchScope value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Email::EmailRecipientResolutionStatus* value) = 0;
...
{
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Email::EmailRecipientResolutionStatus value) = 0;
