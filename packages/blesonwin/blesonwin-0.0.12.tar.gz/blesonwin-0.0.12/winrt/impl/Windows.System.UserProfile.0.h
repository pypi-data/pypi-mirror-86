...
template <> struct guid<Windows::System::UserProfile::IGlobalizationPreferencesStatics2>{ static constexpr GUID value{ 0xFCCE85F1,0x4300,0x4CD0,{ 0x9C,0xAC,0x1A,0x8E,0x7B,0x7E,0x18,0xF4 } }; };
...
{
    hstring AdvertisingId() const noexcept;
...
{
    bool CanUseDiagnosticsToTailorExperiences() const noexcept;
    Windows::System::User User() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<hstring> Calendars() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Clocks() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Currencies() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Languages() const noexcept;
    hstring HomeGeographicRegion() const noexcept;
    Windows::Globalization::DayOfWeek WeekStartsOn() const noexcept;
};
...
{
    Windows::Foundation::Uri OriginalImageFile() const noexcept;
...
{
    bool AccountPictureChangeEnabled() const noexcept;
    bool NameAccessAllowed() const noexcept;
...
{
    Windows::System::UserProfile::UserProfilePersonalizationSettings Current() const noexcept;
...
template <> struct abi<Windows::System::UserProfile::IGlobalizationPreferencesStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_WeekStartsOn(Windows::Globalization::DayOfWeek* value) = 0;
};};

template <> struct abi<Windows::System::UserProfile::IGlobalizationPreferencesStatics2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall TrySetHomeGeographicRegion(HSTRING region, bool* result) = 0;
    virtual HRESULT __stdcall TrySetLanguages(::IUnknown* languageTags, bool* result) = 0;
};};
...
template <> struct abi<Windows::System::UserProfile::IUserInformationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetAccountPicture(Windows::System::UserProfile::AccountPictureKind kind, ::IUnknown** storageFile) = 0;
    ...
    virtual HRESULT __stdcall add_AccountPictureChanged(::IUnknown* changeHandler, event_token* token) = 0;
