...
{
    Windows::Media::Casting::CastingConnectionState State() const noexcept;
    Windows::Media::Casting::CastingDevice Device() const noexcept;
    Windows::Media::Casting::CastingSource Source() const noexcept;
    void Source(Windows::Media::Casting::CastingSource const& value) const noexcept;
...
{
    Windows::Media::Casting::CastingConnectionErrorStatus ErrorStatus() const noexcept;
...
struct consume_Windows_Media_Casting_ICastingDevice
{
    ...
    Windows::Storage::Streams::IRandomAccessStreamWithContentType Icon() const noexcept;
...
{
    Windows::Media::Casting::CastingDevicePickerFilter Filter() const noexcept;
...
struct consume_Windows_Media_Casting_ICastingDevicePickerFilter
{
    ...
    bool SupportsPictures() const noexcept;
    void SupportsPictures(bool value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Casting::CastingSource> SupportedCastingSources() const noexcept;
};
...
{
    Windows::Media::Casting::CastingDevice SelectedCastingDevice() const noexcept;
};
...
{
    Windows::Foundation::Uri PreferredSourceUri() const noexcept;
    void PreferredSourceUri(Windows::Foundation::Uri const& value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_State(Windows::Media::Casting::CastingConnectionState* value) = 0;
...
{
    virtual HRESULT __stdcall get_ErrorStatus(Windows::Media::Casting::CastingConnectionErrorStatus* value) = 0;
...
template <> struct abi<Windows::Media::Casting::ICastingDevicePicker>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_CastingDeviceSelected(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CastingDeviceSelected(event_token token) = 0;
    virtual HRESULT __stdcall add_CastingDevicePickerDismissed(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall GetDeviceSelector(Windows::Media::Casting::CastingPlaybackTypes type, HSTRING* value) = 0;
