...
{
    int32_t CountryCode() const noexcept;
...
template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberFormatter>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FormatWithOutputFormat(::IUnknown* number, Windows::Globalization::PhoneNumberFormatting::PhoneNumberFormat numberFormat, HSTRING* result) = 0;
...
template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall PredictNumberKind(Windows::Globalization::PhoneNumberFormatting::PredictedPhoneNumberKind* result) = 0;
    virtual HRESULT __stdcall GetGeographicRegionCode(HSTRING* result) = 0;
    virtual HRESULT __stdcall CheckNumberMatch(::IUnknown* otherNumber, Windows::Globalization::PhoneNumberFormatting::PhoneNumberMatchResult* result) = 0;
};};
...
{
    virtual HRESULT __stdcall TryParse(HSTRING input, ::IUnknown** phoneNumber, Windows::Globalization::PhoneNumberFormatting::PhoneNumberParseResult* result) = 0;
    virtual HRESULT __stdcall TryParseWithRegion(HSTRING input, HSTRING regionCode, ::IUnknown** phoneNumber, Windows::Globalization::PhoneNumberFormatting::PhoneNumberParseResult* result) = 0;
};};
