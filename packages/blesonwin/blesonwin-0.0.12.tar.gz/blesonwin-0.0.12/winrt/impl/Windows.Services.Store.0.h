...
{
    Windows::Services::Store::StorePackageLicense StorePackageLicense() const noexcept;
...
{
    hstring SkuStoreId() const noexcept;
    bool IsActive() const noexcept;
    bool IsTrial() const noexcept;
    Windows::Foundation::DateTime ExpirationDate() const noexcept;
    hstring ExtendedJsonData() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::Services::Store::StoreLicense> AddOnLicenses() const noexcept;
    Windows::Foundation::TimeSpan TrialTimeRemaining() const noexcept;
    bool IsTrialOwnedByThisUser() const noexcept;
    hstring TrialUniqueId() const noexcept;
};
...
{
    hstring StoreId() const noexcept;
    Windows::Foundation::DateTime EndDate() const noexcept;
    Windows::Services::Store::StorePrice Price() const noexcept;
    hstring ExtendedJsonData() const noexcept;
...
{
    bool IsTrial() const noexcept;
    hstring CampaignId() const noexcept;
    hstring DeveloperOfferId() const noexcept;
    Windows::Foundation::DateTime AcquiredDate() const noexcept;
    Windows::Foundation::DateTime StartDate() const noexcept;
    Windows::Foundation::DateTime EndDate() const noexcept;
    Windows::Foundation::TimeSpan TrialTimeRemaining() const noexcept;
    hstring ExtendedJsonData() const noexcept;
};
...
{
    Windows::Services::Store::StoreConsumableStatus Status() const noexcept;
    GUID TrackingId() const noexcept;
    uint32_t BalanceRemaining() const noexcept;
    HRESULT ExtendedError() const noexcept;
};
...
struct consume_Windows_Services_Store_IStoreImage
{
    ...
    hstring ImagePurposeTag() const noexcept;
...
struct consume_Windows_Services_Store_IStoreLicense
{
    ...
    Windows::Foundation::DateTime ExpirationDate() const noexcept;
    hstring ExtendedJsonData() const noexcept;
    hstring InAppOfferToken() const noexcept;
};
...
struct consume_Windows_Services_Store_IStorePackageLicense
{
    ...
    Windows::ApplicationModel::Package Package() const noexcept;
...
{
    Windows::Services::Store::StorePackageUpdateState OverallState() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StorePackageUpdateStatus> StorePackageUpdateStatuses() const noexcept;
};
...
{
    hstring FormattedBasePrice() const noexcept;
    hstring FormattedPrice() const noexcept;
    bool IsOnSale() const noexcept;
    Windows::Foundation::DateTime SaleEndDate() const noexcept;
    hstring CurrencyCode() const noexcept;
    hstring FormattedRecurrencePrice() const noexcept;
};
...
struct consume_Windows_Services_Store_IStoreProduct
{
    ...
    hstring ProductKind() const noexcept;
    bool HasDigitalDownload() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Keywords() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreImage> Images() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreVideo> Videos() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreSku> Skus() const noexcept;
    bool IsInUserCollection() const noexcept;
    Windows::Services::Store::StorePrice Price() const noexcept;
    hstring ExtendedJsonData() const noexcept;
    Windows::Foundation::Uri LinkUri() const noexcept;
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::Services::Store::StoreProduct> Products() const noexcept;
...
{
    Windows::Services::Store::StoreProduct Product() const noexcept;
    HRESULT ExtendedError() const noexcept;
};
...
struct consume_Windows_Services_Store_IStorePurchaseProperties
{
    ...
    hstring ExtendedJsonData() const noexcept;
    void ExtendedJsonData(param::hstring const& value) const noexcept;
};
...
{
    Windows::Services::Store::StorePurchaseStatus Status() const noexcept;
    HRESULT ExtendedError() const noexcept;
};
...
{
    Windows::Web::Http::HttpStatusCode HttpStatusCode() const noexcept;
};
...
struct consume_Windows_Services_Store_IStoreSku
{
    ...
    hstring Description() const noexcept;
    bool IsTrial() const noexcept;
    hstring CustomDeveloperData() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreImage> Images() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreVideo> Videos() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Store::StoreAvailability> Availabilities() const noexcept;
    Windows::Services::Store::StorePrice Price() const noexcept;
    hstring ExtendedJsonData() const noexcept;
    bool IsInUserCollection() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> BundledSkus() const noexcept;
    Windows::Services::Store::StoreCollectionData CollectionData() const noexcept;
    Windows::Foundation::IAsyncOperation<bool> GetIsInstalledAsync() const;
    Windows::Foundation::IAsyncOperation<Windows::Services::Store::StorePurchaseResult> RequestPurchaseAsync() const;
    Windows::Foundation::IAsyncOperation<Windows::Services::Store::StorePurchaseResult> RequestPurchaseAsync(Windows::Services::Store::StorePurchaseProperties const& storePurchaseProperties) const;
    bool IsSubscription() const noexcept;
    Windows::Services::Store::StoreSubscriptionInfo SubscriptionInfo() const noexcept;
};
...
{
    uint32_t BillingPeriod() const noexcept;
    Windows::Services::Store::StoreDurationUnit BillingPeriodUnit() const noexcept;
    bool HasTrialPeriod() const noexcept;
    uint32_t TrialPeriod() const noexcept;
    Windows::Services::Store::StoreDurationUnit TrialPeriodUnit() const noexcept;
};
...
{
    Windows::Foundation::Uri Uri() const noexcept;
    hstring VideoPurposeTag() const noexcept;
    uint32_t Width() const noexcept;
    uint32_t Height() const noexcept;
    hstring Caption() const noexcept;
    Windows::Services::Store::StoreImage PreviewImage() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Services::Store::StoreConsumableStatus* value) = 0;
...
template <> struct abi<Windows::Services::Store::IStoreContext>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_OfflineLicensesChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall ReportConsumableFulfillmentAsync(HSTRING productStoreId, uint32_t quantity, GUID trackingId, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall add_LicenseLost(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_OverallState(Windows::Services::Store::StorePackageUpdateState* value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Services::Store::StorePurchaseStatus* value) = 0;
    virtual HRESULT __stdcall get_ExtendedError(HRESULT* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_HttpStatusCode(Windows::Web::Http::HttpStatusCode* value) = 0;
};};
...
template <> struct abi<Windows::Services::Store::IStoreSubscriptionInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BillingPeriodUnit(Windows::Services::Store::StoreDurationUnit* value) = 0;
    virtual HRESULT __stdcall get_HasTrialPeriod(bool* value) = 0;
    virtual HRESULT __stdcall get_TrialPeriod(uint32_t* value) = 0;
    virtual HRESULT __stdcall get_TrialPeriodUnit(Windows::Services::Store::StoreDurationUnit* value) = 0;
};};
