...
{
    Windows::Foundation::Uri ServiceUri() const noexcept;
...
template <> struct abi<Windows::Phone::System::UserProfile::GameServices::Core::IGameService>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall PostResult(uint32_t gameVariant, Windows::Phone::System::UserProfile::GameServices::Core::GameServiceScoreKind scoreKind, int64_t scoreValue, Windows::Phone::System::UserProfile::GameServices::Core::GameServiceGameOutcome gameOutcome, ::IUnknown* buffer) = 0;
};};
