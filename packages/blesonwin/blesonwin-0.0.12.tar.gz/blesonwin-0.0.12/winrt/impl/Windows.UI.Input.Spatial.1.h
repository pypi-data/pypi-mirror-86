...
struct WINRT_EBO ISpatialInteractionController2 :
    ...
    impl::require<ISpatialInteractionController2, Windows::UI::Input::Spatial::ISpatialInteractionController>
{
...
struct WINRT_EBO ISpatialInteractionSourceLocation3 :
    ...
    impl::require<ISpatialInteractionSourceLocation3, Windows::UI::Input::Spatial::ISpatialInteractionSourceLocation2>
{
...
struct WINRT_EBO ISpatialPointerInteractionSourcePose2 :
    ...
    impl::require<ISpatialPointerInteractionSourcePose2, Windows::UI::Input::Spatial::ISpatialPointerInteractionSourcePose>
{
