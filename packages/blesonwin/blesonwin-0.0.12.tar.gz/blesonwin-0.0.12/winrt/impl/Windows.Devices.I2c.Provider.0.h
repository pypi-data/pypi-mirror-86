...
{
    int32_t SlaveAddress() const noexcept;
    void SlaveAddress(int32_t value) const noexcept;
    Windows::Devices::I2c::Provider::ProviderI2cBusSpeed BusSpeed() const noexcept;
    void BusSpeed(Windows::Devices::I2c::Provider::ProviderI2cBusSpeed const& value) const noexcept;
    Windows::Devices::I2c::Provider::ProviderI2cSharingMode SharingMode() const noexcept;
    void SharingMode(Windows::Devices::I2c::Provider::ProviderI2cSharingMode const& value) const noexcept;
};
...
template <> struct abi<Windows::Devices::I2c::Provider::II2cDeviceProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall WritePartial(uint32_t __bufferSize, uint8_t* buffer, struct_of<8>* result) = 0;
    virtual HRESULT __stdcall Read(uint32_t __bufferSize, uint8_t* buffer) = 0;
    virtual HRESULT __stdcall ReadPartial(uint32_t __bufferSize, uint8_t* buffer, struct_of<8>* result) = 0;
    ...
    virtual HRESULT __stdcall WriteReadPartial(uint32_t __writeBufferSize, uint8_t* writeBuffer, uint32_t __readBufferSize, uint8_t* readBuffer, struct_of<8>* result) = 0;
};};
...
template <> struct abi<Windows::Devices::I2c::Provider::IProviderI2cConnectionSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BusSpeed(Windows::Devices::I2c::Provider::ProviderI2cBusSpeed* value) = 0;
    virtual HRESULT __stdcall put_BusSpeed(Windows::Devices::I2c::Provider::ProviderI2cBusSpeed value) = 0;
    virtual HRESULT __stdcall get_SharingMode(Windows::Devices::I2c::Provider::ProviderI2cSharingMode* value) = 0;
    virtual HRESULT __stdcall put_SharingMode(Windows::Devices::I2c::Provider::ProviderI2cSharingMode value) = 0;
};};
