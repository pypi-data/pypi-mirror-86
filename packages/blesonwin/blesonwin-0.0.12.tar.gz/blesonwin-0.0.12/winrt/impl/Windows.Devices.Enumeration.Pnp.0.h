...
{
    Windows::Devices::Enumeration::Pnp::PnpObjectType Type() const noexcept;
...
{
    virtual HRESULT __stdcall get_Type(Windows::Devices::Enumeration::Pnp::PnpObjectType* value) = 0;
...
{
    virtual HRESULT __stdcall CreateFromIdAsync(Windows::Devices::Enumeration::Pnp::PnpObjectType type, HSTRING id, ::IUnknown* requestedProperties, ::IUnknown** asyncOp) = 0;
    virtual HRESULT __stdcall FindAllAsync(Windows::Devices::Enumeration::Pnp::PnpObjectType type, ::IUnknown* requestedProperties, ::IUnknown** asyncOp) = 0;
    virtual HRESULT __stdcall FindAllAsyncAqsFilter(Windows::Devices::Enumeration::Pnp::PnpObjectType type, ::IUnknown* requestedProperties, HSTRING aqsFilter, ::IUnknown** asyncOp) = 0;
    virtual HRESULT __stdcall CreateWatcher(Windows::Devices::Enumeration::Pnp::PnpObjectType type, ::IUnknown* requestedProperties, ::IUnknown** watcher) = 0;
    virtual HRESULT __stdcall CreateWatcherAqsFilter(Windows::Devices::Enumeration::Pnp::PnpObjectType type, ::IUnknown* requestedProperties, HSTRING aqsFilter, ::IUnknown** watcher) = 0;
};};
