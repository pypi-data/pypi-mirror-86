...
template <> struct is_struct<Windows::UI::Xaml::Automation::Peers::RawElementProviderRuntimeId>
{
...
struct WINRT_EBO ColorSpectrumAutomationPeer :
    Windows::UI::Xaml::Automation::Peers::IColorSpectrumAutomationPeer,
...
struct WINRT_EBO NavigationViewItemAutomationPeer :
    Windows::UI::Xaml::Automation::Peers::INavigationViewItemAutomationPeer,
...
struct WINRT_EBO PersonPictureAutomationPeer :
    Windows::UI::Xaml::Automation::Peers::IPersonPictureAutomationPeer,
...
struct WINRT_EBO RatingControlAutomationPeer :
    Windows::UI::Xaml::Automation::Peers::IRatingControlAutomationPeer,
