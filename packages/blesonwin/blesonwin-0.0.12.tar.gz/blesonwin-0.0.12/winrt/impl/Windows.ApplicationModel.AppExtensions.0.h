...
{
    hstring AppExtensionName() const noexcept;
    Windows::ApplicationModel::Package Package() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppExtensions::AppExtension> Extensions() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_PackageInstalled(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_PackageUpdated(::IUnknown* handler, event_token* token) = 0;
