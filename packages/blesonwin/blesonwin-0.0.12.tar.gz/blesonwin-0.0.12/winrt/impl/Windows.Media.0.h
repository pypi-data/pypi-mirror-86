...
{
    Windows::Media::MediaPlaybackAutoRepeatMode RequestedAutoRepeatMode() const noexcept;
};
...
struct consume_Windows_Media_IImageDisplayProperties
{
    ...
    void Subtitle(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_Media_IMediaControl
{
    ...
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] Windows::Media::SoundLevel SoundLevel() const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] void TrackName(param::hstring const& value) const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] hstring TrackName() const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] void ArtistName(param::hstring const& value) const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] hstring ArtistName() const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] void IsPlaying(bool value) const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] bool IsPlaying() const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] void AlbumArt(Windows::Foundation::Uri const& value) const noexcept;
    [[deprecated("MediaControl may be altered or unavailable for releases after Windows 8.1. Instead, use SystemMediaTransportControls.")]] Windows::Foundation::Uri AlbumArt() const noexcept;
};
...
struct consume_Windows_Media_IMediaFrame
{
    ...
    void RelativeTime(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> RelativeTime() const noexcept;
    void SystemRelativeTime(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> SystemRelativeTime() const noexcept;
    ...
    void IsDiscontinuous(bool value) const noexcept;
    bool IsDiscontinuous() const noexcept;
    Windows::Foundation::Collections::IPropertySet ExtendedProperties() const noexcept;
};
...
{
    hstring Bookmark() const noexcept;
};
...
{
    Windows::Foundation::Collections::ValueSet Arguments() const noexcept;
};
...
struct consume_Windows_Media_IMediaTimelineController
{
    ...
    double ClockRate() const noexcept;
    void ClockRate(double value) const noexcept;
    Windows::Media::MediaTimelineControllerState State() const noexcept;
...
struct consume_Windows_Media_IMusicDisplayProperties
{
    ...
    void AlbumArtist(param::hstring const& value) const noexcept;
    hstring Artist() const noexcept;
    void Artist(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_Media_IMusicDisplayProperties2
{
    ...
    void AlbumTitle(param::hstring const& value) const noexcept;
    uint32_t TrackNumber() const noexcept;
    void TrackNumber(uint32_t value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Genres() const noexcept;
};
...
{
    uint32_t AlbumTrackCount() const noexcept;
    void AlbumTrackCount(uint32_t value) const noexcept;
};
...
{
    Windows::Foundation::TimeSpan RequestedPlaybackPosition() const noexcept;
};
...
{
    double RequestedPlaybackRate() const noexcept;
};
...
{
    bool RequestedShuffleEnabled() const noexcept;
};
...
{
    Windows::Media::MediaPlaybackStatus PlaybackStatus() const noexcept;
    void PlaybackStatus(Windows::Media::MediaPlaybackStatus const& value) const noexcept;
    Windows::Media::SystemMediaTransportControlsDisplayUpdater DisplayUpdater() const noexcept;
    Windows::Media::SoundLevel SoundLevel() const noexcept;
    bool IsEnabled() const noexcept;
    void IsEnabled(bool value) const noexcept;
    bool IsPlayEnabled() const noexcept;
    void IsPlayEnabled(bool value) const noexcept;
    bool IsStopEnabled() const noexcept;
    void IsStopEnabled(bool value) const noexcept;
    bool IsPauseEnabled() const noexcept;
    void IsPauseEnabled(bool value) const noexcept;
    bool IsRecordEnabled() const noexcept;
    void IsRecordEnabled(bool value) const noexcept;
    bool IsFastForwardEnabled() const noexcept;
    void IsFastForwardEnabled(bool value) const noexcept;
    bool IsRewindEnabled() const noexcept;
    void IsRewindEnabled(bool value) const noexcept;
    bool IsPreviousEnabled() const noexcept;
    void IsPreviousEnabled(bool value) const noexcept;
    bool IsNextEnabled() const noexcept;
    void IsNextEnabled(bool value) const noexcept;
    bool IsChannelUpEnabled() const noexcept;
    void IsChannelUpEnabled(bool value) const noexcept;
    bool IsChannelDownEnabled() const noexcept;
    void IsChannelDownEnabled(bool value) const noexcept;
...
struct consume_Windows_Media_ISystemMediaTransportControls2
{
    ...
    void AutoRepeatMode(Windows::Media::MediaPlaybackAutoRepeatMode const& value) const noexcept;
...
{
    Windows::Media::SystemMediaTransportControlsButton Button() const noexcept;
};
...
struct consume_Windows_Media_ISystemMediaTransportControlsDisplayUpdater
{
    ...
    hstring AppMediaId() const noexcept;
    void AppMediaId(param::hstring const& value) const noexcept;
    ...
    Windows::Media::ImageDisplayProperties ImageProperties() const noexcept;
...
{
    Windows::Media::SystemMediaTransportControlsProperty Property() const noexcept;
};
...
struct consume_Windows_Media_ISystemMediaTransportControlsTimelineProperties
{
    ...
    void StartTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan EndTime() const noexcept;
    void EndTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan MinSeekTime() const noexcept;
    void MinSeekTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan MaxSeekTime() const noexcept;
    void MaxSeekTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan Position() const noexcept;
    void Position(Windows::Foundation::TimeSpan const& value) const noexcept;
};
...
{
    hstring VideoStabilization() const noexcept;
};
...
{
    Windows::Graphics::Imaging::SoftwareBitmap SoftwareBitmap() const noexcept;
    Windows::Foundation::IAsyncAction CopyToAsync(Windows::Media::VideoFrame const& frame) const;
    Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface Direct3DSurface() const noexcept;
};
...
{
    virtual HRESULT __stdcall LockBuffer(Windows::Media::AudioBufferAccessMode mode, ::IUnknown** value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_RequestedAutoRepeatMode(Windows::Media::MediaPlaybackAutoRepeatMode* value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_SoundLevelChanged(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_SoundLevelChanged(event_token cookie) = 0;
    virtual HRESULT __stdcall add_PlayPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_PlayPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_PausePressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_PausePressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_StopPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_StopPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_PlayPauseTogglePressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_PlayPauseTogglePressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_RecordPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_RecordPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_NextTrackPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_NextTrackPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_PreviousTrackPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_PreviousTrackPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_FastForwardPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_FastForwardPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_RewindPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_RewindPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ChannelUpPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ChannelUpPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ChannelDownPressed(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ChannelDownPressed(event_token cookie) = 0;
    virtual HRESULT __stdcall get_SoundLevel(Windows::Media::SoundLevel* value) = 0;
...
template <> struct abi<Windows::Media::IMediaExtensionManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RegisterAudioDecoder(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype) = 0;
    virtual HRESULT __stdcall RegisterAudioDecoderWithSettings(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype, ::IUnknown* configuration) = 0;
    virtual HRESULT __stdcall RegisterAudioEncoder(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype) = 0;
    virtual HRESULT __stdcall RegisterAudioEncoderWithSettings(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype, ::IUnknown* configuration) = 0;
    virtual HRESULT __stdcall RegisterVideoDecoder(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype) = 0;
    virtual HRESULT __stdcall RegisterVideoDecoderWithSettings(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype, ::IUnknown* configuration) = 0;
    virtual HRESULT __stdcall RegisterVideoEncoder(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype) = 0;
    virtual HRESULT __stdcall RegisterVideoEncoderWithSettings(HSTRING activatableClassId, GUID inputSubtype, GUID outputSubtype, ::IUnknown* configuration) = 0;
};};
...
template <> struct abi<Windows::Media::IMediaTimelineController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Media::MediaTimelineControllerState* value) = 0;
    virtual HRESULT __stdcall add_PositionChanged(::IUnknown* positionChangedEventHandler, event_token* eventCookie) = 0;
    virtual HRESULT __stdcall remove_PositionChanged(event_token eventCookie) = 0;
    virtual HRESULT __stdcall add_StateChanged(::IUnknown* stateChangedEventHandler, event_token* eventCookie) = 0;
...
template <> struct abi<Windows::Media::IMediaTimelineController2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Failed(::IUnknown* eventHandler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Failed(event_token token) = 0;
    virtual HRESULT __stdcall add_Ended(::IUnknown* eventHandler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_PlaybackStatus(Windows::Media::MediaPlaybackStatus* value) = 0;
    virtual HRESULT __stdcall put_PlaybackStatus(Windows::Media::MediaPlaybackStatus value) = 0;
    ...
    virtual HRESULT __stdcall add_ButtonPressed(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ButtonPressed(event_token token) = 0;
    virtual HRESULT __stdcall add_PropertyChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::ISystemMediaTransportControls2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_AutoRepeatMode(Windows::Media::MediaPlaybackAutoRepeatMode value) = 0;
    ...
    virtual HRESULT __stdcall add_PlaybackPositionChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlaybackPositionChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_PlaybackRateChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlaybackRateChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_ShuffleEnabledChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ShuffleEnabledChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_AutoRepeatModeChangeRequested(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Button(Windows::Media::SystemMediaTransportControlsButton* value) = 0;
};};
...
template <> struct abi<Windows::Media::ISystemMediaTransportControlsDisplayUpdater>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CopyFromFileAsync(Windows::Media::MediaPlaybackType type, ::IUnknown* source, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall get_Property(Windows::Media::SystemMediaTransportControlsProperty* value) = 0;
};};
