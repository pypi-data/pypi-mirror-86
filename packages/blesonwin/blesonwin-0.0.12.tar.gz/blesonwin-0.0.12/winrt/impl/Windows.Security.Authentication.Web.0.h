...
{
    hstring ResponseData() const noexcept;
    Windows::Security::Authentication::Web::WebAuthenticationStatus ResponseStatus() const noexcept;
    uint32_t ResponseErrorDetail() const noexcept;
};
...
{
    virtual HRESULT __stdcall AuthenticateWithCallbackUriAsync(Windows::Security::Authentication::Web::WebAuthenticationOptions options, ::IUnknown* requestUri, ::IUnknown* callbackUri, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall AuthenticateWithoutCallbackUriAsync(Windows::Security::Authentication::Web::WebAuthenticationOptions options, ::IUnknown* requestUri, ::IUnknown** asyncInfo) = 0;
...
template <> struct abi<Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue(::IUnknown* requestUri, ::IUnknown* callbackUri, ::IUnknown* continuationData, Windows::Security::Authentication::Web::WebAuthenticationOptions options) = 0;
    virtual HRESULT __stdcall AuthenticateSilentlyAsync(::IUnknown* requestUri, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall AuthenticateSilentlyWithOptionsAsync(::IUnknown* requestUri, Windows::Security::Authentication::Web::WebAuthenticationOptions options, ::IUnknown** asyncInfo) = 0;
};};
...
template <> struct abi<Windows::Security::Authentication::Web::IWebAuthenticationResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ResponseStatus(Windows::Security::Authentication::Web::WebAuthenticationStatus* value) = 0;
