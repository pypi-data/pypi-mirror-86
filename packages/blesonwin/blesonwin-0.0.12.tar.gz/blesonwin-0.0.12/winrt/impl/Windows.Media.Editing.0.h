...
{
    Windows::Foundation::TimeSpan TrimTimeFromStart() const noexcept;
    void TrimTimeFromStart(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan TrimTimeFromEnd() const noexcept;
    void TrimTimeFromEnd(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan OriginalDuration() const noexcept;
    Windows::Foundation::TimeSpan TrimmedDuration() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> UserData() const noexcept;
    void Delay(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan Delay() const noexcept;
    ...
    Windows::Foundation::Collections::IVector<Windows::Media::Effects::IAudioEffectDefinition> AudioEffectDefinitions() const noexcept;
};
...
struct consume_Windows_Media_Editing_IMediaClip
{
    ...
    Windows::Foundation::TimeSpan StartTimeInComposition() const noexcept;
    Windows::Foundation::TimeSpan EndTimeInComposition() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Editing::EmbeddedAudioTrack> EmbeddedAudioTracks() const noexcept;
    uint32_t SelectedEmbeddedAudioTrackIndex() const noexcept;
    void SelectedEmbeddedAudioTrackIndex(uint32_t value) const noexcept;
    void Volume(double value) const noexcept;
    double Volume() const noexcept;
    Windows::Media::MediaProperties::VideoEncodingProperties GetVideoEncodingProperties() const;
    Windows::Foundation::Collections::IVector<Windows::Media::Effects::IAudioEffectDefinition> AudioEffectDefinitions() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Effects::IVideoEffectDefinition> VideoEffectDefinitions() const noexcept;
};
...
struct consume_Windows_Media_Editing_IMediaComposition
{
    ...
    Windows::Foundation::Collections::IVector<Windows::Media::Editing::MediaClip> Clips() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Editing::BackgroundAudioTrack> BackgroundAudioTracks() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> UserData() const noexcept;
...
{
    Windows::Foundation::Collections::IVector<Windows::Media::Editing::MediaOverlayLayer> OverlayLayers() const noexcept;
};
...
{
    Windows::Foundation::Rect Position() const noexcept;
    void Position(Windows::Foundation::Rect const& value) const noexcept;
    void Delay(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan Delay() const noexcept;
    double Opacity() const noexcept;
    void Opacity(double value) const noexcept;
    Windows::Media::Editing::MediaOverlay Clone() const;
    Windows::Media::Editing::MediaClip Clip() const noexcept;
    bool AudioEnabled() const noexcept;
    void AudioEnabled(bool value) const noexcept;
};
...
struct consume_Windows_Media_Editing_IMediaOverlayLayer
{
    ...
    Windows::Foundation::Collections::IVector<Windows::Media::Editing::MediaOverlay> Overlays() const noexcept;
    Windows::Media::Effects::IVideoCompositorDefinition CustomCompositorDefinition() const noexcept;
};
...
{
    virtual HRESULT __stdcall CreateFromColor(struct_of<4> color, Windows::Foundation::TimeSpan originalDuration, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateFromFileAsync(::IUnknown* file, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall CreateFromImageFileAsync(::IUnknown* file, Windows::Foundation::TimeSpan originalDuration, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Media::Editing::IMediaClipStatics2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateFromSurface(::IUnknown* surface, Windows::Foundation::TimeSpan originalDuration, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Media::Editing::IMediaComposition>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetThumbnailAsync(Windows::Foundation::TimeSpan timeFromStart, int32_t scaledWidth, int32_t scaledHeight, Windows::Media::Editing::VideoFramePrecision framePrecision, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetThumbnailsAsync(::IUnknown* timesFromStart, int32_t scaledWidth, int32_t scaledHeight, Windows::Media::Editing::VideoFramePrecision framePrecision, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RenderToFileAsync(::IUnknown* destination, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RenderToFileWithTrimmingPreferenceAsync(::IUnknown* destination, Windows::Media::Editing::MediaTrimmingPreference trimmingPreference, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RenderToFileWithProfileAsync(::IUnknown* destination, Windows::Media::Editing::MediaTrimmingPreference trimmingPreference, ::IUnknown* encodingProfile, ::IUnknown** operation) = 0;
...
template <> struct abi<Windows::Media::Editing::IMediaOverlayFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithPositionAndOpacity(::IUnknown* clip, Windows::Foundation::Rect position, double opacity, ::IUnknown** mediaOverlay) = 0;
};};
