...
struct consume_Windows_ApplicationModel_Contacts_Provider_IContactPickerUI
{
    ...
    [[deprecated("DesiredFields may be altered or unavailable for releases after Windows 8.1. Instead, use DesiredFieldsWithContactFieldType.")]] Windows::Foundation::Collections::IVectorView<hstring> DesiredFields() const noexcept;
...
{
    virtual HRESULT __stdcall AddContact(HSTRING id, ::IUnknown* contact, Windows::ApplicationModel::Contacts::Provider::AddContactResult* result) = 0;
    ...
    virtual HRESULT __stdcall add_ContactRemoved(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall AddContact(::IUnknown* contact, Windows::ApplicationModel::Contacts::Provider::AddContactResult* result) = 0;
