...
template <> struct is_struct<Windows::UI::Xaml::CornerRadius>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::UI::Xaml::Duration>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::UI::Xaml::GridLength>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::UI::Xaml::Thickness>
{
    static constexpr bool value{ true };
};
    ...
    impl::require<FrameworkElement, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2, Windows::UI::Xaml::IFrameworkElement2, Windows::UI::Xaml::IFrameworkElement3, Windows::UI::Xaml::IFrameworkElement4, Windows::UI::Xaml::IFrameworkElement6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElement, Windows::UI::Xaml::IUIElement2, Windows::UI::Xaml::IUIElement3, Windows::UI::Xaml::IUIElement4, Windows::UI::Xaml::IUIElement5, Windows::UI::Xaml::IUIElement7, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7>
{
    ...
    static Windows::UI::Xaml::DependencyProperty ActualThemeProperty();
};
...
struct WINRT_EBO UIElement :
    ...
    impl::require<UIElement, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2, Windows::UI::Xaml::IUIElement2, Windows::UI::Xaml::IUIElement3, Windows::UI::Xaml::IUIElement4, Windows::UI::Xaml::IUIElement5, Windows::UI::Xaml::IUIElement7, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7>
{
    ...
    static Windows::UI::Xaml::RoutedEvent PreviewKeyDownEvent();
    static Windows::UI::Xaml::RoutedEvent CharacterReceivedEvent();
    static Windows::UI::Xaml::RoutedEvent PreviewKeyUpEvent();
};
