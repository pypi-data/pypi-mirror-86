...
struct consume_Windows_UI_Popups_IMessageDialog
{
    ...
    void Content(param::hstring const& value) const noexcept;
    Windows::Foundation::IAsyncOperation<Windows::UI::Popups::IUICommand> ShowAsync() const;
    Windows::UI::Popups::MessageDialogOptions Options() const noexcept;
    void Options(Windows::UI::Popups::MessageDialogOptions const& value) const noexcept;
};
...
struct consume_Windows_UI_Popups_IUICommand
{
    ...
    Windows::UI::Popups::UICommandInvokedHandler Invoked() const noexcept;
    void Invoked(Windows::UI::Popups::UICommandInvokedHandler const& value) const noexcept;
    Windows::Foundation::IInspectable Id() const noexcept;
    void Id(Windows::Foundation::IInspectable const& value) const noexcept;
};
...
template <> struct abi<Windows::UI::Popups::IMessageDialog>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Options(Windows::UI::Popups::MessageDialogOptions* value) = 0;
    virtual HRESULT __stdcall put_Options(Windows::UI::Popups::MessageDialogOptions value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Commands(::IUnknown** value) = 0;
    virtual HRESULT __stdcall ShowAsync(Windows::Foundation::Point invocationPoint, ::IUnknown** asyncOperation) = 0;
    virtual HRESULT __stdcall ShowAsyncWithRect(Windows::Foundation::Rect selection, ::IUnknown** asyncOperation) = 0;
    virtual HRESULT __stdcall ShowAsyncWithRectAndPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** asyncOperation) = 0;
};};
