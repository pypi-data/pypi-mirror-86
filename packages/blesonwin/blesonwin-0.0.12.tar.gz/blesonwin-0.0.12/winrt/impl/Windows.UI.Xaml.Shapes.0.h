...
struct consume_Windows_UI_Xaml_Shapes_ILine
{
    ...
    void X1(double value) const noexcept;
    double Y1() const noexcept;
    void Y1(double value) const noexcept;
    double X2() const noexcept;
    void X2(double value) const noexcept;
    double Y2() const noexcept;
    void Y2(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty X1Property() const noexcept;
    Windows::UI::Xaml::DependencyProperty Y1Property() const noexcept;
    Windows::UI::Xaml::DependencyProperty X2Property() const noexcept;
    Windows::UI::Xaml::DependencyProperty Y2Property() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::Geometry Data() const noexcept;
    void Data(Windows::UI::Xaml::Media::Geometry const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty DataProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Shapes_IShape
{
    ...
    Windows::UI::Xaml::Media::Brush Stroke() const noexcept;
    void Stroke(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    double StrokeMiterLimit() const noexcept;
    void StrokeMiterLimit(double value) const noexcept;
    double StrokeThickness() const noexcept;
    void StrokeThickness(double value) const noexcept;
    Windows::UI::Xaml::Media::PenLineCap StrokeStartLineCap() const noexcept;
    void StrokeStartLineCap(Windows::UI::Xaml::Media::PenLineCap const& value) const noexcept;
    Windows::UI::Xaml::Media::PenLineCap StrokeEndLineCap() const noexcept;
    void StrokeEndLineCap(Windows::UI::Xaml::Media::PenLineCap const& value) const noexcept;
    Windows::UI::Xaml::Media::PenLineJoin StrokeLineJoin() const noexcept;
    void StrokeLineJoin(Windows::UI::Xaml::Media::PenLineJoin const& value) const noexcept;
    double StrokeDashOffset() const noexcept;
    void StrokeDashOffset(double value) const noexcept;
    Windows::UI::Xaml::Media::PenLineCap StrokeDashCap() const noexcept;
    void StrokeDashCap(Windows::UI::Xaml::Media::PenLineCap const& value) const noexcept;
    Windows::UI::Xaml::Media::DoubleCollection StrokeDashArray() const noexcept;
    void StrokeDashArray(Windows::UI::Xaml::Media::DoubleCollection const& value) const noexcept;
    ...
    Windows::UI::Xaml::Media::Transform GeometryTransform() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Shapes_IShapeStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty StrokeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeMiterLimitProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeThicknessProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeStartLineCapProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeEndLineCapProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeLineJoinProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeDashOffsetProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeDashCapProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StrokeDashArrayProperty() const noexcept;
...
template <> struct abi<Windows::UI::Xaml::Shapes::IShape>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_StrokeStartLineCap(Windows::UI::Xaml::Media::PenLineCap* value) = 0;
    virtual HRESULT __stdcall put_StrokeStartLineCap(Windows::UI::Xaml::Media::PenLineCap value) = 0;
    virtual HRESULT __stdcall get_StrokeEndLineCap(Windows::UI::Xaml::Media::PenLineCap* value) = 0;
    virtual HRESULT __stdcall put_StrokeEndLineCap(Windows::UI::Xaml::Media::PenLineCap value) = 0;
    virtual HRESULT __stdcall get_StrokeLineJoin(Windows::UI::Xaml::Media::PenLineJoin* value) = 0;
    virtual HRESULT __stdcall put_StrokeLineJoin(Windows::UI::Xaml::Media::PenLineJoin value) = 0;
    ...
    virtual HRESULT __stdcall get_StrokeDashCap(Windows::UI::Xaml::Media::PenLineCap* value) = 0;
    virtual HRESULT __stdcall put_StrokeDashCap(Windows::UI::Xaml::Media::PenLineCap value) = 0;
