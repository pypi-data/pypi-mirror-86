...
struct consume_Windows_UI_Input_ICrossSlidingEventArgs
{
    ...
    Windows::UI::Input::CrossSlidingState CrossSlidingState() const noexcept;
};
...
struct consume_Windows_UI_Input_IDraggingEventArgs
{
    Windows::Devices::Input::PointerDeviceType PointerDeviceType() const noexcept;
    Windows::Foundation::Point Position() const noexcept;
    Windows::UI::Input::DraggingState DraggingState() const noexcept;
};
...
{
    Windows::UI::Input::EdgeGestureKind Kind() const noexcept;
};
...
{
    Windows::UI::Input::GestureSettings GestureSettings() const noexcept;
    void GestureSettings(Windows::UI::Input::GestureSettings const& value) const noexcept;
    bool IsInertial() const noexcept;
    bool IsActive() const noexcept;
    bool ShowGestureFeedback() const noexcept;
    void ShowGestureFeedback(bool value) const noexcept;
    Windows::Foundation::Point PivotCenter() const noexcept;
    void PivotCenter(Windows::Foundation::Point const& value) const noexcept;
    float PivotRadius() const noexcept;
    void PivotRadius(float value) const noexcept;
    float InertiaTranslationDeceleration() const noexcept;
    void InertiaTranslationDeceleration(float value) const noexcept;
    float InertiaRotationDeceleration() const noexcept;
    void InertiaRotationDeceleration(float value) const noexcept;
    float InertiaExpansionDeceleration() const noexcept;
    void InertiaExpansionDeceleration(float value) const noexcept;
    float InertiaTranslationDisplacement() const noexcept;
    void InertiaTranslationDisplacement(float value) const noexcept;
    float InertiaRotationAngle() const noexcept;
    void InertiaRotationAngle(float value) const noexcept;
    float InertiaExpansion() const noexcept;
    void InertiaExpansion(float value) const noexcept;
    bool ManipulationExact() const noexcept;
    void ManipulationExact(bool value) const noexcept;
    Windows::UI::Input::CrossSlideThresholds CrossSlideThresholds() const noexcept;
    void CrossSlideThresholds(Windows::UI::Input::CrossSlideThresholds const& value) const noexcept;
    bool CrossSlideHorizontally() const noexcept;
    void CrossSlideHorizontally(bool value) const noexcept;
    bool CrossSlideExact() const noexcept;
    void CrossSlideExact(bool value) const noexcept;
    bool AutoProcessInertia() const noexcept;
    void AutoProcessInertia(bool value) const noexcept;
    Windows::UI::Input::MouseWheelParameters MouseWheelParameters() const noexcept;
...
{
    bool IsInterceptionEnabledWhenInForeground() const noexcept;
    void IsInterceptionEnabledWhenInForeground(bool value) const noexcept;
...
{
    Windows::Foundation::Point CharTranslation() const noexcept;
    void CharTranslation(Windows::Foundation::Point const& value) const noexcept;
    float DeltaScale() const noexcept;
    void DeltaScale(float value) const noexcept;
    float DeltaRotationAngle() const noexcept;
    void DeltaRotationAngle(float value) const noexcept;
    Windows::Foundation::Point PageTranslation() const noexcept;
    void PageTranslation(Windows::Foundation::Point const& value) const noexcept;
};
...
{
    Windows::Devices::Input::PointerDevice PointerDevice() const noexcept;
    Windows::Foundation::Point Position() const noexcept;
    Windows::Foundation::Point RawPosition() const noexcept;
    uint32_t PointerId() const noexcept;
    uint32_t FrameId() const noexcept;
    uint64_t Timestamp() const noexcept;
    bool IsInContact() const noexcept;
    Windows::UI::Input::PointerPointProperties Properties() const noexcept;
};
...
struct consume_Windows_UI_Input_IPointerPointProperties
{
    ...
    bool IsEraser() const noexcept;
    float Orientation() const noexcept;
    float XTilt() const noexcept;
    float YTilt() const noexcept;
    float Twist() const noexcept;
    Windows::Foundation::Rect ContactRect() const noexcept;
    Windows::Foundation::Rect ContactRectRaw() const noexcept;
    bool TouchConfidence() const noexcept;
    bool IsLeftButtonPressed() const noexcept;
    bool IsRightButtonPressed() const noexcept;
    bool IsMiddleButtonPressed() const noexcept;
    int32_t MouseWheelDelta() const noexcept;
    bool IsHorizontalMouseWheel() const noexcept;
    bool IsPrimary() const noexcept;
    bool IsInRange() const noexcept;
    bool IsCanceled() const noexcept;
    bool IsBarrelButtonPressed() const noexcept;
    bool IsXButton1Pressed() const noexcept;
    bool IsXButton2Pressed() const noexcept;
    Windows::UI::Input::PointerUpdateKind PointerUpdateKind() const noexcept;
...
{
    Windows::Foundation::IReference<float> ZDistance() const noexcept;
};
...
{
    Windows::UI::Input::IPointerPointTransform Inverse() const noexcept;
...
{
    void IsContactFeedbackEnabled(bool value) const noexcept;
    bool IsContactFeedbackEnabled() const noexcept;
    void IsBarrelButtonFeedbackEnabled(bool value) const noexcept;
    bool IsBarrelButtonFeedbackEnabled() const noexcept;
};
...
{
    Windows::UI::Input::RadialControllerMenu Menu() const noexcept;
    double RotationResolutionInDegrees() const noexcept;
    void RotationResolutionInDegrees(double value) const noexcept;
    bool UseAutomaticHapticFeedback() const noexcept;
    void UseAutomaticHapticFeedback(bool value) const noexcept;
...
{
    Windows::UI::Input::RadialControllerScreenContact Contact() const noexcept;
};
...
{
    void ActiveControllerWhenMenuIsSuppressed(Windows::UI::Input::RadialController const& value) const noexcept;
    Windows::UI::Input::RadialController ActiveControllerWhenMenuIsSuppressed() const noexcept;
    void IsMenuSuppressed(bool value) const noexcept;
    bool IsMenuSuppressed() const noexcept;
};
...
{
    void AppController(Windows::UI::Input::RadialController const& value) const noexcept;
    Windows::UI::Input::RadialController AppController() const noexcept;
    void IsAppControllerEnabled(bool value) const noexcept;
    bool IsAppControllerEnabled() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Input::RadialControllerMenuItem> Items() const noexcept;
...
{
    double RotationDeltaInDegrees() const noexcept;
    Windows::UI::Input::RadialControllerScreenContact Contact() const noexcept;
};
...
template <> struct abi<Windows::UI::Input::ICrossSlidingEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_CrossSlidingState(Windows::UI::Input::CrossSlidingState* value) = 0;
};};
...
template <> struct abi<Windows::UI::Input::IDraggingEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_PointerDeviceType(Windows::Devices::Input::PointerDeviceType* value) = 0;
    virtual HRESULT __stdcall get_Position(Windows::Foundation::Point* value) = 0;
    virtual HRESULT __stdcall get_DraggingState(Windows::UI::Input::DraggingState* value) = 0;
};};

template <> struct abi<Windows::UI::Input::IEdgeGesture>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_Starting(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_Canceled(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Kind(Windows::UI::Input::EdgeGestureKind* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_GestureSettings(Windows::UI::Input::GestureSettings* value) = 0;
    virtual HRESULT __stdcall put_GestureSettings(Windows::UI::Input::GestureSettings value) = 0;
    ...
    virtual HRESULT __stdcall get_CrossSlideThresholds(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_CrossSlideThresholds(struct_of<16> value) = 0;
    ...
    virtual HRESULT __stdcall add_Tapped(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_Tapped(event_token cookie) = 0;
    virtual HRESULT __stdcall add_RightTapped(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_RightTapped(event_token cookie) = 0;
    virtual HRESULT __stdcall add_Holding(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_Holding(event_token cookie) = 0;
    virtual HRESULT __stdcall add_Dragging(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_Dragging(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ManipulationStarted(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_ManipulationStarted(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ManipulationUpdated(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_ManipulationUpdated(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ManipulationInertiaStarting(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_ManipulationInertiaStarting(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ManipulationCompleted(::IUnknown* handler, event_token* pCookie) = 0;
    virtual HRESULT __stdcall remove_ManipulationCompleted(event_token cookie) = 0;
    virtual HRESULT __stdcall add_CrossSliding(::IUnknown* handler, event_token* pCookie) = 0;
...
template <> struct abi<Windows::UI::Input::IKeyboardDeliveryInterceptor>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_KeyDown(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_KeyDown(event_token token) = 0;
    virtual HRESULT __stdcall add_KeyUp(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Input::IPointerPointProperties>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PointerUpdateKind(Windows::UI::Input::PointerUpdateKind* value) = 0;
...
template <> struct abi<Windows::UI::Input::IRadialController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ScreenContactStarted(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ScreenContactStarted(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ScreenContactEnded(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ScreenContactEnded(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ScreenContactContinued(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ScreenContactContinued(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ControlLost(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ControlLost(event_token cookie) = 0;
    virtual HRESULT __stdcall add_RotationChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RotationChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_ButtonClicked(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ButtonClicked(event_token token) = 0;
    virtual HRESULT __stdcall add_ControlAcquired(::IUnknown* handler, event_token* cookie) = 0;
...
template <> struct abi<Windows::UI::Input::IRadialController2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ButtonHolding(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ButtonHolding(event_token token) = 0;
    virtual HRESULT __stdcall add_ButtonReleased(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Input::IRadialControllerConfiguration>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TrySelectDefaultMenuItem(Windows::UI::Input::RadialControllerSystemMenuItemKind type, bool* result) = 0;
};};
...
{
    virtual HRESULT __stdcall put_AppController(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_AppController(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_IsAppControllerEnabled(bool value) = 0;
    virtual HRESULT __stdcall get_IsAppControllerEnabled(bool* value) = 0;
};};
...
template <> struct abi<Windows::UI::Input::IRadialControllerMenuItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Invoked(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Input::IRadialControllerMenuItemStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateFromKnownIcon(HSTRING displayText, Windows::UI::Input::RadialControllerMenuKnownIcon value, ::IUnknown** result) = 0;
};};
