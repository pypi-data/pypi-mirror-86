...
{
    Windows::ApplicationModel::Store::LicenseInformation LicenseInformation() const noexcept;
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::ProductLicense> ProductLicenses() const noexcept;
...
{
    hstring CurrentMarket() const noexcept;
    hstring Description() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::ProductListing> ProductListings() const noexcept;
    hstring FormattedPrice() const noexcept;
    hstring Name() const noexcept;
    uint32_t AgeRating() const noexcept;
};
...
{
    bool IsConsumable() const noexcept;
};
...
{
    Windows::ApplicationModel::Store::ProductType ProductType() const noexcept;
};
...
{
    hstring Description() const noexcept;
    Windows::Foundation::Collections::IIterable<hstring> Keywords() const noexcept;
    Windows::ApplicationModel::Store::ProductType ProductType() const noexcept;
...
struct consume_Windows_ApplicationModel_Store_IProductPurchaseDisplayProperties
{
    ...
    Windows::Foundation::Uri Image() const noexcept;
    void Image(Windows::Foundation::Uri const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Store::ProductPurchaseStatus Status() const noexcept;
    GUID TransactionId() const noexcept;
    hstring ReceiptXml() const noexcept;
    hstring OfferId() const noexcept;
};
...
{
    virtual HRESULT __stdcall ReportConsumableFulfillmentAsync(HSTRING productId, GUID transactionId, ::IUnknown** reportConsumableFulfillmentOperation) = 0;
...
template <> struct abi<Windows::ApplicationModel::Store::ILicenseInformation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LicenseChanged(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_ProductType(Windows::ApplicationModel::Store::ProductType* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Store::ProductPurchaseStatus* value) = 0;
