...
{
    Windows::Foundation::Deferral GetDeferral() const;
    bool HasPreviousContentExpired() const noexcept;
};
...
struct consume_Windows_Services_TargetedContent_ITargetedContentCollection
{
    ...
    Windows::Foundation::Collections::IMapView<hstring, Windows::Services::TargetedContent::TargetedContentValue> Properties() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentCollection> Collections() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentItem> Items() const noexcept;
};
...
struct consume_Windows_Services_TargetedContent_ITargetedContentContainer
{
    ...
    Windows::Services::TargetedContent::TargetedContentAvailability Availability() const noexcept;
    Windows::Services::TargetedContent::TargetedContentCollection Content() const noexcept;
...
struct consume_Windows_Services_TargetedContent_ITargetedContentItem
{
    ...
    void ReportInteraction(Windows::Services::TargetedContent::TargetedContentInteraction const& interaction) const;
    void ReportCustomInteraction(param::hstring const& customInteractionName) const;
    Windows::Services::TargetedContent::TargetedContentItemState State() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::Services::TargetedContent::TargetedContentValue> Properties() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentCollection> Collections() const noexcept;
};
...
struct consume_Windows_Services_TargetedContent_ITargetedContentItemState
{
    ...
    Windows::Services::TargetedContent::TargetedContentAppInstallationState AppInstallationState() const noexcept;
};
...
{
    Windows::Services::TargetedContent::TargetedContentObjectKind ObjectKind() const noexcept;
    Windows::Services::TargetedContent::TargetedContentCollection Collection() const noexcept;
    Windows::Services::TargetedContent::TargetedContentItem Item() const noexcept;
    Windows::Services::TargetedContent::TargetedContentValue Value() const noexcept;
};
...
{
    hstring SubscriptionId() const noexcept;
    bool AllowPartialContentAvailability() const noexcept;
    void AllowPartialContentAvailability(bool value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> CloudQueryParameters() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> LocalFilters() const noexcept;
    void Update() const;
};
...
{
    Windows::Services::TargetedContent::TargetedContentValueKind ValueKind() const noexcept;
    hstring Path() const noexcept;
    hstring String() const noexcept;
    Windows::Foundation::Uri Uri() const noexcept;
    double Number() const noexcept;
    bool Boolean() const noexcept;
    Windows::Services::TargetedContent::TargetedContentFile File() const noexcept;
    Windows::Services::TargetedContent::TargetedContentImage ImageFile() const noexcept;
    Windows::Services::TargetedContent::TargetedContentAction Action() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Strings() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Foundation::Uri> Uris() const noexcept;
    Windows::Foundation::Collections::IVectorView<double> Numbers() const noexcept;
    Windows::Foundation::Collections::IVectorView<bool> Booleans() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentFile> Files() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentImage> ImageFiles() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentAction> Actions() const noexcept;
};
...
template <> struct abi<Windows::Services::TargetedContent::ITargetedContentCollection>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ReportInteraction(Windows::Services::TargetedContent::TargetedContentInteraction interaction) = 0;
...
template <> struct abi<Windows::Services::TargetedContent::ITargetedContentContainer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Availability(Windows::Services::TargetedContent::TargetedContentAvailability* value) = 0;
...
template <> struct abi<Windows::Services::TargetedContent::ITargetedContentItemState>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AppInstallationState(Windows::Services::TargetedContent::TargetedContentAppInstallationState* value) = 0;
};};

template <> struct abi<Windows::Services::TargetedContent::ITargetedContentObject>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ObjectKind(Windows::Services::TargetedContent::TargetedContentObjectKind* value) = 0;
...
template <> struct abi<Windows::Services::TargetedContent::ITargetedContentSubscription>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ContentChanged(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_ContentChanged(event_token cookie) = 0;
    virtual HRESULT __stdcall add_AvailabilityChanged(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_AvailabilityChanged(event_token cookie) = 0;
    virtual HRESULT __stdcall add_StateChanged(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_ValueKind(Windows::Services::TargetedContent::TargetedContentValueKind* value) = 0;
    virtual HRESULT __stdcall get_Path(HSTRING* value) = 0;
