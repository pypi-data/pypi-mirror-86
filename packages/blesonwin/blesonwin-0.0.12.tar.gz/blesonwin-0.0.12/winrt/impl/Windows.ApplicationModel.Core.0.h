...
template <> struct guid<Windows::ApplicationModel::Core::IAppListEntry2>{ static constexpr GUID value{ 0xD0A618AD,0xBF35,0x42AC,{ 0xAC,0x06,0x86,0xEE,0xEB,0x41,0xD0,0x4B } }; };
...
template <> struct guid<Windows::ApplicationModel::Core::ICoreApplication3>{ static constexpr GUID value{ 0xFEEC0D39,0x598B,0x4507,{ 0x8A,0x67,0x77,0x26,0x32,0x58,0x0A,0x57 } }; };
...
template <> struct guid<Windows::ApplicationModel::Core::ICoreApplicationView6>{ static constexpr GUID value{ 0xC119D49A,0x0679,0x49BA,{ 0x80,0x3F,0xB7,0x9C,0x5C,0xF3,0x4C,0xCA } }; };
...
{
    Windows::UI::Core::CoreWindow CoreWindow() const noexcept;
...
struct consume_Windows_ApplicationModel_Core_ICoreApplicationView3
{
    ...
    Windows::ApplicationModel::Core::CoreApplicationViewTitleBar TitleBar() const noexcept;
...
{
    void ExtendViewIntoTitleBar(bool value) const noexcept;
    bool ExtendViewIntoTitleBar() const noexcept;
    double SystemOverlayLeftInset() const noexcept;
    double SystemOverlayRightInset() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Core::CoreApplicationView> Views() const noexcept;
    ...
    Windows::ApplicationModel::Core::CoreApplicationView MainView() const noexcept;
};
...
{
    Windows::ApplicationModel::Core::UnhandledError UnhandledError() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplication>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Suspending(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Suspending(event_token token) = 0;
    virtual HRESULT __stdcall add_Resuming(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplication2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LeavingBackground(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LeavingBackground(event_token token) = 0;
    virtual HRESULT __stdcall add_EnteredBackground(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall RequestRestartAsync(HSTRING launchArguments, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestRestartForUserAsync(::IUnknown* user, HSTRING launchArguments, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationExit>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Exiting(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_UnhandledErrorDetected(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationView>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Activated(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationView3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_HostedViewClosing(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Core::ICoreApplicationViewTitleBar>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LayoutMetricsChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_IsVisibleChanged(::IUnknown* handler, event_token* token) = 0;
