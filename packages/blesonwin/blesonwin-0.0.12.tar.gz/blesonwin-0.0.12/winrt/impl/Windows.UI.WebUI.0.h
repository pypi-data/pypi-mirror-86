...
template <> struct guid<Windows::UI::WebUI::IWebUIActivationStatics3>{ static constexpr GUID value{ 0x91ABB686,0x1AF5,0x4445,{ 0xB4,0x9F,0x94,0x59,0xF4,0x0F,0xC8,0xDE } }; };
...
{
    Windows::UI::WebUI::ActivatedOperation ActivatedOperation() const noexcept;
};
...
{
    Windows::UI::WebUI::PrintContent Content() const noexcept;
    void Content(Windows::UI::WebUI::PrintContent const& value) const noexcept;
    float LeftMargin() const noexcept;
    void LeftMargin(float value) const noexcept;
    float TopMargin() const noexcept;
    void TopMargin(float value) const noexcept;
    float RightMargin() const noexcept;
    void RightMargin(float value) const noexcept;
    float BottomMargin() const noexcept;
    void BottomMargin(float value) const noexcept;
    bool EnableHeaderFooter() const noexcept;
    void EnableHeaderFooter(bool value) const noexcept;
    bool ShrinkToFit() const noexcept;
    void ShrinkToFit(bool value) const noexcept;
    float PercentScale() const noexcept;
    void PercentScale(float scalePercent) const noexcept;
    hstring PageRange() const noexcept;
...
struct consume_Windows_UI_WebUI_IWebUIBackgroundTaskInstance
{
    ...
    void Succeeded(bool succeeded) const noexcept;
};
...
{
    Windows::UI::WebUI::IWebUIBackgroundTaskInstance Current() const noexcept;
};
...
{
    Windows::UI::WebUI::WebUINavigatedOperation NavigatedOperation() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Content(Windows::UI::WebUI::PrintContent* value) = 0;
    virtual HRESULT __stdcall put_Content(Windows::UI::WebUI::PrintContent value) = 0;
...
template <> struct abi<Windows::UI::WebUI::IWebUIActivationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Navigated(::IUnknown* handler, event_token* token) = 0;
