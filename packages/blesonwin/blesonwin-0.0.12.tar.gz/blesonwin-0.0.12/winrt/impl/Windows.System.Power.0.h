...
{
    uint32_t LowUsageLevel() const noexcept;
    uint32_t NearMaxAcceptableUsageLevel() const noexcept;
    uint32_t MaxAcceptableUsageLevel() const noexcept;
    uint32_t ExcessiveUsageLevel() const noexcept;
    uint32_t NearTerminationUsageLevel() const noexcept;
    uint32_t TerminationUsageLevel() const noexcept;
    uint32_t RecentEnergyUsage() const noexcept;
    uint32_t RecentEnergyUsageLevel() const noexcept;
...
{
    Windows::System::Power::EnergySaverStatus EnergySaverStatus() const noexcept;
    ...
    Windows::System::Power::BatteryStatus BatteryStatus() const noexcept;
    ...
    Windows::System::Power::PowerSupplyStatus PowerSupplyStatus() const noexcept;
    ...
    int32_t RemainingChargePercent() const noexcept;
    ...
    Windows::Foundation::TimeSpan RemainingDischargeTime() const noexcept;
...
template <> struct abi<Windows::System::Power::IBackgroundEnergyManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RecentEnergyUsageIncreased(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RecentEnergyUsageIncreased(event_token token) = 0;
    virtual HRESULT __stdcall add_RecentEnergyUsageReturnedToLow(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_EnergySaverStatus(Windows::System::Power::EnergySaverStatus* value) = 0;
    virtual HRESULT __stdcall add_EnergySaverStatusChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_EnergySaverStatusChanged(event_token token) = 0;
    virtual HRESULT __stdcall get_BatteryStatus(Windows::System::Power::BatteryStatus* value) = 0;
    virtual HRESULT __stdcall add_BatteryStatusChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BatteryStatusChanged(event_token token) = 0;
    virtual HRESULT __stdcall get_PowerSupplyStatus(Windows::System::Power::PowerSupplyStatus* value) = 0;
    virtual HRESULT __stdcall add_PowerSupplyStatusChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_RemainingChargePercentChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_RemainingDischargeTimeChanged(::IUnknown* handler, event_token* token) = 0;
