...
struct consume_Windows_ApplicationModel_DataTransfer_DragDrop_Core_ICoreDragDropManager
{
    ...
    bool AreConcurrentOperationsEnabled() const noexcept;
    void AreConcurrentOperationsEnabled(bool value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_DataTransfer_DragDrop_Core_ICoreDragInfo
{
    ...
    Windows::ApplicationModel::DataTransfer::DragDrop::DragDropModifiers Modifiers() const noexcept;
...
{
    Windows::ApplicationModel::DataTransfer::DataPackageOperation AllowedOperations() const noexcept;
};
...
struct consume_Windows_ApplicationModel_DataTransfer_DragDrop_Core_ICoreDragOperation
{
    ...
    Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragUIContentMode DragUIContentMode() const noexcept;
    void DragUIContentMode(Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragUIContentMode const& value) const noexcept;
...
{
    Windows::ApplicationModel::DataTransfer::DataPackageOperation AllowedOperations() const noexcept;
    void AllowedOperations(Windows::ApplicationModel::DataTransfer::DataPackageOperation const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_DataTransfer_DragDrop_Core_ICoreDragUIOverride
{
    ...
    void IsContentVisible(bool value) const noexcept;
    hstring Caption() const noexcept;
    void Caption(param::hstring const& value) const noexcept;
    bool IsCaptionVisible() const noexcept;
    void IsCaptionVisible(bool value) const noexcept;
    bool IsGlyphVisible() const noexcept;
    void IsGlyphVisible(bool value) const noexcept;
    void Clear() const;
};
...
{
    virtual HRESULT __stdcall add_TargetRequested(::IUnknown* value, event_token* returnValue) = 0;
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Modifiers(Windows::ApplicationModel::DataTransfer::DragDrop::DragDropModifiers* value) = 0;
...
{
    virtual HRESULT __stdcall get_AllowedOperations(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragOperation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetDragUIContentFromSoftwareBitmapWithAnchorPoint(::IUnknown* softwareBitmap, Windows::Foundation::Point anchorPoint) = 0;
    virtual HRESULT __stdcall get_DragUIContentMode(Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragUIContentMode* value) = 0;
    virtual HRESULT __stdcall put_DragUIContentMode(Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragUIContentMode value) = 0;
...
{
    virtual HRESULT __stdcall get_AllowedOperations(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) = 0;
    virtual HRESULT __stdcall put_AllowedOperations(Windows::ApplicationModel::DataTransfer::DataPackageOperation value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragUIOverride>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetContentFromSoftwareBitmapWithAnchorPoint(::IUnknown* softwareBitmap, Windows::Foundation::Point anchorPoint) = 0;
