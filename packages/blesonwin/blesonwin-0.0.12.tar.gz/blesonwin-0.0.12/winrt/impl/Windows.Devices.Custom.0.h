...
{
    Windows::Devices::Custom::IOControlAccessMode AccessMode() const noexcept;
    Windows::Devices::Custom::IOControlBufferingMethod BufferingMethod() const noexcept;
    uint16_t Function() const noexcept;
    uint16_t DeviceType() const noexcept;
    uint32_t ControlCode() const noexcept;
};
...
{
    uint16_t Unknown() const noexcept;
};
...
{
    virtual HRESULT __stdcall GetDeviceSelector(GUID classGuid, HSTRING* value) = 0;
    virtual HRESULT __stdcall FromIdAsync(HSTRING deviceId, Windows::Devices::Custom::DeviceAccessMode desiredAccess, Windows::Devices::Custom::DeviceSharingMode sharingMode, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Devices::Custom::IIOControlCode>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_AccessMode(Windows::Devices::Custom::IOControlAccessMode* value) = 0;
    virtual HRESULT __stdcall get_BufferingMethod(Windows::Devices::Custom::IOControlBufferingMethod* value) = 0;
...
{
    virtual HRESULT __stdcall CreateIOControlCode(uint16_t deviceType, uint16_t function, Windows::Devices::Custom::IOControlAccessMode accessMode, Windows::Devices::Custom::IOControlBufferingMethod bufferingMethod, ::IUnknown** instance) = 0;
};};
