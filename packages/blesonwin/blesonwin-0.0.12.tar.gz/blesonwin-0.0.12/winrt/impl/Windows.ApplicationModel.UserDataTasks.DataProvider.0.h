...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskDataProviderConnection Connection() const noexcept;
};
...
{
    hstring TaskListId() const noexcept;
...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskListCompleteTaskRequest Request() const noexcept;
...
{
    hstring TaskListId() const noexcept;
    Windows::ApplicationModel::UserDataTasks::UserDataTask Task() const noexcept;
...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskListCreateOrUpdateTaskRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskListDeleteTaskRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskListSkipOccurrenceRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::UserDataTasks::DataProvider::UserDataTaskListSyncManagerSyncRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    virtual HRESULT __stdcall add_CreateOrUpdateTaskRequested(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_SkipOccurrenceRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SkipOccurrenceRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_CompleteTaskRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CompleteTaskRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_DeleteTaskRequested(::IUnknown* handler, event_token* token) = 0;
