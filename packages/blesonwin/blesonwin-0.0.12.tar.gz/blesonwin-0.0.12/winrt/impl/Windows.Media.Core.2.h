...
template <> struct is_struct<Windows::Media::Core::MseTimeRange>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Media::Core::TimedTextDouble>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Media::Core::TimedTextPadding>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Media::Core::TimedTextPoint>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Media::Core::TimedTextSize>
{
    static constexpr bool value{ true };
};
...
struct WINRT_EBO AudioStreamDescriptor :
    ...
    impl::require<AudioStreamDescriptor, Windows::Media::Core::IAudioStreamDescriptor2, Windows::Media::Core::IMediaStreamDescriptor2>
{
...
struct WINRT_EBO InitializeMediaStreamSourceRequestedEventArgs :
...
struct WINRT_EBO LowLightFusionResult :
...
struct WINRT_EBO MediaSourceAppServiceConnection :
...
struct WINRT_EBO VideoStreamDescriptor :
    ...
    impl::require<VideoStreamDescriptor, Windows::Media::Core::IMediaStreamDescriptor2>
{
