...
{
    Windows::Foundation::Numerics::float2 FocalLength() const noexcept;
    Windows::Foundation::Numerics::float2 PrincipalPoint() const noexcept;
    Windows::Foundation::Numerics::float3 RadialDistortion() const noexcept;
    Windows::Foundation::Numerics::float2 TangentialDistortion() const noexcept;
    uint32_t ImageWidth() const noexcept;
    uint32_t ImageHeight() const noexcept;
...
{
    Windows::Foundation::Numerics::float4x4 UndistortedProjectionTransform() const noexcept;
...
{
    Windows::Media::Devices::Core::FrameExposureCapabilities Exposure() const noexcept;
    Windows::Media::Devices::Core::FrameExposureCompensationCapabilities ExposureCompensation() const noexcept;
    Windows::Media::Devices::Core::FrameIsoSpeedCapabilities IsoSpeed() const noexcept;
    Windows::Media::Devices::Core::FrameFocusCapabilities Focus() const noexcept;
    bool PhotoConfirmationSupported() const noexcept;
};
...
{
    Windows::Media::Devices::Core::FrameFlashCapabilities Flash() const noexcept;
};
...
{
    Windows::Media::Devices::Core::FrameExposureControl ExposureControl() const noexcept;
    Windows::Media::Devices::Core::FrameExposureCompensationControl ExposureCompensationControl() const noexcept;
    Windows::Media::Devices::Core::FrameIsoSpeedControl IsoSpeedControl() const noexcept;
    Windows::Media::Devices::Core::FrameFocusControl FocusControl() const noexcept;
    Windows::Foundation::IReference<bool> PhotoConfirmationEnabled() const noexcept;
    void PhotoConfirmationEnabled(optional<bool> const& value) const noexcept;
};
...
{
    Windows::Media::Devices::Core::FrameFlashControl FlashControl() const noexcept;
};
...
{
    Windows::Foundation::IReference<float> Value() const noexcept;
    void Value(optional<float> const& value) const noexcept;
};
...
struct consume_Windows_Media_Devices_Core_IFrameExposureControl
{
    ...
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> Value() const noexcept;
    void Value(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
};
...
{
    Windows::Media::Devices::Core::FrameFlashMode Mode() const noexcept;
    void Mode(Windows::Media::Devices::Core::FrameFlashMode const& value) const noexcept;
    bool Auto() const noexcept;
    void Auto(bool value) const noexcept;
...
struct consume_Windows_Media_Devices_Core_IVariablePhotoSequenceController
{
    ...
    Windows::Media::Devices::Core::FrameControlCapabilities FrameCapabilities() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Devices::Core::FrameController> DesiredFrameControllers() const noexcept;
};
...
template <> struct abi<Windows::Media::Devices::Core::ICameraIntrinsics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ProjectOntoFrame(Windows::Foundation::Numerics::float3 coordinate, Windows::Foundation::Point* result) = 0;
    virtual HRESULT __stdcall UnprojectAtUnitDepth(Windows::Foundation::Point pixelCoordinate, Windows::Foundation::Numerics::float2* result) = 0;
    virtual HRESULT __stdcall ProjectManyOntoFrame(uint32_t __coordinatesSize, Windows::Foundation::Numerics::float3* coordinates, uint32_t __resultsSize, Windows::Foundation::Point* results) = 0;
    virtual HRESULT __stdcall UnprojectPixelsAtUnitDepth(uint32_t __pixelCoordinatesSize, Windows::Foundation::Point* pixelCoordinates, uint32_t __resultsSize, Windows::Foundation::Numerics::float2* results) = 0;
};};
...
template <> struct abi<Windows::Media::Devices::Core::ICameraIntrinsics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall DistortPoint(Windows::Foundation::Point input, Windows::Foundation::Point* result) = 0;
    virtual HRESULT __stdcall DistortPoints(uint32_t __inputsSize, Windows::Foundation::Point* inputs, uint32_t __resultsSize, Windows::Foundation::Point* results) = 0;
    virtual HRESULT __stdcall UndistortPoint(Windows::Foundation::Point input, Windows::Foundation::Point* result) = 0;
    virtual HRESULT __stdcall UndistortPoints(uint32_t __inputsSize, Windows::Foundation::Point* inputs, uint32_t __resultsSize, Windows::Foundation::Point* results) = 0;
};};

template <> struct abi<Windows::Media::Devices::Core::ICameraIntrinsicsFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::Foundation::Numerics::float2 focalLength, Windows::Foundation::Numerics::float2 principalPoint, Windows::Foundation::Numerics::float3 radialDistortion, Windows::Foundation::Numerics::float2 tangentialDistortion, uint32_t imageWidth, uint32_t imageHeight, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::Media::Devices::Core::IDepthCorrelatedCoordinateMapper>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall UnprojectPoint(Windows::Foundation::Point sourcePoint, ::IUnknown* targetCoordinateSystem, Windows::Foundation::Numerics::float3* result) = 0;
    virtual HRESULT __stdcall UnprojectPoints(uint32_t __sourcePointsSize, Windows::Foundation::Point* sourcePoints, ::IUnknown* targetCoordinateSystem, uint32_t __resultsSize, Windows::Foundation::Numerics::float3* results) = 0;
    virtual HRESULT __stdcall MapPoint(Windows::Foundation::Point sourcePoint, ::IUnknown* targetCoordinateSystem, ::IUnknown* targetCameraIntrinsics, Windows::Foundation::Point* result) = 0;
    virtual HRESULT __stdcall MapPoints(uint32_t __sourcePointsSize, Windows::Foundation::Point* sourcePoints, ::IUnknown* targetCoordinateSystem, ::IUnknown* targetCameraIntrinsics, uint32_t __resultsSize, Windows::Foundation::Point* results) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Mode(Windows::Media::Devices::Core::FrameFlashMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Devices::Core::FrameFlashMode value) = 0;
    virtual HRESULT __stdcall get_Auto(bool* value) = 0;
    virtual HRESULT __stdcall put_Auto(bool value) = 0;
