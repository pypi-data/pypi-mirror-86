...
template <> struct abi<Windows::System::Threading::Core::IPreallocatedWorkItemFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWorkItemWithPriority(::IUnknown* handler, Windows::System::Threading::WorkItemPriority priority, ::IUnknown** WorkItem) = 0;
    virtual HRESULT __stdcall CreateWorkItemWithPriorityAndOptions(::IUnknown* handler, Windows::System::Threading::WorkItemPriority priority, Windows::System::Threading::WorkItemOptions options, ::IUnknown** WorkItem) = 0;
};};
...
template <> struct abi<Windows::System::Threading::Core::ISignalNotifierStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AttachToEventWithTimeout(HSTRING name, ::IUnknown* handler, Windows::Foundation::TimeSpan timeout, ::IUnknown** signalNotifier) = 0;
    virtual HRESULT __stdcall AttachToSemaphore(HSTRING name, ::IUnknown* handler, ::IUnknown** signalNotifier) = 0;
    virtual HRESULT __stdcall AttachToSemaphoreWithTimeout(HSTRING name, ::IUnknown* handler, Windows::Foundation::TimeSpan timeout, ::IUnknown** signalNotifier) = 0;
};};
