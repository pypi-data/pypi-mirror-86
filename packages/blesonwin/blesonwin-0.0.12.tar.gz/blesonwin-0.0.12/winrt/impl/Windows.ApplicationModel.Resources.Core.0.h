...
struct consume_Windows_ApplicationModel_Resources_Core_INamedResource
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Resources::Core::ResourceCandidate> Candidates() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Resources::Core::ResourceQualifier> Qualifiers() const noexcept;
    bool IsMatch() const noexcept;
    bool IsMatchAsDefault() const noexcept;
    bool IsDefault() const noexcept;
    hstring ValueAsString() const noexcept;
...
{
    Windows::Foundation::Collections::IObservableMap<hstring, hstring> QualifierValues() const noexcept;
    void Reset() const;
    ...
    void Languages(param::async_vector_view<hstring> const& languages) const noexcept;
};
...
{
    Windows::ApplicationModel::Resources::Core::ResourceMap MainResourceMap() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Resources::Core::ResourceMap> AllResourceMaps() const noexcept;
    [[deprecated("DefaultContext may be altered or unavailable for releases after Windows Phone 'OSVersion' (TBD). Instead, use ResourceContext.GetForCurrentView.")]] Windows::ApplicationModel::Resources::Core::ResourceContext DefaultContext() const noexcept;
...
{
    Windows::ApplicationModel::Resources::Core::ResourceManager Current() const noexcept;
...
{
    hstring QualifierName() const noexcept;
    hstring QualifierValue() const noexcept;
    bool IsDefault() const noexcept;
    bool IsMatch() const noexcept;
...
{
    virtual HRESULT __stdcall SetGlobalQualifierValueWithPersistence(HSTRING key, HSTRING value, Windows::ApplicationModel::Resources::Core::ResourceQualifierPersistence persistence) = 0;
};};
...
{
    virtual HRESULT __stdcall GetAllNamedResourcesForPackage(HSTRING packageName, struct_of<20> resourceLayoutInfo, ::IUnknown** table) = 0;
    virtual HRESULT __stdcall GetAllSubtreesForPackage(HSTRING packageName, struct_of<20> resourceLayoutInfo, ::IUnknown** table) = 0;
};};
