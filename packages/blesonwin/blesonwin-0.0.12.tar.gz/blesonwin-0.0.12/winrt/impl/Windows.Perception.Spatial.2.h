...
template <> struct is_struct<Windows::Perception::Spatial::SpatialBoundingBox>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Perception::Spatial::SpatialBoundingFrustum>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Perception::Spatial::SpatialBoundingOrientedBox>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Perception::Spatial::SpatialBoundingSphere>
{
    static constexpr bool value{ true };
};
