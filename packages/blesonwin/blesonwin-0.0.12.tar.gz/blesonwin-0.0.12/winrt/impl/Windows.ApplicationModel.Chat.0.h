...
struct consume_Windows_ApplicationModel_Chat_IChatCapabilities
{
    ...
    bool IsChatCapable() const noexcept;
    bool IsFileTransferCapable() const noexcept;
    bool IsGeoLocationPushCapable() const noexcept;
    bool IsIntegratedMessagingCapable() const noexcept;
};
...
{
    bool HasUnreadMessages() const noexcept;
    hstring Id() const noexcept;
    hstring Subject() const noexcept;
    void Subject(param::hstring const& value) const noexcept;
    bool IsConversationMuted() const noexcept;
    void IsConversationMuted(bool value) const noexcept;
    hstring MostRecentMessageId() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Participants() const noexcept;
    Windows::ApplicationModel::Chat::ChatConversationThreadingInfo ThreadingInfo() const noexcept;
...
{
    bool CanModifyParticipants() const noexcept;
    void CanModifyParticipants(bool value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Chat_IChatConversationThreadingInfo
{
    ...
    hstring Custom() const noexcept;
    void Custom(param::hstring const& value) const noexcept;
    hstring ConversationId() const noexcept;
    void ConversationId(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Participants() const noexcept;
    Windows::ApplicationModel::Chat::ChatConversationThreadingKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Chat::ChatConversationThreadingKind const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::ChatItemKind ItemKind() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Chat::ChatMessageAttachment> Attachments() const noexcept;
    hstring Body() const noexcept;
    void Body(param::hstring const& value) const noexcept;
    hstring From() const noexcept;
    hstring Id() const noexcept;
    bool IsForwardingDisabled() const noexcept;
    bool IsIncoming() const noexcept;
    bool IsRead() const noexcept;
    Windows::Foundation::DateTime LocalTimestamp() const noexcept;
    Windows::Foundation::DateTime NetworkTimestamp() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Recipients() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Chat::ChatMessageStatus> RecipientSendStatuses() const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageStatus Status() const noexcept;
    hstring Subject() const noexcept;
    hstring TransportFriendlyName() const noexcept;
    hstring TransportId() const noexcept;
    void TransportId(param::hstring const& value) const noexcept;
};
...
{
    uint64_t EstimatedDownloadSize() const noexcept;
    void EstimatedDownloadSize(uint64_t value) const noexcept;
    void From(param::hstring const& value) const noexcept;
    bool IsAutoReply() const noexcept;
    void IsAutoReply(bool value) const noexcept;
    void IsForwardingDisabled(bool value) const noexcept;
    bool IsReplyDisabled() const noexcept;
    ...
    bool IsSimMessage() const noexcept;
    void LocalTimestamp(Windows::Foundation::DateTime const& value) const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageKind MessageKind() const noexcept;
    void MessageKind(Windows::ApplicationModel::Chat::ChatMessageKind const& value) const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageOperatorKind MessageOperatorKind() const noexcept;
    void MessageOperatorKind(Windows::ApplicationModel::Chat::ChatMessageOperatorKind const& value) const noexcept;
    void NetworkTimestamp(Windows::Foundation::DateTime const& value) const noexcept;
    bool IsReceivedDuringQuietHours() const noexcept;
    void IsReceivedDuringQuietHours(bool value) const noexcept;
    void RemoteId(param::hstring const& value) const noexcept;
    void Status(Windows::ApplicationModel::Chat::ChatMessageStatus const& value) const noexcept;
    void Subject(param::hstring const& value) const noexcept;
    bool ShouldSuppressNotification() const noexcept;
    void ShouldSuppressNotification(bool value) const noexcept;
    Windows::ApplicationModel::Chat::ChatConversationThreadingInfo ThreadingInfo() const noexcept;
    void ThreadingInfo(Windows::ApplicationModel::Chat::ChatConversationThreadingInfo const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Chat::ChatRecipientDeliveryInfo> RecipientsDeliveryInfos() const noexcept;
};
...
{
    hstring SyncId() const noexcept;
    void SyncId(param::hstring const& value) const noexcept;
};
...
{
    Windows::Storage::Streams::IRandomAccessStreamReference DataStreamReference() const noexcept;
    void DataStreamReference(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    uint32_t GroupId() const noexcept;
    void GroupId(uint32_t value) const noexcept;
...
struct consume_Windows_ApplicationModel_Chat_IChatMessageAttachment2
{
    ...
    double TransferProgress() const noexcept;
    void TransferProgress(double value) const noexcept;
    hstring OriginalFileName() const noexcept;
    void OriginalFileName(param::hstring const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::ChatMessageChangeType ChangeType() const noexcept;
    Windows::ApplicationModel::Chat::ChatMessage Message() const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::ChatMessage ChatMessage() const noexcept;
};
...
{
    bool ShouldDisplayToast() const noexcept;
    bool ShouldUpdateDetailText() const noexcept;
    bool ShouldUpdateBadge() const noexcept;
    bool ShouldUpdateActionCenter() const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::ChatMessageChangeTracker ChangeTracker() const noexcept;
...
{
    hstring Id() const noexcept;
    Windows::ApplicationModel::Chat::ChatStoreChangedEventKind Kind() const noexcept;
};
...
{
    bool IsAppSetAsNotificationProvider() const noexcept;
...
{
    Windows::ApplicationModel::Chat::ChatMessageTransportConfiguration Configuration() const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageTransportKind TransportKind() const noexcept;
};
...
{
    int32_t MaxAttachmentCount() const noexcept;
    int32_t MaxMessageSizeInKilobytes() const noexcept;
    int32_t MaxRecipientCount() const noexcept;
    Windows::Media::MediaProperties::MediaEncodingProfile SupportedVideoFormat() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::Foundation::IInspectable> ExtendedProperties() const noexcept;
};
...
{
    Windows::Foundation::IReference<uint32_t> MaxPartCount() const noexcept;
    Windows::Foundation::IReference<uint32_t> PartCount() const noexcept;
    Windows::Foundation::IReference<uint32_t> RemainingCharacterCountInPart() const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageValidationStatus Status() const noexcept;
};
...
{
    hstring SearchString() const noexcept;
    void SearchString(param::hstring const& value) const noexcept;
};
...
{
    hstring TransportAddress() const noexcept;
    void TransportAddress(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> DeliveryTime() const noexcept;
    void DeliveryTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ReadTime() const noexcept;
    void ReadTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Chat::ChatTransportErrorCodeCategory TransportErrorCodeCategory() const noexcept;
    Windows::ApplicationModel::Chat::ChatTransportInterpretedErrorCode TransportInterpretedErrorCode() const noexcept;
    int32_t TransportErrorCode() const noexcept;
    bool IsErrorPermanent() const noexcept;
    Windows::ApplicationModel::Chat::ChatMessageStatus Status() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Chat_IChatSyncConfiguration
{
    ...
    Windows::ApplicationModel::Chat::ChatRestoreHistorySpan RestoreHistorySpan() const noexcept;
    void RestoreHistorySpan(Windows::ApplicationModel::Chat::ChatRestoreHistorySpan const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::ChatSyncConfiguration Configuration() const noexcept;
...
struct consume_Windows_ApplicationModel_Chat_IRcsEndUserMessage
{
    ...
    hstring Text() const noexcept;
    bool IsPinRequired() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Chat::RcsEndUserMessageAction> Actions() const noexcept;
...
struct consume_Windows_ApplicationModel_Chat_IRcsEndUserMessageAvailableEventArgs
{
    ...
    Windows::ApplicationModel::Chat::RcsEndUserMessage Message() const noexcept;
};
...
{
    Windows::ApplicationModel::Chat::RcsServiceKind ServiceKind() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Chat_IRcsTransport
{
    ...
    hstring TransportFriendlyName() const noexcept;
    hstring TransportId() const noexcept;
    Windows::ApplicationModel::Chat::RcsTransportConfiguration Configuration() const noexcept;
...
struct consume_Windows_ApplicationModel_Chat_IRcsTransportConfiguration
{
    int32_t MaxAttachmentCount() const noexcept;
    int32_t MaxMessageSizeInKilobytes() const noexcept;
    int32_t MaxGroupMessageSizeInKilobytes() const noexcept;
    int32_t MaxRecipientCount() const noexcept;
    int32_t MaxFileSizeInKilobytes() const noexcept;
    int32_t WarningFileSizeInKilobytes() const noexcept;
};
...
{
    hstring TransportId() const noexcept;
    hstring ParticipantAddress() const noexcept;
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatConversation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall MarkMessagesAsReadAsync(Windows::Foundation::DateTime value, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall add_RemoteParticipantComposingChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatConversationThreadingInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Participants(::IUnknown** result) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Chat::ChatConversationThreadingKind* result) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Chat::ChatConversationThreadingKind value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Chat::IChatItem>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ItemKind(Windows::ApplicationModel::Chat::ChatItemKind* result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessage>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Chat::ChatMessageStatus* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessage2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MessageKind(Windows::ApplicationModel::Chat::ChatMessageKind* result) = 0;
    virtual HRESULT __stdcall put_MessageKind(Windows::ApplicationModel::Chat::ChatMessageKind value) = 0;
    virtual HRESULT __stdcall get_MessageOperatorKind(Windows::ApplicationModel::Chat::ChatMessageOperatorKind* result) = 0;
    virtual HRESULT __stdcall put_MessageOperatorKind(Windows::ApplicationModel::Chat::ChatMessageOperatorKind value) = 0;
    ...
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Chat::ChatMessageStatus value) = 0;
    virtual HRESULT __stdcall put_Subject(HSTRING value) = 0;
...
{
    virtual HRESULT __stdcall get_ChangeType(Windows::ApplicationModel::Chat::ChatMessageChangeType* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessageStore>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetMessageReader2(Windows::Foundation::TimeSpan recentTimeLimit, ::IUnknown** value) = 0;
    ...
    virtual HRESULT __stdcall add_MessageChanged(::IUnknown* value, event_token* returnValue) = 0;
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessageStore2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_StoreChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Id(HSTRING* result) = 0;
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Chat::ChatStoreChangedEventKind* result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessageTransport2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TransportKind(Windows::ApplicationModel::Chat::ChatMessageTransportKind* result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatMessageValidationResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Chat::ChatMessageValidationStatus* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatRecipientDeliveryInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TransportErrorCodeCategory(Windows::ApplicationModel::Chat::ChatTransportErrorCodeCategory* result) = 0;
    virtual HRESULT __stdcall get_TransportInterpretedErrorCode(Windows::ApplicationModel::Chat::ChatTransportInterpretedErrorCode* result) = 0;
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Chat::ChatMessageStatus* result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IChatSyncConfiguration>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RestoreHistorySpan(Windows::ApplicationModel::Chat::ChatRestoreHistorySpan* result) = 0;
    virtual HRESULT __stdcall put_RestoreHistorySpan(Windows::ApplicationModel::Chat::ChatRestoreHistorySpan value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_MessageAvailableChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_ServiceKind(Windows::ApplicationModel::Chat::RcsServiceKind* result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Chat::IRcsTransport>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TransportId(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Configuration(::IUnknown** result) = 0;
    virtual HRESULT __stdcall IsStoreAndForwardEnabled(Windows::ApplicationModel::Chat::RcsServiceKind serviceKind, bool* result) = 0;
    virtual HRESULT __stdcall IsServiceKindSupported(Windows::ApplicationModel::Chat::RcsServiceKind serviceKind, bool* result) = 0;
    virtual HRESULT __stdcall add_ServiceKindSupportedChanged(::IUnknown* handler, event_token* token) = 0;
