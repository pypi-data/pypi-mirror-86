...
{
    Windows::UI::Notifications::Management::UserNotificationListener Current() const noexcept;
};
...
template <> struct abi<Windows::UI::Notifications::Management::IUserNotificationListener>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetAccessStatus(Windows::UI::Notifications::Management::UserNotificationListenerAccessStatus* accessStatus) = 0;
    virtual HRESULT __stdcall add_NotificationChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_NotificationChanged(event_token token) = 0;
    virtual HRESULT __stdcall GetNotificationsAsync(Windows::UI::Notifications::NotificationKinds kinds, ::IUnknown** result) = 0;
