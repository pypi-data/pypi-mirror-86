...
struct consume_Windows_Devices_Sms_ISmsAppMessage
{
    ...
    hstring To() const noexcept;
    void To(param::hstring const& value) const noexcept;
    hstring From() const noexcept;
    hstring Body() const noexcept;
    void Body(param::hstring const& value) const noexcept;
    hstring CallbackNumber() const noexcept;
    void CallbackNumber(param::hstring const& value) const noexcept;
    bool IsDeliveryNotificationEnabled() const noexcept;
    void IsDeliveryNotificationEnabled(bool value) const noexcept;
    int32_t RetryAttemptCount() const noexcept;
    void RetryAttemptCount(int32_t value) const noexcept;
    Windows::Devices::Sms::SmsEncoding Encoding() const noexcept;
    void Encoding(Windows::Devices::Sms::SmsEncoding const& value) const noexcept;
    int32_t PortNumber() const noexcept;
    void PortNumber(int32_t value) const noexcept;
    int32_t TeleserviceId() const noexcept;
    void TeleserviceId(int32_t value) const noexcept;
    int32_t ProtocolId() const noexcept;
    void ProtocolId(int32_t value) const noexcept;
    Windows::Storage::Streams::IBuffer BinaryBody() const noexcept;
    void BinaryBody(Windows::Storage::Streams::IBuffer const& value) const noexcept;
};
...
{
    [[deprecated("SmsBinaryMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsAppMessage.")]] Windows::Devices::Sms::SmsDataFormat Format() const noexcept;
    [[deprecated("SmsBinaryMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsAppMessage.")]] void Format(Windows::Devices::Sms::SmsDataFormat const& value) const noexcept;
...
struct consume_Windows_Devices_Sms_ISmsBroadcastMessage
{
    ...
    Windows::Devices::Sms::SmsGeographicalScope GeographicalScope() const noexcept;
    int32_t MessageCode() const noexcept;
    int32_t UpdateNumber() const noexcept;
    Windows::Devices::Sms::SmsBroadcastType BroadcastType() const noexcept;
    bool IsEmergencyAlert() const noexcept;
    bool IsUserPopupRequested() const noexcept;
};
...
struct consume_Windows_Devices_Sms_ISmsDevice
{
    ...
    [[deprecated("SmsDevice may be altered or unavailable for releases after Windows 10. Instead, use SmsDevice2.")]] hstring AccountPhoneNumber() const noexcept;
    [[deprecated("SmsDevice may be altered or unavailable for releases after Windows 10. Instead, use SmsDevice2.")]] Windows::Devices::Sms::CellularClass CellularClass() const noexcept;
    [[deprecated("SmsDevice may be altered or unavailable for releases after Windows 10. Instead, use SmsDevice2.")]] Windows::Devices::Sms::SmsDeviceMessageStore MessageStore() const noexcept;
    [[deprecated("SmsDevice may be altered or unavailable for releases after Windows 10. Instead, use SmsDevice2.")]] Windows::Devices::Sms::SmsDeviceStatus DeviceStatus() const noexcept;
...
{
    hstring SmscAddress() const noexcept;
    void SmscAddress(param::hstring const& value) const noexcept;
    hstring DeviceId() const noexcept;
    hstring ParentDeviceId() const noexcept;
    hstring AccountPhoneNumber() const noexcept;
    Windows::Devices::Sms::CellularClass CellularClass() const noexcept;
    Windows::Devices::Sms::SmsDeviceStatus DeviceStatus() const noexcept;
...
struct consume_Windows_Devices_Sms_ISmsDeviceMessageStore
{
    ...
    [[deprecated("SmsDeviceMessageStore may be altered or unavailable for releases after Windows 10.")]] uint32_t MaxMessages() const noexcept;
};
...
{
    Windows::Devices::Sms::SmsMessageType MessageType() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> ImsiPrefixes() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DeviceIds() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> SenderNumbers() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> TextMessagePrefixes() const noexcept;
    Windows::Foundation::Collections::IVector<int32_t> PortNumbers() const noexcept;
    Windows::Devices::Sms::CellularClass CellularClass() const noexcept;
    void CellularClass(Windows::Devices::Sms::CellularClass const& value) const noexcept;
    Windows::Foundation::Collections::IVector<int32_t> ProtocolIds() const noexcept;
    Windows::Foundation::Collections::IVector<int32_t> TeleserviceIds() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> WapApplicationIds() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> WapContentTypes() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Devices::Sms::SmsBroadcastType> BroadcastTypes() const noexcept;
    Windows::Foundation::Collections::IVector<int32_t> BroadcastChannels() const noexcept;
};
...
{
    Windows::Devices::Sms::SmsFilterActionType ActionType() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Devices::Sms::SmsFilterRule> Rules() const noexcept;
};
...
struct consume_Windows_Devices_Sms_ISmsMessage
{
    ...
    Windows::Devices::Sms::SmsMessageClass MessageClass() const noexcept;
};
...
{
    [[deprecated("SmsMessageReceivedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Devices::Sms::SmsTextMessage TextMessage() const noexcept;
    [[deprecated("SmsMessageReceivedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Devices::Sms::SmsBinaryMessage BinaryMessage() const noexcept;
};
...
{
    Windows::Devices::Sms::SmsMessageType MessageType() const noexcept;
    Windows::Devices::Sms::SmsTextMessage2 TextMessage() const noexcept;
    Windows::Devices::Sms::SmsWapMessage WapMessage() const noexcept;
    Windows::Devices::Sms::SmsAppMessage AppMessage() const noexcept;
    Windows::Devices::Sms::SmsBroadcastMessage BroadcastMessage() const noexcept;
    Windows::Devices::Sms::SmsVoicemailMessage VoicemailMessage() const noexcept;
    Windows::Devices::Sms::SmsStatusMessage StatusMessage() const noexcept;
    void Drop() const;
    void Accept() const;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Devices::Sms::SmsMessageRegistration> AllRegistrations() const noexcept;
...
{
    [[deprecated("SmsReceivedEventDetails may be altered or unavailable for releases after Windows 10. Instead, use SmsMessageReceivedTriggerDetails.")]] hstring DeviceId() const noexcept;
    [[deprecated("SmsReceivedEventDetails may be altered or unavailable for releases after Windows 10. Instead, use SmsMessageReceivedTriggerDetails.")]] uint32_t MessageIndex() const noexcept;
};
...
{
    [[deprecated("SmsReceivedEventDetails may be altered or unavailable for releases after Windows 10. Instead, use SmsMessageReceivedTriggerDetails.")]] Windows::Devices::Sms::SmsMessageClass MessageClass() const noexcept;
    [[deprecated("SmsReceivedEventDetails may be altered or unavailable for releases after Windows 10. Instead, use SmsMessageReceivedTriggerDetails.")]] Windows::Devices::Sms::SmsBinaryMessage BinaryMessage() const noexcept;
};
...
struct consume_Windows_Devices_Sms_ISmsSendMessageResult
{
    ...
    Windows::Foundation::Collections::IVectorView<int32_t> MessageReferenceNumbers() const noexcept;
    Windows::Devices::Sms::CellularClass CellularClass() const noexcept;
    Windows::Devices::Sms::SmsModemErrorCode ModemErrorCode() const noexcept;
    bool IsErrorTransient() const noexcept;
    int32_t NetworkCauseCode() const noexcept;
    int32_t TransportFailureCause() const noexcept;
};
...
struct consume_Windows_Devices_Sms_ISmsStatusMessage
{
    ...
    int32_t MessageReferenceNumber() const noexcept;
    Windows::Foundation::DateTime ServiceCenterTimestamp() const noexcept;
    Windows::Foundation::DateTime DischargeTime() const noexcept;
};
...
{
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] Windows::Foundation::DateTime Timestamp() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] uint32_t PartReferenceId() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] uint32_t PartNumber() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] uint32_t PartCount() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] hstring To() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] void To(param::hstring const& value) const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] hstring From() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] void From(param::hstring const& value) const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] hstring Body() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] void Body(param::hstring const& value) const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] Windows::Devices::Sms::SmsEncoding Encoding() const noexcept;
    [[deprecated("SmsTextMessage may be altered or unavailable for releases after Windows 10. Instead, use SmsTextMessage2.")]] void Encoding(Windows::Devices::Sms::SmsEncoding const& value) const noexcept;
...
struct consume_Windows_Devices_Sms_ISmsVoicemailMessage
{
    ...
    hstring To() const noexcept;
    hstring Body() const noexcept;
    Windows::Foundation::IReference<int32_t> MessageCount() const noexcept;
};
...
struct consume_Windows_Devices_Sms_ISmsWapMessage
{
    ...
    hstring To() const noexcept;
    hstring From() const noexcept;
    hstring ApplicationId() const noexcept;
    hstring ContentType() const noexcept;
    Windows::Storage::Streams::IBuffer BinaryBody() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> Headers() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Format(Windows::Devices::Sms::SmsDataFormat* value) = 0;
    virtual HRESULT __stdcall put_Format(Windows::Devices::Sms::SmsDataFormat value) = 0;
...
template <> struct abi<Windows::Devices::Sms::ISmsDevice>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CalculateLength(::IUnknown* message, struct_of<20>* encodedLength) = 0;
    ...
    virtual HRESULT __stdcall add_SmsMessageReceived(::IUnknown* eventHandler, event_token* eventCookie) = 0;
    virtual HRESULT __stdcall remove_SmsMessageReceived(event_token eventCookie) = 0;
    virtual HRESULT __stdcall add_SmsDeviceStatusChanged(::IUnknown* eventHandler, event_token* eventCookie) = 0;
...
template <> struct abi<Windows::Devices::Sms::ISmsDeviceMessageStore>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall DeleteMessagesAsync(Windows::Devices::Sms::SmsMessageFilter messageFilter, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall GetMessageAsync(uint32_t messageId, ::IUnknown** asyncInfo) = 0;
    virtual HRESULT __stdcall GetMessagesAsync(Windows::Devices::Sms::SmsMessageFilter messageFilter, ::IUnknown** asyncInfo) = 0;
...
template <> struct abi<Windows::Devices::Sms::ISmsTextMessage>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Encoding(Windows::Devices::Sms::SmsEncoding* value) = 0;
    virtual HRESULT __stdcall put_Encoding(Windows::Devices::Sms::SmsEncoding value) = 0;
    virtual HRESULT __stdcall ToBinaryMessages(Windows::Devices::Sms::SmsDataFormat format, ::IUnknown** messages) = 0;
};};
...
template <> struct abi<Windows::Devices::Sms::ISmsTextMessageStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FromBinaryData(Windows::Devices::Sms::SmsDataFormat format, uint32_t __valueSize, uint8_t* value, ::IUnknown** textMessage) = 0;
};};
