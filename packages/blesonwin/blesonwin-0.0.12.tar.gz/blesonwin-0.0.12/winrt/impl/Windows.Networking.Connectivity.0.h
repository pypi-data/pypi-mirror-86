...
template<> struct is_enum_flag<Windows::Networking::Connectivity::NetworkTypes> : std::true_type {};
template<> struct is_enum_flag<Windows::Networking::Connectivity::RoamingStates> : std::true_type {};
template<> struct is_enum_flag<Windows::Networking::Connectivity::WwanDataClass> : std::true_type {};
...
template <> struct name<Windows::Networking::Connectivity::IProviderNetworkUsage>{ static constexpr auto & value{ L"Windows.Networking.Connectivity.IProviderNetworkUsage" }; };
...
template <> struct name<Windows::Networking::Connectivity::ProviderNetworkUsage>{ static constexpr auto & value{ L"Windows.Networking.Connectivity.ProviderNetworkUsage" }; };
...
{
    uint64_t BytesSent() const noexcept;
    uint64_t BytesReceived() const noexcept;
    hstring AttributionId() const noexcept;
    hstring AttributionName() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference AttributionThumbnail() const noexcept;
};
...
struct consume_Windows_Networking_Connectivity_ICellularApnContext
{
    ...
    void ProviderId(param::hstring const& value) const noexcept;
    hstring AccessPointName() const noexcept;
    void AccessPointName(param::hstring const& value) const noexcept;
    hstring UserName() const noexcept;
    void UserName(param::hstring const& value) const noexcept;
    hstring Password() const noexcept;
    void Password(param::hstring const& value) const noexcept;
    bool IsCompressionEnabled() const noexcept;
    void IsCompressionEnabled(bool value) const noexcept;
    Windows::Networking::Connectivity::CellularApnAuthenticationType AuthenticationType() const noexcept;
    void AuthenticationType(Windows::Networking::Connectivity::CellularApnAuthenticationType const& value) const noexcept;
};
...
{
    Windows::Networking::Connectivity::NetworkCostType NetworkCostType() const noexcept;
    bool Roaming() const noexcept;
    bool OverDataLimit() const noexcept;
    bool ApproachingDataLimit() const noexcept;
};
...
{
    bool BackgroundDataUsageRestricted() const noexcept;
};
...
struct consume_Windows_Networking_Connectivity_IConnectionProfile
{
    ...
    Windows::Networking::Connectivity::NetworkSecuritySettings NetworkSecuritySettings() const noexcept;
};
...
{
    bool IsWwanConnectionProfile() const noexcept;
    bool IsWlanConnectionProfile() const noexcept;
    Windows::Networking::Connectivity::WwanConnectionProfileDetails WwanConnectionProfileDetails() const noexcept;
    Windows::Networking::Connectivity::WlanConnectionProfileDetails WlanConnectionProfileDetails() const noexcept;
    Windows::Foundation::IReference<GUID> ServiceProviderGuid() const noexcept;
...
{
    void IsConnected(bool value) const noexcept;
    bool IsConnected() const noexcept;
    void IsWwanConnectionProfile(bool value) const noexcept;
    bool IsWwanConnectionProfile() const noexcept;
    void IsWlanConnectionProfile(bool value) const noexcept;
    bool IsWlanConnectionProfile() const noexcept;
    void NetworkCostType(Windows::Networking::Connectivity::NetworkCostType const& value) const noexcept;
    Windows::Networking::Connectivity::NetworkCostType NetworkCostType() const noexcept;
    void ServiceProviderGuid(optional<GUID> const& value) const noexcept;
    Windows::Foundation::IReference<GUID> ServiceProviderGuid() const noexcept;
};
...
{
    void IsRoaming(optional<bool> const& value) const noexcept;
    Windows::Foundation::IReference<bool> IsRoaming() const noexcept;
    void IsOverDataLimit(optional<bool> const& value) const noexcept;
    Windows::Foundation::IReference<bool> IsOverDataLimit() const noexcept;
    void IsBackgroundDataUsageRestricted(optional<bool> const& value) const noexcept;
    Windows::Foundation::IReference<bool> IsBackgroundDataUsageRestricted() const noexcept;
    Windows::Storage::Streams::IBuffer RawData() const noexcept;
};
...
{
    Windows::Networking::Connectivity::ConnectionProfile ConnectionProfile() const noexcept;
};
...
struct consume_Windows_Networking_Connectivity_IConnectivityInterval
{
    ...
    Windows::Foundation::TimeSpan ConnectionDuration() const noexcept;
};
...
{
    Windows::Networking::Connectivity::DataPlanUsage DataPlanUsage() const noexcept;
    Windows::Foundation::IReference<uint32_t> DataLimitInMegabytes() const noexcept;
    Windows::Foundation::IReference<uint64_t> InboundBitsPerSecond() const noexcept;
    Windows::Foundation::IReference<uint64_t> OutboundBitsPerSecond() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> NextBillingCycle() const noexcept;
    Windows::Foundation::IReference<uint32_t> MaxTransferSizeInMegabytes() const noexcept;
};
...
{
    uint32_t MegabytesUsed() const noexcept;
    Windows::Foundation::DateTime LastSyncTime() const noexcept;
};
...
{
    [[deprecated("IDataUsage may be altered or unavailable for releases after Windows 8.1. Instead, use INetworkUsage.")]] uint64_t BytesSent() const noexcept;
    [[deprecated("IDataUsage may be altered or unavailable for releases after Windows 8.1. Instead, use INetworkUsage.")]] uint64_t BytesReceived() const noexcept;
};
...
{
    Windows::Networking::Connectivity::NetworkAdapter NetworkAdapter() const noexcept;
    Windows::Foundation::IReference<uint8_t> PrefixLength() const noexcept;
};
...
{
    Windows::Networking::Connectivity::LanIdentifierData InfrastructureId() const noexcept;
    Windows::Networking::Connectivity::LanIdentifierData PortId() const noexcept;
    GUID NetworkAdapterId() const noexcept;
};
...
struct consume_Windows_Networking_Connectivity_ILanIdentifierData
{
    ...
    Windows::Foundation::Collections::IVectorView<uint8_t> Value() const noexcept;
};
...
{
    uint64_t OutboundMaxBitsPerSecond() const noexcept;
    uint64_t InboundMaxBitsPerSecond() const noexcept;
    uint32_t IanaInterfaceType() const noexcept;
    Windows::Networking::Connectivity::NetworkItem NetworkItem() const noexcept;
    GUID NetworkAdapterId() const noexcept;
...
{
    Windows::Networking::Connectivity::NetworkAuthenticationType NetworkAuthenticationType() const noexcept;
    Windows::Networking::Connectivity::NetworkEncryptionType NetworkEncryptionType() const noexcept;
};
...
{
    bool HasNewInternetConnectionProfile() const noexcept;
    bool HasNewConnectionCost() const noexcept;
    bool HasNewNetworkConnectivityLevel() const noexcept;
    bool HasNewDomainConnectivityLevel() const noexcept;
    bool HasNewHostNameList() const noexcept;
    bool HasNewWwanRegistrationState() const noexcept;
};
...
{
    bool HasNewTetheringOperationalState() const noexcept;
    bool HasNewTetheringClientCount() const noexcept;
};
...
template <> struct consume<Windows::Networking::Connectivity::IProviderNetworkUsage> { template <typename D> using type = consume_Windows_Networking_Connectivity_IProviderNetworkUsage<D>; };

template <typename D>
struct consume_Windows_Networking_Connectivity_IProxyConfiguration
{
    Windows::Foundation::Collections::IVectorView<Windows::Foundation::Uri> ProxyUris() const noexcept;
    bool CanConnectDirectly() const noexcept;
};
...
struct consume_Windows_Networking_Connectivity_IRoutePolicy
{
    ...
    Windows::Networking::DomainNameType HostNameType() const noexcept;
};
...
template <> struct abi<Windows::Networking::Connectivity::ICellularApnContext>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AuthenticationType(Windows::Networking::Connectivity::CellularApnAuthenticationType* value) = 0;
    virtual HRESULT __stdcall put_AuthenticationType(Windows::Networking::Connectivity::CellularApnAuthenticationType value) = 0;
};};

template <> struct abi<Windows::Networking::Connectivity::IConnectionCost>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_NetworkCostType(Windows::Networking::Connectivity::NetworkCostType* value) = 0;
...
template <> struct abi<Windows::Networking::Connectivity::IConnectionProfile>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetNetworkConnectivityLevel(Windows::Networking::Connectivity::NetworkConnectivityLevel* value) = 0;
    ...
    virtual HRESULT __stdcall GetLocalUsage(Windows::Foundation::DateTime StartTime, Windows::Foundation::DateTime EndTime, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall GetLocalUsagePerRoamingStates(Windows::Foundation::DateTime StartTime, Windows::Foundation::DateTime EndTime, Windows::Networking::Connectivity::RoamingStates States, ::IUnknown** value) = 0;
...
template <> struct abi<Windows::Networking::Connectivity::IConnectionProfile2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDomainConnectivityLevel(Windows::Networking::Connectivity::DomainConnectivityLevel* value) = 0;
    virtual HRESULT __stdcall GetNetworkUsageAsync(Windows::Foundation::DateTime startTime, Windows::Foundation::DateTime endTime, Windows::Networking::Connectivity::DataUsageGranularity granularity, struct_of<8> states, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall GetConnectivityIntervalsAsync(Windows::Foundation::DateTime startTime, Windows::Foundation::DateTime endTime, struct_of<8> states, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Networking::Connectivity::IConnectionProfile3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetAttributedNetworkUsageAsync(Windows::Foundation::DateTime startTime, Windows::Foundation::DateTime endTime, struct_of<8> states, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Networking::Connectivity::IConnectionProfile4>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetProviderNetworkUsageAsync(Windows::Foundation::DateTime startTime, Windows::Foundation::DateTime endTime, struct_of<8> states, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Networking::Connectivity::IConnectionProfileFilter>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_IsWlanConnectionProfile(bool* value) = 0;
    virtual HRESULT __stdcall put_NetworkCostType(Windows::Networking::Connectivity::NetworkCostType value) = 0;
    virtual HRESULT __stdcall get_NetworkCostType(Windows::Networking::Connectivity::NetworkCostType* value) = 0;
...
template <> struct abi<Windows::Networking::Connectivity::INetworkInformationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetSortedEndpointPairs(::IUnknown* destinationList, Windows::Networking::HostNameSortOptions sortOptions, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_NetworkStatusChanged(::IUnknown* networkStatusHandler, event_token* eventCookie) = 0;
...
template <> struct abi<Windows::Networking::Connectivity::INetworkItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetNetworkTypes(Windows::Networking::Connectivity::NetworkTypes* value) = 0;
};};

template <> struct abi<Windows::Networking::Connectivity::INetworkSecuritySettings>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_NetworkAuthenticationType(Windows::Networking::Connectivity::NetworkAuthenticationType* value) = 0;
    virtual HRESULT __stdcall get_NetworkEncryptionType(Windows::Networking::Connectivity::NetworkEncryptionType* value) = 0;
};};
...
template <> struct abi<Windows::Networking::Connectivity::IRoutePolicy>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_HostNameType(Windows::Networking::DomainNameType* value) = 0;
};};

template <> struct abi<Windows::Networking::Connectivity::IRoutePolicyFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateRoutePolicy(::IUnknown* connectionProfile, ::IUnknown* hostName, Windows::Networking::DomainNameType type, ::IUnknown** routePolicy) = 0;
};};
...
template <> struct abi<Windows::Networking::Connectivity::IWwanConnectionProfileDetails>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AccessPointName(HSTRING* value) = 0;
    virtual HRESULT __stdcall GetNetworkRegistrationState(Windows::Networking::Connectivity::WwanNetworkRegistrationState* value) = 0;
    virtual HRESULT __stdcall GetCurrentDataClass(Windows::Networking::Connectivity::WwanDataClass* value) = 0;
};};
