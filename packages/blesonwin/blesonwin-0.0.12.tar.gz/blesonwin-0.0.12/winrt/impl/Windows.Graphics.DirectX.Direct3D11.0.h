...
{
    Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription Description() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Description(struct_of<20>* value) = 0;
};};
