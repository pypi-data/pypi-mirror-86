...
template <> struct is_struct<Windows::Graphics::Imaging::BitmapBounds>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Graphics::Imaging::BitmapPlaneDescription>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Graphics::Imaging::BitmapSize>
{
    static constexpr bool value{ true };
};
