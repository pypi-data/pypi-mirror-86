...
{
    Windows::Gaming::Input::Custom::GameControllerVersionInfo FirmwareVersionInfo() const noexcept;
    uint16_t HardwareProductId() const noexcept;
    uint16_t HardwareVendorId() const noexcept;
    Windows::Gaming::Input::Custom::GameControllerVersionInfo HardwareVersionInfo() const noexcept;
...
{
    uint32_t ExtendedErrorCode() const noexcept;
    uint32_t FinalComponentId() const noexcept;
    Windows::Gaming::Input::Custom::GipFirmwareUpdateStatus Status() const noexcept;
};
...
{
    virtual HRESULT __stdcall RegisterCustomFactoryForGipInterface(::IUnknown* factory, GUID interfaceId) = 0;
    ...
    virtual HRESULT __stdcall RegisterCustomFactoryForXusbType(::IUnknown* factory, Windows::Gaming::Input::Custom::XusbDeviceType xusbType, Windows::Gaming::Input::Custom::XusbDeviceSubtype xusbSubtype) = 0;
};};
...
{
    virtual HRESULT __stdcall get_FirmwareVersionInfo(struct_of<8>* value) = 0;
    ...
    virtual HRESULT __stdcall get_HardwareVersionInfo(struct_of<8>* value) = 0;
...
template <> struct abi<Windows::Gaming::Input::Custom::IGipFirmwareUpdateResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Gaming::Input::Custom::GipFirmwareUpdateStatus* value) = 0;
};};
...
template <> struct abi<Windows::Gaming::Input::Custom::IGipGameControllerInputSink>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall OnMessageReceived(uint64_t timestamp, Windows::Gaming::Input::Custom::GipMessageClass messageClass, uint8_t messageId, uint8_t sequenceId, uint32_t __messageBufferSize, uint8_t* messageBuffer) = 0;
};};

template <> struct abi<Windows::Gaming::Input::Custom::IGipGameControllerProvider>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall SendMessage(Windows::Gaming::Input::Custom::GipMessageClass messageClass, uint8_t messageId, uint32_t __messageBufferSize, uint8_t* messageBuffer) = 0;
    virtual HRESULT __stdcall SendReceiveMessage(Windows::Gaming::Input::Custom::GipMessageClass messageClass, uint8_t messageId, uint32_t __requestMessageBufferSize, uint8_t* requestMessageBuffer, uint32_t __responseMessageBufferSize, uint8_t* responseMessageBuffer) = 0;
