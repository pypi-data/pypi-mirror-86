...
{
    Windows::Security::Credentials::WebAccount Account() const noexcept;
};
...
struct consume_Windows_Security_Authentication_Web_Core_IWebProviderError
{
    ...
    Windows::Foundation::Collections::IMap<hstring, hstring> Properties() const noexcept;
};
...
struct consume_Windows_Security_Authentication_Web_Core_IWebTokenRequest
{
    ...
    Windows::Security::Authentication::Web::Core::WebTokenRequestPromptType PromptType() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> Properties() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMap<hstring, hstring> AppProperties() const noexcept;
};
...
{
    hstring CorrelationId() const noexcept;
    void CorrelationId(param::hstring const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Security::Authentication::Web::Core::WebTokenResponse> ResponseData() const noexcept;
    Windows::Security::Authentication::Web::Core::WebTokenRequestStatus ResponseStatus() const noexcept;
    Windows::Security::Authentication::Web::Core::WebProviderError ResponseError() const noexcept;
...
struct consume_Windows_Security_Authentication_Web_Core_IWebTokenResponse
{
    ...
    Windows::Security::Authentication::Web::Core::WebProviderError ProviderError() const noexcept;
...
template <> struct abi<Windows::Security::Authentication::Web::Core::IWebAccountMonitor>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DefaultSignInAccountChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Security::Authentication::Web::Core::IWebTokenRequest>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PromptType(Windows::Security::Authentication::Web::Core::WebTokenRequestPromptType* value) = 0;
...
template <> struct abi<Windows::Security::Authentication::Web::Core::IWebTokenRequestFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithPromptType(::IUnknown* provider, HSTRING scope, HSTRING clientId, Windows::Security::Authentication::Web::Core::WebTokenRequestPromptType promptType, ::IUnknown** webTokenRequest) = 0;
...
template <> struct abi<Windows::Security::Authentication::Web::Core::IWebTokenRequestResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ResponseStatus(Windows::Security::Authentication::Web::Core::WebTokenRequestStatus* value) = 0;
