...
struct consume_Windows_Graphics_Display_IBrightnessOverride
{
    ...
    double BrightnessLevel() const noexcept;
...
{
    Windows::Graphics::Display::DisplayOrientations CurrentOrientation() const noexcept;
    Windows::Graphics::Display::DisplayOrientations NativeOrientation() const noexcept;
    ...
    Windows::Graphics::Display::ResolutionScale ResolutionScale() const noexcept;
    float LogicalDpi() const noexcept;
    float RawDpiX() const noexcept;
    float RawDpiY() const noexcept;
...
{
    double RawPixelsPerViewPixel() const noexcept;
};
...
{
    Windows::Foundation::IReference<double> DiagonalSizeInInches() const noexcept;
};
...
{
    uint32_t ScreenWidthInRawPixels() const noexcept;
    uint32_t ScreenHeightInRawPixels() const noexcept;
};
...
struct consume_Windows_Graphics_Display_IDisplayInformationStatics
{
    ...
    Windows::Graphics::Display::DisplayOrientations AutoRotationPreferences() const noexcept;
    void AutoRotationPreferences(Windows::Graphics::Display::DisplayOrientations const& value) const noexcept;
...
{
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] Windows::Graphics::Display::DisplayOrientations CurrentOrientation() const noexcept;
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] Windows::Graphics::Display::DisplayOrientations NativeOrientation() const noexcept;
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] Windows::Graphics::Display::DisplayOrientations AutoRotationPreferences() const noexcept;
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] void AutoRotationPreferences(Windows::Graphics::Display::DisplayOrientations const& value) const noexcept;
    ...
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] Windows::Graphics::Display::ResolutionScale ResolutionScale() const noexcept;
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] float LogicalDpi() const noexcept;
    ...
    [[deprecated("DisplayProperties may be altered or unavailable for releases after Windows Phone 8.1. Instead, use DisplayInformation.")]] bool StereoEnabled() const noexcept;
...
template <> struct abi<Windows::Graphics::Display::IBrightnessOverride>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetBrightnessLevel(double brightnessLevel, Windows::Graphics::Display::DisplayBrightnessOverrideOptions options) = 0;
    virtual HRESULT __stdcall SetBrightnessScenario(Windows::Graphics::Display::DisplayBrightnessScenario scenario, Windows::Graphics::Display::DisplayBrightnessOverrideOptions options) = 0;
    virtual HRESULT __stdcall GetLevelForScenario(Windows::Graphics::Display::DisplayBrightnessScenario scenario, double* brightnessLevel) = 0;
    virtual HRESULT __stdcall StartOverride() = 0;
    virtual HRESULT __stdcall StopOverride() = 0;
    virtual HRESULT __stdcall add_IsSupportedChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_IsSupportedChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_IsOverrideActiveChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_IsOverrideActiveChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_BrightnessLevelChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_CurrentOrientation(Windows::Graphics::Display::DisplayOrientations* value) = 0;
    virtual HRESULT __stdcall get_NativeOrientation(Windows::Graphics::Display::DisplayOrientations* value) = 0;
    ...
    virtual HRESULT __stdcall get_ResolutionScale(Windows::Graphics::Display::ResolutionScale* value) = 0;
    ...
    virtual HRESULT __stdcall add_DpiChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DpiChanged(event_token token) = 0;
    virtual HRESULT __stdcall get_StereoEnabled(bool* value) = 0;
    virtual HRESULT __stdcall add_StereoEnabledChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_ColorProfileChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Graphics::Display::IDisplayInformationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AutoRotationPreferences(Windows::Graphics::Display::DisplayOrientations* value) = 0;
    virtual HRESULT __stdcall put_AutoRotationPreferences(Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall add_DisplayContentsInvalidated(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Graphics::Display::IDisplayPropertiesStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ResolutionScale(Windows::Graphics::Display::ResolutionScale* value) = 0;
    virtual HRESULT __stdcall get_LogicalDpi(float* value) = 0;
    virtual HRESULT __stdcall add_LogicalDpiChanged(::IUnknown* handler, event_token* token) = 0;
