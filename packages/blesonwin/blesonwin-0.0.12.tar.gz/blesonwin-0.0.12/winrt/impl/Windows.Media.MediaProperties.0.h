...
template <> struct guid<Windows::Media::MediaProperties::IMediaEncodingProfile2>{ static constexpr GUID value{ 0x349B3E0A,0x4035,0x488E,{ 0x98,0x77,0x85,0x63,0x28,0x65,0xED,0x10 } }; };
...
{
    void Bitrate(uint32_t value) const noexcept;
    uint32_t Bitrate() const noexcept;
    void ChannelCount(uint32_t value) const noexcept;
    uint32_t ChannelCount() const noexcept;
    void SampleRate(uint32_t value) const noexcept;
    uint32_t SampleRate() const noexcept;
    void BitsPerSample(uint32_t value) const noexcept;
...
{
    int32_t ConstrainedBaseline() const noexcept;
    int32_t Baseline() const noexcept;
    int32_t Extended() const noexcept;
    int32_t Main() const noexcept;
    int32_t High() const noexcept;
    int32_t High10() const noexcept;
    int32_t High422() const noexcept;
    int32_t High444() const noexcept;
    int32_t StereoHigh() const noexcept;
    int32_t MultiviewHigh() const noexcept;
};
...
{
    void Width(uint32_t value) const noexcept;
    uint32_t Width() const noexcept;
    void Height(uint32_t value) const noexcept;
...
{
    void Audio(Windows::Media::MediaProperties::AudioEncodingProperties const& value) const noexcept;
    Windows::Media::MediaProperties::AudioEncodingProperties Audio() const noexcept;
    void Video(Windows::Media::MediaProperties::VideoEncodingProperties const& value) const noexcept;
    Windows::Media::MediaProperties::VideoEncodingProperties Video() const noexcept;
    void Container(Windows::Media::MediaProperties::ContainerEncodingProperties const& value) const noexcept;
    Windows::Media::MediaProperties::ContainerEncodingProperties Container() const noexcept;
};
...
{
    Windows::Media::MediaProperties::MediaPropertySet Properties() const noexcept;
    hstring Type() const noexcept;
    void Subtype(param::hstring const& value) const noexcept;
    hstring Subtype() const noexcept;
};
...
{
    hstring Aac() const noexcept;
    hstring AacAdts() const noexcept;
    hstring Ac3() const noexcept;
    hstring AmrNb() const noexcept;
    hstring AmrWb() const noexcept;
    hstring Argb32() const noexcept;
    hstring Asf() const noexcept;
    hstring Avi() const noexcept;
    hstring Bgra8() const noexcept;
    hstring Bmp() const noexcept;
    hstring Eac3() const noexcept;
    hstring Float() const noexcept;
    hstring Gif() const noexcept;
    hstring H263() const noexcept;
    hstring H264() const noexcept;
    hstring H264Es() const noexcept;
    hstring Hevc() const noexcept;
    hstring HevcEs() const noexcept;
    hstring Iyuv() const noexcept;
    hstring Jpeg() const noexcept;
    hstring JpegXr() const noexcept;
    hstring Mjpg() const noexcept;
    hstring Mpeg() const noexcept;
    hstring Mpeg1() const noexcept;
    hstring Mpeg2() const noexcept;
    hstring Mp3() const noexcept;
    hstring Mpeg4() const noexcept;
    hstring Nv12() const noexcept;
    hstring Pcm() const noexcept;
    hstring Png() const noexcept;
    hstring Rgb24() const noexcept;
    hstring Rgb32() const noexcept;
    hstring Tiff() const noexcept;
    hstring Wave() const noexcept;
    hstring Wma8() const noexcept;
    hstring Wma9() const noexcept;
    hstring Wmv3() const noexcept;
    hstring Wvc1() const noexcept;
    hstring Yuy2() const noexcept;
    hstring Yv12() const noexcept;
};
...
{
    hstring Vp9() const noexcept;
    hstring L8() const noexcept;
    hstring L16() const noexcept;
    hstring D16() const noexcept;
};
...
{
    hstring Alac() const noexcept;
    hstring Flac() const noexcept;
};
...
{
    void Numerator(uint32_t value) const noexcept;
    uint32_t Numerator() const noexcept;
    void Denominator(uint32_t value) const noexcept;
    uint32_t Denominator() const noexcept;
};
...
{
    int32_t Simple() const noexcept;
    int32_t Main() const noexcept;
    int32_t SignalNoiseRatioScalable() const noexcept;
    int32_t SpatiallyScalable() const noexcept;
    int32_t High() const noexcept;
};
...
struct consume_Windows_Media_MediaProperties_IVideoEncodingProperties
{
    ...
    void Height(uint32_t value) const noexcept;
    uint32_t Height() const noexcept;
    Windows::Media::MediaProperties::MediaRatio FrameRate() const noexcept;
    Windows::Media::MediaProperties::MediaRatio PixelAspectRatio() const noexcept;
};
...
struct consume_Windows_Media_MediaProperties_IVideoEncodingProperties2
{
    void SetFormatUserData(array_view<uint8_t const> value) const;
    void GetFormatUserData(com_array<uint8_t>& value) const;
    void ProfileId(int32_t value) const noexcept;
    int32_t ProfileId() const noexcept;
};
...
{
    Windows::Media::MediaProperties::SphericalVideoFrameFormat SphericalVideoFrameFormat() const noexcept;
};
...
{
    virtual HRESULT __stdcall CreateUncompressed(Windows::Media::MediaProperties::MediaPixelFormat format, ::IUnknown** value) = 0;
...
{
    virtual HRESULT __stdcall SetAudioTracks(::IUnknown* value) = 0;
    virtual HRESULT __stdcall GetAudioTracks(::IUnknown** value) = 0;
    virtual HRESULT __stdcall SetVideoTracks(::IUnknown* value) = 0;
    virtual HRESULT __stdcall GetVideoTracks(::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Media::MediaProperties::IMediaEncodingProfileStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateM4a(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateMp3(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateWma(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateMp4(Windows::Media::MediaProperties::VideoEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateWmv(Windows::Media::MediaProperties::VideoEncodingQuality quality, ::IUnknown** value) = 0;
...
{
    virtual HRESULT __stdcall CreateWav(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateAvi(Windows::Media::MediaProperties::VideoEncodingQuality quality, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Media::MediaProperties::IMediaEncodingProfileStatics3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateAlac(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateFlac(Windows::Media::MediaProperties::AudioEncodingQuality quality, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateHevc(Windows::Media::MediaProperties::VideoEncodingQuality quality, ::IUnknown** value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_SphericalVideoFrameFormat(Windows::Media::MediaProperties::SphericalVideoFrameFormat* value) = 0;
};};
