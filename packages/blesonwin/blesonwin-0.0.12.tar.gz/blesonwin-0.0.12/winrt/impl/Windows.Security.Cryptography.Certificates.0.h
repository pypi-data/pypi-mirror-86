...
struct consume_Windows_Security_Cryptography_Certificates_ICertificate
{
    ...
    com_array<uint8_t> SerialNumber() const noexcept;
    ...
    hstring Issuer() const noexcept;
    bool HasPrivateKey() const noexcept;
    bool IsStronglyProtected() const noexcept;
    Windows::Foundation::DateTime ValidFrom() const noexcept;
    Windows::Foundation::DateTime ValidTo() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> EnhancedKeyUsages() const noexcept;
    void FriendlyName(param::hstring const& value) const noexcept;
...
{
    bool IsSecurityDeviceBound() const noexcept;
    Windows::Security::Cryptography::Certificates::CertificateKeyUsages KeyUsages() const noexcept;
    hstring KeyAlgorithmName() const noexcept;
    hstring SignatureAlgorithmName() const noexcept;
    hstring SignatureHashAlgorithmName() const noexcept;
    Windows::Security::Cryptography::Certificates::SubjectAlternativeNameInfo SubjectAlternativeName() const noexcept;
};
...
{
    bool IsPerUser() const noexcept;
    hstring StoreName() const noexcept;
    hstring KeyStorageProviderName() const noexcept;
};
...
{
    Windows::Security::Cryptography::Certificates::UserCertificateEnrollmentManager UserCertificateEnrollmentManager() const noexcept;
...
{
    hstring ObjectId() const noexcept;
    void ObjectId(param::hstring const& value) const noexcept;
    bool IsCritical() const noexcept;
    void IsCritical(bool value) const noexcept;
    void EncodeValue(param::hstring const& value) const;
    com_array<uint8_t> Value() const noexcept;
    void Value(array_view<uint8_t const> value) const noexcept;
};
...
{
    bool EncipherOnly() const noexcept;
    void EncipherOnly(bool value) const noexcept;
    bool CrlSign() const noexcept;
    void CrlSign(bool value) const noexcept;
    bool KeyCertificateSign() const noexcept;
    void KeyCertificateSign(bool value) const noexcept;
    bool KeyAgreement() const noexcept;
    void KeyAgreement(bool value) const noexcept;
    bool DataEncipherment() const noexcept;
    void DataEncipherment(bool value) const noexcept;
    bool KeyEncipherment() const noexcept;
    void KeyEncipherment(bool value) const noexcept;
    bool NonRepudiation() const noexcept;
    void NonRepudiation(bool value) const noexcept;
    bool DigitalSignature() const noexcept;
    void DigitalSignature(bool value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> EnhancedKeyUsages() const noexcept;
    hstring IssuerName() const noexcept;
    void IssuerName(param::hstring const& value) const noexcept;
    hstring FriendlyName() const noexcept;
    void FriendlyName(param::hstring const& value) const noexcept;
    com_array<uint8_t> Thumbprint() const noexcept;
    void Thumbprint(array_view<uint8_t const> value) const noexcept;
    bool HardwareOnly() const noexcept;
    void HardwareOnly(bool value) const noexcept;
};
...
{
    bool IncludeDuplicates() const noexcept;
    void IncludeDuplicates(bool value) const noexcept;
    bool IncludeExpiredCertificates() const noexcept;
    void IncludeExpiredCertificates(bool value) const noexcept;
    hstring StoreName() const noexcept;
    void StoreName(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_Security_Cryptography_Certificates_ICertificateRequestProperties
{
    ...
    hstring KeyAlgorithmName() const noexcept;
    void KeyAlgorithmName(param::hstring const& value) const noexcept;
    uint32_t KeySize() const noexcept;
    void KeySize(uint32_t value) const noexcept;
    hstring FriendlyName() const noexcept;
    void FriendlyName(param::hstring const& value) const noexcept;
    hstring HashAlgorithmName() const noexcept;
    void HashAlgorithmName(param::hstring const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::ExportOption Exportable() const noexcept;
    void Exportable(Windows::Security::Cryptography::Certificates::ExportOption const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::EnrollKeyUsages KeyUsages() const noexcept;
    void KeyUsages(Windows::Security::Cryptography::Certificates::EnrollKeyUsages const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::KeyProtectionLevel KeyProtectionLevel() const noexcept;
    void KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel const& value) const noexcept;
    hstring KeyStorageProviderName() const noexcept;
    void KeyStorageProviderName(param::hstring const& value) const noexcept;
};
...
{
    hstring SmartcardReaderName() const noexcept;
    void SmartcardReaderName(param::hstring const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate SigningCertificate() const noexcept;
    void SigningCertificate(Windows::Security::Cryptography::Certificates::Certificate const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate AttestationCredentialCertificate() const noexcept;
    void AttestationCredentialCertificate(Windows::Security::Cryptography::Certificates::Certificate const& value) const noexcept;
};
...
{
    hstring CurveName() const noexcept;
    void CurveName(param::hstring const& value) const noexcept;
    com_array<uint8_t> CurveParameters() const noexcept;
    void CurveParameters(array_view<uint8_t const> value) const noexcept;
    hstring ContainerNamePrefix() const noexcept;
    void ContainerNamePrefix(param::hstring const& value) const noexcept;
    hstring ContainerName() const noexcept;
    void ContainerName(param::hstring const& value) const noexcept;
    bool UseExistingKey() const noexcept;
    void UseExistingKey(bool value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> SuppressedDefaults() const noexcept;
    Windows::Security::Cryptography::Certificates::SubjectAlternativeNameInfo SubjectAlternativeName() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Security::Cryptography::Certificates::CertificateExtension> Extensions() const noexcept;
};
...
struct consume_Windows_Security_Cryptography_Certificates_ICertificateStoresStatics
{
    ...
    Windows::Security::Cryptography::Certificates::CertificateStore TrustedRootCertificationAuthorities() const noexcept;
    Windows::Security::Cryptography::Certificates::CertificateStore IntermediateCertificationAuthorities() const noexcept;
...
{
    Windows::Foundation::Collections::IVector<hstring> EnhancedKeyUsages() const noexcept;
    Windows::Foundation::DateTime ValidationTimestamp() const noexcept;
    void ValidationTimestamp(Windows::Foundation::DateTime const& value) const noexcept;
    bool RevocationCheckEnabled() const noexcept;
    void RevocationCheckEnabled(bool value) const noexcept;
    bool NetworkRetrievalEnabled() const noexcept;
    void NetworkRetrievalEnabled(bool value) const noexcept;
    bool AuthorityInformationAccessEnabled() const noexcept;
    void AuthorityInformationAccessEnabled(bool value) const noexcept;
    bool CurrentTimeValidationEnabled() const noexcept;
    void CurrentTimeValidationEnabled(bool value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Security::Cryptography::Certificates::Certificate> ExclusiveTrustRoots() const noexcept;
};
...
{
    Windows::Security::Cryptography::Certificates::CertificateChainPolicy CertificateChainPolicy() const noexcept;
    void CertificateChainPolicy(Windows::Security::Cryptography::Certificates::CertificateChainPolicy const& value) const noexcept;
    Windows::Networking::HostName ServerDnsName() const noexcept;
    void ServerDnsName(Windows::Networking::HostName const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::Certificate> Certificates() const noexcept;
    com_array<uint8_t> Content() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::CmsSignerInfo> Signers() const noexcept;
...
{
    Windows::Security::Cryptography::Certificates::Certificate Certificate() const noexcept;
    void Certificate(Windows::Security::Cryptography::Certificates::Certificate const& value) const noexcept;
    hstring HashAlgorithmName() const noexcept;
    void HashAlgorithmName(param::hstring const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::CmsTimestampInfo TimestampInfo() const noexcept;
};
...
{
    hstring Rsa() const noexcept;
    hstring Dsa() const noexcept;
    hstring Ecdh256() const noexcept;
    hstring Ecdh384() const noexcept;
    hstring Ecdh521() const noexcept;
    hstring Ecdsa256() const noexcept;
    hstring Ecdsa384() const noexcept;
    hstring Ecdsa521() const noexcept;
};
...
{
    hstring Ecdsa() const noexcept;
    hstring Ecdh() const noexcept;
};
...
{
    hstring SoftwareKeyStorageProvider() const noexcept;
    hstring SmartcardKeyStorageProvider() const noexcept;
    hstring PlatformKeyStorageProvider() const noexcept;
};
...
{
    hstring PassportKeyStorageProvider() const noexcept;
};
...
struct consume_Windows_Security_Cryptography_Certificates_IPfxImportParameters
{
    ...
    Windows::Security::Cryptography::Certificates::KeyProtectionLevel KeyProtectionLevel() const noexcept;
    void KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel const& value) const noexcept;
    Windows::Security::Cryptography::Certificates::InstallOptions InstallOptions() const noexcept;
    void InstallOptions(Windows::Security::Cryptography::Certificates::InstallOptions const& value) const noexcept;
    hstring FriendlyName() const noexcept;
    void FriendlyName(param::hstring const& value) const noexcept;
    hstring KeyStorageProviderName() const noexcept;
    void KeyStorageProviderName(param::hstring const& value) const noexcept;
    hstring ContainerNamePrefix() const noexcept;
    void ContainerNamePrefix(param::hstring const& value) const noexcept;
    hstring ReaderName() const noexcept;
    void ReaderName(param::hstring const& value) const noexcept;
};
...
{
    hstring Personal() const noexcept;
    hstring TrustedRootCertificationAuthorities() const noexcept;
    hstring IntermediateCertificationAuthorities() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<hstring> EmailName() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> IPAddress() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Url() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> DnsName() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> DistinguishedName() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> PrincipalName() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> EmailNames() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> IPAddresses() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Urls() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DnsNames() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DistinguishedNames() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> PrincipalNames() const noexcept;
    Windows::Security::Cryptography::Certificates::CertificateExtension Extension() const noexcept;
};
...
{
    virtual HRESULT __stdcall Validate(Windows::Security::Cryptography::Certificates::ChainValidationResult* status) = 0;
    virtual HRESULT __stdcall ValidateWithParameters(::IUnknown* parameter, Windows::Security::Cryptography::Certificates::ChainValidationResult* status) = 0;
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateEnrollmentManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall InstallCertificateAsync(HSTRING certificate, Windows::Security::Cryptography::Certificates::InstallOptions installOption, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall ImportPfxDataAsync(HSTRING pfxData, HSTRING password, Windows::Security::Cryptography::Certificates::ExportOption exportable, Windows::Security::Cryptography::Certificates::KeyProtectionLevel keyProtectionLevel, Windows::Security::Cryptography::Certificates::InstallOptions installOption, HSTRING friendlyName, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateEnrollmentManagerStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ImportPfxDataToKspAsync(HSTRING pfxData, HSTRING password, Windows::Security::Cryptography::Certificates::ExportOption exportable, Windows::Security::Cryptography::Certificates::KeyProtectionLevel keyProtectionLevel, Windows::Security::Cryptography::Certificates::InstallOptions installOption, HSTRING friendlyName, HSTRING keyStorageProvider, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICertificateRequestProperties>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Exportable(Windows::Security::Cryptography::Certificates::ExportOption* value) = 0;
    virtual HRESULT __stdcall put_Exportable(Windows::Security::Cryptography::Certificates::ExportOption value) = 0;
    virtual HRESULT __stdcall get_KeyUsages(Windows::Security::Cryptography::Certificates::EnrollKeyUsages* value) = 0;
    virtual HRESULT __stdcall put_KeyUsages(Windows::Security::Cryptography::Certificates::EnrollKeyUsages value) = 0;
    virtual HRESULT __stdcall get_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel* value) = 0;
    virtual HRESULT __stdcall put_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel value) = 0;
    virtual HRESULT __stdcall get_KeyStorageProviderName(HSTRING* value) = 0;
...
{
    virtual HRESULT __stdcall get_CertificateChainPolicy(Windows::Security::Cryptography::Certificates::CertificateChainPolicy* value) = 0;
    virtual HRESULT __stdcall put_CertificateChainPolicy(Windows::Security::Cryptography::Certificates::CertificateChainPolicy value) = 0;
...
template <> struct abi<Windows::Security::Cryptography::Certificates::ICmsAttachedSignature>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall VerifySignature(Windows::Security::Cryptography::Certificates::SignatureValidationResult* value) = 0;
};};
...
template <> struct abi<Windows::Security::Cryptography::Certificates::IPfxImportParameters>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel* value) = 0;
    virtual HRESULT __stdcall put_KeyProtectionLevel(Windows::Security::Cryptography::Certificates::KeyProtectionLevel value) = 0;
    virtual HRESULT __stdcall get_InstallOptions(Windows::Security::Cryptography::Certificates::InstallOptions* value) = 0;
    virtual HRESULT __stdcall put_InstallOptions(Windows::Security::Cryptography::Certificates::InstallOptions value) = 0;
    virtual HRESULT __stdcall get_FriendlyName(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_FriendlyName(HSTRING value) = 0;
    virtual HRESULT __stdcall get_KeyStorageProviderName(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_KeyStorageProviderName(HSTRING value) = 0;
