...
struct consume_Windows_Devices_Pwm_IPwmController
{
    ...
    double ActualFrequency() const noexcept;
    double SetDesiredFrequency(double desiredFrequency) const;
    double MinFrequency() const noexcept;
    double MaxFrequency() const noexcept;
...
{
    Windows::Devices::Pwm::PwmController Controller() const noexcept;
    double GetActiveDutyCyclePercentage() const;
    void SetActiveDutyCyclePercentage(double dutyCyclePercentage) const;
    Windows::Devices::Pwm::PwmPulsePolarity Polarity() const noexcept;
    void Polarity(Windows::Devices::Pwm::PwmPulsePolarity const& value) const noexcept;
    void Start() const;
    void Stop() const;
...
template <> struct abi<Windows::Devices::Pwm::IPwmPin>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Polarity(Windows::Devices::Pwm::PwmPulsePolarity* value) = 0;
    virtual HRESULT __stdcall put_Polarity(Windows::Devices::Pwm::PwmPulsePolarity value) = 0;
