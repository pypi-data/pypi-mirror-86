...
{
    Windows::Media::Capture::Frames::MediaFrameReference FrameReference() const noexcept;
...
{
    Windows::Media::Capture::Frames::MediaFrameReference FrameReference() const noexcept;
    Windows::Media::Capture::Frames::VideoMediaFrame VideoMediaFrame() const noexcept;
    Windows::Media::Capture::Frames::DepthMediaFrameFormat DepthFormat() const noexcept;
...
{
    uint32_t MaxReliableDepth() const noexcept;
    uint32_t MinReliableDepth() const noexcept;
};
...
{
    Windows::Media::Capture::Frames::VideoMediaFrameFormat VideoFormat() const noexcept;
    double DepthScaleInMeters() const noexcept;
};
...
struct consume_Windows_Media_Capture_Frames_IInfraredMediaFrame
{
    Windows::Media::Capture::Frames::MediaFrameReference FrameReference() const noexcept;
    Windows::Media::Capture::Frames::VideoMediaFrame VideoMediaFrame() const noexcept;
    bool IsIlluminated() const noexcept;
};
...
{
    hstring MajorType() const noexcept;
    hstring Subtype() const noexcept;
    Windows::Media::MediaProperties::MediaRatio FrameRate() const noexcept;
    Windows::Foundation::Collections::IMapView<GUID, Windows::Foundation::IInspectable> Properties() const noexcept;
    Windows::Media::Capture::Frames::VideoMediaFrameFormat VideoFormat() const noexcept;
};
...
{
    void AcquisitionMode(Windows::Media::Capture::Frames::MediaFrameReaderAcquisitionMode const& value) const noexcept;
    Windows::Media::Capture::Frames::MediaFrameReaderAcquisitionMode AcquisitionMode() const noexcept;
};
...
{
    Windows::Media::Capture::Frames::MediaFrameSourceKind SourceKind() const noexcept;
    Windows::Media::Capture::Frames::MediaFrameFormat Format() const noexcept;
    ...
    Windows::Foundation::Collections::IMapView<GUID, Windows::Foundation::IInspectable> Properties() const noexcept;
    Windows::Media::Capture::Frames::BufferMediaFrame BufferMediaFrame() const noexcept;
    Windows::Media::Capture::Frames::VideoMediaFrame VideoMediaFrame() const noexcept;
...
{
    Windows::Media::Capture::Frames::MediaFrameSourceInfo Info() const noexcept;
    Windows::Media::Capture::Frames::MediaFrameSourceController Controller() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::Frames::MediaFrameFormat> SupportedFormats() const noexcept;
    Windows::Media::Capture::Frames::MediaFrameFormat CurrentFormat() const noexcept;
...
struct consume_Windows_Media_Capture_Frames_IMediaFrameSourceController
{
    ...
    Windows::Media::Devices::VideoDeviceController VideoDeviceController() const noexcept;
};
...
{
    Windows::Media::Capture::Frames::MediaFrameSourceGetPropertyStatus Status() const noexcept;
...
struct consume_Windows_Media_Capture_Frames_IMediaFrameSourceGroup
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::Frames::MediaFrameSourceInfo> SourceInfos() const noexcept;
};
...
{
    hstring Id() const noexcept;
    Windows::Media::Capture::MediaStreamType MediaStreamType() const noexcept;
    Windows::Media::Capture::Frames::MediaFrameSourceKind SourceKind() const noexcept;
    Windows::Media::Capture::Frames::MediaFrameSourceGroup SourceGroup() const noexcept;
...
struct consume_Windows_Media_Capture_Frames_IVideoMediaFrame
{
    ...
    Windows::Media::Devices::Core::CameraIntrinsics CameraIntrinsics() const noexcept;
    Windows::Media::Capture::Frames::InfraredMediaFrame InfraredMediaFrame() const noexcept;
    Windows::Media::Capture::Frames::DepthMediaFrame DepthMediaFrame() const noexcept;
...
{
    Windows::Media::Capture::Frames::MediaFrameFormat MediaFrameFormat() const noexcept;
    Windows::Media::Capture::Frames::DepthMediaFrameFormat DepthFormat() const noexcept;
...
{
    virtual HRESULT __stdcall put_AcquisitionMode(Windows::Media::Capture::Frames::MediaFrameReaderAcquisitionMode value) = 0;
    virtual HRESULT __stdcall get_AcquisitionMode(Windows::Media::Capture::Frames::MediaFrameReaderAcquisitionMode* value) = 0;
};};

template <> struct abi<Windows::Media::Capture::Frames::IMediaFrameReference>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_SourceKind(Windows::Media::Capture::Frames::MediaFrameSourceKind* value) = 0;
...
template <> struct abi<Windows::Media::Capture::Frames::IMediaFrameSource>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_FormatChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Media::Capture::Frames::MediaFrameSourceGetPropertyStatus* value) = 0;
...
{
    virtual HRESULT __stdcall get_Id(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_MediaStreamType(Windows::Media::Capture::MediaStreamType* value) = 0;
    virtual HRESULT __stdcall get_SourceKind(Windows::Media::Capture::Frames::MediaFrameSourceKind* value) = 0;
