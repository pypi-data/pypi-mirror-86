...
{
    Windows::Networking::Proximity::PeerInformation PeerInformation() const noexcept;
};
...
{
    bool AllowBluetooth() const noexcept;
    void AllowBluetooth(bool value) const noexcept;
    bool AllowInfrastructure() const noexcept;
    void AllowInfrastructure(bool value) const noexcept;
    bool AllowWiFiDirect() const noexcept;
    void AllowWiFiDirect(bool value) const noexcept;
    hstring DisplayName() const noexcept;
    void DisplayName(param::hstring const& value) const noexcept;
    Windows::Networking::Proximity::PeerDiscoveryTypes SupportedDiscoveryTypes() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> AlternateIdentities() const noexcept;
    void Start() const;
...
{
    Windows::Networking::Proximity::PeerRole Role() const noexcept;
    void Role(Windows::Networking::Proximity::PeerRole const& value) const noexcept;
    Windows::Storage::Streams::IBuffer DiscoveryData() const noexcept;
    void DiscoveryData(Windows::Storage::Streams::IBuffer const& value) const noexcept;
...
struct consume_Windows_Networking_Proximity_IPeerWatcher
{
    ...
    Windows::Networking::Proximity::PeerWatcherStatus Status() const noexcept;
    void Start() const;
    void Stop() const;
};
...
struct consume_Windows_Networking_Proximity_IProximityDevice
{
    ...
    uint32_t MaxMessageBytes() const noexcept;
    uint64_t BitsPerSecond() const noexcept;
...
{
    hstring MessageType() const noexcept;
    int64_t SubscriptionId() const noexcept;
    Windows::Storage::Streams::IBuffer Data() const noexcept;
    hstring DataAsString() const noexcept;
};
...
{
    Windows::Networking::Proximity::TriggeredConnectState State() const noexcept;
...
template <> struct abi<Windows::Networking::Proximity::IPeerFinderStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SupportedDiscoveryTypes(Windows::Networking::Proximity::PeerDiscoveryTypes* value) = 0;
    ...
    virtual HRESULT __stdcall add_TriggeredConnectionStateChanged(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_TriggeredConnectionStateChanged(event_token cookie) = 0;
    virtual HRESULT __stdcall add_ConnectionRequested(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_Role(Windows::Networking::Proximity::PeerRole* value) = 0;
    virtual HRESULT __stdcall put_Role(Windows::Networking::Proximity::PeerRole value) = 0;
...
template <> struct abi<Windows::Networking::Proximity::IPeerWatcher>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Networking::Proximity::PeerWatcherStatus* status) = 0;
    virtual HRESULT __stdcall Start() = 0;
    virtual HRESULT __stdcall Stop() = 0;
};};
...
template <> struct abi<Windows::Networking::Proximity::IProximityDevice>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DeviceArrived(::IUnknown* arrivedHandler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_DeviceArrived(event_token cookie) = 0;
    virtual HRESULT __stdcall add_DeviceDeparted(::IUnknown* departedHandler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_State(Windows::Networking::Proximity::TriggeredConnectState* value) = 0;
