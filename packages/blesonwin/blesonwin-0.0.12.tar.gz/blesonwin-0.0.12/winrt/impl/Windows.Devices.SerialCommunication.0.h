...
{
    Windows::Devices::SerialCommunication::SerialError Error() const noexcept;
};
...
{
    Windows::Devices::SerialCommunication::SerialPinChange PinChange() const noexcept;
};
...
{
    uint32_t BaudRate() const noexcept;
    void BaudRate(uint32_t value) const noexcept;
    bool BreakSignalState() const noexcept;
    void BreakSignalState(bool value) const noexcept;
    uint32_t BytesReceived() const noexcept;
    bool CarrierDetectState() const noexcept;
    bool ClearToSendState() const noexcept;
    uint16_t DataBits() const noexcept;
    void DataBits(uint16_t value) const noexcept;
    bool DataSetReadyState() const noexcept;
    Windows::Devices::SerialCommunication::SerialHandshake Handshake() const noexcept;
    void Handshake(Windows::Devices::SerialCommunication::SerialHandshake const& value) const noexcept;
    bool IsDataTerminalReadyEnabled() const noexcept;
    void IsDataTerminalReadyEnabled(bool value) const noexcept;
    bool IsRequestToSendEnabled() const noexcept;
    void IsRequestToSendEnabled(bool value) const noexcept;
    Windows::Devices::SerialCommunication::SerialParity Parity() const noexcept;
    void Parity(Windows::Devices::SerialCommunication::SerialParity const& value) const noexcept;
    hstring PortName() const noexcept;
    Windows::Foundation::TimeSpan ReadTimeout() const noexcept;
    void ReadTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Devices::SerialCommunication::SerialStopBitCount StopBits() const noexcept;
    void StopBits(Windows::Devices::SerialCommunication::SerialStopBitCount const& value) const noexcept;
    uint16_t UsbVendorId() const noexcept;
    uint16_t UsbProductId() const noexcept;
    Windows::Foundation::TimeSpan WriteTimeout() const noexcept;
    void WriteTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
...
{
    virtual HRESULT __stdcall get_Error(Windows::Devices::SerialCommunication::SerialError* value) = 0;
};};

template <> struct abi<Windows::Devices::SerialCommunication::IPinChangedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_PinChange(Windows::Devices::SerialCommunication::SerialPinChange* value) = 0;
};};
...
template <> struct abi<Windows::Devices::SerialCommunication::ISerialDevice>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Handshake(Windows::Devices::SerialCommunication::SerialHandshake* value) = 0;
    virtual HRESULT __stdcall put_Handshake(Windows::Devices::SerialCommunication::SerialHandshake value) = 0;
    ...
    virtual HRESULT __stdcall get_Parity(Windows::Devices::SerialCommunication::SerialParity* value) = 0;
    virtual HRESULT __stdcall put_Parity(Windows::Devices::SerialCommunication::SerialParity value) = 0;
    ...
    virtual HRESULT __stdcall get_StopBits(Windows::Devices::SerialCommunication::SerialStopBitCount* value) = 0;
    virtual HRESULT __stdcall put_StopBits(Windows::Devices::SerialCommunication::SerialStopBitCount value) = 0;
    ...
    virtual HRESULT __stdcall add_ErrorReceived(::IUnknown* reportHandler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ErrorReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_PinChanged(::IUnknown* reportHandler, event_token* token) = 0;
