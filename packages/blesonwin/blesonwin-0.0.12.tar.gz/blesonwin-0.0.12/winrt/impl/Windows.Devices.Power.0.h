...
{
    Windows::Foundation::IReference<int32_t> ChargeRateInMilliwatts() const noexcept;
    Windows::Foundation::IReference<int32_t> DesignCapacityInMilliwattHours() const noexcept;
    Windows::Foundation::IReference<int32_t> FullChargeCapacityInMilliwattHours() const noexcept;
    Windows::Foundation::IReference<int32_t> RemainingCapacityInMilliwattHours() const noexcept;
    Windows::System::Power::BatteryStatus Status() const noexcept;
};
...
{
    Windows::Devices::Power::Battery AggregateBattery() const noexcept;
...
template <> struct abi<Windows::Devices::Power::IBattery>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ReportUpdated(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Devices::Power::IBatteryReport>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::System::Power::BatteryStatus* value) = 0;
};};
