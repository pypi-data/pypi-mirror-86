...
template <> struct name<Windows::ApplicationModel::Activation::ICommandLineActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.ICommandLineActivatedEventArgs" }; };
template <> struct name<Windows::ApplicationModel::Activation::ICommandLineActivationOperation>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.ICommandLineActivationOperation" }; };
...
template <> struct name<Windows::ApplicationModel::Activation::IStartupTaskActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.IStartupTaskActivatedEventArgs" }; };
...
template <> struct name<Windows::ApplicationModel::Activation::CommandLineActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.CommandLineActivatedEventArgs" }; };
template <> struct name<Windows::ApplicationModel::Activation::CommandLineActivationOperation>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.CommandLineActivationOperation" }; };
...
template <> struct name<Windows::ApplicationModel::Activation::StartupTaskActivatedEventArgs>{ static constexpr auto & value{ L"Windows.ApplicationModel.Activation.StartupTaskActivatedEventArgs" }; };
...
{
    Windows::ApplicationModel::Activation::ActivationKind Kind() const noexcept;
    Windows::ApplicationModel::Activation::ApplicationExecutionState PreviousExecutionState() const noexcept;
    Windows::ApplicationModel::Activation::SplashScreen SplashScreen() const noexcept;
};
...
{
    int32_t CurrentlyShownApplicationViewId() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentsProvider::AddAppointmentOperation AddAppointmentOperation() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentsProvider::RemoveAppointmentOperation RemoveAppointmentOperation() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentsProvider::ReplaceAppointmentOperation ReplaceAppointmentOperation() const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> InstanceStartDate() const noexcept;
...
{
    Windows::Foundation::DateTime TimeToShow() const noexcept;
...
{
    Windows::ApplicationModel::Background::IBackgroundTaskInstance TaskInstance() const noexcept;
};
...
{
    Windows::Storage::Provider::CachedFileUpdaterUI CachedFileUpdaterUI() const noexcept;
};
...
{
    Windows::Foundation::IInspectable VideoDeviceController() const noexcept;
    Windows::Foundation::IInspectable VideoDeviceExtension() const noexcept;
};
...
{
    Windows::ApplicationModel::Activation::CommandLineActivationOperation Operation() const noexcept;
};
template <> struct consume<Windows::ApplicationModel::Activation::ICommandLineActivatedEventArgs> { template <typename D> using type = consume_Windows_ApplicationModel_Activation_ICommandLineActivatedEventArgs<D>; };

template <typename D>
struct consume_Windows_ApplicationModel_Activation_ICommandLineActivationOperation
{
    hstring Arguments() const noexcept;
    hstring CurrentDirectoryPath() const noexcept;
    void ExitCode(int32_t value) const noexcept;
    int32_t ExitCode() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
template <> struct consume<Windows::ApplicationModel::Activation::ICommandLineActivationOperation> { template <typename D> using type = consume_Windows_ApplicationModel_Activation_ICommandLineActivationOperation<D>; };
...
{
    hstring ServiceId() const noexcept;
    hstring ServiceUserId() const noexcept;
...
{
    Windows::ApplicationModel::Contacts::ContactAddress Address() const noexcept;
    Windows::ApplicationModel::Contacts::Contact Contact() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactPanel ContactPanel() const noexcept;
    Windows::ApplicationModel::Contacts::Contact Contact() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::Provider::ContactPickerUI ContactPickerUI() const noexcept;
};
...
{
    Windows::Foundation::Collections::ValueSet ContinuationData() const noexcept;
};
...
{
    hstring DeviceInformationId() const noexcept;
    hstring Verb() const noexcept;
};
...
{
    hstring AppName() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Storage::IStorageItem> Files() const noexcept;
    hstring Verb() const noexcept;
};
...
{
    hstring CallerPackageFamilyName() const noexcept;
};
...
{
    Windows::Storage::Pickers::Provider::FileOpenPickerUI FileOpenPickerUI() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Storage::StorageFile> Files() const noexcept;
};
...
{
    Windows::Storage::Pickers::Provider::FileSavePickerUI FileSavePickerUI() const noexcept;
};
...
{
    hstring CallerPackageFamilyName() const noexcept;
    hstring EnterpriseId() const noexcept;
};
...
{
    Windows::Storage::StorageFolder Folder() const noexcept;
};
...
{
    Windows::ApplicationModel::Activation::TileActivatedInfo TileActivatedInfo() const noexcept;
};
...
{
    Windows::Foundation::IInspectable Info() const noexcept;
};
...
{
    Windows::ApplicationModel::Calls::LockScreenCallUI CallUI() const noexcept;
};
...
{
    hstring PickerOperationId() const noexcept;
};
...
{
    bool PrelaunchActivated() const noexcept;
};
...
{
    Windows::Devices::Printers::Extensions::Print3DWorkflow Workflow() const noexcept;
};
...
{
    Windows::Devices::Printers::Extensions::PrintTaskConfiguration Configuration() const noexcept;
};
...
{
    Windows::System::ProtocolForResultsOperation ProtocolForResultsOperation() const noexcept;
};
...
{
    Windows::Foundation::IInspectable SharedContext() const noexcept;
};
...
{
    hstring QueryText() const noexcept;
...
{
    Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails LinguisticDetails() const noexcept;
};
...
{
    Windows::ApplicationModel::DataTransfer::ShareTarget::ShareOperation ShareOperation() const noexcept;
};
...
{
    Windows::Foundation::Rect ImageLocation() const noexcept;
...
{
    hstring TaskId() const noexcept;
};
template <> struct consume<Windows::ApplicationModel::Activation::IStartupTaskActivatedEventArgs> { template <typename D> using type = consume_Windows_ApplicationModel_Activation_IStartupTaskActivatedEventArgs<D>; };

template <typename D>
struct consume_Windows_ApplicationModel_Activation_ITileActivatedInfo
{
    Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::ShownTileNotification> RecentlyShownNotifications() const noexcept;
};
...
{
    Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountProviderOperation Operation() const noexcept;
};
...
{
    Windows::UI::ViewManagement::ActivationViewSwitcher ViewSwitcher() const noexcept;
};
...
{
    Windows::Media::SpeechRecognition::SpeechRecognitionResult Result() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Activation_IWalletActionActivatedEventArgs
{
    ...
    Windows::ApplicationModel::Wallet::WalletActionKind ActionKind() const noexcept;
    hstring ActionId() const noexcept;
};
...
{
    Windows::Security::Authentication::Web::Provider::IWebAccountProviderOperation Operation() const noexcept;
};
...
{
    Windows::Security::Authentication::Web::WebAuthenticationResult WebAuthenticationResult() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Activation::ActivationKind* value) = 0;
    virtual HRESULT __stdcall get_PreviousExecutionState(Windows::ApplicationModel::Activation::ApplicationExecutionState* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Activation::ICommandLineActivationOperation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_CurrentDirectoryPath(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_ExitCode(int32_t value) = 0;
    virtual HRESULT __stdcall get_ExitCode(int32_t* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Activation::IWalletActionActivatedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ActionKind(Windows::ApplicationModel::Wallet::WalletActionKind* value) = 0;
