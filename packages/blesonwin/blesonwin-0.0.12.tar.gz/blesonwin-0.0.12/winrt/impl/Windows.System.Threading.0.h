...
template<> struct is_enum_flag<Windows::System::Threading::WorkItemOptions> : std::true_type {};
...
template <> struct abi<Windows::System::Threading::IThreadPoolStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RunWithPriorityAsync(::IUnknown* handler, Windows::System::Threading::WorkItemPriority priority, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RunWithPriorityAndOptionsAsync(::IUnknown* handler, Windows::System::Threading::WorkItemPriority priority, Windows::System::Threading::WorkItemOptions options, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall CreatePeriodicTimer(::IUnknown* handler, Windows::Foundation::TimeSpan period, ::IUnknown** timer) = 0;
    virtual HRESULT __stdcall CreateTimer(::IUnknown* handler, Windows::Foundation::TimeSpan delay, ::IUnknown** timer) = 0;
    virtual HRESULT __stdcall CreatePeriodicTimerWithCompletion(::IUnknown* handler, Windows::Foundation::TimeSpan period, ::IUnknown* destroyed, ::IUnknown** timer) = 0;
    virtual HRESULT __stdcall CreateTimerWithCompletion(::IUnknown* handler, Windows::Foundation::TimeSpan delay, ::IUnknown* destroyed, ::IUnknown** timer) = 0;
};};
