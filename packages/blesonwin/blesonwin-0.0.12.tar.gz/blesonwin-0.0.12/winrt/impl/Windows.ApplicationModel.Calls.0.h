...
{
    bool BlockUnknownNumbers() const noexcept;
    void BlockUnknownNumbers(bool value) const noexcept;
    bool BlockPrivateNumbers() const noexcept;
    void BlockPrivateNumbers(bool value) const noexcept;
...
struct consume_Windows_ApplicationModel_Calls_IPhoneCallManagerStatics2
{
    ...
    bool IsCallActive() const noexcept;
    bool IsCallIncoming() const noexcept;
...
{
    bool IsVideoCallingCapable() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Calls_IPhoneDialOptions
{
    ...
    void Contact(Windows::ApplicationModel::Contacts::Contact const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactPhone ContactPhone() const noexcept;
    void ContactPhone(Windows::ApplicationModel::Contacts::ContactPhone const& value) const noexcept;
    Windows::ApplicationModel::Calls::PhoneCallMedia Media() const noexcept;
    void Media(Windows::ApplicationModel::Calls::PhoneCallMedia const& value) const noexcept;
    Windows::ApplicationModel::Calls::PhoneAudioRoutingEndpoint AudioEndpoint() const noexcept;
    void AudioEndpoint(Windows::ApplicationModel::Calls::PhoneAudioRoutingEndpoint const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Calls_IPhoneLine
{
    ...
    Windows::ApplicationModel::Calls::PhoneNetworkState NetworkState() const noexcept;
    hstring DisplayName() const noexcept;
    Windows::ApplicationModel::Calls::PhoneVoicemail Voicemail() const noexcept;
    hstring NetworkName() const noexcept;
    Windows::ApplicationModel::Calls::PhoneLineCellularDetails CellularDetails() const noexcept;
    Windows::ApplicationModel::Calls::PhoneLineTransport Transport() const noexcept;
    bool CanDial() const noexcept;
    bool SupportsTile() const noexcept;
    Windows::ApplicationModel::Calls::PhoneCallVideoCapabilities VideoCallingCapabilities() const noexcept;
    Windows::ApplicationModel::Calls::PhoneLineConfiguration LineConfiguration() const noexcept;
...
{
    Windows::ApplicationModel::Calls::PhoneSimState SimState() const noexcept;
    int32_t SimSlotIndex() const noexcept;
    bool IsModemOn() const noexcept;
    int32_t RegistrationRejectCode() const noexcept;
...
{
    bool IsVideoCallingEnabled() const noexcept;
...
struct consume_Windows_ApplicationModel_Calls_IPhoneLineWatcher
{
    ...
    Windows::ApplicationModel::Calls::PhoneLineWatcherStatus Status() const noexcept;
};
...
{
    hstring Number() const noexcept;
    int32_t MessageCount() const noexcept;
    Windows::ApplicationModel::Calls::PhoneVoicemailType Type() const noexcept;
...
{
    virtual HRESULT __stdcall add_CallStateChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Calls::IPhoneDialOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Media(Windows::ApplicationModel::Calls::PhoneCallMedia* value) = 0;
    virtual HRESULT __stdcall put_Media(Windows::ApplicationModel::Calls::PhoneCallMedia value) = 0;
    virtual HRESULT __stdcall get_AudioEndpoint(Windows::ApplicationModel::Calls::PhoneAudioRoutingEndpoint* value) = 0;
    virtual HRESULT __stdcall put_AudioEndpoint(Windows::ApplicationModel::Calls::PhoneAudioRoutingEndpoint value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Calls::IPhoneLine>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_LineChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_NetworkState(Windows::ApplicationModel::Calls::PhoneNetworkState* value) = 0;
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) = 0;
    ...
    virtual HRESULT __stdcall get_Transport(Windows::ApplicationModel::Calls::PhoneLineTransport* value) = 0;
...
{
    virtual HRESULT __stdcall get_SimState(Windows::ApplicationModel::Calls::PhoneSimState* value) = 0;
    ...
    virtual HRESULT __stdcall GetNetworkOperatorDisplayText(Windows::ApplicationModel::Calls::PhoneLineNetworkOperatorDisplayTextLocation location, HSTRING* value) = 0;
};};
...
{
    virtual HRESULT __stdcall FromIdAsync(GUID lineId, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Calls::IPhoneLineWatcher>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LineAdded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LineAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_LineRemoved(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LineRemoved(event_token token) = 0;
    virtual HRESULT __stdcall add_LineUpdated(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Calls::PhoneLineWatcherStatus* status) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Calls::IPhoneVoicemail>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Type(Windows::ApplicationModel::Calls::PhoneVoicemailType* value) = 0;
