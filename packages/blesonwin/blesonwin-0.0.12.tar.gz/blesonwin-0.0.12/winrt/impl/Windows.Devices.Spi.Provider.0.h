...
struct consume_Windows_Devices_Spi_Provider_IProviderSpiConnectionSettings
{
    ...
    Windows::Devices::Spi::Provider::ProviderSpiMode Mode() const noexcept;
    void Mode(Windows::Devices::Spi::Provider::ProviderSpiMode const& value) const noexcept;
    ...
    Windows::Devices::Spi::Provider::ProviderSpiSharingMode SharingMode() const noexcept;
    void SharingMode(Windows::Devices::Spi::Provider::ProviderSpiSharingMode const& value) const noexcept;
};
...
struct consume_Windows_Devices_Spi_Provider_ISpiDeviceProvider
{
    ...
    Windows::Devices::Spi::Provider::ProviderSpiConnectionSettings ConnectionSettings() const noexcept;
...
template <> struct abi<Windows::Devices::Spi::Provider::IProviderSpiConnectionSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Mode(Windows::Devices::Spi::Provider::ProviderSpiMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Devices::Spi::Provider::ProviderSpiMode value) = 0;
    ...
    virtual HRESULT __stdcall get_SharingMode(Windows::Devices::Spi::Provider::ProviderSpiSharingMode* value) = 0;
    virtual HRESULT __stdcall put_SharingMode(Windows::Devices::Spi::Provider::ProviderSpiSharingMode value) = 0;
};};
