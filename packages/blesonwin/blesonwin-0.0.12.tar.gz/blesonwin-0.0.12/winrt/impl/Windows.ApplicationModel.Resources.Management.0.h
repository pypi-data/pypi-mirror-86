...
{
    Windows::ApplicationModel::Resources::Management::IndexedResourceType Type() const noexcept;
    Windows::Foundation::Uri Uri() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, hstring> Metadata() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Resources::Management::IndexedResourceQualifier> Qualifiers() const noexcept;
...
{
    virtual HRESULT __stdcall get_Type(Windows::ApplicationModel::Resources::Management::IndexedResourceType* value) = 0;
