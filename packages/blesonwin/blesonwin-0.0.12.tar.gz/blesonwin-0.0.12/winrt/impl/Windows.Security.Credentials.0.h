...
{
    Windows::Storage::Streams::IBuffer CertificateChainBuffer() const noexcept;
    Windows::Storage::Streams::IBuffer AttestationBuffer() const noexcept;
    Windows::Security::Credentials::KeyCredentialAttestationStatus Status() const noexcept;
};
...
struct consume_Windows_Security_Credentials_IKeyCredentialOperationResult
{
    ...
    Windows::Security::Credentials::KeyCredentialStatus Status() const noexcept;
};
...
{
    Windows::Security::Credentials::KeyCredential Credential() const noexcept;
    Windows::Security::Credentials::KeyCredentialStatus Status() const noexcept;
};
...
{
    hstring Resource() const noexcept;
    void Resource(param::hstring const& resource) const noexcept;
    hstring UserName() const noexcept;
    void UserName(param::hstring const& userName) const noexcept;
    hstring Password() const noexcept;
    void Password(param::hstring const& password) const noexcept;
...
struct consume_Windows_Security_Credentials_IWebAccount
{
    ...
    hstring UserName() const noexcept;
    Windows::Security::Credentials::WebAccountState State() const noexcept;
};
...
struct consume_Windows_Security_Credentials_IWebAccountProvider
{
    ...
    [[deprecated("IconUri may be altered or unavailable for releases after Windows 8.2. Instead, use Icon.")]] Windows::Foundation::Uri IconUri() const noexcept;
};
...
{
    hstring DisplayPurpose() const noexcept;
    hstring Authority() const noexcept;
};
...
template <> struct abi<Windows::Security::Credentials::IKeyCredential>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RetrievePublicKeyWithBlobType(Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType blobType, ::IUnknown** value) = 0;
...
template <> struct abi<Windows::Security::Credentials::IKeyCredentialAttestationResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Security::Credentials::KeyCredentialAttestationStatus* value) = 0;
};};
...
template <> struct abi<Windows::Security::Credentials::IKeyCredentialManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestCreateAsync(HSTRING name, Windows::Security::Credentials::KeyCredentialCreationOption option, ::IUnknown** value) = 0;
...
template <> struct abi<Windows::Security::Credentials::IKeyCredentialOperationResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Security::Credentials::KeyCredentialStatus* value) = 0;
};};
...
template <> struct abi<Windows::Security::Credentials::IWebAccount>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Security::Credentials::WebAccountState* value) = 0;
};};
...
template <> struct abi<Windows::Security::Credentials::IWebAccount2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetPictureAsync(Windows::Security::Credentials::WebAccountPictureSize desizedSize, ::IUnknown** asyncInfo) = 0;
...
{
    virtual HRESULT __stdcall CreateWebAccount(::IUnknown* webAccountProvider, HSTRING userName, Windows::Security::Credentials::WebAccountState state, ::IUnknown** instance) = 0;
};};
