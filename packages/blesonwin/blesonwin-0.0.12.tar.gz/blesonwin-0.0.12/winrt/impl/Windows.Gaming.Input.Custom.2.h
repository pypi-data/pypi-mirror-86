...
template <> struct is_struct<Windows::Gaming::Input::Custom::GameControllerVersionInfo>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::Custom::GipFirmwareUpdateProgress>
{
    static constexpr bool value{ true };
};
