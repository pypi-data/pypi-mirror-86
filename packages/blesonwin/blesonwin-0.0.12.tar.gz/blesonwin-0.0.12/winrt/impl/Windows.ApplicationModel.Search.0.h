...
struct consume_Windows_ApplicationModel_Search_ILocalContentSuggestionSettings
{
    ...
    Windows::Foundation::Collections::IVector<Windows::Storage::StorageFolder> Locations() const noexcept;
    void AqsFilter(param::hstring const& value) const noexcept;
    hstring AqsFilter() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> PropertiesToMatch() const noexcept;
};
...
{
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] void SearchHistoryEnabled(bool value) const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] bool SearchHistoryEnabled() const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] void SearchHistoryContext(param::hstring const& value) const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] hstring SearchHistoryContext() const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] void PlaceholderText(param::hstring const& value) const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] hstring PlaceholderText() const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] hstring QueryText() const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] hstring Language() const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] bool Visible() const noexcept;
    ...
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] void ShowOnKeyboardInput(bool value) const noexcept;
    [[deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")]] bool ShowOnKeyboardInput() const noexcept;
...
{
    [[deprecated("ISearchPaneQueryChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring QueryText() const noexcept;
    [[deprecated("ISearchPaneQueryChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring Language() const noexcept;
    [[deprecated("ISearchPaneQueryChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails LinguisticDetails() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<hstring> QueryTextAlternatives() const noexcept;
    uint32_t QueryTextCompositionStart() const noexcept;
    uint32_t QueryTextCompositionLength() const noexcept;
};
...
{
    [[deprecated("ISearchPaneQuerySubmittedEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring QueryText() const noexcept;
    [[deprecated("ISearchPaneQuerySubmittedEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring Language() const noexcept;
};
...
{
    [[deprecated("ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails may be altered or unavailable for releases after Windows 10.")]] Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails LinguisticDetails() const noexcept;
};
...
{
    [[deprecated("ISearchPaneResultSuggestionChosenEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring Tag() const noexcept;
};
...
{
    [[deprecated("ISearchPaneSuggestionsRequest may be altered or unavailable for releases after Windows 10.")]] bool IsCanceled() const noexcept;
    [[deprecated("ISearchPaneSuggestionsRequest may be altered or unavailable for releases after Windows 10.")]] Windows::ApplicationModel::Search::SearchSuggestionCollection SearchSuggestionCollection() const noexcept;
...
{
    [[deprecated("ISearchPaneSuggestionsRequestedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::ApplicationModel::Search::SearchPaneSuggestionsRequest Request() const noexcept;
};
...
{
    [[deprecated("ISearchPaneVisibilityChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] bool Visible() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Search_ISearchSuggestionsRequest
{
    ...
    Windows::ApplicationModel::Search::SearchSuggestionCollection SearchSuggestionCollection() const noexcept;
...
template <> struct abi<Windows::ApplicationModel::Search::ISearchPane>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_QueryChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_QueryChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_SuggestionsRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SuggestionsRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_QuerySubmitted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_QuerySubmitted(event_token token) = 0;
    virtual HRESULT __stdcall add_ResultSuggestionChosen(::IUnknown* handler, event_token* token) = 0;
