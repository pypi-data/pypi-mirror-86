...
template <> struct name<Windows::ApplicationModel::Background::IGeovisitTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.IGeovisitTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::GeovisitTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.GeovisitTrigger" }; };
...
template <> struct name<Windows::ApplicationModel::Background::PaymentAppCanMakePaymentTrigger>{ static constexpr auto & value{ L"Windows.ApplicationModel.Background.PaymentAppCanMakePaymentTrigger" }; };
...
{
    void ProviderInfo(Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo const& value) const noexcept;
    Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo ProviderInfo() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Background_IAppBroadcastTriggerProviderInfo
{
    ...
    void LogoResource(param::hstring const& value) const noexcept;
    hstring LogoResource() const noexcept;
    void VideoKeyFrameInterval(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan VideoKeyFrameInterval() const noexcept;
    void MaxVideoBitrate(uint32_t value) const noexcept;
    uint32_t MaxVideoBitrate() const noexcept;
    void MaxVideoWidth(uint32_t value) const noexcept;
    uint32_t MaxVideoWidth() const noexcept;
    void MaxVideoHeight(uint32_t value) const noexcept;
    uint32_t MaxVideoHeight() const noexcept;
};
...
{
    void TaskEntryPoint(param::hstring const& value) const noexcept;
    hstring TaskEntryPoint() const noexcept;
...
{
    void CancelOnConditionLoss(bool value) const noexcept;
    bool CancelOnConditionLoss() const noexcept;
};
...
{
    void IsNetworkRequested(bool value) const noexcept;
    bool IsNetworkRequested() const noexcept;
};
...
{
    Windows::ApplicationModel::Background::BackgroundTaskRegistrationGroup TaskGroup() const noexcept;
    void TaskGroup(Windows::ApplicationModel::Background::BackgroundTaskRegistrationGroup const& value) const noexcept;
};
...
{
    GUID InstanceId() const noexcept;
    Windows::ApplicationModel::Background::BackgroundTaskRegistration Task() const noexcept;
    uint32_t Progress() const noexcept;
    void Progress(uint32_t value) const noexcept;
    Windows::Foundation::IInspectable TriggerDetails() const noexcept;
    ...
    uint32_t SuspendedCount() const noexcept;
...
{
    Windows::ApplicationModel::Background::IBackgroundTrigger Trigger() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Background_IBackgroundTaskRegistrationGroup
{
    ...
    Windows::Foundation::Collections::IMapView<GUID, Windows::ApplicationModel::Background::BackgroundTaskRegistration> AllTasks() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMapView<GUID, Windows::ApplicationModel::Background::IBackgroundTaskRegistration> AllTasks() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Background::BackgroundTaskRegistrationGroup> AllTaskGroups() const noexcept;
...
{
    Windows::ApplicationModel::Background::BackgroundWorkCostValue CurrentBackgroundWorkCost() const noexcept;
};
...
{
    Windows::Devices::Bluetooth::Advertisement::BluetoothLEAdvertisement Advertisement() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan MinSamplingInterval() const noexcept;
    Windows::Foundation::TimeSpan MaxSamplingInterval() const noexcept;
    Windows::Foundation::TimeSpan MinOutOfRangeTimeout() const noexcept;
    Windows::Foundation::TimeSpan MaxOutOfRangeTimeout() const noexcept;
    Windows::Devices::Bluetooth::BluetoothSignalStrengthFilter SignalStrengthFilter() const noexcept;
    void SignalStrengthFilter(Windows::Devices::Bluetooth::BluetoothSignalStrengthFilter const& value) const noexcept;
    Windows::Devices::Bluetooth::Advertisement::BluetoothLEAdvertisementFilter AdvertisementFilter() const noexcept;
    void AdvertisementFilter(Windows::Devices::Bluetooth::Advertisement::BluetoothLEAdvertisementFilter const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Background_ICachedFileUpdaterTriggerDetails
{
    ...
    bool CanRequestUserInput() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan WaitInterval() const noexcept;
};
...
{
    hstring TriggerQualifier() const noexcept;
...
{
    Windows::Devices::Bluetooth::GenericAttributeProfile::GattCharacteristic Characteristic() const noexcept;
};
...
{
    Windows::Devices::Bluetooth::Background::BluetoothEventTriggeringMode EventTriggeringMode() const noexcept;
};
...
{
    hstring TriggerId() const noexcept;
    Windows::Devices::Bluetooth::GenericAttributeProfile::GattLocalService Service() const noexcept;
    void AdvertisingParameters(Windows::Devices::Bluetooth::GenericAttributeProfile::GattServiceProviderAdvertisingParameters const& value) const noexcept;
    Windows::Devices::Bluetooth::GenericAttributeProfile::GattServiceProviderAdvertisingParameters AdvertisingParameters() const noexcept;
};
...
{
    Windows::ApplicationModel::Background::GattServiceProviderTrigger Trigger() const noexcept;
...
struct consume_Windows_ApplicationModel_Background_IGeovisitTrigger
{
    ...
    void MonitoringScope(Windows::Devices::Geolocation::VisitMonitoringScope const& value) const noexcept;
};
template <> struct consume<Windows::ApplicationModel::Background::IGeovisitTrigger> { template <typename D> using type = consume_Windows_ApplicationModel_Background_IGeovisitTrigger<D>; };

template <typename D>
struct consume_Windows_ApplicationModel_Background_ILocationTrigger
{
    Windows::ApplicationModel::Background::LocationTriggerType TriggerType() const noexcept;
};
...
{
    uint32_t FreshnessTime() const noexcept;
    bool OneShot() const noexcept;
};
...
{
    bool OneShot() const noexcept;
    Windows::ApplicationModel::Calls::Background::PhoneTriggerType TriggerType() const noexcept;
};
...
{
    Windows::Devices::Bluetooth::Background::RfcommInboundConnectionInformation InboundConnection() const noexcept;
    Windows::Devices::Bluetooth::Background::RfcommOutboundConnectionInformation OutboundConnection() const noexcept;
    bool AllowMultipleConnections() const noexcept;
    void AllowMultipleConnections(bool value) const noexcept;
    Windows::Networking::Sockets::SocketProtectionLevel ProtectionLevel() const noexcept;
    void ProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel const& value) const noexcept;
    Windows::Networking::HostName RemoteHostName() const noexcept;
    void RemoteHostName(Windows::Networking::HostName const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Background::SystemConditionType ConditionType() const noexcept;
};
...
{
    bool OneShot() const noexcept;
    Windows::ApplicationModel::Background::SystemTriggerType TriggerType() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Background::IAlarmApplicationManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetAccessStatus(Windows::ApplicationModel::Background::AlarmAccessStatus* status) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IBackgroundExecutionManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetAccessStatus(Windows::ApplicationModel::Background::BackgroundAccessStatus* status) = 0;
    virtual HRESULT __stdcall GetAccessStatusForApplication(HSTRING applicationId, Windows::ApplicationModel::Background::BackgroundAccessStatus* status) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IBackgroundTaskInstance>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Canceled(::IUnknown* cancelHandler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall GetThrottleCount(Windows::ApplicationModel::Background::BackgroundTaskThrottleCounter counter, uint32_t* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IBackgroundTaskRegistration>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Name(HSTRING* value) = 0;
    virtual HRESULT __stdcall add_Progress(::IUnknown* handler, event_token* cookie) = 0;
    virtual HRESULT __stdcall remove_Progress(event_token cookie) = 0;
    virtual HRESULT __stdcall add_Completed(::IUnknown* handler, event_token* cookie) = 0;
...
template <> struct abi<Windows::ApplicationModel::Background::IBackgroundTaskRegistrationGroup>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Name(HSTRING* value) = 0;
    virtual HRESULT __stdcall add_BackgroundActivated(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_CurrentBackgroundWorkCost(Windows::ApplicationModel::Background::BackgroundWorkCostValue* value) = 0;
};};
...
{
    virtual HRESULT __stdcall Create(Windows::Foundation::TimeSpan waitInterval, ::IUnknown** trigger) = 0;
};};
...
{
    virtual HRESULT __stdcall RequestAsyncSimple(HSTRING deviceId, Windows::Foundation::TimeSpan expectedDuration, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestAsyncWithArguments(HSTRING deviceId, Windows::Foundation::TimeSpan expectedDuration, HSTRING arguments, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_EventTriggeringMode(Windows::Devices::Bluetooth::Background::BluetoothEventTriggeringMode* value) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateWithEventTriggeringMode(::IUnknown* characteristic, Windows::Devices::Bluetooth::Background::BluetoothEventTriggeringMode eventTriggeringMode, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateAsync(HSTRING triggerId, GUID serviceUuid, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IGeovisitTrigger>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_MonitoringScope(Windows::Devices::Geolocation::VisitMonitoringScope value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ILocationTrigger>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_TriggerType(Windows::ApplicationModel::Background::LocationTriggerType* triggerType) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ILocationTriggerFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::ApplicationModel::Background::LocationTriggerType triggerType, ::IUnknown** locationTrigger) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IPhoneTrigger>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TriggerType(Windows::ApplicationModel::Calls::Background::PhoneTriggerType* result) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::IPhoneTriggerFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::ApplicationModel::Calls::Background::PhoneTriggerType type, bool oneShot, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Background::IRfcommConnectionTrigger>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_ProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel value) = 0;
...
{
    virtual HRESULT __stdcall get_TriggerType(Windows::Devices::SmartCards::SmartCardTriggerType* triggerType) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ISmartCardTriggerFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::Devices::SmartCards::SmartCardTriggerType triggerType, ::IUnknown** trigger) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ConditionType(Windows::ApplicationModel::Background::SystemConditionType* conditionType) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ISystemConditionFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::ApplicationModel::Background::SystemConditionType conditionType, ::IUnknown** condition) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ISystemTrigger>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_OneShot(bool* oneShot) = 0;
    virtual HRESULT __stdcall get_TriggerType(Windows::ApplicationModel::Background::SystemTriggerType* triggerType) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::ISystemTriggerFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::ApplicationModel::Background::SystemTriggerType triggerType, bool oneShot, ::IUnknown** trigger) = 0;
};};
...
{
    virtual HRESULT __stdcall Create(Windows::UI::Notifications::NotificationKinds notificationKinds, ::IUnknown** trigger) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Background::BackgroundTaskCanceledEventHandler>{ struct type : ::IUnknown
{
    virtual HRESULT __stdcall Invoke(::IUnknown* sender, Windows::ApplicationModel::Background::BackgroundTaskCancellationReason reason) = 0;
};};
