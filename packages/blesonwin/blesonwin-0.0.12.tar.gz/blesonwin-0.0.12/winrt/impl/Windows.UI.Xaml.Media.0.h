...
template <> struct guid<Windows::UI::Xaml::Media::IAcrylicBrush>{ static constexpr GUID value{ 0x79BBCF4E,0xCD66,0x4F1B,{ 0xA8,0xB6,0xCD,0x6D,0x29,0x77,0xC1,0x8D } }; };
template <> struct guid<Windows::UI::Xaml::Media::IAcrylicBrushFactory>{ static constexpr GUID value{ 0x81A32568,0xF6CC,0x4013,{ 0x83,0x63,0x92,0x8A,0xE2,0x3B,0x7A,0x61 } }; };
template <> struct guid<Windows::UI::Xaml::Media::IAcrylicBrushStatics>{ static constexpr GUID value{ 0x2787FD79,0xA3DA,0x423F,{ 0xB8,0x1A,0x59,0x91,0x47,0x97,0x15,0x23 } }; };
...
template <> struct guid<Windows::UI::Xaml::Media::IRevealBackgroundBrush>{ static constexpr GUID value{ 0x261DCC0E,0x1991,0x4CDF,{ 0xAE,0xE0,0x63,0x50,0xA3,0xF9,0x0B,0xB9 } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBackgroundBrushFactory>{ static constexpr GUID value{ 0x8C56BCAA,0x02A5,0x4F45,{ 0x85,0x06,0x8D,0x39,0x22,0x8F,0x5D,0x3F } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBorderBrush>{ static constexpr GUID value{ 0x060BA115,0xC542,0x483C,{ 0x82,0x02,0x5F,0x03,0x33,0x18,0x66,0xC9 } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBorderBrushFactory>{ static constexpr GUID value{ 0x94C25298,0xF5F8,0x4482,{ 0xA2,0x5C,0x67,0x58,0x50,0x1A,0x86,0x26 } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBrush>{ static constexpr GUID value{ 0x2036A0ED,0x8271,0x4398,{ 0x90,0x19,0x25,0x87,0x20,0x93,0xF1,0x3F } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBrushFactory>{ static constexpr GUID value{ 0x9D9379CE,0xE3A0,0x4AAF,{ 0xBE,0x37,0xEA,0x9D,0x9D,0xD4,0x31,0x05 } }; };
template <> struct guid<Windows::UI::Xaml::Media::IRevealBrushStatics>{ static constexpr GUID value{ 0x190F2625,0x7209,0x4D42,{ 0xA8,0x47,0x1A,0xC4,0xBB,0xBB,0x34,0x99 } }; };
...
{
    Windows::UI::Xaml::Media::AcrylicBackgroundSource BackgroundSource() const noexcept;
    void BackgroundSource(Windows::UI::Xaml::Media::AcrylicBackgroundSource const& value) const noexcept;
    Windows::UI::Color TintColor() const noexcept;
    void TintColor(Windows::UI::Color const& value) const noexcept;
    double TintOpacity() const noexcept;
    void TintOpacity(double value) const noexcept;
    Windows::Foundation::TimeSpan TintTransitionDuration() const noexcept;
    void TintTransitionDuration(Windows::Foundation::TimeSpan const& value) const noexcept;
    bool AlwaysUseFallback() const noexcept;
    void AlwaysUseFallback(bool value) const noexcept;
};
...
{
    Windows::UI::Xaml::Media::AcrylicBrush CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::DependencyProperty BackgroundSourceProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TintColorProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TintOpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TintTransitionDurationProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AlwaysUseFallbackProperty() const noexcept;
};
...
{
    Windows::Foundation::Point Point() const noexcept;
    void Point(Windows::Foundation::Point const& value) const noexcept;
    Windows::Foundation::Size Size() const noexcept;
    void Size(Windows::Foundation::Size const& value) const noexcept;
    double RotationAngle() const noexcept;
    void RotationAngle(double value) const noexcept;
    bool IsLargeArc() const noexcept;
    void IsLargeArc(bool value) const noexcept;
    Windows::UI::Xaml::Media::SweepDirection SweepDirection() const noexcept;
    void SweepDirection(Windows::UI::Xaml::Media::SweepDirection const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty PointProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SizeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RotationAngleProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsLargeArcProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SweepDirectionProperty() const noexcept;
};
...
{
    Windows::Foundation::Point Point1() const noexcept;
    void Point1(Windows::Foundation::Point const& value) const noexcept;
    Windows::Foundation::Point Point2() const noexcept;
    void Point2(Windows::Foundation::Point const& value) const noexcept;
    Windows::Foundation::Point Point3() const noexcept;
    void Point3(Windows::Foundation::Point const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty Point1Property() const noexcept;
    Windows::UI::Xaml::DependencyProperty Point2Property() const noexcept;
    Windows::UI::Xaml::DependencyProperty Point3Property() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_IBrush
{
    ...
    void Opacity(double value) const noexcept;
    Windows::UI::Xaml::Media::Transform Transform() const noexcept;
    void Transform(Windows::UI::Xaml::Media::Transform const& value) const noexcept;
    Windows::UI::Xaml::Media::Transform RelativeTransform() const noexcept;
    void RelativeTransform(Windows::UI::Xaml::Media::Transform const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty OpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TransformProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RelativeTransformProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_ICompositeTransform
{
    ...
    void CenterX(double value) const noexcept;
    double CenterY() const noexcept;
    void CenterY(double value) const noexcept;
    double ScaleX() const noexcept;
    void ScaleX(double value) const noexcept;
    double ScaleY() const noexcept;
    void ScaleY(double value) const noexcept;
    double SkewX() const noexcept;
    void SkewX(double value) const noexcept;
    double SkewY() const noexcept;
    void SkewY(double value) const noexcept;
    double Rotation() const noexcept;
    void Rotation(double value) const noexcept;
    double TranslateX() const noexcept;
    void TranslateX(double value) const noexcept;
    double TranslateY() const noexcept;
    void TranslateY(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty CenterXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ScaleXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ScaleYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SkewXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SkewYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RotationProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TranslateXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TranslateYProperty() const noexcept;
};
...
{
    Windows::Foundation::Point Center() const noexcept;
    void Center(Windows::Foundation::Point const& value) const noexcept;
    double RadiusX() const noexcept;
    void RadiusX(double value) const noexcept;
    double RadiusY() const noexcept;
    void RadiusY(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_IEllipseGeometryStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty RadiusXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RadiusYProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::FontFamily XamlAutoFontFamily() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::GeneralTransform Inverse() const noexcept;
...
{
    Windows::UI::Xaml::Media::GeneralTransform InverseCore() const noexcept;
...
struct consume_Windows_UI_Xaml_Media_IGeometry
{
    Windows::UI::Xaml::Media::Transform Transform() const noexcept;
    void Transform(Windows::UI::Xaml::Media::Transform const& value) const noexcept;
    Windows::Foundation::Rect Bounds() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::FillRule FillRule() const noexcept;
    void FillRule(Windows::UI::Xaml::Media::FillRule const& value) const noexcept;
    Windows::UI::Xaml::Media::GeometryCollection Children() const noexcept;
    void Children(Windows::UI::Xaml::Media::GeometryCollection const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty FillRuleProperty() const noexcept;
...
{
    Windows::UI::Xaml::Media::Geometry Empty() const noexcept;
    double StandardFlatteningTolerance() const noexcept;
    Windows::UI::Xaml::DependencyProperty TransformProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::GradientSpreadMethod SpreadMethod() const noexcept;
    void SpreadMethod(Windows::UI::Xaml::Media::GradientSpreadMethod const& value) const noexcept;
    Windows::UI::Xaml::Media::BrushMappingMode MappingMode() const noexcept;
    void MappingMode(Windows::UI::Xaml::Media::BrushMappingMode const& value) const noexcept;
    Windows::UI::Xaml::Media::ColorInterpolationMode ColorInterpolationMode() const noexcept;
    void ColorInterpolationMode(Windows::UI::Xaml::Media::ColorInterpolationMode const& value) const noexcept;
    Windows::UI::Xaml::Media::GradientStopCollection GradientStops() const noexcept;
    void GradientStops(Windows::UI::Xaml::Media::GradientStopCollection const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty SpreadMethodProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MappingModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ColorInterpolationModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty GradientStopsProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_IGradientStop
{
    ...
    void Offset(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty ColorProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty OffsetProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::ImageSource ImageSource() const noexcept;
    void ImageSource(Windows::UI::Xaml::Media::ImageSource const& value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty ImageSourceProperty() const noexcept;
};
...
{
    Windows::Foundation::Point StartPoint() const noexcept;
    void StartPoint(Windows::Foundation::Point const& value) const noexcept;
    Windows::Foundation::Point EndPoint() const noexcept;
    void EndPoint(Windows::Foundation::Point const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty StartPointProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty EndPointProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::LoadedImageSourceLoadStatus Status() const noexcept;
};
...
{
    Windows::Foundation::Size DecodedPhysicalSize() const noexcept;
    Windows::Foundation::Size DecodedSize() const noexcept;
    Windows::Foundation::Size NaturalSize() const noexcept;
...
{
    Windows::UI::Xaml::Media::Media3D::Matrix3D ProjectionMatrix() const noexcept;
    void ProjectionMatrix(Windows::UI::Xaml::Media::Media3D::Matrix3D const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty ProjectionMatrixProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::Matrix Identity() const noexcept;
...
{
    Windows::UI::Xaml::Media::Matrix Matrix() const noexcept;
    void Matrix(Windows::UI::Xaml::Media::Matrix const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty MatrixProperty() const noexcept;
};
...
{
    Windows::Media::Playback::FailedMediaStreamKind StreamKind() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::PathSegmentCollection Segments() const noexcept;
    void Segments(Windows::UI::Xaml::Media::PathSegmentCollection const& value) const noexcept;
    Windows::Foundation::Point StartPoint() const noexcept;
    void StartPoint(Windows::Foundation::Point const& value) const noexcept;
    bool IsClosed() const noexcept;
    void IsClosed(bool value) const noexcept;
    bool IsFilled() const noexcept;
    void IsFilled(bool value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty SegmentsProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StartPointProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsClosedProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsFilledProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_IPathGeometry
{
    Windows::UI::Xaml::Media::FillRule FillRule() const noexcept;
    void FillRule(Windows::UI::Xaml::Media::FillRule const& value) const noexcept;
    Windows::UI::Xaml::Media::PathFigureCollection Figures() const noexcept;
    void Figures(Windows::UI::Xaml::Media::PathFigureCollection const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty FillRuleProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FiguresProperty() const noexcept;
};
...
{
    double LocalOffsetX() const noexcept;
    void LocalOffsetX(double value) const noexcept;
    double LocalOffsetY() const noexcept;
    void LocalOffsetY(double value) const noexcept;
    double LocalOffsetZ() const noexcept;
    void LocalOffsetZ(double value) const noexcept;
    double RotationX() const noexcept;
    void RotationX(double value) const noexcept;
    double RotationY() const noexcept;
    void RotationY(double value) const noexcept;
    double RotationZ() const noexcept;
    void RotationZ(double value) const noexcept;
    double CenterOfRotationX() const noexcept;
    void CenterOfRotationX(double value) const noexcept;
    double CenterOfRotationY() const noexcept;
    void CenterOfRotationY(double value) const noexcept;
    double CenterOfRotationZ() const noexcept;
    void CenterOfRotationZ(double value) const noexcept;
    double GlobalOffsetX() const noexcept;
    void GlobalOffsetX(double value) const noexcept;
    double GlobalOffsetY() const noexcept;
    void GlobalOffsetY(double value) const noexcept;
    double GlobalOffsetZ() const noexcept;
    void GlobalOffsetZ(double value) const noexcept;
    Windows::UI::Xaml::Media::Media3D::Matrix3D ProjectionMatrix() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty LocalOffsetXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty LocalOffsetYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty LocalOffsetZProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RotationXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RotationYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RotationZProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterOfRotationXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterOfRotationYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterOfRotationZProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty GlobalOffsetXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty GlobalOffsetYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty GlobalOffsetZProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ProjectionMatrixProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::PointCollection Points() const noexcept;
    void Points(Windows::UI::Xaml::Media::PointCollection const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty PointsProperty() const noexcept;
};
...
{
    Windows::Foundation::Rect Rect() const noexcept;
    void Rect(Windows::Foundation::Rect const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty RectProperty() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan RenderingTime() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::RevealBackgroundBrush CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::Media::RevealBorderBrush CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
struct consume_Windows_UI_Xaml_Media_IRevealBrush
{
    Windows::UI::Color Color() const noexcept;
    void Color(Windows::UI::Color const& value) const noexcept;
    Windows::UI::Xaml::ApplicationTheme TargetTheme() const noexcept;
    void TargetTheme(Windows::UI::Xaml::ApplicationTheme const& value) const noexcept;
    bool AlwaysUseFallback() const noexcept;
    void AlwaysUseFallback(bool value) const noexcept;
};
...
{
    Windows::UI::Xaml::Media::RevealBrush CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
{
    Windows::UI::Xaml::DependencyProperty ColorProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TargetThemeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AlwaysUseFallbackProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StateProperty() const noexcept;
...
struct consume_Windows_UI_Xaml_Media_IRotateTransform
{
    ...
    void Angle(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_IRotateTransformStatics
{
    Windows::UI::Xaml::DependencyProperty CenterXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AngleProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_ISkewTransform
{
    ...
    void AngleX(double value) const noexcept;
    double AngleY() const noexcept;
    void AngleY(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_ISkewTransformStatics
{
    Windows::UI::Xaml::DependencyProperty CenterXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CenterYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AngleXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AngleYProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::AlignmentX AlignmentX() const noexcept;
    void AlignmentX(Windows::UI::Xaml::Media::AlignmentX const& value) const noexcept;
    Windows::UI::Xaml::Media::AlignmentY AlignmentY() const noexcept;
    void AlignmentY(Windows::UI::Xaml::Media::AlignmentY const& value) const noexcept;
    Windows::UI::Xaml::Media::Stretch Stretch() const noexcept;
    void Stretch(Windows::UI::Xaml::Media::Stretch const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty AlignmentXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AlignmentYProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty StretchProperty() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan Time() const noexcept;
    void Time(Windows::Foundation::TimeSpan const& value) const noexcept;
...
{
    Windows::UI::Xaml::Media::TimelineMarker Marker() const noexcept;
    void Marker(Windows::UI::Xaml::Media::TimelineMarker const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty TimeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TypeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TextProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::TransformCollection Children() const noexcept;
    void Children(Windows::UI::Xaml::Media::TransformCollection const& value) const noexcept;
    Windows::UI::Xaml::Media::Matrix Value() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_ITranslateTransform
{
    ...
    void X(double value) const noexcept;
    double Y() const noexcept;
    void Y(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty XProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty YProperty() const noexcept;
};
...
{
    Windows::UI::Color FallbackColor() const noexcept;
    void FallbackColor(Windows::UI::Color const& value) const noexcept;
};
...
{
    Windows::UI::Composition::CompositionBrush CompositionBrush() const noexcept;
    void CompositionBrush(Windows::UI::Composition::CompositionBrush const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty FallbackColorProperty() const noexcept;
};
...
{
    Windows::UI::Composition::CompositionLight CompositionLight() const noexcept;
    void CompositionLight(Windows::UI::Composition::CompositionLight const& value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_BackgroundSource(Windows::UI::Xaml::Media::AcrylicBackgroundSource* value) = 0;
    virtual HRESULT __stdcall put_BackgroundSource(Windows::UI::Xaml::Media::AcrylicBackgroundSource value) = 0;
    virtual HRESULT __stdcall get_TintColor(struct_of<4>* result) = 0;
    virtual HRESULT __stdcall put_TintColor(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_TintOpacity(double* value) = 0;
    virtual HRESULT __stdcall put_TintOpacity(double value) = 0;
    virtual HRESULT __stdcall get_TintTransitionDuration(Windows::Foundation::TimeSpan* value) = 0;
    virtual HRESULT __stdcall put_TintTransitionDuration(Windows::Foundation::TimeSpan value) = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallback(bool* result) = 0;
    virtual HRESULT __stdcall put_AlwaysUseFallback(bool value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_BackgroundSourceProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_TintColorProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_TintOpacityProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_TintTransitionDurationProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallbackProperty(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IArcSegment>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SweepDirection(Windows::UI::Xaml::Media::SweepDirection* value) = 0;
    virtual HRESULT __stdcall put_SweepDirection(Windows::UI::Xaml::Media::SweepDirection value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_Rendering(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Rendering(event_token token) = 0;
    virtual HRESULT __stdcall add_SurfaceContentsLost(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::Media::IGeneralTransform>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TransformPoint(Windows::Foundation::Point point, Windows::Foundation::Point* returnValue) = 0;
    virtual HRESULT __stdcall TryTransform(Windows::Foundation::Point inPoint, Windows::Foundation::Point* outPoint, bool* returnValue) = 0;
    virtual HRESULT __stdcall TransformBounds(Windows::Foundation::Rect rect, Windows::Foundation::Rect* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::IGeneralTransformOverrides>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TryTransformCore(Windows::Foundation::Point inPoint, Windows::Foundation::Point* outPoint, bool* returnValue) = 0;
    virtual HRESULT __stdcall TransformBoundsCore(Windows::Foundation::Rect rect, Windows::Foundation::Rect* returnValue) = 0;
};};
...
{
    virtual HRESULT __stdcall get_FillRule(Windows::UI::Xaml::Media::FillRule* value) = 0;
    virtual HRESULT __stdcall put_FillRule(Windows::UI::Xaml::Media::FillRule value) = 0;
...
{
    virtual HRESULT __stdcall get_SpreadMethod(Windows::UI::Xaml::Media::GradientSpreadMethod* value) = 0;
    virtual HRESULT __stdcall put_SpreadMethod(Windows::UI::Xaml::Media::GradientSpreadMethod value) = 0;
    virtual HRESULT __stdcall get_MappingMode(Windows::UI::Xaml::Media::BrushMappingMode* value) = 0;
    virtual HRESULT __stdcall put_MappingMode(Windows::UI::Xaml::Media::BrushMappingMode value) = 0;
    virtual HRESULT __stdcall get_ColorInterpolationMode(Windows::UI::Xaml::Media::ColorInterpolationMode* value) = 0;
    virtual HRESULT __stdcall put_ColorInterpolationMode(Windows::UI::Xaml::Media::ColorInterpolationMode value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Media::IImageBrush>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ImageFailed(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ImageFailed(event_token token) = 0;
    virtual HRESULT __stdcall add_ImageOpened(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::UI::Xaml::Media::LoadedImageSourceLoadStatus* value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ILoadedImageSurface>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LoadCompleted(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall StartLoadFromUriWithSize(::IUnknown* uri, Windows::Foundation::Size desiredMaxSize, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall StartLoadFromUri(::IUnknown* uri, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall StartLoadFromStreamWithSize(::IUnknown* stream, Windows::Foundation::Size desiredMaxSize, ::IUnknown** returnValue) = 0;
...
{
    virtual HRESULT __stdcall get_ProjectionMatrix(struct_of<128>* value) = 0;
    virtual HRESULT __stdcall put_ProjectionMatrix(struct_of<128> value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Identity(struct_of<48>* value) = 0;
    virtual HRESULT __stdcall FromElements(double m11, double m12, double m21, double m22, double offsetX, double offsetY, struct_of<48>* returnValue) = 0;
    virtual HRESULT __stdcall GetIsIdentity(struct_of<48> target, bool* value) = 0;
    virtual HRESULT __stdcall Transform(struct_of<48> target, Windows::Foundation::Point point, Windows::Foundation::Point* returnValue) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Media::IMatrixTransform>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Matrix(struct_of<48>* value) = 0;
    virtual HRESULT __stdcall put_Matrix(struct_of<48> value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_StreamKind(Windows::Media::Playback::FailedMediaStreamKind* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Color(struct_of<4>* result) = 0;
    virtual HRESULT __stdcall put_Color(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_TargetTheme(Windows::UI::Xaml::ApplicationTheme* value) = 0;
    virtual HRESULT __stdcall put_TargetTheme(Windows::UI::Xaml::ApplicationTheme value) = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallback(bool* result) = 0;
    virtual HRESULT __stdcall put_AlwaysUseFallback(bool value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ColorProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_TargetThemeProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_AlwaysUseFallbackProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_StateProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall SetState(::IUnknown* element, Windows::UI::Xaml::Media::RevealBrushState value) = 0;
    virtual HRESULT __stdcall GetState(::IUnknown* element, Windows::UI::Xaml::Media::RevealBrushState* result) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstanceWithColor(struct_of<4> color, ::IUnknown** instance) = 0;
};};
...
{
    virtual HRESULT __stdcall get_AlignmentX(Windows::UI::Xaml::Media::AlignmentX* value) = 0;
    virtual HRESULT __stdcall put_AlignmentX(Windows::UI::Xaml::Media::AlignmentX value) = 0;
    virtual HRESULT __stdcall get_AlignmentY(Windows::UI::Xaml::Media::AlignmentY* value) = 0;
    virtual HRESULT __stdcall put_AlignmentY(Windows::UI::Xaml::Media::AlignmentY value) = 0;
    virtual HRESULT __stdcall get_Stretch(Windows::UI::Xaml::Media::Stretch* value) = 0;
    virtual HRESULT __stdcall put_Stretch(Windows::UI::Xaml::Media::Stretch value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Media::ITransformGroup>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Children(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_Children(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_Value(struct_of<48>* value) = 0;
};};
...
{
    virtual HRESULT __stdcall FindElementsInHostCoordinatesPoint(Windows::Foundation::Point intersectingPoint, ::IUnknown* subtree, ::IUnknown** elements) = 0;
    virtual HRESULT __stdcall FindElementsInHostCoordinatesRect(Windows::Foundation::Rect intersectingRect, ::IUnknown* subtree, ::IUnknown** elements) = 0;
    virtual HRESULT __stdcall FindAllElementsInHostCoordinatesPoint(Windows::Foundation::Point intersectingPoint, ::IUnknown* subtree, bool includeAllElements, ::IUnknown** elements) = 0;
    virtual HRESULT __stdcall FindAllElementsInHostCoordinatesRect(Windows::Foundation::Rect intersectingRect, ::IUnknown* subtree, bool includeAllElements, ::IUnknown** elements) = 0;
...
{
    virtual HRESULT __stdcall get_FallbackColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_FallbackColor(struct_of<4> value) = 0;
};};
