...
struct consume_Windows_UI_WebUI_Core_IWebUICommandBar
{
    ...
    Windows::UI::WebUI::Core::WebUICommandBarClosedDisplayMode ClosedDisplayMode() const noexcept;
    void ClosedDisplayMode(Windows::UI::WebUI::Core::WebUICommandBarClosedDisplayMode const& value) const noexcept;
    bool IsOpen() const noexcept;
    void IsOpen(bool value) const noexcept;
    Windows::Foundation::Size Size() const noexcept;
    Windows::Foundation::Collections::IObservableVector<Windows::UI::WebUI::Core::IWebUICommandBarElement> PrimaryCommands() const noexcept;
    Windows::Foundation::Collections::IObservableVector<Windows::UI::WebUI::Core::IWebUICommandBarElement> SecondaryCommands() const noexcept;
...
struct consume_Windows_UI_WebUI_Core_IWebUICommandBarIconButton
{
    ...
    void IsToggleButton(bool value) const noexcept;
    bool IsChecked() const noexcept;
    void IsChecked(bool value) const noexcept;
    Windows::UI::WebUI::Core::IWebUICommandBarIcon Icon() const noexcept;
    void Icon(Windows::UI::WebUI::Core::IWebUICommandBarIcon const& value) const noexcept;
...
{
    bool IsPrimaryCommand() const noexcept;
};
...
{
    hstring Symbol() const noexcept;
    void Symbol(param::hstring const& value) const noexcept;
};
...
template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBar>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ClosedDisplayMode(Windows::UI::WebUI::Core::WebUICommandBarClosedDisplayMode* value) = 0;
    virtual HRESULT __stdcall put_ClosedDisplayMode(Windows::UI::WebUI::Core::WebUICommandBarClosedDisplayMode value) = 0;
    ...
    virtual HRESULT __stdcall add_MenuOpened(::IUnknown* handler, event_token* value) = 0;
    virtual HRESULT __stdcall remove_MenuOpened(event_token value) = 0;
    virtual HRESULT __stdcall add_MenuClosed(::IUnknown* handler, event_token* value) = 0;
    virtual HRESULT __stdcall remove_MenuClosed(event_token value) = 0;
    virtual HRESULT __stdcall add_SizeChanged(::IUnknown* handler, event_token* value) = 0;
...
template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBarConfirmationButton>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ItemInvoked(::IUnknown* handler, event_token* token) = 0;
