...
struct consume_Windows_ApplicationModel_Contacts_IContact
{
    ...
    Windows::Storage::Streams::IRandomAccessStreamReference Thumbnail() const noexcept;
    void Thumbnail(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::IContactField> Fields() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContact2
{
    ...
    hstring Notes() const noexcept;
    void Notes(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactPhone> Phones() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactEmail> Emails() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactAddress> Addresses() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactConnectedServiceAccount> ConnectedServiceAccounts() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactDate> ImportantDates() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DataSuppliers() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactJobInfo> JobInfo() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactSignificantOther> SignificantOthers() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactWebsite> Websites() const noexcept;
    Windows::Foundation::Collections::IPropertySet ProviderProperties() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContact3
{
    ...
    Windows::Foundation::DateTime DisplayPictureUserUpdateTime() const noexcept;
    void DisplayPictureUserUpdateTime(Windows::Foundation::DateTime const& value) const noexcept;
    bool IsMe() const noexcept;
    hstring AggregateId() const noexcept;
    hstring RemoteId() const noexcept;
    void RemoteId(param::hstring const& value) const noexcept;
    hstring RingToneToken() const noexcept;
    void RingToneToken(param::hstring const& value) const noexcept;
    bool IsDisplayPictureManuallySet() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference LargeDisplayPicture() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference SmallDisplayPicture() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference SourceDisplayPicture() const noexcept;
    void SourceDisplayPicture(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    hstring TextToneToken() const noexcept;
    void TextToneToken(param::hstring const& value) const noexcept;
    bool IsAggregate() const noexcept;
    hstring FullName() const noexcept;
    hstring DisplayNameOverride() const noexcept;
    void DisplayNameOverride(param::hstring const& value) const noexcept;
    hstring Nickname() const noexcept;
    void Nickname(param::hstring const& value) const noexcept;
    hstring SortName() const noexcept;
};
...
{
    hstring StreetAddress() const noexcept;
    void StreetAddress(param::hstring const& value) const noexcept;
    hstring Locality() const noexcept;
    void Locality(param::hstring const& value) const noexcept;
    hstring Region() const noexcept;
    void Region(param::hstring const& value) const noexcept;
    hstring Country() const noexcept;
    void Country(param::hstring const& value) const noexcept;
    hstring PostalCode() const noexcept;
    void PostalCode(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactAddressKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Contacts::ContactAddressKind const& value) const noexcept;
...
{
    hstring Id() const noexcept;
    hstring AnnotationListId() const noexcept;
    hstring ContactId() const noexcept;
    void ContactId(param::hstring const& value) const noexcept;
    hstring RemoteId() const noexcept;
    void RemoteId(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactAnnotationOperations SupportedOperations() const noexcept;
    void SupportedOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations const& value) const noexcept;
    bool IsDisabled() const noexcept;
    Windows::Foundation::Collections::ValueSet ProviderProperties() const noexcept;
};
...
{
    hstring ContactListId() const noexcept;
    void ContactListId(param::hstring const& value) const noexcept;
};
...
{
    hstring Id() const noexcept;
    hstring ProviderPackageFamilyName() const noexcept;
    hstring UserDataAccountId() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactBatch
{
    ...
    Windows::ApplicationModel::Contacts::ContactBatchStatus Status() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactCardHeaderKind HeaderKind() const noexcept;
    void HeaderKind(Windows::ApplicationModel::Contacts::ContactCardHeaderKind const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactCardTabKind InitialTabKind() const noexcept;
    void InitialTabKind(Windows::ApplicationModel::Contacts::ContactCardTabKind const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> ServerSearchContactListIds() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactChangeType ChangeType() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactConnectedServiceAccount
{
    hstring Id() const noexcept;
    void Id(param::hstring const& value) const noexcept;
    hstring ServiceName() const noexcept;
    void ServiceName(param::hstring const& value) const noexcept;
};
...
{
    Windows::Foundation::IReference<uint32_t> Day() const noexcept;
    void Day(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> Month() const noexcept;
    void Month(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> Year() const noexcept;
    void Year(optional<int32_t> const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactDateKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Contacts::ContactDateKind const& value) const noexcept;
    hstring Description() const noexcept;
    void Description(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContactEmail
{
    ...
    void Address(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactEmailKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Contacts::ContactEmailKind const& value) const noexcept;
    hstring Description() const noexcept;
    void Description(param::hstring const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactFieldType Type() const noexcept;
    Windows::ApplicationModel::Contacts::ContactFieldCategory Category() const noexcept;
    hstring Name() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactInformation
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Contacts::ContactField> Emails() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Contacts::ContactField> PhoneNumbers() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Contacts::ContactLocationField> Locations() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Contacts::ContactInstantMessageField> InstantMessages() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Contacts::ContactField> CustomFields() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactInstantMessageField
{
    ...
    hstring Service() const noexcept;
    hstring DisplayText() const noexcept;
    Windows::Foundation::Uri LaunchUri() const noexcept;
};
...
{
    hstring CompanyName() const noexcept;
    void CompanyName(param::hstring const& value) const noexcept;
    hstring CompanyYomiName() const noexcept;
    void CompanyYomiName(param::hstring const& value) const noexcept;
    hstring Department() const noexcept;
    void Department(param::hstring const& value) const noexcept;
    hstring Title() const noexcept;
    void Title(param::hstring const& value) const noexcept;
    hstring Manager() const noexcept;
    void Manager(param::hstring const& value) const noexcept;
    hstring Office() const noexcept;
    void Office(param::hstring const& value) const noexcept;
    hstring CompanyAddress() const noexcept;
    void CompanyAddress(param::hstring const& value) const noexcept;
    hstring Description() const noexcept;
    void Description(param::hstring const& value) const noexcept;
};
...
{
    hstring Call() const noexcept;
    hstring Message() const noexcept;
    hstring Map() const noexcept;
    hstring Post() const noexcept;
    hstring VideoCall() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContactList
{
    ...
    void IsHidden(bool value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactListOtherAppReadAccess OtherAppReadAccess() const noexcept;
    void OtherAppReadAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppReadAccess const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactListOtherAppWriteAccess OtherAppWriteAccess() const noexcept;
    void OtherAppWriteAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppWriteAccess const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactChangeTracker ChangeTracker() const noexcept;
    Windows::ApplicationModel::Contacts::ContactListSyncManager SyncManager() const noexcept;
    bool SupportsServerSearch() const noexcept;
    hstring UserDataAccountId() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactList2
{
    ...
    void SupportsServerSearch(bool value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactListSyncConstraints SyncConstraints() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactListLimitedWriteOperations LimitedWriteOperations() const noexcept;
...
{
    bool CanSyncDescriptions() const noexcept;
    void CanSyncDescriptions(bool value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxHomePhoneNumbers() const noexcept;
    void MaxHomePhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxMobilePhoneNumbers() const noexcept;
    void MaxMobilePhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxWorkPhoneNumbers() const noexcept;
    void MaxWorkPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxOtherPhoneNumbers() const noexcept;
    void MaxOtherPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxPagerPhoneNumbers() const noexcept;
    void MaxPagerPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxBusinessFaxPhoneNumbers() const noexcept;
    void MaxBusinessFaxPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxHomeFaxPhoneNumbers() const noexcept;
    void MaxHomeFaxPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxCompanyPhoneNumbers() const noexcept;
    void MaxCompanyPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxAssistantPhoneNumbers() const noexcept;
    void MaxAssistantPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxRadioPhoneNumbers() const noexcept;
    void MaxRadioPhoneNumbers(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxPersonalEmailAddresses() const noexcept;
    void MaxPersonalEmailAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxWorkEmailAddresses() const noexcept;
    void MaxWorkEmailAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxOtherEmailAddresses() const noexcept;
    void MaxOtherEmailAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxHomeAddresses() const noexcept;
    void MaxHomeAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxWorkAddresses() const noexcept;
    void MaxWorkAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxOtherAddresses() const noexcept;
    void MaxOtherAddresses(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxBirthdayDates() const noexcept;
    void MaxBirthdayDates(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxAnniversaryDates() const noexcept;
    void MaxAnniversaryDates(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxOtherDates() const noexcept;
    void MaxOtherDates(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxOtherRelationships() const noexcept;
    void MaxOtherRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxSpouseRelationships() const noexcept;
    void MaxSpouseRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxPartnerRelationships() const noexcept;
    void MaxPartnerRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxSiblingRelationships() const noexcept;
    void MaxSiblingRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxParentRelationships() const noexcept;
    void MaxParentRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxChildRelationships() const noexcept;
    void MaxChildRelationships(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxJobInfo() const noexcept;
    void MaxJobInfo(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> MaxWebsites() const noexcept;
    void MaxWebsites(optional<int32_t> const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactListSyncStatus Status() const noexcept;
    Windows::Foundation::DateTime LastSuccessfulSyncTime() const noexcept;
    Windows::Foundation::DateTime LastAttemptedSyncTime() const noexcept;
...
{
    void Status(Windows::ApplicationModel::Contacts::ContactListSyncStatus const& value) const noexcept;
    void LastSuccessfulSyncTime(Windows::Foundation::DateTime const& value) const noexcept;
    void LastAttemptedSyncTime(Windows::Foundation::DateTime const& value) const noexcept;
};
...
{
    hstring UnstructuredAddress() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactManagerForUser
{
    ...
    Windows::ApplicationModel::Contacts::ContactNameOrder SystemDisplayNameOrder() const noexcept;
    void SystemDisplayNameOrder(Windows::ApplicationModel::Contacts::ContactNameOrder const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactNameOrder SystemSortOrder() const noexcept;
    void SystemSortOrder(Windows::ApplicationModel::Contacts::ContactNameOrder const& value) const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactManagerStatics5
{
    ...
    bool IncludeMiddleNameInSystemDisplayAndSort() const noexcept;
    void IncludeMiddleNameInSystemDisplayAndSort(bool value) const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactMatchReasonKind Field() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Data::Text::TextSegment> Segments() const noexcept;
...
struct consume_Windows_ApplicationModel_Contacts_IContactName
{
    ...
    void FirstName(param::hstring const& value) const noexcept;
    hstring LastName() const noexcept;
    void LastName(param::hstring const& value) const noexcept;
    hstring MiddleName() const noexcept;
    void MiddleName(param::hstring const& value) const noexcept;
    hstring YomiGivenName() const noexcept;
    void YomiGivenName(param::hstring const& value) const noexcept;
    hstring YomiFamilyName() const noexcept;
    void YomiFamilyName(param::hstring const& value) const noexcept;
    hstring HonorificNameSuffix() const noexcept;
    void HonorificNameSuffix(param::hstring const& value) const noexcept;
    hstring HonorificNamePrefix() const noexcept;
    void HonorificNamePrefix(param::hstring const& value) const noexcept;
    hstring DisplayName() const noexcept;
    hstring YomiDisplayName() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContactPanel
{
    ...
    Windows::Foundation::IReference<Windows::UI::Color> HeaderColor() const noexcept;
    void HeaderColor(optional<Windows::UI::Color> const& value) const noexcept;
...
{
    hstring Number() const noexcept;
    void Number(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactPhoneKind Kind() const noexcept;
    void Kind(Windows::ApplicationModel::Contacts::ContactPhoneKind const& value) const noexcept;
    hstring Description() const noexcept;
    void Description(param::hstring const& value) const noexcept;
};
...
{
    hstring CommitButtonText() const noexcept;
    void CommitButtonText(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactSelectionMode SelectionMode() const noexcept;
    void SelectionMode(Windows::ApplicationModel::Contacts::ContactSelectionMode const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DesiredFields() const noexcept;
...
{
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Contacts::ContactFieldType> DesiredFieldsWithContactFieldType() const noexcept;
...
{
    Windows::ApplicationModel::Contacts::ContactQueryTextSearch TextSearch() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> ContactListIds() const noexcept;
    bool IncludeContactsFromHiddenLists() const noexcept;
    void IncludeContactsFromHiddenLists(bool value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactQueryDesiredFields DesiredFields() const noexcept;
    void DesiredFields(Windows::ApplicationModel::Contacts::ContactQueryDesiredFields const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactAnnotationOperations DesiredOperations() const noexcept;
    void DesiredOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> AnnotationListIds() const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactQuerySearchFields Fields() const noexcept;
    void Fields(Windows::ApplicationModel::Contacts::ContactQuerySearchFields const& value) const noexcept;
    hstring Text() const noexcept;
    void Text(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Contacts::ContactQuerySearchScope SearchScope() const noexcept;
    void SearchScope(Windows::ApplicationModel::Contacts::ContactQuerySearchScope const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Contacts::ContactRelationship Relationship() const noexcept;
    void Relationship(Windows::ApplicationModel::Contacts::ContactRelationship const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Contacts_IContactStore2
{
    ...
    void ContactChanged(event_token const& value) const;
    Windows::ApplicationModel::Contacts::AggregateContactManager AggregateContactManager() const noexcept;
...
{
    hstring RawValue() const noexcept;
    void RawValue(param::hstring const& value) const noexcept;
};
...
{
    [[deprecated("IKnownContactFieldStatics may be altered or unavailable for releases after Windows 8.1. Instead, use ContactAddress, ContactPhone, ContactConnectedServiceAccount or ContactEmail.")]] hstring Email() const noexcept;
    [[deprecated("IKnownContactFieldStatics may be altered or unavailable for releases after Windows 8.1. Instead, use ContactAddress, ContactPhone, ContactConnectedServiceAccount or ContactEmail.")]] hstring PhoneNumber() const noexcept;
    [[deprecated("IKnownContactFieldStatics may be altered or unavailable for releases after Windows 8.1. Instead, use ContactAddress, ContactPhone, ContactConnectedServiceAccount or ContactEmail.")]] hstring Location() const noexcept;
    [[deprecated("IKnownContactFieldStatics may be altered or unavailable for releases after Windows 8.1. Instead, use ContactAddress, ContactPhone, ContactConnectedServiceAccount or ContactEmail.")]] hstring InstantMessage() const noexcept;
...
{
    Windows::Foundation::Collections::IVector<hstring> ContactIds() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactAddress>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Contacts::ContactAddressKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Contacts::ContactAddressKind value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactAnnotation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RemoteId(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_RemoteId(HSTRING value) = 0;
    virtual HRESULT __stdcall get_SupportedOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations* value) = 0;
    virtual HRESULT __stdcall put_SupportedOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactBatch>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Contacts::ContactBatchStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_HeaderKind(Windows::ApplicationModel::Contacts::ContactCardHeaderKind* value) = 0;
    virtual HRESULT __stdcall put_HeaderKind(Windows::ApplicationModel::Contacts::ContactCardHeaderKind value) = 0;
    virtual HRESULT __stdcall get_InitialTabKind(Windows::ApplicationModel::Contacts::ContactCardTabKind* value) = 0;
    virtual HRESULT __stdcall put_InitialTabKind(Windows::ApplicationModel::Contacts::ContactCardTabKind value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ChangeType(Windows::ApplicationModel::Contacts::ContactChangeType* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactDate>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Contacts::ContactDateKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Contacts::ContactDateKind value) = 0;
    virtual HRESULT __stdcall get_Description(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_Description(HSTRING value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactEmail>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Contacts::ContactEmailKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Contacts::ContactEmailKind value) = 0;
    virtual HRESULT __stdcall get_Description(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_Description(HSTRING value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Type(Windows::ApplicationModel::Contacts::ContactFieldType* value) = 0;
    virtual HRESULT __stdcall get_Category(Windows::ApplicationModel::Contacts::ContactFieldCategory* value) = 0;
    virtual HRESULT __stdcall get_Name(HSTRING* value) = 0;
...
{
    virtual HRESULT __stdcall CreateField_Default(HSTRING value, Windows::ApplicationModel::Contacts::ContactFieldType type, ::IUnknown** field) = 0;
    virtual HRESULT __stdcall CreateField_Category(HSTRING value, Windows::ApplicationModel::Contacts::ContactFieldType type, Windows::ApplicationModel::Contacts::ContactFieldCategory category, ::IUnknown** field) = 0;
    virtual HRESULT __stdcall CreateField_Custom(HSTRING name, HSTRING value, Windows::ApplicationModel::Contacts::ContactFieldType type, Windows::ApplicationModel::Contacts::ContactFieldCategory category, ::IUnknown** field) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactInstantMessageFieldFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateInstantMessage_Category(HSTRING userName, Windows::ApplicationModel::Contacts::ContactFieldCategory category, ::IUnknown** field) = 0;
    virtual HRESULT __stdcall CreateInstantMessage_All(HSTRING userName, Windows::ApplicationModel::Contacts::ContactFieldCategory category, HSTRING service, HSTRING displayText, ::IUnknown* verb, ::IUnknown** field) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactList>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OtherAppReadAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppReadAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppReadAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppReadAccess value) = 0;
    virtual HRESULT __stdcall get_OtherAppWriteAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppWriteAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppWriteAccess(Windows::ApplicationModel::Contacts::ContactListOtherAppWriteAccess value) = 0;
    ...
    virtual HRESULT __stdcall get_UserDataAccountId(HSTRING* value) = 0;
    virtual HRESULT __stdcall add_ContactChanged(::IUnknown* value, event_token* returnValue) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactList3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetChangeTracker(HSTRING identity, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Contacts::IContactListLimitedWriteOperations>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall TryCreateOrUpdateContactAsync(::IUnknown* contact, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall TryDeleteContactAsync(HSTRING contactId, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Contacts::ContactListSyncStatus* value) = 0;
    ...
    virtual HRESULT __stdcall add_SyncStatusChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Contacts::ContactListSyncStatus value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactLocationFieldFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateLocation_Category(HSTRING unstructuredAddress, Windows::ApplicationModel::Contacts::ContactFieldCategory category, ::IUnknown** field) = 0;
    virtual HRESULT __stdcall CreateLocation_All(HSTRING unstructuredAddress, Windows::ApplicationModel::Contacts::ContactFieldCategory category, HSTRING street, HSTRING city, HSTRING region, HSTRING country, HSTRING postalCode, ::IUnknown** field) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactManagerForUser>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Contacts::ContactStoreAccessType accessType, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestAnnotationStoreAsync(Windows::ApplicationModel::Contacts::ContactAnnotationStoreAccessType accessType, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall get_SystemDisplayNameOrder(Windows::ApplicationModel::Contacts::ContactNameOrder* value) = 0;
    virtual HRESULT __stdcall put_SystemDisplayNameOrder(Windows::ApplicationModel::Contacts::ContactNameOrder value) = 0;
    virtual HRESULT __stdcall get_SystemSortOrder(Windows::ApplicationModel::Contacts::ContactNameOrder* value) = 0;
    virtual HRESULT __stdcall put_SystemSortOrder(Windows::ApplicationModel::Contacts::ContactNameOrder value) = 0;
...
{
    virtual HRESULT __stdcall ShowContactCard(::IUnknown* contact, Windows::Foundation::Rect selection) = 0;
    virtual HRESULT __stdcall ShowContactCardWithPlacement(::IUnknown* contact, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement) = 0;
    virtual HRESULT __stdcall ShowDelayLoadedContactCard(::IUnknown* contact, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** dataLoader) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactManagerStatics3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestStoreAsyncWithAccessType(Windows::ApplicationModel::Contacts::ContactStoreAccessType accessType, ::IUnknown** store) = 0;
    virtual HRESULT __stdcall RequestAnnotationStoreAsync(Windows::ApplicationModel::Contacts::ContactAnnotationStoreAccessType accessType, ::IUnknown** store) = 0;
    virtual HRESULT __stdcall IsShowContactCardSupported(bool* result) = 0;
    virtual HRESULT __stdcall ShowContactCardWithOptions(::IUnknown* contact, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown* contactCardOptions) = 0;
    virtual HRESULT __stdcall IsShowDelayLoadedContactCardSupported(bool* result) = 0;
    virtual HRESULT __stdcall ShowDelayLoadedContactCardWithOptions(::IUnknown* contact, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown* contactCardOptions, ::IUnknown** dataLoader) = 0;
    virtual HRESULT __stdcall ShowFullContactCard(::IUnknown* contact, ::IUnknown* fullContactCardOptions) = 0;
    virtual HRESULT __stdcall get_SystemDisplayNameOrder(Windows::ApplicationModel::Contacts::ContactNameOrder* value) = 0;
    virtual HRESULT __stdcall put_SystemDisplayNameOrder(Windows::ApplicationModel::Contacts::ContactNameOrder value) = 0;
    virtual HRESULT __stdcall get_SystemSortOrder(Windows::ApplicationModel::Contacts::ContactNameOrder* value) = 0;
...
{
    virtual HRESULT __stdcall get_Field(Windows::ApplicationModel::Contacts::ContactMatchReasonKind* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactPanel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_LaunchFullAppRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LaunchFullAppRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_Closing(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactPhone>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Contacts::ContactPhoneKind* value) = 0;
    virtual HRESULT __stdcall put_Kind(Windows::ApplicationModel::Contacts::ContactPhoneKind value) = 0;
    virtual HRESULT __stdcall get_Description(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_Description(HSTRING value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactPicker>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SelectionMode(Windows::ApplicationModel::Contacts::ContactSelectionMode* value) = 0;
    virtual HRESULT __stdcall put_SelectionMode(Windows::ApplicationModel::Contacts::ContactSelectionMode value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactQueryOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DesiredFields(Windows::ApplicationModel::Contacts::ContactQueryDesiredFields* value) = 0;
    virtual HRESULT __stdcall put_DesiredFields(Windows::ApplicationModel::Contacts::ContactQueryDesiredFields value) = 0;
    virtual HRESULT __stdcall get_DesiredOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations* value) = 0;
    virtual HRESULT __stdcall put_DesiredOperations(Windows::ApplicationModel::Contacts::ContactAnnotationOperations value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Contacts::IContactQueryOptionsFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateWithTextAndFields(HSTRING text, Windows::ApplicationModel::Contacts::ContactQuerySearchFields fields, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Contacts::IContactQueryTextSearch>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Fields(Windows::ApplicationModel::Contacts::ContactQuerySearchFields* value) = 0;
    virtual HRESULT __stdcall put_Fields(Windows::ApplicationModel::Contacts::ContactQuerySearchFields value) = 0;
    virtual HRESULT __stdcall get_Text(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_Text(HSTRING value) = 0;
    virtual HRESULT __stdcall get_SearchScope(Windows::ApplicationModel::Contacts::ContactQuerySearchScope* value) = 0;
    virtual HRESULT __stdcall put_SearchScope(Windows::ApplicationModel::Contacts::ContactQuerySearchScope value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Relationship(Windows::ApplicationModel::Contacts::ContactRelationship* value) = 0;
    virtual HRESULT __stdcall put_Relationship(Windows::ApplicationModel::Contacts::ContactRelationship value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IKnownContactFieldStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ConvertNameToType(HSTRING name, Windows::ApplicationModel::Contacts::ContactFieldType* type) = 0;
    virtual HRESULT __stdcall ConvertTypeToName(Windows::ApplicationModel::Contacts::ContactFieldType type, HSTRING* name) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Contacts::IPinnedContactManager>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall IsPinSurfaceSupported(Windows::ApplicationModel::Contacts::PinnedContactSurface surface, bool* result) = 0;
    virtual HRESULT __stdcall IsContactPinned(::IUnknown* contact, Windows::ApplicationModel::Contacts::PinnedContactSurface surface, bool* result) = 0;
    virtual HRESULT __stdcall RequestPinContactAsync(::IUnknown* contact, Windows::ApplicationModel::Contacts::PinnedContactSurface surface, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestPinContactsAsync(::IUnknown* contacts, Windows::ApplicationModel::Contacts::PinnedContactSurface surface, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestUnpinContactAsync(::IUnknown* contact, Windows::ApplicationModel::Contacts::PinnedContactSurface surface, ::IUnknown** operation) = 0;
