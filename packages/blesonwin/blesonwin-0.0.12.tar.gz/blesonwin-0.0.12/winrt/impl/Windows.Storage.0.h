...
template<> struct is_enum_flag<Windows::Storage::FileAttributes> : std::true_type {};
template<> struct is_enum_flag<Windows::Storage::StorageItemTypes> : std::true_type {};
template<> struct is_enum_flag<Windows::Storage::StorageOpenOptions> : std::true_type {};
...
template <> struct name<Windows::Storage::IAppDataPaths>{ static constexpr auto & value{ L"Windows.Storage.IAppDataPaths" }; };
template <> struct name<Windows::Storage::IAppDataPathsStatics>{ static constexpr auto & value{ L"Windows.Storage.IAppDataPathsStatics" }; };
...
template <> struct name<Windows::Storage::IStorageLibrary3>{ static constexpr auto & value{ L"Windows.Storage.IStorageLibrary3" }; };
...
template <> struct name<Windows::Storage::IStorageProvider2>{ static constexpr auto & value{ L"Windows.Storage.IStorageProvider2" }; };
...
template <> struct name<Windows::Storage::ISystemDataPaths>{ static constexpr auto & value{ L"Windows.Storage.ISystemDataPaths" }; };
template <> struct name<Windows::Storage::ISystemDataPathsStatics>{ static constexpr auto & value{ L"Windows.Storage.ISystemDataPathsStatics" }; };
...
template <> struct name<Windows::Storage::IUserDataPaths>{ static constexpr auto & value{ L"Windows.Storage.IUserDataPaths" }; };
template <> struct name<Windows::Storage::IUserDataPathsStatics>{ static constexpr auto & value{ L"Windows.Storage.IUserDataPathsStatics" }; };
template <> struct name<Windows::Storage::AppDataPaths>{ static constexpr auto & value{ L"Windows.Storage.AppDataPaths" }; };
...
template <> struct name<Windows::Storage::SystemDataPaths>{ static constexpr auto & value{ L"Windows.Storage.SystemDataPaths" }; };
...
template <> struct name<Windows::Storage::UserDataPaths>{ static constexpr auto & value{ L"Windows.Storage.UserDataPaths" }; };
...
{
    hstring Cookies() const noexcept;
    hstring Desktop() const noexcept;
    hstring Documents() const noexcept;
    hstring Favorites() const noexcept;
    hstring History() const noexcept;
    hstring InternetCache() const noexcept;
    hstring LocalAppData() const noexcept;
    hstring ProgramData() const noexcept;
    hstring RoamingAppData() const noexcept;
};
template <> struct consume<Windows::Storage::IAppDataPaths> { template <typename D> using type = consume_Windows_Storage_IAppDataPaths<D>; };

template <typename D>
struct consume_Windows_Storage_IAppDataPathsStatics
{
    Windows::Storage::AppDataPaths GetForUser(Windows::System::User const& user) const;
    Windows::Storage::AppDataPaths GetDefault() const;
};
template <> struct consume<Windows::Storage::IAppDataPathsStatics> { template <typename D> using type = consume_Windows_Storage_IAppDataPathsStatics<D>; };
...
struct consume_Windows_Storage_IApplicationData
{
    ...
    Windows::Storage::ApplicationDataContainer LocalSettings() const noexcept;
    Windows::Storage::ApplicationDataContainer RoamingSettings() const noexcept;
    Windows::Storage::StorageFolder LocalFolder() const noexcept;
    Windows::Storage::StorageFolder RoamingFolder() const noexcept;
    Windows::Storage::StorageFolder TemporaryFolder() const noexcept;
    ...
    uint64_t RoamingStorageQuota() const noexcept;
};
...
{
    Windows::Storage::StorageFolder LocalCacheFolder() const noexcept;
};
...
struct consume_Windows_Storage_IApplicationData3
{
    ...
    Windows::Storage::StorageFolder SharedLocalFolder() const noexcept;
};
...
struct consume_Windows_Storage_IApplicationDataContainer
{
    ...
    Windows::Storage::ApplicationDataLocality Locality() const noexcept;
    Windows::Foundation::Collections::IPropertySet Values() const noexcept;
    Windows::Foundation::Collections::IMapView<hstring, Windows::Storage::ApplicationDataContainer> Containers() const noexcept;
...
{
    Windows::Storage::ApplicationData Current() const noexcept;
};
...
{
    Windows::Storage::StorageFolder CameraRoll() const noexcept;
};
...
{
    Windows::Storage::StorageFolder Playlists() const noexcept;
};
...
{
    Windows::Storage::StorageFolder SavedPictures() const noexcept;
};
...
{
    Windows::Storage::StorageFolder MusicLibrary() const noexcept;
    Windows::Storage::StorageFolder PicturesLibrary() const noexcept;
    Windows::Storage::StorageFolder VideosLibrary() const noexcept;
    Windows::Storage::StorageFolder DocumentsLibrary() const noexcept;
    Windows::Storage::StorageFolder HomeGroup() const noexcept;
    Windows::Storage::StorageFolder RemovableDevices() const noexcept;
    Windows::Storage::StorageFolder MediaServerDevices() const noexcept;
};
...
{
    Windows::Storage::StorageFolder Objects3D() const noexcept;
    Windows::Storage::StorageFolder AppCaptures() const noexcept;
    Windows::Storage::StorageFolder RecordedCalls() const noexcept;
};
...
{
    uint32_t CurrentVersion() const noexcept;
    uint32_t DesiredVersion() const noexcept;
...
{
    hstring FileType() const noexcept;
...
struct consume_Windows_Storage_IStorageItem
{
    ...
    Windows::Storage::FileAttributes Attributes() const noexcept;
    Windows::Foundation::DateTime DateCreated() const noexcept;
...
struct consume_Windows_Storage_IStorageItemProperties
{
    ...
    hstring DisplayType() const noexcept;
    hstring FolderRelativeId() const noexcept;
    Windows::Storage::FileProperties::StorageItemContentProperties Properties() const noexcept;
};
...
{
    Windows::Storage::StorageProvider Provider() const noexcept;
};
...
struct consume_Windows_Storage_IStorageLibrary
{
    ...
    Windows::Foundation::Collections::IObservableVector<Windows::Storage::StorageFolder> Folders() const noexcept;
    Windows::Storage::StorageFolder SaveFolder() const noexcept;
...
{
    Windows::Storage::StorageLibraryChangeTracker ChangeTracker() const noexcept;
};
...
{
    Windows::Foundation::IAsyncOperation<bool> AreFolderSuggestionsAvailableAsync() const;
};
template <> struct consume<Windows::Storage::IStorageLibrary3> { template <typename D> using type = consume_Windows_Storage_IStorageLibrary3<D>; };

template <typename D>
struct consume_Windows_Storage_IStorageLibraryChange
{
    Windows::Storage::StorageLibraryChangeType ChangeType() const noexcept;
    hstring Path() const noexcept;
    hstring PreviousPath() const noexcept;
    bool IsOfType(Windows::Storage::StorageItemTypes const& type) const;
...
{
    Windows::Foundation::IAsyncOperation<bool> IsPropertySupportedForPartialFileAsync(param::hstring const& propertyCanonicalName) const;
};
template <> struct consume<Windows::Storage::IStorageProvider2> { template <typename D> using type = consume_Windows_Storage_IStorageProvider2<D>; };

template <typename D>
struct consume_Windows_Storage_IStorageStreamTransaction
{
    Windows::Storage::Streams::IRandomAccessStream Stream() const noexcept;
...
{
    hstring EncodingBitrate() const noexcept;
};
...
{
    hstring Fonts() const noexcept;
    hstring ProgramData() const noexcept;
    hstring Public() const noexcept;
    hstring PublicDesktop() const noexcept;
    hstring PublicDocuments() const noexcept;
    hstring PublicDownloads() const noexcept;
    hstring PublicMusic() const noexcept;
    hstring PublicPictures() const noexcept;
    hstring PublicVideos() const noexcept;
    hstring System() const noexcept;
    hstring SystemHost() const noexcept;
    hstring SystemX86() const noexcept;
    hstring SystemX64() const noexcept;
    hstring SystemArm() const noexcept;
    hstring UserProfiles() const noexcept;
    hstring Windows() const noexcept;
};
template <> struct consume<Windows::Storage::ISystemDataPaths> { template <typename D> using type = consume_Windows_Storage_ISystemDataPaths<D>; };

template <typename D>
struct consume_Windows_Storage_ISystemDataPathsStatics
{
    Windows::Storage::SystemDataPaths GetDefault() const;
};
template <> struct consume<Windows::Storage::ISystemDataPathsStatics> { template <typename D> using type = consume_Windows_Storage_ISystemDataPathsStatics<D>; };

template <typename D>
struct consume_Windows_Storage_ISystemGPSProperties
{
    hstring LatitudeDecimal() const noexcept;
    hstring LongitudeDecimal() const noexcept;
};
...
{
    hstring HorizontalSize() const noexcept;
    hstring VerticalSize() const noexcept;
};
...
struct consume_Windows_Storage_ISystemMediaProperties
{
    ...
    hstring Producer() const noexcept;
    hstring Publisher() const noexcept;
    hstring SubTitle() const noexcept;
    hstring Writer() const noexcept;
    hstring Year() const noexcept;
};
...
{
    hstring AlbumArtist() const noexcept;
    hstring AlbumTitle() const noexcept;
    hstring Artist() const noexcept;
    hstring Composer() const noexcept;
    hstring Conductor() const noexcept;
    hstring DisplayArtist() const noexcept;
    hstring Genre() const noexcept;
    hstring TrackNumber() const noexcept;
};
...
{
    hstring CameraManufacturer() const noexcept;
    hstring CameraModel() const noexcept;
    hstring DateTaken() const noexcept;
    hstring Orientation() const noexcept;
    hstring PeopleNames() const noexcept;
};
...
struct consume_Windows_Storage_ISystemProperties
{
    ...
    hstring ItemNameDisplay() const noexcept;
    hstring Keywords() const noexcept;
    hstring Rating() const noexcept;
    hstring Title() const noexcept;
    Windows::Storage::SystemAudioProperties Audio() const noexcept;
    Windows::Storage::SystemGPSProperties GPS() const noexcept;
    Windows::Storage::SystemMediaProperties Media() const noexcept;
    Windows::Storage::SystemMusicProperties Music() const noexcept;
    Windows::Storage::SystemPhotoProperties Photo() const noexcept;
    Windows::Storage::SystemVideoProperties Video() const noexcept;
    Windows::Storage::SystemImageProperties Image() const noexcept;
};
...
{
    hstring Director() const noexcept;
    hstring FrameHeight() const noexcept;
    hstring FrameWidth() const noexcept;
    hstring Orientation() const noexcept;
    hstring TotalBitrate() const noexcept;
};
...
{
    hstring CameraRoll() const noexcept;
    hstring Cookies() const noexcept;
    hstring Desktop() const noexcept;
    hstring Documents() const noexcept;
    hstring Downloads() const noexcept;
    hstring Favorites() const noexcept;
    hstring History() const noexcept;
    hstring InternetCache() const noexcept;
    hstring LocalAppData() const noexcept;
    hstring LocalAppDataLow() const noexcept;
    hstring Music() const noexcept;
    hstring Pictures() const noexcept;
    hstring Profile() const noexcept;
    hstring Recent() const noexcept;
    hstring RoamingAppData() const noexcept;
    hstring SavedPictures() const noexcept;
    hstring Screenshots() const noexcept;
    hstring Templates() const noexcept;
    hstring Videos() const noexcept;
};
template <> struct consume<Windows::Storage::IUserDataPaths> { template <typename D> using type = consume_Windows_Storage_IUserDataPaths<D>; };

template <typename D>
struct consume_Windows_Storage_IUserDataPathsStatics
{
    Windows::Storage::UserDataPaths GetForUser(Windows::System::User const& user) const;
...
{
    virtual HRESULT __stdcall get_Cookies(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Desktop(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Documents(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Favorites(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_History(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_InternetCache(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_LocalAppData(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_ProgramData(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_RoamingAppData(HSTRING* value) = 0;
};};
...
template <> struct abi<Windows::Storage::IApplicationData>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ClearAsync(Windows::Storage::ApplicationDataLocality locality, ::IUnknown** clearOperation) = 0;
    ...
    virtual HRESULT __stdcall add_DataChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Storage::IApplicationDataContainer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Locality(Windows::Storage::ApplicationDataLocality* value) = 0;
    virtual HRESULT __stdcall get_Values(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Containers(::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateContainer(HSTRING name, Windows::Storage::ApplicationDataCreateDisposition disposition, ::IUnknown** container) = 0;
...
template <> struct abi<Windows::Storage::IDownloadsFolderStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateFileWithCollisionOptionAsync(HSTRING desiredName, Windows::Storage::CreationCollisionOption option, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall CreateFolderWithCollisionOptionAsync(HSTRING desiredName, Windows::Storage::CreationCollisionOption option, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Storage::IDownloadsFolderStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateFileForUserWithCollisionOptionAsync(::IUnknown* user, HSTRING desiredName, Windows::Storage::CreationCollisionOption option, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall CreateFolderForUserWithCollisionOptionAsync(::IUnknown* user, HSTRING desiredName, Windows::Storage::CreationCollisionOption option, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Storage::IFileIOStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ReadTextWithEncodingAsync(::IUnknown* file, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall WriteTextAsync(::IUnknown* file, HSTRING contents, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall WriteTextWithEncodingAsync(::IUnknown* file, HSTRING contents, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall AppendTextAsync(::IUnknown* file, HSTRING contents, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall AppendTextWithEncodingAsync(::IUnknown* file, HSTRING contents, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall ReadLinesAsync(::IUnknown* file, ::IUnknown** linesOperation) = 0;
    virtual HRESULT __stdcall ReadLinesWithEncodingAsync(::IUnknown* file, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** linesOperation) = 0;
    virtual HRESULT __stdcall WriteLinesAsync(::IUnknown* file, ::IUnknown* lines, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall WriteLinesWithEncodingAsync(::IUnknown* file, ::IUnknown* lines, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AppendLinesAsync(::IUnknown* file, ::IUnknown* lines, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AppendLinesWithEncodingAsync(::IUnknown* file, ::IUnknown* lines, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall GetFolderForUserAsync(::IUnknown* user, Windows::Storage::KnownFolderId folderId, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Storage::IPathIOStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ReadTextWithEncodingAsync(HSTRING absolutePath, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall WriteTextAsync(HSTRING absolutePath, HSTRING contents, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall WriteTextWithEncodingAsync(HSTRING absolutePath, HSTRING contents, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall AppendTextAsync(HSTRING absolutePath, HSTRING contents, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall AppendTextWithEncodingAsync(HSTRING absolutePath, HSTRING contents, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** textOperation) = 0;
    virtual HRESULT __stdcall ReadLinesAsync(HSTRING absolutePath, ::IUnknown** linesOperation) = 0;
    virtual HRESULT __stdcall ReadLinesWithEncodingAsync(HSTRING absolutePath, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** linesOperation) = 0;
    virtual HRESULT __stdcall WriteLinesAsync(HSTRING absolutePath, ::IUnknown* lines, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall WriteLinesWithEncodingAsync(HSTRING absolutePath, ::IUnknown* lines, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AppendLinesAsync(HSTRING absolutePath, ::IUnknown* lines, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall AppendLinesWithEncodingAsync(HSTRING absolutePath, ::IUnknown* lines, Windows::Storage::Streams::UnicodeEncoding encoding, ::IUnknown** operation) = 0;
...
template <> struct abi<Windows::Storage::IStorageFile>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall OpenAsync(Windows::Storage::FileAccessMode accessMode, ::IUnknown** operation) = 0;
    ...
    virtual HRESULT __stdcall CopyOverload(::IUnknown* destinationFolder, HSTRING desiredNewName, Windows::Storage::NameCollisionOption option, ::IUnknown** operation) = 0;
    ...
    virtual HRESULT __stdcall MoveOverload(::IUnknown* destinationFolder, HSTRING desiredNewName, Windows::Storage::NameCollisionOption option, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall OpenWithOptionsAsync(Windows::Storage::FileAccessMode accessMode, Windows::Storage::StorageOpenOptions options, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall OpenTransactedWriteWithOptionsAsync(Windows::Storage::StorageOpenOptions options, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Storage::IStorageFolder>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateFileAsync(HSTRING desiredName, Windows::Storage::CreationCollisionOption options, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall CreateFolderAsyncOverloadDefaultOptions(HSTRING desiredName, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall CreateFolderAsync(HSTRING desiredName, Windows::Storage::CreationCollisionOption options, ::IUnknown** operation) = 0;
...
template <> struct abi<Windows::Storage::IStorageItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RenameAsync(HSTRING desiredName, Windows::Storage::NameCollisionOption option, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall DeleteAsyncOverloadDefaultOptions(::IUnknown** operation) = 0;
    virtual HRESULT __stdcall DeleteAsync(Windows::Storage::StorageDeleteOption option, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetBasicPropertiesAsync(::IUnknown** operation) = 0;
    virtual HRESULT __stdcall get_Name(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Path(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Attributes(Windows::Storage::FileAttributes* value) = 0;
    virtual HRESULT __stdcall get_DateCreated(Windows::Foundation::DateTime* value) = 0;
    virtual HRESULT __stdcall IsOfType(Windows::Storage::StorageItemTypes type, bool* value) = 0;
};};
...
{
    virtual HRESULT __stdcall GetThumbnailAsyncOverloadDefaultSizeDefaultOptions(Windows::Storage::FileProperties::ThumbnailMode mode, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetThumbnailAsyncOverloadDefaultOptions(Windows::Storage::FileProperties::ThumbnailMode mode, uint32_t requestedSize, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetThumbnailAsync(Windows::Storage::FileProperties::ThumbnailMode mode, uint32_t requestedSize, Windows::Storage::FileProperties::ThumbnailOptions options, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall GetScaledImageAsThumbnailAsyncOverloadDefaultSizeDefaultOptions(Windows::Storage::FileProperties::ThumbnailMode mode, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetScaledImageAsThumbnailAsyncOverloadDefaultOptions(Windows::Storage::FileProperties::ThumbnailMode mode, uint32_t requestedSize, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall GetScaledImageAsThumbnailAsync(Windows::Storage::FileProperties::ThumbnailMode mode, uint32_t requestedSize, Windows::Storage::FileProperties::ThumbnailOptions options, ::IUnknown** operation) = 0;
};};
...
template <> struct abi<Windows::Storage::IStorageLibrary>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DefinitionChanged(::IUnknown* handler, event_token* eventCookie) = 0;
...
{
    virtual HRESULT __stdcall AreFolderSuggestionsAvailableAsync(::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Storage::IStorageLibraryChange>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ChangeType(Windows::Storage::StorageLibraryChangeType* value) = 0;
    virtual HRESULT __stdcall get_Path(HSTRING* value) = 0;
...
{
    virtual HRESULT __stdcall GetLibraryAsync(Windows::Storage::KnownLibraryId libraryId, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Storage::IStorageLibraryStatics2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetLibraryForUserAsync(::IUnknown* user, Windows::Storage::KnownLibraryId libraryId, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall IsPropertySupportedForPartialFileAsync(HSTRING propertyCanonicalName, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall FailAndClose(Windows::Storage::StreamedFileFailureMode failureMode) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Fonts(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_ProgramData(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Public(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicDesktop(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicDocuments(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicDownloads(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicMusic(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicPictures(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_PublicVideos(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_System(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SystemHost(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SystemX86(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SystemX64(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SystemArm(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_UserProfiles(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Windows(HSTRING* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_CameraRoll(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Cookies(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Desktop(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Documents(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Downloads(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Favorites(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_History(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_InternetCache(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_LocalAppData(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_LocalAppDataLow(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Music(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Pictures(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Profile(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Recent(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_RoamingAppData(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SavedPictures(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Screenshots(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Templates(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Videos(HSTRING* value) = 0;
};};
