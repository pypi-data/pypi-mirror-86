...
{
    Windows::Media::Import::PhotoImportSession Session() const noexcept;
    bool HasSucceeded() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportItem> DeletedItems() const noexcept;
    uint32_t PhotosCount() const noexcept;
    uint64_t PhotosSizeInBytes() const noexcept;
    uint32_t VideosCount() const noexcept;
    uint64_t VideosSizeInBytes() const noexcept;
    uint32_t SidecarsCount() const noexcept;
    uint64_t SidecarsSizeInBytes() const noexcept;
    uint32_t SiblingsCount() const noexcept;
    uint64_t SiblingsSizeInBytes() const noexcept;
    uint32_t TotalCount() const noexcept;
    uint64_t TotalSizeInBytes() const noexcept;
};
...
struct consume_Windows_Media_Import_IPhotoImportFindItemsResult
{
    Windows::Media::Import::PhotoImportSession Session() const noexcept;
    bool HasSucceeded() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportItem> FoundItems() const noexcept;
    uint32_t PhotosCount() const noexcept;
    uint64_t PhotosSizeInBytes() const noexcept;
    uint32_t VideosCount() const noexcept;
    uint64_t VideosSizeInBytes() const noexcept;
    ...
    Windows::Media::Import::PhotoImportImportMode ImportMode() const noexcept;
    uint32_t SelectedPhotosCount() const noexcept;
    uint64_t SelectedPhotosSizeInBytes() const noexcept;
    uint32_t SelectedVideosCount() const noexcept;
    uint64_t SelectedVideosSizeInBytes() const noexcept;
    uint32_t SelectedSidecarsCount() const noexcept;
    uint64_t SelectedSidecarsSizeInBytes() const noexcept;
    uint32_t SelectedSiblingsCount() const noexcept;
    uint64_t SelectedSiblingsSizeInBytes() const noexcept;
    uint32_t SelectedTotalCount() const noexcept;
    uint64_t SelectedTotalSizeInBytes() const noexcept;
...
struct consume_Windows_Media_Import_IPhotoImportImportItemsResult
{
    Windows::Media::Import::PhotoImportSession Session() const noexcept;
    bool HasSucceeded() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportItem> ImportedItems() const noexcept;
    uint32_t PhotosCount() const noexcept;
    uint64_t PhotosSizeInBytes() const noexcept;
    uint32_t VideosCount() const noexcept;
    uint64_t VideosSizeInBytes() const noexcept;
...
struct consume_Windows_Media_Import_IPhotoImportItem
{
    ...
    uint64_t ItemKey() const noexcept;
    Windows::Media::Import::PhotoImportContentType ContentType() const noexcept;
    uint64_t SizeInBytes() const noexcept;
    Windows::Foundation::DateTime Date() const noexcept;
    Windows::Media::Import::PhotoImportSidecar Sibling() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportSidecar> Sidecars() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportVideoSegment> VideoSegments() const noexcept;
    ...
    Windows::Foundation::Collections::IVectorView<hstring> ImportedFileNames() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> DeletedFileNames() const noexcept;
};
...
{
    Windows::Media::Import::PhotoImportItem ImportedItem() const noexcept;
};
...
{
    Windows::Media::Import::PhotoImportStage Stage() const noexcept;
    Windows::Media::Import::PhotoImportSession Session() const noexcept;
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Media::Import::PhotoImportFindItemsResult, uint32_t> ContinueFindingItemsAsync() const noexcept;
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Media::Import::PhotoImportImportItemsResult, Windows::Media::Import::PhotoImportProgress> ContinueImportingItemsAsync() const noexcept;
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Media::Import::PhotoImportDeleteImportedItemsFromSourceResult, double> ContinueDeletingImportedItemsFromSourceAsync() const noexcept;
};
...
{
    Windows::Media::Import::PhotoImportSource Source() const noexcept;
    GUID SessionId() const noexcept;
    void DestinationFolder(Windows::Storage::IStorageFolder const& value) const noexcept;
    Windows::Storage::IStorageFolder DestinationFolder() const noexcept;
    void AppendSessionDateToDestinationFolder(bool value) const noexcept;
    bool AppendSessionDateToDestinationFolder() const noexcept;
    void SubfolderCreationMode(Windows::Media::Import::PhotoImportSubfolderCreationMode const& value) const noexcept;
    Windows::Media::Import::PhotoImportSubfolderCreationMode SubfolderCreationMode() const noexcept;
    void DestinationFileNamePrefix(param::hstring const& value) const noexcept;
    hstring DestinationFileNamePrefix() const noexcept;
...
{
    void SubfolderDateFormat(Windows::Media::Import::PhotoImportSubfolderDateFormat const& value) const noexcept;
    Windows::Media::Import::PhotoImportSubfolderDateFormat SubfolderDateFormat() const noexcept;
    void RememberDeselectedItems(bool value) const noexcept;
    bool RememberDeselectedItems() const noexcept;
};
...
struct consume_Windows_Media_Import_IPhotoImportSource
{
    ...
    hstring ConnectionProtocol() const noexcept;
    Windows::Media::Import::PhotoImportConnectionTransport ConnectionTransport() const noexcept;
    Windows::Media::Import::PhotoImportSourceType Type() const noexcept;
    Windows::Media::Import::PhotoImportPowerSource PowerSource() const noexcept;
    Windows::Foundation::IReference<uint32_t> BatteryLevelPercent() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> DateTime() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Import::PhotoImportStorageMedium> StorageMedia() const noexcept;
    Windows::Foundation::IReference<bool> IsLocked() const noexcept;
    bool IsMassStorage() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Thumbnail() const noexcept;
...
struct consume_Windows_Media_Import_IPhotoImportStorageMedium
{
    ...
    hstring Description() const noexcept;
    hstring SerialNumber() const noexcept;
    Windows::Media::Import::PhotoImportStorageMediumType StorageMediumType() const noexcept;
    Windows::Media::Import::PhotoImportAccessMode SupportedAccessMode() const noexcept;
    uint64_t CapacityInBytes() const noexcept;
    uint64_t AvailableSpaceInBytes() const noexcept;
    void Refresh() const;
};
...
template <> struct abi<Windows::Media::Import::IPhotoImportFindItemsResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetImportMode(Windows::Media::Import::PhotoImportImportMode value) = 0;
    virtual HRESULT __stdcall get_ImportMode(Windows::Media::Import::PhotoImportImportMode* value) = 0;
    ...
    virtual HRESULT __stdcall add_SelectionChanged(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_ItemImported(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall AddItemsInDateRangeToSelection(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength) = 0;
};};
...
template <> struct abi<Windows::Media::Import::IPhotoImportItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ContentType(Windows::Media::Import::PhotoImportContentType* value) = 0;
...
{
    virtual HRESULT __stdcall get_Stage(Windows::Media::Import::PhotoImportStage* value) = 0;
    virtual HRESULT __stdcall get_Session(::IUnknown** value) = 0;
...
template <> struct abi<Windows::Media::Import::IPhotoImportSession>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_SubfolderCreationMode(Windows::Media::Import::PhotoImportSubfolderCreationMode value) = 0;
    virtual HRESULT __stdcall get_SubfolderCreationMode(Windows::Media::Import::PhotoImportSubfolderCreationMode* value) = 0;
    ...
    virtual HRESULT __stdcall FindItemsAsync(Windows::Media::Import::PhotoImportContentTypeFilter contentTypeFilter, Windows::Media::Import::PhotoImportItemSelectionMode itemSelectionMode, ::IUnknown** operation) = 0;
};};

template <> struct abi<Windows::Media::Import::IPhotoImportSession2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_SubfolderDateFormat(Windows::Media::Import::PhotoImportSubfolderDateFormat value) = 0;
    virtual HRESULT __stdcall get_SubfolderDateFormat(Windows::Media::Import::PhotoImportSubfolderDateFormat* value) = 0;
...
template <> struct abi<Windows::Media::Import::IPhotoImportSource>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ConnectionTransport(Windows::Media::Import::PhotoImportConnectionTransport* value) = 0;
    virtual HRESULT __stdcall get_Type(Windows::Media::Import::PhotoImportSourceType* value) = 0;
    virtual HRESULT __stdcall get_PowerSource(Windows::Media::Import::PhotoImportPowerSource* value) = 0;
...
template <> struct abi<Windows::Media::Import::IPhotoImportStorageMedium>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Description(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SerialNumber(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_StorageMediumType(Windows::Media::Import::PhotoImportStorageMediumType* value) = 0;
    virtual HRESULT __stdcall get_SupportedAccessMode(Windows::Media::Import::PhotoImportAccessMode* value) = 0;
