...
template<> struct is_enum_flag<Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectAxes> : std::true_type {};
...
{
    Windows::Gaming::Input::ForceFeedback::ConditionForceEffectKind Kind() const noexcept;
...
struct consume_Windows_Gaming_Input_ForceFeedback_IForceFeedbackEffect
{
    ...
    Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectState State() const noexcept;
    void Start() const;
    void Stop() const;
};
...
{
    bool AreEffectsPaused() const noexcept;
    double MasterGain() const noexcept;
    void MasterGain(double value) const noexcept;
    bool IsEnabled() const noexcept;
    Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectAxes SupportedAxes() const noexcept;
...
{
    Windows::Gaming::Input::ForceFeedback::PeriodicForceEffectKind Kind() const noexcept;
...
{
    virtual HRESULT __stdcall get_Kind(Windows::Gaming::Input::ForceFeedback::ConditionForceEffectKind* value) = 0;
    virtual HRESULT __stdcall SetParameters(Windows::Foundation::Numerics::float3 direction, float positiveCoefficient, float negativeCoefficient, float maxPositiveMagnitude, float maxNegativeMagnitude, float deadZone, float bias) = 0;
};};

template <> struct abi<Windows::Gaming::Input::ForceFeedback::IConditionForceEffectFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateInstance(Windows::Gaming::Input::ForceFeedback::ConditionForceEffectKind effectKind, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::ForceFeedback::IConstantForceEffect>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall SetParameters(Windows::Foundation::Numerics::float3 vector, Windows::Foundation::TimeSpan duration) = 0;
...
template <> struct abi<Windows::Gaming::Input::ForceFeedback::IForceFeedbackEffect>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectState* value) = 0;
...
template <> struct abi<Windows::Gaming::Input::ForceFeedback::IForceFeedbackMotor>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SupportedAxes(Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectAxes* value) = 0;
...
{
    virtual HRESULT __stdcall get_Kind(Windows::Gaming::Input::ForceFeedback::PeriodicForceEffectKind* value) = 0;
    virtual HRESULT __stdcall SetParameters(Windows::Foundation::Numerics::float3 vector, float frequency, float phase, float bias, Windows::Foundation::TimeSpan duration) = 0;
...
{
    virtual HRESULT __stdcall CreateInstance(Windows::Gaming::Input::ForceFeedback::PeriodicForceEffectKind effectKind, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Gaming::Input::ForceFeedback::IRampForceEffect>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall SetParameters(Windows::Foundation::Numerics::float3 startVector, Windows::Foundation::Numerics::float3 endVector, Windows::Foundation::TimeSpan duration) = 0;
