...
struct WINRT_EBO IAppBroadcastBackgroundService2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IAppBroadcastBackgroundServiceSignInInfo2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IAppBroadcastBackgroundServiceStreamInfo2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IAppCaptureMetadataWriter :
    Windows::Foundation::IInspectable,
