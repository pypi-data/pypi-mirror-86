...
template <> struct is_struct<Windows::Gaming::Input::ArcadeStickReading>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::FlightStickReading>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::GamepadReading>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::GamepadVibration>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::RacingWheelReading>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Gaming::Input::UINavigationReading>
{
    static constexpr bool value{ true };
};
