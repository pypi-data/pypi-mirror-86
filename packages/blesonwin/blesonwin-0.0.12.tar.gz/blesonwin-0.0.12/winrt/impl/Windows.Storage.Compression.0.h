...
template <> struct abi<Windows::Storage::Compression::ICompressorFactory>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateCompressorEx(::IUnknown* underlyingStream, Windows::Storage::Compression::CompressAlgorithm algorithm, uint32_t blockSize, ::IUnknown** createdCompressor) = 0;
};};
