...
struct consume_Windows_ApplicationModel_Payments_IPaymentAddress
{
    ...
    Windows::Foundation::Collections::IVectorView<hstring> AddressLines() const noexcept;
    void AddressLines(param::async_vector_view<hstring> const& value) const noexcept;
    hstring Region() const noexcept;
    void Region(param::hstring const& value) const noexcept;
    hstring City() const noexcept;
    void City(param::hstring const& value) const noexcept;
    hstring DependentLocality() const noexcept;
    void DependentLocality(param::hstring const& value) const noexcept;
    hstring PostalCode() const noexcept;
    void PostalCode(param::hstring const& value) const noexcept;
    hstring SortingCode() const noexcept;
    void SortingCode(param::hstring const& value) const noexcept;
    hstring LanguageCode() const noexcept;
    void LanguageCode(param::hstring const& value) const noexcept;
    hstring Organization() const noexcept;
    void Organization(param::hstring const& value) const noexcept;
    hstring Recipient() const noexcept;
    void Recipient(param::hstring const& value) const noexcept;
    hstring PhoneNumber() const noexcept;
    void PhoneNumber(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::ValueSet Properties() const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentCanMakePaymentResultStatus Status() const noexcept;
};
...
{
    hstring Currency() const noexcept;
    void Currency(param::hstring const& value) const noexcept;
    hstring CurrencySystem() const noexcept;
    void CurrencySystem(param::hstring const& value) const noexcept;
...
{
    Windows::ApplicationModel::Payments::PaymentItem Total() const noexcept;
    void Total(Windows::ApplicationModel::Payments::PaymentItem const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Payments::PaymentItem> DisplayItems() const noexcept;
    void DisplayItems(param::async_vector_view<Windows::ApplicationModel::Payments::PaymentItem> const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Payments::PaymentShippingOption> ShippingOptions() const noexcept;
    void ShippingOptions(param::async_vector_view<Windows::ApplicationModel::Payments::PaymentShippingOption> const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Payments::PaymentDetailsModifier> Modifiers() const noexcept;
    void Modifiers(param::async_vector_view<Windows::ApplicationModel::Payments::PaymentDetailsModifier> const& value) const noexcept;
};
...
{
    hstring JsonData() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> SupportedMethodIds() const noexcept;
    Windows::ApplicationModel::Payments::PaymentItem Total() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Payments::PaymentItem> AdditionalDisplayItems() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Payments_IPaymentItem
{
    ...
    Windows::ApplicationModel::Payments::PaymentCurrencyAmount Amount() const noexcept;
    void Amount(Windows::ApplicationModel::Payments::PaymentCurrencyAmount const& value) const noexcept;
    bool Pending() const noexcept;
    void Pending(bool value) const noexcept;
};
...
{
    hstring PackageFullName() const noexcept;
...
{
    Windows::ApplicationModel::Payments::PaymentOptionPresence RequestPayerEmail() const noexcept;
    void RequestPayerEmail(Windows::ApplicationModel::Payments::PaymentOptionPresence const& value) const noexcept;
    Windows::ApplicationModel::Payments::PaymentOptionPresence RequestPayerName() const noexcept;
    void RequestPayerName(Windows::ApplicationModel::Payments::PaymentOptionPresence const& value) const noexcept;
    Windows::ApplicationModel::Payments::PaymentOptionPresence RequestPayerPhoneNumber() const noexcept;
    void RequestPayerPhoneNumber(Windows::ApplicationModel::Payments::PaymentOptionPresence const& value) const noexcept;
    bool RequestShipping() const noexcept;
    void RequestShipping(bool value) const noexcept;
    Windows::ApplicationModel::Payments::PaymentShippingType ShippingType() const noexcept;
    void ShippingType(Windows::ApplicationModel::Payments::PaymentShippingType const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentMerchantInfo MerchantInfo() const noexcept;
    Windows::ApplicationModel::Payments::PaymentDetails Details() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Payments::PaymentMethodData> MethodData() const noexcept;
    Windows::ApplicationModel::Payments::PaymentOptions Options() const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentRequestChangeKind ChangeKind() const noexcept;
    Windows::ApplicationModel::Payments::PaymentAddress ShippingAddress() const noexcept;
    Windows::ApplicationModel::Payments::PaymentShippingOption SelectedShippingOption() const noexcept;
...
{
    bool ChangeAcceptedByMerchant() const noexcept;
    void ChangeAcceptedByMerchant(bool value) const noexcept;
    hstring Message() const noexcept;
    void Message(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::Payments::PaymentDetails UpdatedPaymentDetails() const noexcept;
    void UpdatedPaymentDetails(Windows::ApplicationModel::Payments::PaymentDetails const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentRequestStatus Status() const noexcept;
    Windows::ApplicationModel::Payments::PaymentResponse Response() const noexcept;
};
...
{
    Windows::ApplicationModel::Payments::PaymentToken PaymentToken() const noexcept;
    Windows::ApplicationModel::Payments::PaymentShippingOption ShippingOption() const noexcept;
    Windows::ApplicationModel::Payments::PaymentAddress ShippingAddress() const noexcept;
    hstring PayerEmail() const noexcept;
    hstring PayerName() const noexcept;
    hstring PayerPhoneNumber() const noexcept;
...
struct consume_Windows_ApplicationModel_Payments_IPaymentShippingOption
{
    ...
    void IsSelected(bool value) const noexcept;
};
...
{
    hstring PaymentMethodId() const noexcept;
    hstring JsonDetails() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Payments::PaymentCanMakePaymentResultStatus* value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Payments::IPaymentCanMakePaymentResultFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::ApplicationModel::Payments::PaymentCanMakePaymentResultStatus value, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall CanMakePaymentAsync(::IUnknown* paymentRequest, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_RequestPayerEmail(Windows::ApplicationModel::Payments::PaymentOptionPresence* value) = 0;
    virtual HRESULT __stdcall put_RequestPayerEmail(Windows::ApplicationModel::Payments::PaymentOptionPresence value) = 0;
    virtual HRESULT __stdcall get_RequestPayerName(Windows::ApplicationModel::Payments::PaymentOptionPresence* value) = 0;
    virtual HRESULT __stdcall put_RequestPayerName(Windows::ApplicationModel::Payments::PaymentOptionPresence value) = 0;
    virtual HRESULT __stdcall get_RequestPayerPhoneNumber(Windows::ApplicationModel::Payments::PaymentOptionPresence* value) = 0;
    virtual HRESULT __stdcall put_RequestPayerPhoneNumber(Windows::ApplicationModel::Payments::PaymentOptionPresence value) = 0;
    virtual HRESULT __stdcall get_RequestShipping(bool* value) = 0;
    virtual HRESULT __stdcall put_RequestShipping(bool value) = 0;
    virtual HRESULT __stdcall get_ShippingType(Windows::ApplicationModel::Payments::PaymentShippingType* value) = 0;
    virtual HRESULT __stdcall put_ShippingType(Windows::ApplicationModel::Payments::PaymentShippingType value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ChangeKind(Windows::ApplicationModel::Payments::PaymentRequestChangeKind* value) = 0;
...
{
    virtual HRESULT __stdcall CreateWithMerchantInfoOptionsAndId(::IUnknown* details, ::IUnknown* methodData, ::IUnknown* merchantInfo, ::IUnknown* options, HSTRING id, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Payments::IPaymentRequestSubmitResult>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Payments::PaymentRequestStatus* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Payments::IPaymentResponse>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CompleteAsync(Windows::ApplicationModel::Payments::PaymentRequestCompletionStatus status, ::IUnknown** result) = 0;
};};
