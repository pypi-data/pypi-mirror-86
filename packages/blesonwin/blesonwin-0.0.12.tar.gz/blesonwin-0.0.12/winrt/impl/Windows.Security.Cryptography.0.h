...
template <> struct abi<Windows::Security::Cryptography::ICryptographicBufferStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ConvertStringToBinary(HSTRING value, Windows::Security::Cryptography::BinaryStringEncoding encoding, ::IUnknown** buffer) = 0;
    virtual HRESULT __stdcall ConvertBinaryToString(Windows::Security::Cryptography::BinaryStringEncoding encoding, ::IUnknown* buffer, HSTRING* value) = 0;
};};
