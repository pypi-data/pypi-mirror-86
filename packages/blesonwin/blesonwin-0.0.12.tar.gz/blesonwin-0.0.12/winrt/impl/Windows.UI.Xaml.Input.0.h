...
template <> struct guid<Windows::UI::Xaml::Input::ICharacterReceivedRoutedEventArgs>{ static constexpr GUID value{ 0x7849FD82,0x48E4,0x444D,{ 0x94,0x19,0x93,0xAB,0x88,0x92,0xC1,0x07 } }; };
...
template <> struct guid<Windows::UI::Xaml::Input::IKeyboardAccelerator>{ static constexpr GUID value{ 0x92E6181E,0x19AE,0x465A,{ 0x9B,0x3C,0xA7,0x1E,0xE9,0xEA,0x74,0x20 } }; };
template <> struct guid<Windows::UI::Xaml::Input::IKeyboardAcceleratorFactory>{ static constexpr GUID value{ 0x44D88A99,0x4BFD,0x4A47,{ 0xA8,0x93,0x51,0x5F,0x38,0x86,0x23,0xF6 } }; };
template <> struct guid<Windows::UI::Xaml::Input::IKeyboardAcceleratorInvokedEventArgs>{ static constexpr GUID value{ 0xC00B03F2,0x04E7,0x4415,{ 0xB1,0x7D,0xD7,0x6B,0x94,0x90,0xDE,0x2B } }; };
template <> struct guid<Windows::UI::Xaml::Input::IKeyboardAcceleratorStatics>{ static constexpr GUID value{ 0x3BD43D51,0x9BB3,0x456D,{ 0xBF,0x15,0x80,0x4A,0xDF,0xB8,0x62,0x61 } }; };
...
template <> struct guid<Windows::UI::Xaml::Input::IPointerRoutedEventArgs2>{ static constexpr GUID value{ 0x0821F294,0x1DE6,0x4711,{ 0xBA,0x7C,0x8D,0x4B,0x8B,0x09,0x11,0xD0 } }; };
template <> struct guid<Windows::UI::Xaml::Input::IProcessKeyboardAcceleratorEventArgs>{ static constexpr GUID value{ 0xFB79C216,0x972B,0x440C,{ 0x9B,0x83,0x2B,0x41,0x98,0xDC,0xF0,0x9D } }; };
...
{
    hstring PressedKeys() const noexcept;
};
...
{
    bool IsDisplayModeEnabled() const noexcept;
...
{
    bool AreKeyTipsEnabled() const noexcept;
    void AreKeyTipsEnabled(bool value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Input_ICharacterReceivedRoutedEventArgs
{
    ...
    Windows::UI::Core::CorePhysicalKeyStatus KeyStatus() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
};
...
{
    Windows::Devices::Input::PointerDeviceType PointerDeviceType() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyObject SearchRoot() const noexcept;
    void SearchRoot(Windows::UI::Xaml::DependencyObject const& value) const noexcept;
    Windows::Foundation::Rect ExclusionRect() const noexcept;
    void ExclusionRect(Windows::Foundation::Rect const& value) const noexcept;
    Windows::Foundation::Rect HintRect() const noexcept;
    void HintRect(Windows::Foundation::Rect const& value) const noexcept;
    Windows::UI::Xaml::Input::XYFocusNavigationStrategyOverride XYFocusNavigationStrategyOverride() const noexcept;
    void XYFocusNavigationStrategyOverride(Windows::UI::Xaml::Input::XYFocusNavigationStrategyOverride const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyObject OldFocusedElement() const noexcept;
    Windows::UI::Xaml::DependencyObject NewFocusedElement() const noexcept;
    void NewFocusedElement(Windows::UI::Xaml::DependencyObject const& value) const noexcept;
    Windows::UI::Xaml::FocusState FocusState() const noexcept;
    Windows::UI::Xaml::Input::FocusNavigationDirection Direction() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::UI::Xaml::Input::FocusInputDeviceKind InputDevice() const noexcept;
...
{
    Windows::Devices::Input::PointerDeviceType PointerDeviceType() const noexcept;
    Windows::UI::Input::HoldingState HoldingState() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::Foundation::Point GetPosition(Windows::UI::Xaml::UIElement const& relativeTo) const;
};
...
{
    double DesiredDeceleration() const noexcept;
    void DesiredDeceleration(double value) const noexcept;
    double DesiredExpansion() const noexcept;
    void DesiredExpansion(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Input_IInertiaRotationBehavior
{
    double DesiredDeceleration() const noexcept;
    void DesiredDeceleration(double value) const noexcept;
    double DesiredRotation() const noexcept;
    void DesiredRotation(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Input_IInertiaTranslationBehavior
{
    double DesiredDeceleration() const noexcept;
    void DesiredDeceleration(double value) const noexcept;
    double DesiredDisplacement() const noexcept;
    void DesiredDisplacement(double value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Input::InputScopeName> Names() const noexcept;
};
...
{
    Windows::UI::Xaml::Input::InputScopeNameValue NameValue() const noexcept;
    void NameValue(Windows::UI::Xaml::Input::InputScopeNameValue const& value) const noexcept;
};
...
{
    Windows::System::VirtualKey Key() const noexcept;
    Windows::UI::Core::CorePhysicalKeyStatus KeyStatus() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
};
...
{
    Windows::System::VirtualKey OriginalKey() const noexcept;
};
...
{
    Windows::System::VirtualKey Key() const noexcept;
    void Key(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKeyModifiers Modifiers() const noexcept;
    void Modifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    bool IsEnabled() const noexcept;
    void IsEnabled(bool value) const noexcept;
    Windows::UI::Xaml::DependencyObject ScopeOwner() const noexcept;
    void ScopeOwner(Windows::UI::Xaml::DependencyObject const& value) const noexcept;
    event_token Invoked(Windows::Foundation::TypedEventHandler<Windows::UI::Xaml::Input::KeyboardAccelerator, Windows::UI::Xaml::Input::KeyboardAcceleratorInvokedEventArgs> const& value) const;
    using Invoked_revoker = event_revoker<Windows::UI::Xaml::Input::IKeyboardAccelerator>;
    Invoked_revoker Invoked(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::UI::Xaml::Input::KeyboardAccelerator, Windows::UI::Xaml::Input::KeyboardAcceleratorInvokedEventArgs> const& value) const;
...
{
    Windows::UI::Xaml::Input::KeyboardAccelerator CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const;
};
...
struct consume_Windows_UI_Xaml_Input_IKeyboardAcceleratorInvokedEventArgs
{
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::UI::Xaml::DependencyObject Element() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty KeyProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ModifiersProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ScopeOwnerProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::UIElement Container() const noexcept;
    Windows::Foundation::Point Position() const noexcept;
    bool IsInertial() const noexcept;
    Windows::UI::Input::ManipulationDelta Cumulative() const noexcept;
    Windows::UI::Input::ManipulationVelocities Velocities() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::Devices::Input::PointerDeviceType PointerDeviceType() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Input_IManipulationDeltaRoutedEventArgs
{
    ...
    Windows::Foundation::Point Position() const noexcept;
    bool IsInertial() const noexcept;
    Windows::UI::Input::ManipulationDelta Delta() const noexcept;
    Windows::UI::Input::ManipulationDelta Cumulative() const noexcept;
    Windows::UI::Input::ManipulationVelocities Velocities() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
...
{
    Windows::UI::Xaml::UIElement Container() const noexcept;
    Windows::UI::Xaml::Input::InertiaExpansionBehavior ExpansionBehavior() const noexcept;
    void ExpansionBehavior(Windows::UI::Xaml::Input::InertiaExpansionBehavior const& value) const noexcept;
    Windows::UI::Xaml::Input::InertiaRotationBehavior RotationBehavior() const noexcept;
    void RotationBehavior(Windows::UI::Xaml::Input::InertiaRotationBehavior const& value) const noexcept;
    Windows::UI::Xaml::Input::InertiaTranslationBehavior TranslationBehavior() const noexcept;
    void TranslationBehavior(Windows::UI::Xaml::Input::InertiaTranslationBehavior const& value) const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
    Windows::Devices::Input::PointerDeviceType PointerDeviceType() const noexcept;
    Windows::UI::Input::ManipulationDelta Delta() const noexcept;
...
struct consume_Windows_UI_Xaml_Input_IManipulationPivot
{
    ...
    void Radius(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::Input::ManipulationModes Mode() const noexcept;
    void Mode(Windows::UI::Xaml::Input::ManipulationModes const& value) const noexcept;
    Windows::UI::Xaml::UIElement Container() const noexcept;
    void Container(Windows::UI::Xaml::UIElement const& value) const noexcept;
    Windows::UI::Xaml::Input::ManipulationPivot Pivot() const noexcept;
    void Pivot(Windows::UI::Xaml::Input::ManipulationPivot const& value) const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
};
...
{
    Windows::UI::Xaml::Input::Pointer Pointer() const noexcept;
    Windows::System::VirtualKeyModifiers KeyModifiers() const noexcept;
    bool Handled() const noexcept;
    void Handled(bool value) const noexcept;
...
template <> struct abi<Windows::UI::Xaml::Input::IAccessKeyManagerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_IsDisplayModeEnabledChanged(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::Input::ICharacterReceivedRoutedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_KeyStatus(struct_of<12>* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_CanExecuteChanged(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::Input::IContextRequestedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
    virtual HRESULT __stdcall TryGetPosition(::IUnknown* relativeTo, Windows::Foundation::Point* point, bool* returnValue) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Input::IDoubleTappedRoutedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_PointerDeviceType(Windows::Devices::Input::PointerDeviceType* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
    virtual HRESULT __stdcall GetPosition(::IUnknown* relativeTo, Windows::Foundation::Point* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Input::IFindNextElementOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_XYFocusNavigationStrategyOverride(Windows::UI::Xaml::Input::XYFocusNavigationStrategyOverride* value) = 0;
    virtual HRESULT __stdcall put_XYFocusNavigationStrategyOverride(Windows::UI::Xaml::Input::XYFocusNavigationStrategyOverride value) = 0;
};};
...
{
    virtual HRESULT __stdcall TryMoveFocus(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, bool* returnValue) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Input::IFocusManagerStatics3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall FindNextFocusableElement(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindNextFocusableElementWithHint(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, Windows::Foundation::Rect hintRect, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Input::IFocusManagerStatics4>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall TryMoveFocusWithOptions(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, ::IUnknown* focusNavigationOptions, bool* returnValue) = 0;
    virtual HRESULT __stdcall FindNextElement(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, ::IUnknown** returnValue) = 0;
    ...
    virtual HRESULT __stdcall FindNextElementWithOptions(Windows::UI::Xaml::Input::FocusNavigationDirection focusNavigationDirection, ::IUnknown* focusNavigationOptions, ::IUnknown** returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Input::IGettingFocusEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Direction(Windows::UI::Xaml::Input::FocusNavigationDirection* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
    virtual HRESULT __stdcall get_InputDevice(Windows::UI::Xaml::Input::FocusInputDeviceKind* value) = 0;
...
{
    virtual HRESULT __stdcall get_PointerDeviceType(Windows::Devices::Input::PointerDeviceType* value) = 0;
    virtual HRESULT __stdcall get_HoldingState(Windows::UI::Input::HoldingState* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
    virtual HRESULT __stdcall GetPosition(::IUnknown* relativeTo, Windows::Foundation::Point* returnValue) = 0;
};};
...
{
    virtual HRESULT __stdcall get_NameValue(Windows::UI::Xaml::Input::InputScopeNameValue* value) = 0;
    virtual HRESULT __stdcall put_NameValue(Windows::UI::Xaml::Input::InputScopeNameValue value) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Input::IInputScopeNameFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateInstance(Windows::UI::Xaml::Input::InputScopeNameValue nameValue, ::IUnknown** instance) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Input::IKeyRoutedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Key(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall get_KeyStatus(struct_of<12>* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_OriginalKey(Windows::System::VirtualKey* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Key(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_Key(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_Modifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_Modifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_IsEnabled(bool* value) = 0;
    virtual HRESULT __stdcall put_IsEnabled(bool value) = 0;
    virtual HRESULT __stdcall get_ScopeOwner(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_ScopeOwner(::IUnknown* value) = 0;
    virtual HRESULT __stdcall add_Invoked(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_KeyProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_ModifiersProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_IsEnabledProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_ScopeOwnerProperty(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Input::IManipulationCompletedRoutedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Cumulative(struct_of<20>* value) = 0;
    virtual HRESULT __stdcall get_Velocities(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
    virtual HRESULT __stdcall get_PointerDeviceType(Windows::Devices::Input::PointerDeviceType* value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Input::IManipulationDeltaRoutedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Position(Windows::Foundation::Point* value) = 0;
    virtual HRESULT __stdcall get_IsInertial(bool* value) = 0;
    virtual HRESULT __stdcall get_Delta(struct_of<20>* value) = 0;
    virtual HRESULT __stdcall get_Cumulative(struct_of<20>* value) = 0;
    virtual HRESULT __stdcall get_Velocities(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
...
{
    virtual HRESULT __stdcall CreateInstanceWithCenterAndRadius(Windows::Foundation::Point center, double radius, ::IUnknown** instance) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Mode(Windows::UI::Xaml::Input::ManipulationModes* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::UI::Xaml::Input::ManipulationModes value) = 0;
    virtual HRESULT __stdcall get_Container(::IUnknown** value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Input::IPointerRoutedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_KeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall get_Handled(bool* value) = 0;
    virtual HRESULT __stdcall put_Handled(bool value) = 0;
...
{
    virtual HRESULT __stdcall get_IsGenerated(bool* value) = 0;
};};
