...
struct consume_Windows_Devices_AllJoyn_IAllJoynAboutData
{
    ...
    hstring DefaultAppName() const noexcept;
    void DefaultAppName(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> AppNames() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> DateOfManufacture() const noexcept;
    void DateOfManufacture(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    hstring DefaultDescription() const noexcept;
    void DefaultDescription(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> Descriptions() const noexcept;
    hstring DefaultManufacturer() const noexcept;
    void DefaultManufacturer(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> Manufacturers() const noexcept;
    hstring ModelNumber() const noexcept;
    void ModelNumber(param::hstring const& value) const noexcept;
    hstring SoftwareVersion() const noexcept;
    void SoftwareVersion(param::hstring const& value) const noexcept;
    Windows::Foundation::Uri SupportUrl() const noexcept;
    void SupportUrl(Windows::Foundation::Uri const& value) const noexcept;
    GUID AppId() const noexcept;
    void AppId(GUID const& value) const noexcept;
};
...
struct consume_Windows_Devices_AllJoyn_IAllJoynAboutDataView
{
    ...
    hstring AJSoftwareVersion() const noexcept;
    GUID AppId() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> DateOfManufacture() const noexcept;
    Windows::Globalization::Language DefaultLanguage() const noexcept;
    hstring DeviceId() const noexcept;
    hstring HardwareVersion() const noexcept;
    hstring ModelNumber() const noexcept;
    hstring SoftwareVersion() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Globalization::Language> SupportedLanguages() const noexcept;
    Windows::Foundation::Uri SupportUrl() const noexcept;
    hstring AppName() const noexcept;
    hstring Description() const noexcept;
    hstring DeviceName() const noexcept;
...
{
    hstring UniqueName() const noexcept;
    uint16_t SessionPort() const noexcept;
    Windows::Devices::AllJoyn::AllJoynTrafficType TrafficType() const noexcept;
    bool SamePhysicalNode() const noexcept;
    bool SameNetwork() const noexcept;
    void Accept() const;
};
...
{
    Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism AuthenticationMechanism() const noexcept;
    hstring PeerUniqueName() const noexcept;
...
{
    Windows::Devices::AllJoyn::AllJoynAboutData AboutData() const noexcept;
    hstring ConnectionSpecification() const noexcept;
    Windows::Devices::AllJoyn::AllJoynBusAttachmentState State() const noexcept;
    hstring UniqueName() const noexcept;
    ...
    Windows::Foundation::Collections::IVector<Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism> AuthenticationMechanisms() const noexcept;
...
struct consume_Windows_Devices_AllJoyn_IAllJoynBusObject
{
    ...
    Windows::Devices::AllJoyn::AllJoynBusAttachment BusAttachment() const noexcept;
    Windows::Devices::AllJoyn::AllJoynSession Session() const noexcept;
...
struct consume_Windows_Devices_AllJoyn_IAllJoynCredentials
{
    ...
    Windows::Security::Credentials::PasswordCredential PasswordCredential() const noexcept;
    void PasswordCredential(Windows::Security::Credentials::PasswordCredential const& value) const noexcept;
    Windows::Foundation::TimeSpan Timeout() const noexcept;
    void Timeout(Windows::Foundation::TimeSpan const& value) const noexcept;
};
...
{
    uint16_t AttemptCount() const noexcept;
    Windows::Devices::AllJoyn::AllJoynCredentials Credentials() const noexcept;
    hstring PeerUniqueName() const noexcept;
    hstring RequestedUserName() const noexcept;
...
struct consume_Windows_Devices_AllJoyn_IAllJoynCredentialsVerificationRequestedEventArgs
{
    Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism AuthenticationMechanism() const noexcept;
    hstring PeerUniqueName() const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate PeerCertificate() const noexcept;
    Windows::Networking::Sockets::SocketSslErrorSeverity PeerCertificateErrorSeverity() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::ChainValidationResult> PeerCertificateErrors() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::Certificate> PeerIntermediateCertificates() const noexcept;
    void Accept() const;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    hstring SenderUniqueName() const noexcept;
};
...
{
    hstring UniqueName() const noexcept;
    hstring ObjectPath() const noexcept;
    uint16_t SessionPort() const noexcept;
};
...
{
    Windows::Devices::AllJoyn::AllJoynSessionLostReason Reason() const noexcept;
};
...
{
    int32_t Ok() const noexcept;
    int32_t Fail() const noexcept;
    int32_t OperationTimedOut() const noexcept;
    int32_t OtherEndClosed() const noexcept;
    int32_t ConnectionRefused() const noexcept;
    int32_t AuthenticationFailed() const noexcept;
    int32_t AuthenticationRejectedByUser() const noexcept;
    int32_t SslConnectFailed() const noexcept;
    int32_t SslIdentityVerificationFailed() const noexcept;
    int32_t InsufficientSecurity() const noexcept;
    int32_t InvalidArgument1() const noexcept;
    int32_t InvalidArgument2() const noexcept;
    int32_t InvalidArgument3() const noexcept;
    int32_t InvalidArgument4() const noexcept;
    int32_t InvalidArgument5() const noexcept;
    int32_t InvalidArgument6() const noexcept;
    int32_t InvalidArgument7() const noexcept;
    int32_t InvalidArgument8() const noexcept;
};
...
template <> struct abi<Windows::Devices::AllJoyn::IAllJoynAcceptSessionJoinerEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TrafficType(Windows::Devices::AllJoyn::AllJoynTrafficType* value) = 0;
...
{
    virtual HRESULT __stdcall Create(HSTRING uniqueName, uint16_t sessionPort, Windows::Devices::AllJoyn::AllJoynTrafficType trafficType, uint8_t proximity, ::IUnknown* acceptSessionJoiner, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::Devices::AllJoyn::IAllJoynAuthenticationCompleteEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_AuthenticationMechanism(Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism* value) = 0;
...
template <> struct abi<Windows::Devices::AllJoyn::IAllJoynBusAttachment>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Devices::AllJoyn::AllJoynBusAttachmentState* value) = 0;
    virtual HRESULT __stdcall get_UniqueName(HSTRING* value) = 0;
    ...
    virtual HRESULT __stdcall add_CredentialsRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CredentialsRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_CredentialsVerificationRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CredentialsVerificationRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_AuthenticationComplete(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Devices::AllJoyn::IAllJoynBusAttachment2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_AcceptSessionJoinerRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_AcceptSessionJoinerRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_SessionJoined(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Devices::AllJoyn::IAllJoynCredentialsVerificationRequestedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PeerCertificateErrorSeverity(Windows::Networking::Sockets::SocketSslErrorSeverity* value) = 0;
...
template <> struct abi<Windows::Devices::AllJoyn::IAllJoynSession>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_MemberAdded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MemberAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_MemberRemoved(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MemberRemoved(event_token token) = 0;
    virtual HRESULT __stdcall add_Lost(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Devices::AllJoyn::AllJoynSessionLostReason* value) = 0;
};};

template <> struct abi<Windows::Devices::AllJoyn::IAllJoynSessionLostEventArgsFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(Windows::Devices::AllJoyn::AllJoynSessionLostReason reason, ::IUnknown** result) = 0;
};};
