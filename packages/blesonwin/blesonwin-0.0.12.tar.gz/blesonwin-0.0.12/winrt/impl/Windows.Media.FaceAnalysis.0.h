...
{
    Windows::Graphics::Imaging::BitmapBounds FaceBox() const noexcept;
};
...
struct consume_Windows_Media_FaceAnalysis_IFaceDetector
{
    ...
    Windows::Graphics::Imaging::BitmapSize MinDetectableFaceSize() const noexcept;
    void MinDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const noexcept;
    Windows::Graphics::Imaging::BitmapSize MaxDetectableFaceSize() const noexcept;
    void MaxDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_FaceBox(struct_of<16>* returnValue) = 0;
};};
...
template <> struct abi<Windows::Media::FaceAnalysis::IFaceDetector>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall DetectFacesWithSearchAreaAsync(::IUnknown* image, struct_of<16> searchArea, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall get_MinDetectableFaceSize(struct_of<8>* returnValue) = 0;
    virtual HRESULT __stdcall put_MinDetectableFaceSize(struct_of<8> value) = 0;
    virtual HRESULT __stdcall get_MaxDetectableFaceSize(struct_of<8>* returnValue) = 0;
    virtual HRESULT __stdcall put_MaxDetectableFaceSize(struct_of<8> value) = 0;
};};
...
template <> struct abi<Windows::Media::FaceAnalysis::IFaceDetectorStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall IsBitmapPixelFormatSupported(Windows::Graphics::Imaging::BitmapPixelFormat bitmapPixelFormat, bool* result) = 0;
