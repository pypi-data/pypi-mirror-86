...
struct WINRT_EBO IMediaStreamDescriptor2 :
    ...
    impl::require<IMediaStreamDescriptor2, Windows::Media::Core::IMediaStreamDescriptor>
{
...
struct WINRT_EBO IMediaStreamSource4 :
    ...
    impl::require<IMediaStreamSource4, Windows::Media::Core::IMediaSource, Windows::Media::Core::IMediaStreamSource>
{
...
struct WINRT_EBO ISceneAnalysisEffectFrame2 :
    ...
    impl::require<ISceneAnalysisEffectFrame2, Windows::Foundation::IClosable, Windows::Media::IMediaFrame>
{
