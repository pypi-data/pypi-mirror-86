...
{
    Windows::Graphics::Printing::PrintTaskOptions PrintTaskOptions() const noexcept;
};
...
{
    int32_t PageNumber() const noexcept;
};
...
{
    Windows::Graphics::Printing::PrintTaskOptions PrintTaskOptions() const noexcept;
    int32_t CurrentPreviewPageNumber() const noexcept;
};
...
{
    Windows::Graphics::Printing::IPrintDocumentSource DocumentSource() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty DocumentSourceProperty() const noexcept;
};
...
template <> struct abi<Windows::UI::Xaml::Printing::IPrintDocument>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Paginate(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Paginate(event_token token) = 0;
    virtual HRESULT __stdcall add_GetPreviewPage(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_GetPreviewPage(event_token token) = 0;
    virtual HRESULT __stdcall add_AddPages(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall SetPreviewPageCount(int32_t count, Windows::UI::Xaml::Printing::PreviewPageCountType type) = 0;
