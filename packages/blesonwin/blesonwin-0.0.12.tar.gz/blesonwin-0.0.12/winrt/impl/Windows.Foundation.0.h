...
struct consume_Windows_Foundation_IPropertyValue
{
    ...
    bool IsNumericScalar() const noexcept;
...
{
    hstring AbsoluteUri() const noexcept;
    hstring DisplayUri() const noexcept;
    hstring Domain() const noexcept;
    hstring Extension() const noexcept;
    hstring Fragment() const noexcept;
    hstring Host() const noexcept;
    hstring Password() const noexcept;
    hstring Path() const noexcept;
    hstring Query() const noexcept;
    Windows::Foundation::WwwFormUrlDecoder QueryParsed() const noexcept;
    hstring RawUri() const noexcept;
    hstring SchemeName() const noexcept;
...
{
    hstring AbsoluteCanonicalUri() const noexcept;
    hstring DisplayIri() const noexcept;
};
...
template <> struct abi<Windows::Foundation::IMemoryBufferReference>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Closed(::IUnknown* handler, event_token* cookie) = 0;
...
template <> struct abi<Windows::Foundation::IPropertyValue>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetGuid(GUID* value) = 0;
    virtual HRESULT __stdcall GetDateTime(Windows::Foundation::DateTime* value) = 0;
    virtual HRESULT __stdcall GetTimeSpan(Windows::Foundation::TimeSpan* value) = 0;
    virtual HRESULT __stdcall GetPoint(Windows::Foundation::Point* value) = 0;
    virtual HRESULT __stdcall GetSize(Windows::Foundation::Size* value) = 0;
    virtual HRESULT __stdcall GetRect(Windows::Foundation::Rect* value) = 0;
    ...
    virtual HRESULT __stdcall GetGuidArray(uint32_t* __valueSize, GUID** value) = 0;
    virtual HRESULT __stdcall GetDateTimeArray(uint32_t* __valueSize, Windows::Foundation::DateTime** value) = 0;
    virtual HRESULT __stdcall GetTimeSpanArray(uint32_t* __valueSize, Windows::Foundation::TimeSpan** value) = 0;
    virtual HRESULT __stdcall GetPointArray(uint32_t* __valueSize, Windows::Foundation::Point** value) = 0;
    virtual HRESULT __stdcall GetSizeArray(uint32_t* __valueSize, Windows::Foundation::Size** value) = 0;
    virtual HRESULT __stdcall GetRectArray(uint32_t* __valueSize, Windows::Foundation::Rect** value) = 0;
};};
...
template <> struct abi<Windows::Foundation::IPropertyValueStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateGuid(GUID value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateDateTime(Windows::Foundation::DateTime value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateTimeSpan(Windows::Foundation::TimeSpan value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreatePoint(Windows::Foundation::Point value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateSize(Windows::Foundation::Size value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateRect(Windows::Foundation::Rect value, ::IUnknown** propertyValue) = 0;
    ...
    virtual HRESULT __stdcall CreateGuidArray(uint32_t __valueSize, GUID* value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateDateTimeArray(uint32_t __valueSize, Windows::Foundation::DateTime* value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateTimeSpanArray(uint32_t __valueSize, Windows::Foundation::TimeSpan* value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreatePointArray(uint32_t __valueSize, Windows::Foundation::Point* value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateSizeArray(uint32_t __valueSize, Windows::Foundation::Size* value, ::IUnknown** propertyValue) = 0;
    virtual HRESULT __stdcall CreateRectArray(uint32_t __valueSize, Windows::Foundation::Rect* value, ::IUnknown** propertyValue) = 0;
};};
