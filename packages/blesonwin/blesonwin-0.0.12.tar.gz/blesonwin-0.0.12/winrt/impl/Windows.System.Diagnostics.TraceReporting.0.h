...
{
    GUID ScenarioId() const noexcept;
    uint64_t ProfileHash() const noexcept;
    bool IsExclusive() const noexcept;
    bool IsAutoLogger() const noexcept;
    int64_t MaxTraceDurationFileTime() const noexcept;
    Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTracePriority Priority() const noexcept;
};
...
{
    int64_t RuntimeFileTime() const noexcept;
    int64_t EtwRuntimeFileTime() const noexcept;
};
...
{
    virtual HRESULT __stdcall IsScenarioEnabled(GUID scenarioId, bool* isActive) = 0;
    virtual HRESULT __stdcall TryEscalateScenario(GUID scenarioId, Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticEscalationType escalationType, HSTRING outputDirectory, bool timestampOutputDirectory, bool forceEscalationUpload, ::IUnknown* triggers, bool* result) = 0;
    virtual HRESULT __stdcall DownloadLatestSettingsForNamespace(HSTRING partner, HSTRING feature, bool isScenarioNamespace, bool downloadOverCostedNetwork, bool downloadOverBattery, Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticActionState* result) = 0;
    virtual HRESULT __stdcall GetActiveScenarioList(::IUnknown** scenarioIds) = 0;
    virtual HRESULT __stdcall ForceUpload(Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticEventBufferLatencies latency, bool uploadOverCostedNetwork, bool uploadOverBattery, Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticActionState* result) = 0;
    virtual HRESULT __stdcall IsTraceRunning(Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTraceSlotType slotType, GUID scenarioId, uint64_t traceProfileHash, Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTraceSlotState* slotState) = 0;
    virtual HRESULT __stdcall GetActiveTraceRuntime(Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTraceSlotType slotType, ::IUnknown** traceRuntimeInfo) = 0;
    virtual HRESULT __stdcall GetKnownTraceList(Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTraceSlotType slotType, ::IUnknown** traceInfo) = 0;
};};
...
template <> struct abi<Windows::System::Diagnostics::TraceReporting::IPlatformDiagnosticTraceInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Priority(Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTracePriority* value) = 0;
};};
