...
{
    void Polarity(Windows::Devices::Gpio::GpioChangePolarity const& value) const noexcept;
    Windows::Devices::Gpio::GpioChangePolarity Polarity() const noexcept;
...
{
    int32_t PinCount() const noexcept;
...
struct consume_Windows_Devices_Gpio_IGpioPin
{
    ...
    Windows::Foundation::TimeSpan DebounceTimeout() const noexcept;
    void DebounceTimeout(Windows::Foundation::TimeSpan const& value) const noexcept;
    int32_t PinNumber() const noexcept;
    Windows::Devices::Gpio::GpioSharingMode SharingMode() const noexcept;
...
{
    Windows::Devices::Gpio::GpioPinEdge Edge() const noexcept;
};
...
{
    virtual HRESULT __stdcall put_Polarity(Windows::Devices::Gpio::GpioChangePolarity value) = 0;
    virtual HRESULT __stdcall get_Polarity(Windows::Devices::Gpio::GpioChangePolarity* value) = 0;
    virtual HRESULT __stdcall get_IsStarted(bool* value) = 0;
    virtual HRESULT __stdcall Start() = 0;
    virtual HRESULT __stdcall Stop() = 0;
    virtual HRESULT __stdcall Read(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall Reset(struct_of<16>* value) = 0;
};};
...
template <> struct abi<Windows::Devices::Gpio::IGpioChangeReader>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetNextItem(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall PeekNextItem(struct_of<16>* value) = 0;
...
template <> struct abi<Windows::Devices::Gpio::IGpioController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall OpenPinWithSharingMode(int32_t pinNumber, Windows::Devices::Gpio::GpioSharingMode sharingMode, ::IUnknown** pin) = 0;
    virtual HRESULT __stdcall TryOpenPin(int32_t pinNumber, Windows::Devices::Gpio::GpioSharingMode sharingMode, ::IUnknown** pin, Windows::Devices::Gpio::GpioOpenStatus* openStatus, bool* succeeded) = 0;
};};
...
{
    virtual HRESULT __stdcall add_ValueChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_SharingMode(Windows::Devices::Gpio::GpioSharingMode* value) = 0;
    virtual HRESULT __stdcall IsDriveModeSupported(Windows::Devices::Gpio::GpioPinDriveMode driveMode, bool* supported) = 0;
    virtual HRESULT __stdcall GetDriveMode(Windows::Devices::Gpio::GpioPinDriveMode* value) = 0;
    virtual HRESULT __stdcall SetDriveMode(Windows::Devices::Gpio::GpioPinDriveMode value) = 0;
    virtual HRESULT __stdcall Write(Windows::Devices::Gpio::GpioPinValue value) = 0;
    virtual HRESULT __stdcall Read(Windows::Devices::Gpio::GpioPinValue* value) = 0;
};};

template <> struct abi<Windows::Devices::Gpio::IGpioPinValueChangedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Edge(Windows::Devices::Gpio::GpioPinEdge* value) = 0;
};};
