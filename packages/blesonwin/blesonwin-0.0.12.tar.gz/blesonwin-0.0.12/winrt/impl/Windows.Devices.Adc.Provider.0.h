...
struct consume_Windows_Devices_Adc_Provider_IAdcControllerProvider
{
    ...
    int32_t ResolutionInBits() const noexcept;
    int32_t MinValue() const noexcept;
    int32_t MaxValue() const noexcept;
    Windows::Devices::Adc::Provider::ProviderAdcChannelMode ChannelMode() const noexcept;
    void ChannelMode(Windows::Devices::Adc::Provider::ProviderAdcChannelMode const& value) const noexcept;
...
template <> struct abi<Windows::Devices::Adc::Provider::IAdcControllerProvider>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ChannelMode(Windows::Devices::Adc::Provider::ProviderAdcChannelMode* value) = 0;
    virtual HRESULT __stdcall put_ChannelMode(Windows::Devices::Adc::Provider::ProviderAdcChannelMode value) = 0;
    virtual HRESULT __stdcall IsChannelModeSupported(Windows::Devices::Adc::Provider::ProviderAdcChannelMode channelMode, bool* result) = 0;
