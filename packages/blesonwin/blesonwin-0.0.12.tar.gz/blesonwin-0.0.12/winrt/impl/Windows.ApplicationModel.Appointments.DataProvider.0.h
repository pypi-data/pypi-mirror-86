...
{
    hstring AppointmentCalendarLocalId() const noexcept;
    hstring AppointmentLocalId() const noexcept;
    ...
    bool NotifyInvitees() const noexcept;
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarCancelMeetingRequest Request() const noexcept;
...
struct consume_Windows_ApplicationModel_Appointments_DataProvider_IAppointmentCalendarCreateOrUpdateAppointmentRequest
{
    ...
    bool NotifyInvitees() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> ChangedProperties() const noexcept;
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarCreateOrUpdateAppointmentRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
struct consume_Windows_ApplicationModel_Appointments_DataProvider_IAppointmentCalendarForwardMeetingRequest
{
    ...
    hstring AppointmentLocalId() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> AppointmentOriginalStartTime() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::AppointmentInvitee> Invitees() const noexcept;
    hstring Subject() const noexcept;
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarForwardMeetingRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarProposeNewTimeForMeetingRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarSyncManagerSyncRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentCalendarUpdateMeetingResponseRequest Request() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
};
...
{
    Windows::ApplicationModel::Appointments::DataProvider::AppointmentDataProviderConnection Connection() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarUpdateMeetingResponseRequest>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AppointmentLocalId(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_AppointmentOriginalStartTime(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse* response) = 0;
    virtual HRESULT __stdcall get_Subject(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Comment(HSTRING* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::DataProvider::IAppointmentDataProviderConnection>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_CreateOrUpdateAppointmentRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CreateOrUpdateAppointmentRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_CancelMeetingRequested(::IUnknown* handler, event_token* token) = 0;
