...
{
    Windows::Storage::Pickers::PickerViewMode ViewMode() const noexcept;
    void ViewMode(Windows::Storage::Pickers::PickerViewMode const& value) const noexcept;
    hstring SettingsIdentifier() const noexcept;
    void SettingsIdentifier(param::hstring const& value) const noexcept;
    Windows::Storage::Pickers::PickerLocationId SuggestedStartLocation() const noexcept;
    void SuggestedStartLocation(Windows::Storage::Pickers::PickerLocationId const& value) const noexcept;
...
{
    [[deprecated("Instead, use PickSingleFileAsync/PickMultipleFilesAsync")]] Windows::Foundation::Collections::ValueSet ContinuationData() const noexcept;
...
struct consume_Windows_Storage_Pickers_IFileSavePicker
{
    ...
    hstring CommitButtonText() const noexcept;
    void CommitButtonText(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::Foundation::Collections::IVector<hstring>> FileTypeChoices() const noexcept;
    hstring DefaultFileExtension() const noexcept;
    void DefaultFileExtension(param::hstring const& value) const noexcept;
    Windows::Storage::StorageFile SuggestedSaveFile() const noexcept;
    void SuggestedSaveFile(Windows::Storage::StorageFile const& value) const noexcept;
    hstring SuggestedFileName() const noexcept;
    void SuggestedFileName(param::hstring const& value) const noexcept;
...
{
    virtual HRESULT __stdcall get_ViewMode(Windows::Storage::Pickers::PickerViewMode* value) = 0;
    virtual HRESULT __stdcall put_ViewMode(Windows::Storage::Pickers::PickerViewMode value) = 0;
    ...
    virtual HRESULT __stdcall get_SuggestedStartLocation(Windows::Storage::Pickers::PickerLocationId* value) = 0;
    virtual HRESULT __stdcall put_SuggestedStartLocation(Windows::Storage::Pickers::PickerLocationId value) = 0;
