...
{
    Windows::Networking::HostName ConnectionHostName() const noexcept;
    hstring ConnectionServiceName() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId ServiceId() const noexcept;
    Windows::Networking::Sockets::SocketProtectionLevel ProtectionLevel() const noexcept;
    Windows::Networking::Sockets::SocketProtectionLevel MaxProtectionLevel() const noexcept;
...
{
    Windows::Devices::Bluetooth::BluetoothDevice Device() const noexcept;
};
...
struct consume_Windows_Devices_Bluetooth_Rfcomm_IRfcommDeviceServicesResult
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Devices::Bluetooth::Rfcomm::RfcommDeviceService> Services() const noexcept;
};
...
struct consume_Windows_Devices_Bluetooth_Rfcomm_IRfcommServiceIdStatics
{
    ...
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId SerialPort() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId ObexObjectPush() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId ObexFileTransfer() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId PhoneBookAccessPce() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId PhoneBookAccessPse() const noexcept;
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId GenericFileTransfer() const noexcept;
};
...
{
    Windows::Devices::Bluetooth::Rfcomm::RfcommServiceId ServiceId() const noexcept;
    Windows::Foundation::Collections::IMap<uint32_t, Windows::Storage::Streams::IBuffer> SdpRawAttributes() const noexcept;
...
template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceService>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MaxProtectionLevel(Windows::Networking::Sockets::SocketProtectionLevel* value) = 0;
    virtual HRESULT __stdcall GetSdpRawAttributesAsync(::IUnknown** asyncOp) = 0;
    virtual HRESULT __stdcall GetSdpRawAttributesWithCacheModeAsync(Windows::Devices::Bluetooth::BluetoothCacheMode cacheMode, ::IUnknown** asyncOp) = 0;
};};
...
template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceServiceStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDeviceSelectorForBluetoothDeviceWithCacheMode(::IUnknown* bluetoothDevice, Windows::Devices::Bluetooth::BluetoothCacheMode cacheMode, HSTRING* selector) = 0;
    ...
    virtual HRESULT __stdcall GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode(::IUnknown* bluetoothDevice, ::IUnknown* serviceId, Windows::Devices::Bluetooth::BluetoothCacheMode cacheMode, HSTRING* selector) = 0;
};};
...
{
    virtual HRESULT __stdcall FromUuid(GUID uuid, ::IUnknown** serviceId) = 0;
