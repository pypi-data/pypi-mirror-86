...
struct consume_Windows_Networking_PushNotifications_IPushNotificationReceivedEventArgs
{
    ...
    Windows::Networking::PushNotifications::PushNotificationType NotificationType() const noexcept;
    Windows::UI::Notifications::ToastNotification ToastNotification() const noexcept;
    Windows::UI::Notifications::TileNotification TileNotification() const noexcept;
    Windows::UI::Notifications::BadgeNotification BadgeNotification() const noexcept;
    Windows::Networking::PushNotifications::RawNotification RawNotification() const noexcept;
};
...
struct consume_Windows_Networking_PushNotifications_IRawNotification2
{
    ...
    hstring ChannelId() const noexcept;
};
...
template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_PushNotificationReceived(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationReceivedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_NotificationType(Windows::Networking::PushNotifications::PushNotificationType* value) = 0;
