...
{
    Windows::Devices::Adc::AdcController Controller() const noexcept;
...
struct consume_Windows_Devices_Adc_IAdcController
{
    ...
    Windows::Devices::Adc::AdcChannelMode ChannelMode() const noexcept;
    void ChannelMode(Windows::Devices::Adc::AdcChannelMode const& value) const noexcept;
...
template <> struct abi<Windows::Devices::Adc::IAdcController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ChannelMode(Windows::Devices::Adc::AdcChannelMode* value) = 0;
    virtual HRESULT __stdcall put_ChannelMode(Windows::Devices::Adc::AdcChannelMode value) = 0;
    virtual HRESULT __stdcall IsChannelModeSupported(Windows::Devices::Adc::AdcChannelMode channelMode, bool* result) = 0;
