...
{
    Windows::Foundation::DateTime TargetTime() const noexcept;
    Windows::Foundation::TimeSpan PredictionAmount() const noexcept;
};
...
{
    virtual HRESULT __stdcall FromHistoricalTargetTime(Windows::Foundation::DateTime targetTime, ::IUnknown** value) = 0;
};};
