...
struct consume_Windows_Security_Credentials_UI_ICredentialPickerOptions
{
    ...
    void ErrorCode(uint32_t value) const noexcept;
    uint32_t ErrorCode() const noexcept;
    void TargetName(param::hstring const& value) const noexcept;
    hstring TargetName() const noexcept;
    void AuthenticationProtocol(Windows::Security::Credentials::UI::AuthenticationProtocol const& value) const noexcept;
    Windows::Security::Credentials::UI::AuthenticationProtocol AuthenticationProtocol() const noexcept;
    void CustomAuthenticationProtocol(param::hstring const& value) const noexcept;
    hstring CustomAuthenticationProtocol() const noexcept;
    void PreviousCredential(Windows::Storage::Streams::IBuffer const& value) const noexcept;
    Windows::Storage::Streams::IBuffer PreviousCredential() const noexcept;
    void AlwaysDisplayDialog(bool value) const noexcept;
    bool AlwaysDisplayDialog() const noexcept;
    void CallerSavesCredential(bool value) const noexcept;
    bool CallerSavesCredential() const noexcept;
    void CredentialSaveOption(Windows::Security::Credentials::UI::CredentialSaveOption const& value) const noexcept;
    Windows::Security::Credentials::UI::CredentialSaveOption CredentialSaveOption() const noexcept;
};
...
struct consume_Windows_Security_Credentials_UI_ICredentialPickerResults
{
    uint32_t ErrorCode() const noexcept;
    Windows::Security::Credentials::UI::CredentialSaveOption CredentialSaveOption() const noexcept;
    bool CredentialSaved() const noexcept;
    Windows::Storage::Streams::IBuffer Credential() const noexcept;
    hstring CredentialDomainName() const noexcept;
    hstring CredentialUserName() const noexcept;
    hstring CredentialPassword() const noexcept;
};
...
template <> struct abi<Windows::Security::Credentials::UI::ICredentialPickerOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_AuthenticationProtocol(Windows::Security::Credentials::UI::AuthenticationProtocol value) = 0;
    virtual HRESULT __stdcall get_AuthenticationProtocol(Windows::Security::Credentials::UI::AuthenticationProtocol* value) = 0;
    ...
    virtual HRESULT __stdcall put_CredentialSaveOption(Windows::Security::Credentials::UI::CredentialSaveOption value) = 0;
    virtual HRESULT __stdcall get_CredentialSaveOption(Windows::Security::Credentials::UI::CredentialSaveOption* value) = 0;
};};
