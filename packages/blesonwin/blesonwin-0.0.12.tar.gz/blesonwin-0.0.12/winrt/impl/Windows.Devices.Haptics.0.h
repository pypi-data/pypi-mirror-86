...
{
    uint16_t Click() const noexcept;
    uint16_t BuzzContinuous() const noexcept;
    uint16_t RumbleContinuous() const noexcept;
    uint16_t Press() const noexcept;
    uint16_t Release() const noexcept;
};
...
struct consume_Windows_Devices_Haptics_ISimpleHapticsController
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Devices::Haptics::SimpleHapticsControllerFeedback> SupportedFeedback() const noexcept;
    bool IsIntensitySupported() const noexcept;
    bool IsPlayCountSupported() const noexcept;
    bool IsPlayDurationSupported() const noexcept;
    bool IsReplayPauseIntervalSupported() const noexcept;
...
{
    uint16_t Waveform() const noexcept;
...
template <> struct abi<Windows::Devices::Haptics::ISimpleHapticsController>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SendHapticFeedbackForDuration(::IUnknown* feedback, double intensity, Windows::Foundation::TimeSpan playDuration) = 0;
    virtual HRESULT __stdcall SendHapticFeedbackForPlayCount(::IUnknown* feedback, double intensity, int32_t playCount, Windows::Foundation::TimeSpan replayPauseInterval) = 0;
};};
