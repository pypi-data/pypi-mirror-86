...
{
    Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationStatus Status() const noexcept;
    Windows::Networking::HostName IPAddress() const noexcept;
    bool HasInstanceNameChanged() const noexcept;
};
...
{
    hstring DnssdServiceInstanceName() const noexcept;
    void DnssdServiceInstanceName(param::hstring const& value) const noexcept;
    Windows::Networking::HostName HostName() const noexcept;
    void HostName(Windows::Networking::HostName const& value) const noexcept;
    uint16_t Port() const noexcept;
    void Port(uint16_t value) const noexcept;
    uint16_t Priority() const noexcept;
    void Priority(uint16_t value) const noexcept;
    uint16_t Weight() const noexcept;
    void Weight(uint16_t value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, hstring> TextAttributes() const noexcept;
...
struct consume_Windows_Networking_ServiceDiscovery_Dnssd_IDnssdServiceWatcher
{
    ...
    Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcherStatus Status() const noexcept;
    void Start() const;
    void Stop() const;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationStatus* value) = 0;
...
template <> struct abi<Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcherStatus* status) = 0;
