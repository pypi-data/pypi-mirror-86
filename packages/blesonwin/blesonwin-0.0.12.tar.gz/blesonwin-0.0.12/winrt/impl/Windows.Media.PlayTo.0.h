...
enum class [[deprecated("PlayToConnectionError may be altered or unavailable for releases after Windows 10. Instead, use CastingConnectionErrorStatus.")]] PlayToConnectionError : int32_t
{
    None = 0,
...
enum class [[deprecated("PlayToConnectionState may be altered or unavailable for releases after Windows 10. Instead, use CastingConnectionState.")]] PlayToConnectionState : int32_t
{
    Disconnected = 0,
    Connected = 1,
    Rendering = 2,
...
{
    [[deprecated("PlayToConnection may be altered or unavailable for releases after Windows 10. Instead, use CastingConnection.")]] Windows::Media::PlayTo::PlayToConnectionState State() const noexcept;
...
{
    [[deprecated("PlayToConnectionErrorEventArgs may be altered or unavailable for releases after Windows 10. Instead, use CastingConnectionErrorOccurredEventArgs.")]] Windows::Media::PlayTo::PlayToConnectionError Code() const noexcept;
    [[deprecated("PlayToConnectionErrorEventArgs may be altered or unavailable for releases after Windows 10. Instead, use CastingConnectionErrorOccurredEventArgs.")]] hstring Message() const noexcept;
};
...
{
    [[deprecated("PlayToConnectionStateChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Media::PlayTo::PlayToConnectionState PreviousState() const noexcept;
    [[deprecated("PlayToConnectionStateChangedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Media::PlayTo::PlayToConnectionState CurrentState() const noexcept;
};
...
{
    [[deprecated("PlayToConnectionTransferredEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Media::PlayTo::PlayToSource PreviousSource() const noexcept;
    [[deprecated("PlayToConnectionTransferredEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Media::PlayTo::PlayToSource CurrentSource() const noexcept;
};
...
struct consume_Windows_Media_PlayTo_IPlayToManager
{
    ...
    [[deprecated("PlayToManager may be altered or unavailable for releases after Windows 10.")]] void DefaultSourceSelection(bool value) const noexcept;
    [[deprecated("PlayToManager may be altered or unavailable for releases after Windows 10.")]] bool DefaultSourceSelection() const noexcept;
};
...
struct consume_Windows_Media_PlayTo_IPlayToReceiver
{
    ...
    void SupportsImage(bool value) const noexcept;
    bool SupportsImage() const noexcept;
    void SupportsAudio(bool value) const noexcept;
    bool SupportsAudio() const noexcept;
    void SupportsVideo(bool value) const noexcept;
    bool SupportsVideo() const noexcept;
    Windows::Foundation::Collections::IPropertySet Properties() const noexcept;
...
{
    [[deprecated("PlayToSource may be altered or unavailable for releases after Windows 10. Instead, use CastingSource.")]] Windows::Media::PlayTo::PlayToConnection Connection() const noexcept;
    [[deprecated("PlayToSource may be altered or unavailable for releases after Windows 10. Instead, use CastingSource.")]] Windows::Media::PlayTo::PlayToSource Next() const noexcept;
    [[deprecated("PlayToSource may be altered or unavailable for releases after Windows 10. Instead, use CastingSource.")]] void Next(Windows::Media::PlayTo::PlayToSource const& value) const noexcept;
...
{
    [[deprecated("PlayToSourceRequest may be altered or unavailable for releases after Windows 10.")]] Windows::Foundation::DateTime Deadline() const noexcept;
...
{
    [[deprecated("PlayToSourceRequestedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Media::PlayTo::PlayToSourceRequest SourceRequest() const noexcept;
};
...
{
    [[deprecated("PlayToSourceSelectedEventArgs may be altered or unavailable for releases after Windows 10.")]] hstring FriendlyName() const noexcept;
    [[deprecated("PlayToSourceSelectedEventArgs may be altered or unavailable for releases after Windows 10.")]] Windows::Storage::Streams::IRandomAccessStreamWithContentType Icon() const noexcept;
    [[deprecated("PlayToSourceSelectedEventArgs may be altered or unavailable for releases after Windows 10.")]] bool SupportsImage() const noexcept;
    [[deprecated("PlayToSourceSelectedEventArgs may be altered or unavailable for releases after Windows 10.")]] bool SupportsAudio() const noexcept;
    [[deprecated("PlayToSourceSelectedEventArgs may be altered or unavailable for releases after Windows 10.")]] bool SupportsVideo() const noexcept;
};
...
{
    [[deprecated("PlayToSourceWithPreferredSourceUri may be altered or unavailable for releases after Windows 10. Instead, use CastingSource.")]] Windows::Foundation::Uri PreferredSourceUri() const noexcept;
    [[deprecated("PlayToSourceWithPreferredSourceUri may be altered or unavailable for releases after Windows 10. Instead, use CastingSource.")]] void PreferredSourceUri(Windows::Foundation::Uri const& value) const noexcept;
};
...
{
    Windows::Storage::Streams::IRandomAccessStreamWithContentType Stream() const noexcept;
    ...
    Windows::Foundation::IReference<Windows::Foundation::DateTime> Date() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Thumbnail() const noexcept;
    Windows::Foundation::IReference<uint32_t> Rating() const noexcept;
...
{
    virtual HRESULT __stdcall get_State(Windows::Media::PlayTo::PlayToConnectionState* value) = 0;
    ...
    virtual HRESULT __stdcall add_Transferred(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Transferred(event_token token) = 0;
    virtual HRESULT __stdcall add_Error(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Code(Windows::Media::PlayTo::PlayToConnectionError* value) = 0;
...
{
    virtual HRESULT __stdcall get_PreviousState(Windows::Media::PlayTo::PlayToConnectionState* value) = 0;
    virtual HRESULT __stdcall get_CurrentState(Windows::Media::PlayTo::PlayToConnectionState* value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_SourceRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SourceRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_SourceSelected(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_PlayRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlayRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_PauseRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PauseRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_SourceChangeRequested(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_CurrentTimeChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CurrentTimeChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_MuteChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MuteChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_VolumeChangeRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_VolumeChangeRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_TimeUpdateRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_TimeUpdateRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_StopRequested(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall NotifyTimeUpdate(Windows::Foundation::TimeSpan currentTime) = 0;
    virtual HRESULT __stdcall NotifyDurationChange(Windows::Foundation::TimeSpan duration) = 0;
