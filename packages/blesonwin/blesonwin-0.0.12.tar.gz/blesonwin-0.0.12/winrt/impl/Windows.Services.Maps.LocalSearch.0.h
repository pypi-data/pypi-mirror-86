...
template <> struct guid<Windows::Services::Maps::LocalSearch::IPlaceInfoHelperStatics>{ static constexpr GUID value{ 0xDD1CA9A7,0xA9C6,0x491B,{ 0xBC,0x09,0xE8,0x0F,0xCE,0xA4,0x8E,0xE6 } }; };
...
{
    hstring BankAndCreditUnions() const noexcept;
    hstring EatDrink() const noexcept;
    hstring Hospitals() const noexcept;
    hstring HotelsAndMotels() const noexcept;
    hstring All() const noexcept;
    hstring Parking() const noexcept;
    hstring SeeDo() const noexcept;
    hstring Shop() const noexcept;
};
...
struct consume_Windows_Services_Maps_LocalSearch_ILocalLocation
{
    ...
    hstring DataAttribution() const noexcept;
};
...
{
    hstring Category() const noexcept;
    Windows::Services::Maps::LocalSearch::LocalLocationRatingInfo RatingInfo() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::LocalSearch::LocalLocationHoursOfOperationItem> HoursOfOperation() const noexcept;
};
...
struct consume_Windows_Services_Maps_LocalSearch_ILocalLocationFinderResult
{
    ...
    Windows::Services::Maps::LocalSearch::LocalLocationFinderStatus Status() const noexcept;
};
...
{
    Windows::Globalization::DayOfWeek Day() const noexcept;
    Windows::Foundation::TimeSpan Start() const noexcept;
    Windows::Foundation::TimeSpan Span() const noexcept;
};
...
{
    Windows::Foundation::IReference<double> AggregateRating() const noexcept;
    Windows::Foundation::IReference<int32_t> RatingCount() const noexcept;
    hstring ProviderIdentifier() const noexcept;
};
...
template <> struct abi<Windows::Services::Maps::LocalSearch::ILocalLocationFinderResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::LocalSearch::LocalLocationFinderStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Day(Windows::Globalization::DayOfWeek* value) = 0;
...
{
    virtual HRESULT __stdcall CreateFromLocalLocation(::IUnknown* location, ::IUnknown** resultValue) = 0;
};};
