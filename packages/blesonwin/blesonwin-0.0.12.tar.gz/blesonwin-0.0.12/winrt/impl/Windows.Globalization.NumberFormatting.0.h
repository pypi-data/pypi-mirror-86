...
struct consume_Windows_Globalization_NumberFormatting_ICurrencyFormatter
{
    ...
    [[deprecated("Currency may be read-only for releases after Windows 8.1. Instead, use a new CurrencyFormatter.")]] void Currency(param::hstring const& value) const noexcept;
};
...
{
    Windows::Globalization::NumberFormatting::CurrencyFormatterMode Mode() const noexcept;
    void Mode(Windows::Globalization::NumberFormatting::CurrencyFormatterMode const& value) const noexcept;
...
{
    Windows::Globalization::NumberFormatting::RoundingAlgorithm RoundingAlgorithm() const noexcept;
    void RoundingAlgorithm(Windows::Globalization::NumberFormatting::RoundingAlgorithm const& value) const noexcept;
    double Increment() const noexcept;
    void Increment(double value) const noexcept;
};
...
struct consume_Windows_Globalization_NumberFormatting_INumberFormatterOptions
{
    ...
    int32_t IntegerDigits() const noexcept;
    void IntegerDigits(int32_t value) const noexcept;
    int32_t FractionDigits() const noexcept;
    void FractionDigits(int32_t value) const noexcept;
    bool IsGrouped() const noexcept;
    void IsGrouped(bool value) const noexcept;
    bool IsDecimalPointAlwaysDisplayed() const noexcept;
    void IsDecimalPointAlwaysDisplayed(bool value) const noexcept;
...
{
    Windows::Globalization::NumberFormatting::INumberRounder NumberRounder() const noexcept;
    void NumberRounder(Windows::Globalization::NumberFormatting::INumberRounder const& value) const noexcept;
};
...
{
    bool IsZeroSigned() const noexcept;
    void IsZeroSigned(bool value) const noexcept;
};
...
struct consume_Windows_Globalization_NumberFormatting_ISignificantDigitsNumberRounder
{
    Windows::Globalization::NumberFormatting::RoundingAlgorithm RoundingAlgorithm() const noexcept;
    void RoundingAlgorithm(Windows::Globalization::NumberFormatting::RoundingAlgorithm const& value) const noexcept;
    uint32_t SignificantDigits() const noexcept;
    void SignificantDigits(uint32_t value) const noexcept;
};
...
{
    int32_t SignificantDigits() const noexcept;
    void SignificantDigits(int32_t value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Mode(Windows::Globalization::NumberFormatting::CurrencyFormatterMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Globalization::NumberFormatting::CurrencyFormatterMode value) = 0;
    virtual HRESULT __stdcall ApplyRoundingForCurrency(Windows::Globalization::NumberFormatting::RoundingAlgorithm roundingAlgorithm) = 0;
};};
...
{
    virtual HRESULT __stdcall get_RoundingAlgorithm(Windows::Globalization::NumberFormatting::RoundingAlgorithm* value) = 0;
    virtual HRESULT __stdcall put_RoundingAlgorithm(Windows::Globalization::NumberFormatting::RoundingAlgorithm value) = 0;
