...
template<> struct is_enum_flag<Windows::Services::Maps::MapManeuverNotices> : std::true_type {};
template<> struct is_enum_flag<Windows::Services::Maps::MapRouteRestrictions> : std::true_type {};
...
template <> struct name<Windows::Services::Maps::IMapRoute4>{ static constexpr auto & value{ L"Windows.Services.Maps.IMapRoute4" }; };
...
template <> struct name<Windows::Services::Maps::IPlaceInfo>{ static constexpr auto & value{ L"Windows.Services.Maps.IPlaceInfo" }; };
template <> struct name<Windows::Services::Maps::IPlaceInfoCreateOptions>{ static constexpr auto & value{ L"Windows.Services.Maps.IPlaceInfoCreateOptions" }; };
template <> struct name<Windows::Services::Maps::IPlaceInfoStatics>{ static constexpr auto & value{ L"Windows.Services.Maps.IPlaceInfoStatics" }; };
...
template <> struct name<Windows::Services::Maps::PlaceInfo>{ static constexpr auto & value{ L"Windows.Services.Maps.PlaceInfo" }; };
template <> struct name<Windows::Services::Maps::PlaceInfoCreateOptions>{ static constexpr auto & value{ L"Windows.Services.Maps.PlaceInfoCreateOptions" }; };
...
struct consume_Windows_Services_Maps_IEnhancedWaypoint
{
    ...
    Windows::Services::Maps::WaypointKind Kind() const noexcept;
};
...
{
    Windows::Services::Maps::ManeuverWarningKind Kind() const noexcept;
    Windows::Services::Maps::ManeuverWarningSeverity Severity() const noexcept;
};
...
{
    hstring BuildingName() const noexcept;
    hstring BuildingFloor() const noexcept;
    hstring BuildingRoom() const noexcept;
    hstring BuildingWing() const noexcept;
    hstring StreetNumber() const noexcept;
    hstring Street() const noexcept;
    hstring Neighborhood() const noexcept;
    hstring District() const noexcept;
    hstring Town() const noexcept;
    hstring Region() const noexcept;
    hstring RegionCode() const noexcept;
    hstring Country() const noexcept;
    hstring CountryCode() const noexcept;
    hstring PostCode() const noexcept;
...
{
    hstring FormattedAddress() const noexcept;
};
...
struct consume_Windows_Services_Maps_IMapLocation
{
    ...
    Windows::Services::Maps::MapAddress Address() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::MapLocation> Locations() const noexcept;
    Windows::Services::Maps::MapLocationFinderStatus Status() const noexcept;
};
...
{
    Windows::Devices::Geolocation::GeoboundingBox BoundingBox() const noexcept;
    double LengthInMeters() const noexcept;
    Windows::Foundation::TimeSpan EstimatedDuration() const noexcept;
    Windows::Devices::Geolocation::Geopath Path() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::MapRouteLeg> Legs() const noexcept;
    bool IsTrafficBased() const noexcept;
};
...
{
    Windows::Services::Maps::MapRouteRestrictions ViolatedRestrictions() const noexcept;
    bool HasBlockedRoads() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan DurationWithoutTraffic() const noexcept;
    Windows::Services::Maps::TrafficCongestion TrafficCongestion() const noexcept;
};
...
{
    bool IsScenic() const noexcept;
};
template <> struct consume<Windows::Services::Maps::IMapRoute4> { template <typename D> using type = consume_Windows_Services_Maps_IMapRoute4<D>; };

template <typename D>
struct consume_Windows_Services_Maps_IMapRouteDrivingOptions
{
    uint32_t MaxAlternateRouteCount() const noexcept;
    void MaxAlternateRouteCount(uint32_t value) const noexcept;
    Windows::Foundation::IReference<double> InitialHeading() const noexcept;
    void InitialHeading(optional<double> const& value) const noexcept;
    Windows::Services::Maps::MapRouteOptimization RouteOptimization() const noexcept;
    void RouteOptimization(Windows::Services::Maps::MapRouteOptimization const& value) const noexcept;
    Windows::Services::Maps::MapRouteRestrictions RouteRestrictions() const noexcept;
    void RouteRestrictions(Windows::Services::Maps::MapRouteRestrictions const& value) const noexcept;
};
...
struct consume_Windows_Services_Maps_IMapRouteFinderResult
{
    ...
    Windows::Services::Maps::MapRouteFinderStatus Status() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::MapRoute> AlternateRoutes() const noexcept;
};
...
struct consume_Windows_Services_Maps_IMapRouteLeg
{
    ...
    double LengthInMeters() const noexcept;
    Windows::Foundation::TimeSpan EstimatedDuration() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::MapRouteManeuver> Maneuvers() const noexcept;
};
...
{
    Windows::Devices::Geolocation::Geopoint StartingPoint() const noexcept;
    double LengthInMeters() const noexcept;
    hstring InstructionText() const noexcept;
    Windows::Services::Maps::MapRouteManeuverKind Kind() const noexcept;
    hstring ExitNumber() const noexcept;
    Windows::Services::Maps::MapManeuverNotices ManeuverNotices() const noexcept;
};
...
{
    double StartHeading() const noexcept;
    double EndHeading() const noexcept;
    hstring StreetName() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::ManeuverWarning> Warnings() const noexcept;
};
...
{
    void ServiceToken(param::hstring const& value) const noexcept;
    hstring ServiceToken() const noexcept;
};
...
{
    hstring WorldViewRegionCode() const noexcept;
};
...
{
    hstring DataAttributions() const noexcept;
};
...
{
    void DataUsagePreference(Windows::Services::Maps::MapServiceDataUsagePreference const& value) const noexcept;
    Windows::Services::Maps::MapServiceDataUsagePreference DataUsagePreference() const noexcept;
};
...
struct consume_Windows_Services_Maps_IPlaceInfo
{
    ...
    hstring Identifier() const noexcept;
    hstring DisplayName() const noexcept;
    hstring DisplayAddress() const noexcept;
    Windows::Devices::Geolocation::IGeoshape Geoshape() const noexcept;
};
template <> struct consume<Windows::Services::Maps::IPlaceInfo> { template <typename D> using type = consume_Windows_Services_Maps_IPlaceInfo<D>; };
...
struct consume_Windows_Services_Maps_IPlaceInfoCreateOptions
{
    ...
    hstring DisplayName() const noexcept;
    void DisplayAddress(param::hstring const& value) const noexcept;
    hstring DisplayAddress() const noexcept;
};
template <> struct consume<Windows::Services::Maps::IPlaceInfoCreateOptions> { template <typename D> using type = consume_Windows_Services_Maps_IPlaceInfoCreateOptions<D>; };

template <typename D>
struct consume_Windows_Services_Maps_IPlaceInfoStatics
{
    Windows::Services::Maps::PlaceInfo Create(Windows::Devices::Geolocation::Geopoint const& referencePoint) const;
    Windows::Services::Maps::PlaceInfo Create(Windows::Devices::Geolocation::Geopoint const& referencePoint, Windows::Services::Maps::PlaceInfoCreateOptions const& options) const;
    Windows::Services::Maps::PlaceInfo CreateFromIdentifier(param::hstring const& identifier) const;
    Windows::Services::Maps::PlaceInfo CreateFromIdentifier(param::hstring const& identifier, Windows::Devices::Geolocation::Geopoint const& defaultPoint, Windows::Services::Maps::PlaceInfoCreateOptions const& options) const;
    Windows::Services::Maps::PlaceInfo CreateFromMapLocation(Windows::Services::Maps::MapLocation const& location) const;
    bool IsShowSupported() const noexcept;
};
template <> struct consume<Windows::Services::Maps::IPlaceInfoStatics> { template <typename D> using type = consume_Windows_Services_Maps_IPlaceInfoStatics<D>; };
...
template <> struct abi<Windows::Services::Maps::IEnhancedWaypoint>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::Services::Maps::WaypointKind* value) = 0;
};};

template <> struct abi<Windows::Services::Maps::IEnhancedWaypointFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(::IUnknown* point, Windows::Services::Maps::WaypointKind kind, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Services::Maps::IManeuverWarning>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Kind(Windows::Services::Maps::ManeuverWarningKind* value) = 0;
    virtual HRESULT __stdcall get_Severity(Windows::Services::Maps::ManeuverWarningSeverity* value) = 0;
};};
...
template <> struct abi<Windows::Services::Maps::IMapLocationFinderResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::MapLocationFinderStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall FindLocationsAtWithAccuracyAsync(::IUnknown* queryPoint, Windows::Services::Maps::MapLocationDesiredAccuracy accuracy, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ViolatedRestrictions(Windows::Services::Maps::MapRouteRestrictions* value) = 0;
...
template <> struct abi<Windows::Services::Maps::IMapRoute3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TrafficCongestion(Windows::Services::Maps::TrafficCongestion* value) = 0;
};};

template <> struct abi<Windows::Services::Maps::IMapRoute4>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_IsScenic(bool* value) = 0;
};};
...
template <> struct abi<Windows::Services::Maps::IMapRouteDrivingOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RouteOptimization(Windows::Services::Maps::MapRouteOptimization* value) = 0;
    virtual HRESULT __stdcall put_RouteOptimization(Windows::Services::Maps::MapRouteOptimization value) = 0;
    virtual HRESULT __stdcall get_RouteRestrictions(Windows::Services::Maps::MapRouteRestrictions* value) = 0;
    virtual HRESULT __stdcall put_RouteRestrictions(Windows::Services::Maps::MapRouteRestrictions value) = 0;
};};
...
template <> struct abi<Windows::Services::Maps::IMapRouteFinderResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::MapRouteFinderStatus* value) = 0;
};};
...
template <> struct abi<Windows::Services::Maps::IMapRouteFinderStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDrivingRouteWithOptimizationAsync(::IUnknown* startPoint, ::IUnknown* endPoint, Windows::Services::Maps::MapRouteOptimization optimization, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteWithOptimizationAndRestrictionsAsync(::IUnknown* startPoint, ::IUnknown* endPoint, Windows::Services::Maps::MapRouteOptimization optimization, Windows::Services::Maps::MapRouteRestrictions restrictions, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteWithOptimizationRestrictionsAndHeadingAsync(::IUnknown* startPoint, ::IUnknown* endPoint, Windows::Services::Maps::MapRouteOptimization optimization, Windows::Services::Maps::MapRouteRestrictions restrictions, double headingInDegrees, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteFromWaypointsAsync(::IUnknown* wayPoints, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteFromWaypointsAndOptimizationAsync(::IUnknown* wayPoints, Windows::Services::Maps::MapRouteOptimization optimization, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteFromWaypointsOptimizationAndRestrictionsAsync(::IUnknown* wayPoints, Windows::Services::Maps::MapRouteOptimization optimization, Windows::Services::Maps::MapRouteRestrictions restrictions, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetDrivingRouteFromWaypointsOptimizationRestrictionsAndHeadingAsync(::IUnknown* wayPoints, Windows::Services::Maps::MapRouteOptimization optimization, Windows::Services::Maps::MapRouteRestrictions restrictions, double headingInDegrees, ::IUnknown** result) = 0;
...
template <> struct abi<Windows::Services::Maps::IMapRouteManeuver>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::Services::Maps::MapRouteManeuverKind* value) = 0;
    virtual HRESULT __stdcall get_ExitNumber(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_ManeuverNotices(Windows::Services::Maps::MapManeuverNotices* value) = 0;
};};
...
{
    virtual HRESULT __stdcall put_DataUsagePreference(Windows::Services::Maps::MapServiceDataUsagePreference value) = 0;
    virtual HRESULT __stdcall get_DataUsagePreference(Windows::Services::Maps::MapServiceDataUsagePreference* value) = 0;
};};

template <> struct abi<Windows::Services::Maps::IPlaceInfo>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Show(Windows::Foundation::Rect selection) = 0;
    virtual HRESULT __stdcall ShowWithPreferredPlacement(Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement) = 0;
    virtual HRESULT __stdcall get_Identifier(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_DisplayAddress(HSTRING* value) = 0;
...
template <> struct abi<Windows::Services::Maps::IPlaceInfoCreateOptions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_DisplayAddress(HSTRING value) = 0;
    virtual HRESULT __stdcall get_DisplayAddress(HSTRING* value) = 0;
};};

template <> struct abi<Windows::Services::Maps::IPlaceInfoStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(::IUnknown* referencePoint, ::IUnknown** resultValue) = 0;
    virtual HRESULT __stdcall CreateWithGeopointAndOptions(::IUnknown* referencePoint, ::IUnknown* options, ::IUnknown** resultValue) = 0;
    virtual HRESULT __stdcall CreateFromIdentifier(HSTRING identifier, ::IUnknown** resultValue) = 0;
    virtual HRESULT __stdcall CreateFromIdentifierWithOptions(HSTRING identifier, ::IUnknown* defaultPoint, ::IUnknown* options, ::IUnknown** resultValue) = 0;
    virtual HRESULT __stdcall CreateFromMapLocation(::IUnknown* location, ::IUnknown** resultValue) = 0;
    virtual HRESULT __stdcall get_IsShowSupported(bool* value) = 0;
};};
