...
{
    Windows::Storage::Streams::IRandomAccessStream Logo() const noexcept;
    Windows::Storage::Streams::IRandomAccessStream Glyph() const noexcept;
    Windows::Foundation::IReference<uint32_t> Number() const noexcept;
    hstring AutomationName() const noexcept;
...
struct consume_Windows_ApplicationModel_LockScreen_ILockScreenInfo
{
    ...
    Windows::Storage::Streams::IRandomAccessStream LockScreenImage() const noexcept;
    ...
    Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::LockScreen::LockScreenBadge> Badges() const noexcept;
    ...
    Windows::Foundation::Collections::IVectorView<hstring> DetailText() const noexcept;
    ...
    Windows::Storage::Streams::IRandomAccessStream AlarmIcon() const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::LockScreen::ILockApplicationHost>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Unlocking(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_LockScreenImageChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_BadgesChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BadgesChanged(event_token token) = 0;
    virtual HRESULT __stdcall get_Badges(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_DetailTextChanged(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_AlarmIconChanged(::IUnknown* handler, event_token* token) = 0;
