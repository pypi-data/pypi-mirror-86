...
{
    Windows::ApplicationModel::Wallet::WalletBarcodeSymbology Symbology() const noexcept;
...
struct consume_Windows_ApplicationModel_Wallet_IWalletItem
{
    ...
    void IsAcknowledged(bool value) const noexcept;
    hstring IssuerDisplayName() const noexcept;
    void IssuerDisplayName(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> LastUpdated() const noexcept;
    void LastUpdated(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Wallet::WalletItemKind Kind() const noexcept;
    Windows::ApplicationModel::Wallet::WalletBarcode Barcode() const noexcept;
    void Barcode(Windows::ApplicationModel::Wallet::WalletBarcode const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ExpirationDate() const noexcept;
    void ExpirationDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Logo159x159() const noexcept;
    void Logo159x159(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Logo336x336() const noexcept;
    void Logo336x336(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Logo99x99() const noexcept;
    void Logo99x99(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    hstring DisplayMessage() const noexcept;
    void DisplayMessage(param::hstring const& value) const noexcept;
    bool IsDisplayMessageLaunchable() const noexcept;
    void IsDisplayMessageLaunchable(bool value) const noexcept;
    hstring LogoText() const noexcept;
    void LogoText(param::hstring const& value) const noexcept;
    Windows::UI::Color HeaderColor() const noexcept;
    void HeaderColor(Windows::UI::Color const& value) const noexcept;
    Windows::UI::Color BodyColor() const noexcept;
    void BodyColor(Windows::UI::Color const& value) const noexcept;
    Windows::UI::Color HeaderFontColor() const noexcept;
    void HeaderFontColor(Windows::UI::Color const& value) const noexcept;
    Windows::UI::Color BodyFontColor() const noexcept;
    void BodyFontColor(Windows::UI::Color const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference HeaderBackgroundImage() const noexcept;
    void HeaderBackgroundImage(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference BodyBackgroundImage() const noexcept;
    void BodyBackgroundImage(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference LogoImage() const noexcept;
    void LogoImage(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference PromotionalImage() const noexcept;
    void PromotionalImage(Windows::Storage::Streams::IRandomAccessStreamReference const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> RelevantDate() const noexcept;
    void RelevantDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    hstring RelevantDateDisplayMessage() const noexcept;
    void RelevantDateDisplayMessage(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletTransaction> TransactionHistory() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletRelevantLocation> RelevantLocations() const noexcept;
    bool IsMoreTransactionHistoryLaunchable() const noexcept;
    void IsMoreTransactionHistoryLaunchable(bool value) const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletItemCustomProperty> DisplayProperties() const noexcept;
    Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletVerb> Verbs() const noexcept;
};
...
struct consume_Windows_ApplicationModel_Wallet_IWalletItemCustomProperty
{
    ...
    bool AutoDetectLinks() const noexcept;
    void AutoDetectLinks(bool value) const noexcept;
    Windows::ApplicationModel::Wallet::WalletDetailViewPosition DetailViewPosition() const noexcept;
    void DetailViewPosition(Windows::ApplicationModel::Wallet::WalletDetailViewPosition const& value) const noexcept;
    Windows::ApplicationModel::Wallet::WalletSummaryViewPosition SummaryViewPosition() const noexcept;
    void SummaryViewPosition(Windows::ApplicationModel::Wallet::WalletSummaryViewPosition const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Wallet_IWalletRelevantLocation
{
    ...
    void Position(Windows::Devices::Geolocation::BasicGeoposition const& value) const noexcept;
    hstring DisplayMessage() const noexcept;
    void DisplayMessage(param::hstring const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Wallet_IWalletTransaction
{
    ...
    hstring DisplayAmount() const noexcept;
    void DisplayAmount(param::hstring const& value) const noexcept;
    bool IgnoreTimeOfDay() const noexcept;
    void IgnoreTimeOfDay(bool value) const noexcept;
    hstring DisplayLocation() const noexcept;
    void DisplayLocation(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> TransactionDate() const noexcept;
    void TransactionDate(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    bool IsLaunchable() const noexcept;
    void IsLaunchable(bool value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Symbology(Windows::ApplicationModel::Wallet::WalletBarcodeSymbology* value) = 0;
...
{
    virtual HRESULT __stdcall CreateWalletBarcode(Windows::ApplicationModel::Wallet::WalletBarcodeSymbology symbology, HSTRING value, ::IUnknown** barcode) = 0;
...
template <> struct abi<Windows::ApplicationModel::Wallet::IWalletItem>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Kind(Windows::ApplicationModel::Wallet::WalletItemKind* value) = 0;
    ...
    virtual HRESULT __stdcall get_HeaderColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_HeaderColor(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_BodyColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_BodyColor(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_HeaderFontColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_HeaderFontColor(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_BodyFontColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_BodyFontColor(struct_of<4> value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Wallet::IWalletItemCustomProperty>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DetailViewPosition(Windows::ApplicationModel::Wallet::WalletDetailViewPosition* value) = 0;
    virtual HRESULT __stdcall put_DetailViewPosition(Windows::ApplicationModel::Wallet::WalletDetailViewPosition value) = 0;
    virtual HRESULT __stdcall get_SummaryViewPosition(Windows::ApplicationModel::Wallet::WalletSummaryViewPosition* value) = 0;
    virtual HRESULT __stdcall put_SummaryViewPosition(Windows::ApplicationModel::Wallet::WalletSummaryViewPosition value) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateWalletItem(Windows::ApplicationModel::Wallet::WalletItemKind kind, HSTRING displayName, ::IUnknown** walletItem) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Wallet::IWalletItemStore>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetItemsWithKindAsync(Windows::ApplicationModel::Wallet::WalletItemKind kind, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall add_ItemsChanged(::IUnknown* handler, event_token* cookie) = 0;
...
template <> struct abi<Windows::ApplicationModel::Wallet::IWalletRelevantLocation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_Position(struct_of<24> value) = 0;
    virtual HRESULT __stdcall get_DisplayMessage(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_DisplayMessage(HSTRING value) = 0;
};};
