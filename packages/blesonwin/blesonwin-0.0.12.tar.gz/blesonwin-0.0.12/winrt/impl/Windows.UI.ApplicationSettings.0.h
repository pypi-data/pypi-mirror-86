...
template<> struct is_enum_flag<Windows::UI::ApplicationSettings::SupportedWebAccountActions> : std::true_type {};
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::ApplicationSettings::WebAccountProviderCommand> WebAccountProviderCommands() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::ApplicationSettings::WebAccountCommand> WebAccountCommands() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::ApplicationSettings::CredentialCommand> CredentialCommands() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::ApplicationSettings::SettingsCommand> Commands() const noexcept;
    hstring HeaderText() const noexcept;
    void HeaderText(param::hstring const& value) const noexcept;
...
struct consume_Windows_UI_ApplicationSettings_ICredentialCommand
{
    ...
    Windows::UI::ApplicationSettings::CredentialCommandCredentialDeletedHandler CredentialDeleted() const noexcept;
};
...
{
    Windows::UI::ApplicationSettings::SettingsCommand AccountsCommand() const noexcept;
};
...
{
    [[deprecated("SettingsPaneCommandsRequest is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Foundation::Collections::IVector<Windows::UI::ApplicationSettings::SettingsCommand> ApplicationCommands() const noexcept;
};
...
{
    [[deprecated("SettingsPaneCommandsRequestedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::UI::ApplicationSettings::SettingsPaneCommandsRequest Request() const noexcept;
};
...
struct consume_Windows_UI_ApplicationSettings_ISettingsPaneStatics
{
    ...
    [[deprecated("SettingsPane is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::UI::ApplicationSettings::SettingsEdgeLocation Edge() const noexcept;
};
...
struct consume_Windows_UI_ApplicationSettings_IWebAccountCommand
{
    ...
    Windows::UI::ApplicationSettings::WebAccountCommandInvokedHandler Invoked() const noexcept;
    Windows::UI::ApplicationSettings::SupportedWebAccountActions Actions() const noexcept;
};
...
{
    Windows::UI::ApplicationSettings::WebAccountAction Action() const noexcept;
};
...
{
    Windows::Security::Credentials::WebAccountProvider WebAccountProvider() const noexcept;
    Windows::UI::ApplicationSettings::WebAccountProviderCommandInvokedHandler Invoked() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_AccountCommandsRequested(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall add_CommandsRequested(::IUnknown* handler, event_token* cookie) = 0;
...
template <> struct abi<Windows::UI::ApplicationSettings::ISettingsPaneStatics>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetForCurrentView(::IUnknown** current) = 0;
    virtual HRESULT __stdcall Show() = 0;
    virtual HRESULT __stdcall get_Edge(Windows::UI::ApplicationSettings::SettingsEdgeLocation* value) = 0;
};};
...
template <> struct abi<Windows::UI::ApplicationSettings::IWebAccountCommand>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Actions(Windows::UI::ApplicationSettings::SupportedWebAccountActions* value) = 0;
};};

template <> struct abi<Windows::UI::ApplicationSettings::IWebAccountCommandFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall CreateWebAccountCommand(::IUnknown* webAccount, ::IUnknown* invoked, Windows::UI::ApplicationSettings::SupportedWebAccountActions actions, ::IUnknown** instance) = 0;
};};

template <> struct abi<Windows::UI::ApplicationSettings::IWebAccountInvokedArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Action(Windows::UI::ApplicationSettings::WebAccountAction* action) = 0;
};};
