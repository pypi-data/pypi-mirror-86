...
{
    Windows::Networking::Vpn::VpnAppIdType Type() const noexcept;
    void Type(Windows::Networking::Vpn::VpnAppIdType const& value) const noexcept;
...
struct consume_Windows_Networking_Vpn_IVpnChannel
{
    ...
    Windows::Networking::Vpn::VpnChannelConfiguration Configuration() const noexcept;
    ...
    void PlugInContext(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::Foundation::IInspectable PlugInContext() const noexcept;
    Windows::Networking::Vpn::VpnSystemHealth SystemHealth() const noexcept;
...
{
    Windows::Networking::Vpn::VpnChannelActivityEventType Type() const noexcept;
};
...
{
    Windows::Networking::Vpn::VpnChannelActivityEventType ActivityState() const noexcept;
};
...
{
    hstring ServerServiceName() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Networking::HostName> ServerHostNameList() const noexcept;
    hstring CustomField() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Foundation::Uri> ServerUris() const noexcept;
};
...
{
    Windows::Security::Credentials::PasswordCredential PasskeyCredential() const noexcept;
    Windows::Security::Cryptography::Certificates::Certificate CertificateCredential() const noexcept;
    hstring AdditionalPin() const noexcept;
    Windows::Security::Credentials::PasswordCredential OldPasswordCredential() const noexcept;
};
...
{
    void InitialCheckState(bool value) const noexcept;
    bool InitialCheckState() const noexcept;
...
{
    void OptionsText(param::async_vector_view<hstring> const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> OptionsText() const noexcept;
    uint32_t Selected() const noexcept;
};
...
{
    void DefaultText(param::hstring const& value) const noexcept;
    hstring DefaultText() const noexcept;
    void NoEcho(bool value) const noexcept;
    bool NoEcho() const noexcept;
...
struct consume_Windows_Networking_Vpn_IVpnCustomPrompt
{
    ...
    void Compulsory(bool value) const noexcept;
    bool Compulsory() const noexcept;
    void Bordered(bool value) const noexcept;
...
{
    void InitialValue(bool value) const noexcept;
    bool InitialValue() const noexcept;
...
struct consume_Windows_Networking_Vpn_IVpnCustomPromptElement
{
    ...
    void Compulsory(bool value) const noexcept;
    bool Compulsory() const noexcept;
    void Emphasized(bool value) const noexcept;
...
{
    Windows::Foundation::Collections::IVector<hstring> Options() const noexcept;
    uint32_t SelectedIndex() const noexcept;
};
...
{
    void PlaceholderText(param::hstring const& value) const noexcept;
    hstring PlaceholderText() const noexcept;
    void IsTextHidden(bool value) const noexcept;
    bool IsTextHidden() const noexcept;
    hstring Text() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnDomainNameInfo> DomainNameList() const noexcept;
    void ProxyAutoConfigurationUri(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Foundation::Uri ProxyAutoConfigurationUri() const noexcept;
};
...
{
    void DomainName(Windows::Networking::HostName const& value) const noexcept;
    Windows::Networking::HostName DomainName() const noexcept;
    void DomainNameType(Windows::Networking::Vpn::VpnDomainNameType const& value) const noexcept;
    Windows::Networking::Vpn::VpnDomainNameType DomainNameType() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::HostName> DnsServers() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::HostName> WebProxyServers() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::Foundation::Uri> WebProxyUris() const noexcept;
};
...
{
    void NamespaceList(param::vector<Windows::Networking::Vpn::VpnNamespaceInfo> const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnNamespaceInfo> NamespaceList() const noexcept;
    void ProxyAutoConfigUri(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Foundation::Uri ProxyAutoConfigUri() const noexcept;
};
...
struct consume_Windows_Networking_Vpn_IVpnNamespaceInfo
{
    ...
    void DnsServers(param::vector<Windows::Networking::HostName> const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::HostName> DnsServers() const noexcept;
    void WebProxyServers(param::vector<Windows::Networking::HostName> const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::HostName> WebProxyServers() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> Servers() const noexcept;
    Windows::Networking::Vpn::VpnRoutingPolicyType RoutingPolicyType() const noexcept;
    void RoutingPolicyType(Windows::Networking::Vpn::VpnRoutingPolicyType const& value) const noexcept;
    Windows::Networking::Vpn::VpnNativeProtocolType NativeProtocolType() const noexcept;
    void NativeProtocolType(Windows::Networking::Vpn::VpnNativeProtocolType const& value) const noexcept;
    Windows::Networking::Vpn::VpnAuthenticationMethod UserAuthenticationMethod() const noexcept;
    void UserAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod const& value) const noexcept;
    Windows::Networking::Vpn::VpnAuthenticationMethod TunnelAuthenticationMethod() const noexcept;
    void TunnelAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod const& value) const noexcept;
    hstring EapConfiguration() const noexcept;
    void EapConfiguration(param::hstring const& value) const noexcept;
};
...
{
    bool RequireVpnClientAppUI() const noexcept;
    void RequireVpnClientAppUI(bool value) const noexcept;
    Windows::Networking::Vpn::VpnManagementConnectionStatus ConnectionStatus() const noexcept;
};
...
{
    Windows::Storage::Streams::Buffer Buffer() const noexcept;
    void Status(Windows::Networking::Vpn::VpnPacketBufferStatus const& value) const noexcept;
    Windows::Networking::Vpn::VpnPacketBufferStatus Status() const noexcept;
    void TransportAffinity(uint32_t value) const noexcept;
    uint32_t TransportAffinity() const noexcept;
};
...
{
    Windows::Networking::Vpn::VpnAppId AppId() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::Foundation::Uri> ServerUris() const noexcept;
    hstring CustomConfiguration() const noexcept;
    void CustomConfiguration(param::hstring const& value) const noexcept;
    hstring VpnPluginPackageFamilyName() const noexcept;
    void VpnPluginPackageFamilyName(param::hstring const& value) const noexcept;
};
...
{
    hstring ProfileName() const noexcept;
    void ProfileName(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnAppId> AppTriggers() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> Routes() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnDomainNameInfo> DomainNameInfoList() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnTrafficFilter> TrafficFilters() const noexcept;
    bool RememberCredentials() const noexcept;
    void RememberCredentials(bool value) const noexcept;
    bool AlwaysOn() const noexcept;
    void AlwaysOn(bool value) const noexcept;
};
...
{
    void Address(Windows::Networking::HostName const& value) const noexcept;
    Windows::Networking::HostName Address() const noexcept;
    void PrefixSize(uint8_t value) const noexcept;
    uint8_t PrefixSize() const noexcept;
};
...
{
    void Ipv4InclusionRoutes(param::vector<Windows::Networking::Vpn::VpnRoute> const& value) const noexcept;
    void Ipv6InclusionRoutes(param::vector<Windows::Networking::Vpn::VpnRoute> const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> Ipv4InclusionRoutes() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> Ipv6InclusionRoutes() const noexcept;
    void Ipv4ExclusionRoutes(param::vector<Windows::Networking::Vpn::VpnRoute> const& value) const noexcept;
    void Ipv6ExclusionRoutes(param::vector<Windows::Networking::Vpn::VpnRoute> const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> Ipv4ExclusionRoutes() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> Ipv6ExclusionRoutes() const noexcept;
    void ExcludeLocalSubnets(bool value) const noexcept;
    bool ExcludeLocalSubnets() const noexcept;
};
...
{
    Windows::Storage::Streams::Buffer StatementOfHealth() const noexcept;
};
...
{
    Windows::Networking::Vpn::VpnAppId AppId() const noexcept;
    void AppId(Windows::Networking::Vpn::VpnAppId const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> AppClaims() const noexcept;
    Windows::Networking::Vpn::VpnIPProtocol Protocol() const noexcept;
    void Protocol(Windows::Networking::Vpn::VpnIPProtocol const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> LocalPortRanges() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> RemotePortRanges() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> LocalAddressRanges() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> RemoteAddressRanges() const noexcept;
    Windows::Networking::Vpn::VpnRoutingPolicyType RoutingPolicyType() const noexcept;
    void RoutingPolicyType(Windows::Networking::Vpn::VpnRoutingPolicyType const& value) const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnTrafficFilter> TrafficFilterList() const noexcept;
    bool AllowOutbound() const noexcept;
    void AllowOutbound(bool value) const noexcept;
    bool AllowInbound() const noexcept;
    void AllowInbound(bool value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Type(Windows::Networking::Vpn::VpnAppIdType* value) = 0;
    virtual HRESULT __stdcall put_Type(Windows::Networking::Vpn::VpnAppIdType value) = 0;
...
{
    virtual HRESULT __stdcall Create(Windows::Networking::Vpn::VpnAppIdType type, HSTRING value, ::IUnknown** result) = 0;
};};
...
template <> struct abi<Windows::Networking::Vpn::IVpnChannel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RequestCredentials(Windows::Networking::Vpn::VpnCredentialType credType, bool isRetry, bool isSingleSignOnCredential, ::IUnknown* certificate, ::IUnknown** credential) = 0;
    virtual HRESULT __stdcall RequestVpnPacketBuffer(Windows::Networking::Vpn::VpnDataPathType type, ::IUnknown** vpnPacketBuffer) = 0;
    ...
    virtual HRESULT __stdcall add_ActivityChange(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Networking::Vpn::IVpnChannel2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ActivityStateChange(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall RequestCredentialsWithCertificateAsync(Windows::Networking::Vpn::VpnCredentialType credType, uint32_t credOptions, ::IUnknown* certificate, ::IUnknown** credential) = 0;
    virtual HRESULT __stdcall RequestCredentialsWithOptionsAsync(Windows::Networking::Vpn::VpnCredentialType credType, uint32_t credOptions, ::IUnknown** credential) = 0;
    virtual HRESULT __stdcall RequestCredentialsSimpleAsync(Windows::Networking::Vpn::VpnCredentialType credType, ::IUnknown** credential) = 0;
...
{
    virtual HRESULT __stdcall get_Type(Windows::Networking::Vpn::VpnChannelActivityEventType* value) = 0;
};};

template <> struct abi<Windows::Networking::Vpn::IVpnChannelActivityStateChangedArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ActivityState(Windows::Networking::Vpn::VpnChannelActivityEventType* value) = 0;
};};
...
template <> struct abi<Windows::Networking::Vpn::IVpnDomainNameInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_DomainNameType(Windows::Networking::Vpn::VpnDomainNameType value) = 0;
    virtual HRESULT __stdcall get_DomainNameType(Windows::Networking::Vpn::VpnDomainNameType* value) = 0;
...
{
    virtual HRESULT __stdcall CreateVpnDomainNameInfo(HSTRING name, Windows::Networking::Vpn::VpnDomainNameType nameType, ::IUnknown* dnsServerList, ::IUnknown* proxyServerList, ::IUnknown** domainNameInfo) = 0;
};};
...
template <> struct abi<Windows::Networking::Vpn::IVpnNativeProfile>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RoutingPolicyType(Windows::Networking::Vpn::VpnRoutingPolicyType* value) = 0;
    virtual HRESULT __stdcall put_RoutingPolicyType(Windows::Networking::Vpn::VpnRoutingPolicyType value) = 0;
    virtual HRESULT __stdcall get_NativeProtocolType(Windows::Networking::Vpn::VpnNativeProtocolType* value) = 0;
    virtual HRESULT __stdcall put_NativeProtocolType(Windows::Networking::Vpn::VpnNativeProtocolType value) = 0;
    virtual HRESULT __stdcall get_UserAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod* value) = 0;
    virtual HRESULT __stdcall put_UserAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod value) = 0;
    virtual HRESULT __stdcall get_TunnelAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod* value) = 0;
    virtual HRESULT __stdcall put_TunnelAuthenticationMethod(Windows::Networking::Vpn::VpnAuthenticationMethod value) = 0;
...
template <> struct abi<Windows::Networking::Vpn::IVpnNativeProfile2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ConnectionStatus(Windows::Networking::Vpn::VpnManagementConnectionStatus* value) = 0;
};};
...
template <> struct abi<Windows::Networking::Vpn::IVpnPacketBuffer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_Status(Windows::Networking::Vpn::VpnPacketBufferStatus value) = 0;
    virtual HRESULT __stdcall get_Status(Windows::Networking::Vpn::VpnPacketBufferStatus* value) = 0;
...
template <> struct abi<Windows::Networking::Vpn::IVpnTrafficFilter>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Protocol(Windows::Networking::Vpn::VpnIPProtocol* value) = 0;
    virtual HRESULT __stdcall put_Protocol(Windows::Networking::Vpn::VpnIPProtocol value) = 0;
