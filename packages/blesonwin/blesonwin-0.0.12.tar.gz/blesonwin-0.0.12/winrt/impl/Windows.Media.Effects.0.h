...
{
    Windows::Media::Effects::AudioEffectType AudioEffectType() const noexcept;
};
...
{
    hstring ActivatableClassId() const noexcept;
...
{
    [[deprecated("Not supported starting in windows 10")]] Windows::Storage::Streams::IRandomAccessStreamWithContentType EffectsProviderThumbnail() const noexcept;
    [[deprecated("Not supported starting in windows 10")]] hstring EffectsProviderSettingsLabel() const noexcept;
...
{
    bool UseInputFrameForOutput() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::MediaProperties::AudioEncodingProperties> SupportedEncodingProperties() const noexcept;
...
struct consume_Windows_Media_Effects_IBasicVideoEffect
{
    ...
    Windows::Media::Effects::MediaMemoryTypes SupportedMemoryTypes() const noexcept;
    bool TimeIndependent() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::MediaProperties::VideoEncodingProperties> SupportedEncodingProperties() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface> SurfacesToOverlay() const noexcept;
    Windows::Media::VideoFrame BackgroundFrame() const noexcept;
    Windows::Media::VideoFrame OutputFrame() const noexcept;
...
{
    Windows::Media::AudioFrame InputFrame() const noexcept;
    Windows::Media::AudioFrame OutputFrame() const noexcept;
};
...
{
    Windows::Media::VideoFrame InputFrame() const noexcept;
    Windows::Media::VideoFrame OutputFrame() const noexcept;
};
...
{
    double TimeStretchRate() const noexcept;
    void TimeStretchRate(double value) const noexcept;
};
...
{
    Windows::UI::Color PaddingColor() const noexcept;
    void PaddingColor(Windows::UI::Color const& value) const noexcept;
    Windows::Foundation::Size OutputSize() const noexcept;
    void OutputSize(Windows::Foundation::Size const& value) const noexcept;
    Windows::Foundation::Rect CropRectangle() const noexcept;
    void CropRectangle(Windows::Foundation::Rect const& value) const noexcept;
    Windows::Media::MediaProperties::MediaRotation Rotation() const noexcept;
    void Rotation(Windows::Media::MediaProperties::MediaRotation const& value) const noexcept;
    Windows::Media::MediaProperties::MediaMirroringOptions Mirror() const noexcept;
    void Mirror(Windows::Media::MediaProperties::MediaMirroringOptions const& value) const noexcept;
    void ProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm const& value) const noexcept;
    Windows::Media::Transcoding::MediaVideoProcessingAlgorithm ProcessingAlgorithm() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_AudioCaptureEffectsChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_AudioEffectType(Windows::Media::Effects::AudioEffectType* value) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateAudioRenderEffectsManager(HSTRING deviceId, Windows::Media::Render::AudioRenderCategory category, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateAudioRenderEffectsManagerWithMode(HSTRING deviceId, Windows::Media::Render::AudioRenderCategory category, Windows::Media::AudioProcessing mode, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateAudioCaptureEffectsManager(HSTRING deviceId, Windows::Media::Capture::MediaCategory category, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateAudioCaptureEffectsManagerWithMode(HSTRING deviceId, Windows::Media::Capture::MediaCategory category, Windows::Media::AudioProcessing mode, ::IUnknown** value) = 0;
};};

template <> struct abi<Windows::Media::Effects::IAudioRenderEffectsManager>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_AudioRenderEffectsChanged(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Effects::IBasicAudioEffect>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall Close(Windows::Media::Effects::MediaEffectClosedReason reason) = 0;
...
template <> struct abi<Windows::Media::Effects::IBasicVideoEffect>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SupportedMemoryTypes(Windows::Media::Effects::MediaMemoryTypes* value) = 0;
...
{
    virtual HRESULT __stdcall get_PaddingColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_PaddingColor(struct_of<4> value) = 0;
    ...
    virtual HRESULT __stdcall get_Rotation(Windows::Media::MediaProperties::MediaRotation* value) = 0;
    virtual HRESULT __stdcall put_Rotation(Windows::Media::MediaProperties::MediaRotation value) = 0;
    virtual HRESULT __stdcall get_Mirror(Windows::Media::MediaProperties::MediaMirroringOptions* value) = 0;
    virtual HRESULT __stdcall put_Mirror(Windows::Media::MediaProperties::MediaMirroringOptions value) = 0;
    virtual HRESULT __stdcall put_ProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm value) = 0;
    virtual HRESULT __stdcall get_ProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm* value) = 0;
};};
