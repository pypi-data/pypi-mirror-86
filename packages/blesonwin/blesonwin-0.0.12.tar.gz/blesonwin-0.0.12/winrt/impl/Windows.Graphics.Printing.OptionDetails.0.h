...
struct consume_Windows_Graphics_Printing_OptionDetails_IPrintCustomItemDetails
{
    ...
    void ItemDisplayName(param::hstring const& value) const noexcept;
    hstring ItemDisplayName() const noexcept;
};
...
{
    void MaxCharacters(uint32_t value) const noexcept;
    uint32_t MaxCharacters() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Foundation::IInspectable> Items() const noexcept;
};
...
{
    uint32_t MinValue() const noexcept;
    uint32_t MaxValue() const noexcept;
};
...
{
    hstring OptionId() const noexcept;
    Windows::Graphics::Printing::OptionDetails::PrintOptionType OptionType() const noexcept;
    void ErrorText(param::hstring const& value) const noexcept;
    hstring ErrorText() const noexcept;
    void State(Windows::Graphics::Printing::OptionDetails::PrintOptionStates const& value) const noexcept;
    Windows::Graphics::Printing::OptionDetails::PrintOptionStates State() const noexcept;
...
{
    Windows::Foundation::IInspectable OptionId() const noexcept;
};
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::Graphics::Printing::OptionDetails::IPrintOptionDetails> Options() const noexcept;
...
template <> struct abi<Windows::Graphics::Printing::OptionDetails::IPrintOptionDetails>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OptionType(Windows::Graphics::Printing::OptionDetails::PrintOptionType* value) = 0;
    virtual HRESULT __stdcall put_ErrorText(HSTRING value) = 0;
    virtual HRESULT __stdcall get_ErrorText(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_State(Windows::Graphics::Printing::OptionDetails::PrintOptionStates value) = 0;
    virtual HRESULT __stdcall get_State(Windows::Graphics::Printing::OptionDetails::PrintOptionStates* value) = 0;
...
template <> struct abi<Windows::Graphics::Printing::OptionDetails::IPrintTaskOptionDetails>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_OptionChanged(::IUnknown* eventHandler, event_token* eventCookie) = 0;
    virtual HRESULT __stdcall remove_OptionChanged(event_token eventCookie) = 0;
    virtual HRESULT __stdcall add_BeginValidation(::IUnknown* eventHandler, event_token* eventCookie) = 0;
