...
template <> struct guid<Windows::ApplicationModel::Appointments::IAppointmentStore3>{ static constexpr GUID value{ 0x4251940B,0xB078,0x470A,{ 0x9A,0x40,0xC2,0xE0,0x17,0x61,0xF7,0x2F } }; };
...
template <> struct guid<Windows::ApplicationModel::Appointments::IAppointmentStoreChangeTracker2>{ static constexpr GUID value{ 0xB66AAF45,0x9542,0x4CF7,{ 0x85,0x50,0xEB,0x37,0x0E,0x0C,0x08,0xD3 } }; };
...
struct consume_Windows_ApplicationModel_Appointments_IAppointment
{
    ...
    hstring Details() const noexcept;
    void Details(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> Reminder() const noexcept;
    void Reminder(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentOrganizer Organizer() const noexcept;
    void Organizer(Windows::ApplicationModel::Appointments::AppointmentOrganizer const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Appointments::AppointmentInvitee> Invitees() const noexcept;
    ...
    Windows::ApplicationModel::Appointments::AppointmentBusyStatus BusyStatus() const noexcept;
    void BusyStatus(Windows::ApplicationModel::Appointments::AppointmentBusyStatus const& value) const noexcept;
    bool AllDay() const noexcept;
    void AllDay(bool value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentSensitivity Sensitivity() const noexcept;
    void Sensitivity(Windows::ApplicationModel::Appointments::AppointmentSensitivity const& value) const noexcept;
...
{
    hstring LocalId() const noexcept;
    hstring CalendarId() const noexcept;
    hstring RoamingId() const noexcept;
    void RoamingId(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> OriginalStartTime() const noexcept;
    ...
    hstring OnlineMeetingLink() const noexcept;
    void OnlineMeetingLink(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ReplyTime() const noexcept;
    void ReplyTime(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentParticipantResponse UserResponse() const noexcept;
    void UserResponse(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse const& value) const noexcept;
    bool HasInvitees() const noexcept;
    bool IsCanceledMeeting() const noexcept;
    void IsCanceledMeeting(bool value) const noexcept;
    bool IsOrganizedByUser() const noexcept;
    void IsOrganizedByUser(bool value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Appointments_IAppointment3
{
    ...
    Windows::ApplicationModel::Appointments::AppointmentDetailsKind DetailsKind() const noexcept;
    void DetailsKind(Windows::ApplicationModel::Appointments::AppointmentDetailsKind const& value) const noexcept;
};
...
{
    Windows::UI::Color DisplayColor() const noexcept;
    hstring DisplayName() const noexcept;
    void DisplayName(param::hstring const& value) const noexcept;
    hstring LocalId() const noexcept;
    bool IsHidden() const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess OtherAppReadAccess() const noexcept;
    void OtherAppReadAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess OtherAppWriteAccess() const noexcept;
    void OtherAppWriteAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess const& value) const noexcept;
    hstring SourceDisplayName() const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentSummaryCardView SummaryCardView() const noexcept;
    void SummaryCardView(Windows::ApplicationModel::Appointments::AppointmentSummaryCardView const& value) const noexcept;
...
{
    Windows::ApplicationModel::Appointments::AppointmentCalendarSyncManager SyncManager() const noexcept;
    hstring RemoteId() const noexcept;
    void RemoteId(param::hstring const& value) const noexcept;
    void DisplayColor(Windows::UI::Color const& value) const noexcept;
    void IsHidden(bool value) const noexcept;
    hstring UserDataAccountId() const noexcept;
    bool CanCreateOrUpdateAppointments() const noexcept;
    void CanCreateOrUpdateAppointments(bool value) const noexcept;
    bool CanCancelMeetings() const noexcept;
    void CanCancelMeetings(bool value) const noexcept;
    ...
    bool CanNotifyInvitees() const noexcept;
    void CanNotifyInvitees(bool value) const noexcept;
    bool MustNofityInvitees() const noexcept;
    void MustNofityInvitees(bool value) const noexcept;
...
{
    Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus Status() const noexcept;
...
{
    void Status(Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus const& value) const noexcept;
...
{
    Windows::ApplicationModel::Appointments::AppointmentConflictType Type() const noexcept;
    Windows::Foundation::DateTime Date() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::Appointment Appointment() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> ExceptionProperties() const noexcept;
...
{
    Windows::ApplicationModel::Appointments::AppointmentParticipantRole Role() const noexcept;
    void Role(Windows::ApplicationModel::Appointments::AppointmentParticipantRole const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentParticipantResponse Response() const noexcept;
    void Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_Appointments_IAppointmentPropertiesStatics
{
    hstring Subject() const noexcept;
    hstring Location() const noexcept;
    hstring StartTime() const noexcept;
    hstring Duration() const noexcept;
    hstring Reminder() const noexcept;
    hstring BusyStatus() const noexcept;
    hstring Sensitivity() const noexcept;
    hstring OriginalStartTime() const noexcept;
    hstring IsResponseRequested() const noexcept;
    hstring AllowNewTimeProposal() const noexcept;
    hstring AllDay() const noexcept;
    hstring Details() const noexcept;
    hstring OnlineMeetingLink() const noexcept;
    hstring ReplyTime() const noexcept;
    hstring Organizer() const noexcept;
    hstring UserResponse() const noexcept;
    hstring HasInvitees() const noexcept;
    hstring IsCanceledMeeting() const noexcept;
    hstring IsOrganizedByUser() const noexcept;
    hstring Recurrence() const noexcept;
    hstring Uri() const noexcept;
    hstring Invitees() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> DefaultProperties() const noexcept;
};
...
{
    hstring ChangeNumber() const noexcept;
    hstring RemoteChangeNumber() const noexcept;
    hstring DetailsKind() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit Unit() const noexcept;
    void Unit(Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> Occurrences() const noexcept;
    void Occurrences(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> Until() const noexcept;
    void Until(optional<Windows::Foundation::DateTime> const& value) const noexcept;
    uint32_t Interval() const noexcept;
    void Interval(uint32_t value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek DaysOfWeek() const noexcept;
    void DaysOfWeek(Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek const& value) const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth WeekOfMonth() const noexcept;
    void WeekOfMonth(Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth const& value) const noexcept;
    uint32_t Month() const noexcept;
    void Month(uint32_t value) const noexcept;
    uint32_t Day() const noexcept;
    void Day(uint32_t value) const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::RecurrenceType RecurrenceType() const noexcept;
    hstring TimeZone() const noexcept;
    void TimeZone(param::hstring const& value) const noexcept;
};
...
{
    hstring CalendarIdentifier() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentStoreChangeTracker ChangeTracker() const noexcept;
...
{
    Windows::ApplicationModel::Appointments::Appointment Appointment() const noexcept;
    Windows::ApplicationModel::Appointments::AppointmentStoreChangeType ChangeType() const noexcept;
};
...
{
    Windows::ApplicationModel::Appointments::AppointmentCalendar AppointmentCalendar() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVector<hstring> CalendarIds() const noexcept;
    Windows::Foundation::Collections::IVector<hstring> FetchProperties() const noexcept;
    bool IncludeHidden() const noexcept;
    void IncludeHidden(bool value) const noexcept;
    uint32_t MaxCount() const noexcept;
    void MaxCount(uint32_t value) const noexcept;
};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BusyStatus(Windows::ApplicationModel::Appointments::AppointmentBusyStatus* value) = 0;
    virtual HRESULT __stdcall put_BusyStatus(Windows::ApplicationModel::Appointments::AppointmentBusyStatus value) = 0;
    virtual HRESULT __stdcall get_AllDay(bool* value) = 0;
    virtual HRESULT __stdcall put_AllDay(bool value) = 0;
    virtual HRESULT __stdcall get_Sensitivity(Windows::ApplicationModel::Appointments::AppointmentSensitivity* value) = 0;
    virtual HRESULT __stdcall put_Sensitivity(Windows::ApplicationModel::Appointments::AppointmentSensitivity value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_UserResponse(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse* value) = 0;
    virtual HRESULT __stdcall put_UserResponse(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointment3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_DetailsKind(Windows::ApplicationModel::Appointments::AppointmentDetailsKind* value) = 0;
    virtual HRESULT __stdcall put_DetailsKind(Windows::ApplicationModel::Appointments::AppointmentDetailsKind value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentCalendar>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_DisplayColor(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall get_DisplayName(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_DisplayName(HSTRING value) = 0;
    virtual HRESULT __stdcall get_LocalId(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_IsHidden(bool* value) = 0;
    virtual HRESULT __stdcall get_OtherAppReadAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppReadAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppReadAccess value) = 0;
    virtual HRESULT __stdcall get_OtherAppWriteAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess* value) = 0;
    virtual HRESULT __stdcall put_OtherAppWriteAccess(Windows::ApplicationModel::Appointments::AppointmentCalendarOtherAppWriteAccess value) = 0;
    virtual HRESULT __stdcall get_SourceDisplayName(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_SummaryCardView(Windows::ApplicationModel::Appointments::AppointmentSummaryCardView* value) = 0;
    virtual HRESULT __stdcall put_SummaryCardView(Windows::ApplicationModel::Appointments::AppointmentSummaryCardView value) = 0;
    virtual HRESULT __stdcall FindAppointmentsAsync(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindAppointmentsAsyncWithOptions(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown* options, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindExceptionsFromMasterAsync(HSTRING masterLocalId, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall FindAllInstancesAsync(HSTRING masterLocalId, Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall FindAllInstancesAsyncWithOptions(HSTRING masterLocalId, Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown* pOptions, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall GetAppointmentAsync(HSTRING localId, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall GetAppointmentInstanceAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartTime, ::IUnknown** result) = 0;
    ...
    virtual HRESULT __stdcall DeleteAppointmentInstanceAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartTime, ::IUnknown** asyncAction) = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentCalendar2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_DisplayColor(struct_of<4> value) = 0;
    ...
    virtual HRESULT __stdcall TryUpdateMeetingResponseAsync(::IUnknown* meeting, Windows::ApplicationModel::Appointments::AppointmentParticipantResponse response, HSTRING subject, HSTRING comment, bool sendUpdate, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus* value) = 0;
...
{
    virtual HRESULT __stdcall put_Status(Windows::ApplicationModel::Appointments::AppointmentCalendarSyncStatus value) = 0;
...
{
    virtual HRESULT __stdcall get_Type(Windows::ApplicationModel::Appointments::AppointmentConflictType* value) = 0;
...
{
    virtual HRESULT __stdcall get_Role(Windows::ApplicationModel::Appointments::AppointmentParticipantRole* value) = 0;
    virtual HRESULT __stdcall put_Role(Windows::ApplicationModel::Appointments::AppointmentParticipantRole value) = 0;
    virtual HRESULT __stdcall get_Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse* value) = 0;
    virtual HRESULT __stdcall put_Response(Windows::ApplicationModel::Appointments::AppointmentParticipantResponse value) = 0;
};};

template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentManagerForUser>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall ShowAddAppointmentAsync(::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowAddAppointmentWithPlacementAsync(::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowTimeFrameAsync(Windows::Foundation::DateTime timeToShow, Windows::Foundation::TimeSpan duration, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsAsync(HSTRING appointmentId, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING appointmentId, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(::IUnknown* appointment, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options, ::IUnknown** result) = 0;
...
{
    virtual HRESULT __stdcall ShowAddAppointmentAsync(::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowAddAppointmentWithPlacementAsync(::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, ::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING appointmentId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowTimeFrameAsync(Windows::Foundation::DateTime timeToShow, Windows::Foundation::TimeSpan duration, ::IUnknown** asyncAction) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentManagerStatics2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING appointmentId, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** asyncAction) = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(::IUnknown* appointment, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options, ::IUnknown** operation) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Unit(Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit* value) = 0;
    virtual HRESULT __stdcall put_Unit(Windows::ApplicationModel::Appointments::AppointmentRecurrenceUnit value) = 0;
    ...
    virtual HRESULT __stdcall get_DaysOfWeek(Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek* value) = 0;
    virtual HRESULT __stdcall put_DaysOfWeek(Windows::ApplicationModel::Appointments::AppointmentDaysOfWeek value) = 0;
    virtual HRESULT __stdcall get_WeekOfMonth(Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth* value) = 0;
    virtual HRESULT __stdcall put_WeekOfMonth(Windows::ApplicationModel::Appointments::AppointmentWeekOfMonth value) = 0;
...
{
    virtual HRESULT __stdcall get_RecurrenceType(Windows::ApplicationModel::Appointments::RecurrenceType* value) = 0;
...
template <> struct abi<Windows::ApplicationModel::Appointments::IAppointmentStore>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FindAppointmentCalendarsAsyncWithOptions(Windows::ApplicationModel::Appointments::FindAppointmentCalendarsOptions options, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindAppointmentsAsync(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindAppointmentsAsyncWithOptions(Windows::Foundation::DateTime rangeStart, Windows::Foundation::TimeSpan rangeLength, ::IUnknown* options, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindConflictAsync(::IUnknown* appointment, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall FindConflictAsyncWithInstanceStart(::IUnknown* appointment, Windows::Foundation::DateTime instanceStartTime, ::IUnknown** result) = 0;
    virtual HRESULT __stdcall MoveAppointmentAsync(::IUnknown* appointment, ::IUnknown* destinationCalendar, ::IUnknown** asyncAction) = 0;
    virtual HRESULT __stdcall ShowAddAppointmentAsync(::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentAsync(HSTRING localId, ::IUnknown* appointment, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(HSTRING localId, ::IUnknown* appointment, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentAsync(HSTRING localId, Windows::Foundation::Rect selection, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(HSTRING localId, Windows::Foundation::Rect selection, Windows::UI::Popups::Placement preferredPlacement, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsAsync(HSTRING localId, ::IUnknown** asyncAction) = 0;
    virtual HRESULT __stdcall ShowAppointmentDetailsWithDateAsync(HSTRING localId, Windows::Foundation::DateTime instanceStartDate, ::IUnknown** asyncAction) = 0;
    virtual HRESULT __stdcall ShowEditNewAppointmentAsync(::IUnknown* appointment, ::IUnknown** operation) = 0;
...
{
    virtual HRESULT __stdcall add_StoreChanged(::IUnknown* pHandler, event_token* pToken) = 0;
...
{
    virtual HRESULT __stdcall get_Appointment(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_ChangeType(Windows::ApplicationModel::Appointments::AppointmentStoreChangeType* value) = 0;
};};
