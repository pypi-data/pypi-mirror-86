...
struct consume_Windows_Devices_I2c_II2cConnectionSettings
{
    ...
    Windows::Devices::I2c::I2cBusSpeed BusSpeed() const noexcept;
    void BusSpeed(Windows::Devices::I2c::I2cBusSpeed const& value) const noexcept;
    Windows::Devices::I2c::I2cSharingMode SharingMode() const noexcept;
    void SharingMode(Windows::Devices::I2c::I2cSharingMode const& value) const noexcept;
};
...
struct consume_Windows_Devices_I2c_II2cDevice
{
    ...
    Windows::Devices::I2c::I2cConnectionSettings ConnectionSettings() const noexcept;
...
template <> struct abi<Windows::Devices::I2c::II2cConnectionSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BusSpeed(Windows::Devices::I2c::I2cBusSpeed* value) = 0;
    virtual HRESULT __stdcall put_BusSpeed(Windows::Devices::I2c::I2cBusSpeed value) = 0;
    virtual HRESULT __stdcall get_SharingMode(Windows::Devices::I2c::I2cSharingMode* value) = 0;
    virtual HRESULT __stdcall put_SharingMode(Windows::Devices::I2c::I2cSharingMode value) = 0;
};};
