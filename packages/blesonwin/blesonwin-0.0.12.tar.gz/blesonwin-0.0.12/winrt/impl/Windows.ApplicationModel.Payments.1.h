...
struct WINRT_EBO IPaymentCanMakePaymentResult :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IPaymentCanMakePaymentResultFactory :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IPaymentMediator2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IPaymentRequest2 :
    Windows::Foundation::IInspectable,
...
struct WINRT_EBO IPaymentRequestFactory2 :
    Windows::Foundation::IInspectable,
