...
{
    bool SatisfiedByDevice() const noexcept;
    bool SatisfiedByOpenLicense() const noexcept;
    bool SatisfiedByTrial() const noexcept;
    bool SatisfiedByPass() const noexcept;
    bool SatisfiedByInstallMedia() const noexcept;
    bool SatisfiedBySignedInUser() const noexcept;
...
{
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionInfo> LicenseSatisfactionInfos() const noexcept;
...
{
    virtual HRESULT __stdcall RefreshLicensesAsync(Windows::ApplicationModel::Store::LicenseManagement::LicenseRefreshOption refreshOption, ::IUnknown** action) = 0;
};};
