...
enum class [[deprecated("NDCertificateFeature is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDCertificateFeature : int32_t
{
    Transmitter = 1,
    Receiver = 2,
    SharedCertificate = 3,
...
enum class [[deprecated("NDCertificatePlatformID is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDCertificatePlatformID : int32_t
{
    Windows = 0,
    OSX = 1,
    WindowsOnARM = 2,
...
enum class [[deprecated("NDCertificateType is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDCertificateType : int32_t
{
    Unknown = 0,
    PC = 1,
    Device = 2,
...
enum class [[deprecated("NDClosedCaptionFormat is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDClosedCaptionFormat : int32_t
{
    ATSC = 0,
    SCTE20 = 1,
    Unknown = 2,
...
enum class [[deprecated("NDContentIDType is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDContentIDType : int32_t
{
    KeyID = 1,
    PlayReadyObject = 2,
    Custom = 3,
...
enum class [[deprecated("NDMediaStreamType is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDMediaStreamType : int32_t
{
    Audio = 1,
    Video = 2,
};

enum class [[deprecated("NDProximityDetectionType is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDProximityDetectionType : int32_t
{
    UDP = 1,
    TCP = 2,
    TransportAgnostic = 4,
...
enum class [[deprecated("NDStartAsyncOptions is deprecated and might not work on all platforms. For more info, see MSDN.")]] NDStartAsyncOptions : int32_t
{
...
{
    [[deprecated("INDClosedCaptionDataReceivedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDClosedCaptionFormat ClosedCaptionDataFormat() const noexcept;
    [[deprecated("INDClosedCaptionDataReceivedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] int64_t PresentationTimestamp() const noexcept;
    [[deprecated("INDClosedCaptionDataReceivedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> ClosedCaptionData() const noexcept;
};
...
{
    [[deprecated("INDCustomData is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> CustomDataTypeID() const noexcept;
    [[deprecated("INDCustomData is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> CustomData() const noexcept;
};
...
struct consume_Windows_Media_Protection_PlayReady_INDDownloadEngine
{
    ...
    [[deprecated("INDDownloadEngine is deprecated and might not work on all platforms. For more info, see MSDN.")]] bool CanSeek() const noexcept;
    [[deprecated("INDDownloadEngine is deprecated and might not work on all platforms. For more info, see MSDN.")]] uint32_t BufferFullMinThresholdInSamples() const noexcept;
    [[deprecated("INDDownloadEngine is deprecated and might not work on all platforms. For more info, see MSDN.")]] uint32_t BufferFullMaxThresholdInSamples() const noexcept;
    [[deprecated("INDDownloadEngine is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDDownloadEngineNotifier Notifier() const noexcept;
};
...
{
    [[deprecated("INDLicenseFetchCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::INDCustomData ResponseCustomData() const noexcept;
};
...
{
    [[deprecated("INDLicenseFetchDescriptor is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDContentIDType ContentIDType() const noexcept;
    [[deprecated("INDLicenseFetchDescriptor is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> ContentID() const noexcept;
    [[deprecated("INDLicenseFetchDescriptor is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::INDCustomData LicenseFetchChallengeCustomData() const noexcept;
    [[deprecated("INDLicenseFetchDescriptor is deprecated and might not work on all platforms. For more info, see MSDN.")]] void LicenseFetchChallengeCustomData(Windows::Media::Protection::PlayReady::INDCustomData const& licenseFetchChallengeCustomData) const noexcept;
};
...
{
    [[deprecated("INDLicenseFetchResult is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::INDCustomData ResponseCustomData() const noexcept;
};
...
{
    [[deprecated("INDProximityDetectionCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] uint32_t ProximityDetectionRetryCount() const noexcept;
};
...
{
    [[deprecated("INDRegistrationCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::INDCustomData ResponseCustomData() const noexcept;
    [[deprecated("INDRegistrationCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::INDTransmitterProperties TransmitterProperties() const noexcept;
    [[deprecated("INDRegistrationCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] bool TransmitterCertificateAccepted() const noexcept;
    [[deprecated("INDRegistrationCompletedEventArgs is deprecated and might not work on all platforms. For more info, see MSDN.")]] void TransmitterCertificateAccepted(bool accept) const noexcept;
};
...
{
    [[deprecated("INDSendResult is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> Response() const noexcept;
};
...
{
    [[deprecated("INDStartResult is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Core::MediaStreamSource MediaStreamSource() const noexcept;
};
...
struct consume_Windows_Media_Protection_PlayReady_INDStreamParser
{
    ...
    [[deprecated("INDStreamParser is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDStreamParserNotifier Notifier() const noexcept;
};
...
{
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDCertificateType CertificateType() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Media::Protection::PlayReady::NDCertificatePlatformID PlatformIdentifier() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<Windows::Media::Protection::PlayReady::NDCertificateFeature> SupportedFeatures() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] uint32_t SecurityLevel() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] uint32_t SecurityVersion() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] Windows::Foundation::DateTime ExpirationDate() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> ClientID() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] com_array<uint8_t> ModelDigest() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] hstring ModelManufacturerName() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] hstring ModelName() const noexcept;
    [[deprecated("INDTransmitterProperties is deprecated and might not work on all platforms. For more info, see MSDN.")]] hstring ModelNumber() const noexcept;
};
...
{
    GUID KeyId() const noexcept;
    hstring KeyIdString() const noexcept;
    Windows::Foundation::Uri LicenseAcquisitionUrl() const noexcept;
    Windows::Foundation::Uri LicenseAcquisitionUserInterfaceUrl() const noexcept;
    GUID DomainServiceId() const noexcept;
    Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm EncryptionType() const noexcept;
    hstring CustomAttributes() const noexcept;
    Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup DecryptorSetup() const noexcept;
    com_array<uint8_t> GetSerializedHeader() const;
    Windows::Media::Protection::PlayReady::PlayReadyContentHeader HeaderWithEmbeddedUpdates() const noexcept;
};
...
{
    com_array<GUID> KeyIds() const noexcept;
    com_array<hstring> KeyIdStrings() const noexcept;
};
...
{
    GUID AccountId() const noexcept;
    GUID ServiceId() const noexcept;
    uint32_t Revision() const noexcept;
    hstring FriendlyName() const noexcept;
    Windows::Foundation::Uri DomainJoinUrl() const noexcept;
};
...
{
    GUID DomainAccountId() const noexcept;
    void DomainAccountId(GUID const& value) const noexcept;
    hstring DomainFriendlyName() const noexcept;
    void DomainFriendlyName(param::hstring const& value) const noexcept;
    GUID DomainServiceId() const noexcept;
    void DomainServiceId(GUID const& value) const noexcept;
};
...
{
    bool FullyEvaluated() const noexcept;
    bool UsableForPlay() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::DateTime> ExpirationDate() const noexcept;
    uint32_t ExpireAfterFirstPlay() const noexcept;
    GUID DomainAccountID() const noexcept;
...
{
    GUID SecureStopId() const noexcept;
    uint32_t SecurityLevel() const noexcept;
    bool InMemoryOnly() const noexcept;
    bool ExpiresInRealTime() const noexcept;
};
...
{
    Windows::Media::Protection::PlayReady::PlayReadyContentHeader ContentHeader() const noexcept;
    void ContentHeader(Windows::Media::Protection::PlayReady::PlayReadyContentHeader const& value) const noexcept;
    GUID DomainServiceId() const noexcept;
    void DomainServiceId(GUID const& value) const noexcept;
};
...
{
    com_array<uint8_t> MeteringCertificate() const noexcept;
    void MeteringCertificate(array_view<uint8_t const> meteringCertBytes) const noexcept;
};
...
struct consume_Windows_Media_Protection_PlayReady_IPlayReadySecureStopServiceRequest
{
    ...
    com_array<uint8_t> PublisherCertificate() const noexcept;
};
...
struct consume_Windows_Media_Protection_PlayReady_IPlayReadyServiceRequest
{
    ...
    hstring ResponseCustomData() const noexcept;
    hstring ChallengeCustomData() const noexcept;
    void ChallengeCustomData(param::hstring const& value) const noexcept;
...
struct consume_Windows_Media_Protection_PlayReady_IPlayReadySoapMessage
{
    ...
    Windows::Foundation::Collections::IPropertySet MessageHeaders() const noexcept;
    Windows::Foundation::Uri Uri() const noexcept;
};
...
{
    GUID DomainJoinServiceRequestType() const noexcept;
    GUID DomainLeaveServiceRequestType() const noexcept;
    GUID IndividualizationServiceRequestType() const noexcept;
    GUID LicenseAcquirerServiceRequestType() const noexcept;
    GUID MeteringReportServiceRequestType() const noexcept;
    GUID RevocationServiceRequestType() const noexcept;
    GUID MediaProtectionSystemId() const noexcept;
    uint32_t PlayReadySecurityVersion() const noexcept;
};
...
{
    uint32_t PlayReadyCertificateSecurityLevel() const noexcept;
};
...
{
    GUID SecureStopServiceRequestType() const noexcept;
...
{
    hstring InputTrustAuthorityToCreate() const noexcept;
    GUID ProtectionSystemId() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_RegistrationCompleted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RegistrationCompleted(event_token token) = 0;
    virtual HRESULT __stdcall add_ProximityDetectionCompleted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ProximityDetectionCompleted(event_token token) = 0;
    virtual HRESULT __stdcall add_LicenseFetchCompleted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LicenseFetchCompleted(event_token token) = 0;
    virtual HRESULT __stdcall add_ReRegistrationNeeded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ReRegistrationNeeded(event_token token) = 0;
    virtual HRESULT __stdcall add_ClosedCaptionDataReceived(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_ClosedCaptionDataFormat(Windows::Media::Protection::PlayReady::NDClosedCaptionFormat* ccForamt) = 0;
...
template <> struct abi<Windows::Media::Protection::PlayReady::INDDownloadEngine>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall Close() = 0;
    virtual HRESULT __stdcall Seek(Windows::Foundation::TimeSpan startPosition) = 0;
...
{
    virtual HRESULT __stdcall get_ContentIDType(Windows::Media::Protection::PlayReady::NDContentIDType* contentIDType) = 0;
...
{
    virtual HRESULT __stdcall CreateInstance(Windows::Media::Protection::PlayReady::NDContentIDType contentIDType, uint32_t __contentIDBytesSize, uint8_t* contentIDBytes, ::IUnknown* licenseFetchChallengeCustomData, ::IUnknown** instance) = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::INDStreamParser>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetStreamInformation(::IUnknown* descriptor, Windows::Media::Protection::PlayReady::NDMediaStreamType* streamType, uint32_t* streamID) = 0;
...
template <> struct abi<Windows::Media::Protection::PlayReady::INDStreamParserNotifier>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall OnSampleParsed(uint32_t streamID, Windows::Media::Protection::PlayReady::NDMediaStreamType streamType, ::IUnknown* streamSample, int64_t pts, Windows::Media::Protection::PlayReady::NDClosedCaptionFormat ccFormat, uint32_t __ccDataBytesSize, uint8_t* ccDataBytes) = 0;
    virtual HRESULT __stdcall OnBeginSetupDecryptor(::IUnknown* descriptor, GUID keyID, uint32_t __proBytesSize, uint8_t* proBytes) = 0;
};};
...
{
    virtual HRESULT __stdcall get_CertificateType(Windows::Media::Protection::PlayReady::NDCertificateType* type) = 0;
    virtual HRESULT __stdcall get_PlatformIdentifier(Windows::Media::Protection::PlayReady::NDCertificatePlatformID* identifier) = 0;
    virtual HRESULT __stdcall get_SupportedFeatures(uint32_t* __featureSetsSize, Windows::Media::Protection::PlayReady::NDCertificateFeature** featureSets) = 0;
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyContentHeader>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_EncryptionType(Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm* value) = 0;
    virtual HRESULT __stdcall get_CustomAttributes(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_DecryptorSetup(Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup* value) = 0;
...
{
    virtual HRESULT __stdcall CreateInstanceFromWindowsMediaDrmHeader(uint32_t __headerBytesSize, uint8_t* headerBytes, ::IUnknown* licenseAcquisitionUrl, ::IUnknown* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, ::IUnknown** instance) = 0;
    virtual HRESULT __stdcall CreateInstanceFromComponents(GUID contentKeyId, HSTRING contentKeyIdString, Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm contentEncryptionAlgorithm, ::IUnknown* licenseAcquisitionUrl, ::IUnknown* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, ::IUnknown** instance) = 0;
...
{
    virtual HRESULT __stdcall CreateInstanceFromComponents2(uint32_t dwFlags, uint32_t __contentKeyIdsSize, GUID* contentKeyIds, uint32_t __contentKeyIdStringsSize, HSTRING* contentKeyIdStrings, Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm contentEncryptionAlgorithm, ::IUnknown* licenseAcquisitionUrl, ::IUnknown* licenseAcquisitionUserInterfaceUrl, HSTRING customAttributes, GUID domainServiceId, ::IUnknown** instance) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(GUID domainAccountId, ::IUnknown** domainIterable) = 0;
};};
...
{
    virtual HRESULT __stdcall GenerateData(GUID guidCPSystemId, uint32_t countOfStreams, ::IUnknown* configuration, Windows::Media::Protection::PlayReady::PlayReadyITADataFormat format, uint32_t* __dataBytesSize, uint8_t** dataBytes) = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyLicense>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetKIDAtChainDepth(uint32_t chainDepth, GUID* kid) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(uint32_t __publisherCertBytesSize, uint8_t* publisherCertBytes, ::IUnknown** instance) = 0;
    virtual HRESULT __stdcall CreateInstanceFromSessionID(GUID sessionID, uint32_t __publisherCertBytesSize, uint8_t* publisherCertBytes, ::IUnknown** instance) = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyServiceRequest>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ProcessManualEnablingResponse(uint32_t __responseBytesSize, uint8_t* responseBytes, HRESULT* result) = 0;
};};
...
template <> struct abi<Windows::Media::Protection::PlayReady::IPlayReadyStatics3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CheckSupportedHardware(Windows::Media::Protection::PlayReady::PlayReadyHardwareDRMFeatures hwdrmFeature, bool* value) = 0;
};};
