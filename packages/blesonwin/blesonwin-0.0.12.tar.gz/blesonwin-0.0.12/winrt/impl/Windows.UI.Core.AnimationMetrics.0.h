...
{
    Windows::Foundation::Collections::IVectorView<Windows::UI::Core::AnimationMetrics::IPropertyAnimation> Animations() const noexcept;
    Windows::Foundation::TimeSpan StaggerDelay() const noexcept;
    float StaggerDelayFactor() const noexcept;
    Windows::Foundation::TimeSpan DelayLimit() const noexcept;
    int32_t ZOrder() const noexcept;
};
...
{
    Windows::Foundation::IReference<float> InitialOpacity() const noexcept;
    float FinalOpacity() const noexcept;
};
...
{
    Windows::UI::Core::AnimationMetrics::PropertyAnimationType Type() const noexcept;
    Windows::Foundation::TimeSpan Delay() const noexcept;
    Windows::Foundation::TimeSpan Duration() const noexcept;
    Windows::Foundation::Point Control1() const noexcept;
    Windows::Foundation::Point Control2() const noexcept;
};
...
{
    Windows::Foundation::IReference<float> InitialScaleX() const noexcept;
    Windows::Foundation::IReference<float> InitialScaleY() const noexcept;
    float FinalScaleX() const noexcept;
    float FinalScaleY() const noexcept;
    Windows::Foundation::Point NormalizedOrigin() const noexcept;
};
...
{
    virtual HRESULT __stdcall CreateInstance(Windows::UI::Core::AnimationMetrics::AnimationEffect effect, Windows::UI::Core::AnimationMetrics::AnimationEffectTarget target, ::IUnknown** animation) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Type(Windows::UI::Core::AnimationMetrics::PropertyAnimationType* value) = 0;
