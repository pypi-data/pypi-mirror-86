...
{
    Windows::Phone::System::Power::PowerSavingMode PowerSavingMode() const noexcept;
...
{
    bool PowerSavingModeEnabled() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_PowerSavingMode(Windows::Phone::System::Power::PowerSavingMode* value) = 0;
    virtual HRESULT __stdcall add_PowerSavingModeChanged(::IUnknown* changeHandler, event_token* token) = 0;
