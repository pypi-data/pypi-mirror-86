...
struct consume_Windows_UI_Xaml_Media_Media3D_ICompositeTransform3D
{
    ...
    double CenterZ() const noexcept;
    void CenterZ(double value) const noexcept;
    ...
    double ScaleZ() const noexcept;
    void ScaleZ(double value) const noexcept;
    ...
    double TranslateZ() const noexcept;
    void TranslateZ(double value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Media_Media3D_ICompositeTransform3DStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty CenterZProperty() const noexcept;
    ...
    Windows::UI::Xaml::DependencyProperty ScaleZProperty() const noexcept;
    ...
    Windows::UI::Xaml::DependencyProperty TranslateZProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::Media3D::Matrix3D Identity() const noexcept;
...
struct consume_Windows_UI_Xaml_Media_Media3D_IPerspectiveTransform3D
{
    ...
    void Depth(double value) const noexcept;
    double OffsetX() const noexcept;
    void OffsetX(double value) const noexcept;
    double OffsetY() const noexcept;
    void OffsetY(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty DepthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty OffsetXProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty OffsetYProperty() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Identity(struct_of<128>* value) = 0;
    virtual HRESULT __stdcall Multiply(struct_of<128> matrix1, struct_of<128> matrix2, struct_of<128>* returnValue) = 0;
    virtual HRESULT __stdcall FromElements(double m11, double m12, double m13, double m14, double m21, double m22, double m23, double m24, double m31, double m32, double m33, double m34, double offsetX, double offsetY, double offsetZ, double m44, struct_of<128>* returnValue) = 0;
    virtual HRESULT __stdcall GetHasInverse(struct_of<128> target, bool* value) = 0;
    virtual HRESULT __stdcall GetIsIdentity(struct_of<128> target, bool* value) = 0;
    virtual HRESULT __stdcall Invert(struct_of<128> target, struct_of<128>* returnValue) = 0;
};};
