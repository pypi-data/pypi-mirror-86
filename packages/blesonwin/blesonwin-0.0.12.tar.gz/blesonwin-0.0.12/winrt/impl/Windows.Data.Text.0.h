...
{
    Windows::Data::Text::TextSegment SourceTextSegment() const noexcept;
    hstring AlternateText() const noexcept;
    Windows::Data::Text::AlternateNormalizationFormat NormalizationFormat() const noexcept;
};
...
{
    hstring ResolvedLanguage() const noexcept;
    bool LanguageAvailableButNotInstalled() const noexcept;
...
struct consume_Windows_Data_Text_ITextPhoneme
{
    ...
    hstring ReadingText() const noexcept;
};
...
struct consume_Windows_Data_Text_IWordSegment
{
    hstring Text() const noexcept;
    Windows::Data::Text::TextSegment SourceTextSegment() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Data::Text::AlternateWordForm> AlternateForms() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_SourceTextSegment(struct_of<8>* value) = 0;
    virtual HRESULT __stdcall get_AlternateText(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_NormalizationFormat(Windows::Data::Text::AlternateNormalizationFormat* value) = 0;
};};
...
template <> struct abi<Windows::Data::Text::IUnicodeCharactersStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetNumericType(uint32_t codepoint, Windows::Data::Text::UnicodeNumericType* value) = 0;
    virtual HRESULT __stdcall GetGeneralCategory(uint32_t codepoint, Windows::Data::Text::UnicodeGeneralCategory* value) = 0;
};};
