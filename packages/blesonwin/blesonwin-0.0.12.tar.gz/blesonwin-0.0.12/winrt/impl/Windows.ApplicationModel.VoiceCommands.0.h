...
{
    hstring CommandName() const noexcept;
    ...
    Windows::Media::SpeechRecognition::SpeechRecognitionResult SpeechRecognitionResult() const noexcept;
};
...
{
    Windows::ApplicationModel::VoiceCommands::VoiceCommandCompletionReason Reason() const noexcept;
};
...
struct consume_Windows_ApplicationModel_VoiceCommands_IVoiceCommandContentTile
{
    ...
    hstring TextLine1() const noexcept;
    void TextLine1(param::hstring const& value) const noexcept;
    hstring TextLine2() const noexcept;
    void TextLine2(param::hstring const& value) const noexcept;
    hstring TextLine3() const noexcept;
    void TextLine3(param::hstring const& value) const noexcept;
    Windows::Storage::IStorageFile Image() const noexcept;
    void Image(Windows::Storage::IStorageFile const& value) const noexcept;
    Windows::Foundation::IInspectable AppContext() const noexcept;
    void AppContext(Windows::Foundation::IInspectable const& value) const noexcept;
    hstring AppLaunchArgument() const noexcept;
    void AppLaunchArgument(param::hstring const& value) const noexcept;
    Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTileType ContentTileType() const noexcept;
    void ContentTileType(Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTileType const& value) const noexcept;
};
...
struct consume_Windows_ApplicationModel_VoiceCommands_IVoiceCommandDefinitionManagerStatics
{
    ...
    Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::VoiceCommands::VoiceCommandDefinition> InstalledCommandDefinitions() const noexcept;
};
...
{
    Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTile SelectedItem() const noexcept;
};
...
{
    Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage Message() const noexcept;
    void Message(Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage const& value) const noexcept;
    Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage RepeatMessage() const noexcept;
    void RepeatMessage(Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage const& value) const noexcept;
    hstring AppLaunchArgument() const noexcept;
    void AppLaunchArgument(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTile> VoiceCommandContentTiles() const noexcept;
};
...
{
    uint32_t MaxSupportedVoiceCommandContentTiles() const noexcept;
...
struct consume_Windows_ApplicationModel_VoiceCommands_IVoiceCommandServiceConnection
{
    ...
    Windows::Globalization::Language Language() const noexcept;
...
struct consume_Windows_ApplicationModel_VoiceCommands_IVoiceCommandUserMessage
{
    ...
    hstring SpokenMessage() const noexcept;
    void SpokenMessage(param::hstring const& value) const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Reason(Windows::ApplicationModel::VoiceCommands::VoiceCommandCompletionReason* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandContentTile>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ContentTileType(Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTileType* value) = 0;
    virtual HRESULT __stdcall put_ContentTileType(Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTileType value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandServiceConnection>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_VoiceCommandCompleted(::IUnknown* handler, event_token* token) = 0;
