...
{
    Windows::ApplicationModel::AppService::AppServiceClosedStatus Status() const noexcept;
};
...
{
    hstring AppServiceName() const noexcept;
    void AppServiceName(param::hstring const& value) const noexcept;
...
struct consume_Windows_ApplicationModel_AppService_IAppServiceConnection2
{
    ...
    void User(Windows::System::User const& value) const noexcept;
};
...
{
    Windows::ApplicationModel::AppService::AppServiceRequest Request() const noexcept;
...
{
    Windows::Foundation::Collections::ValueSet Message() const noexcept;
    Windows::ApplicationModel::AppService::AppServiceResponseStatus Status() const noexcept;
};
...
struct consume_Windows_ApplicationModel_AppService_IAppServiceTriggerDetails
{
    ...
    Windows::ApplicationModel::AppService::AppServiceConnection AppServiceConnection() const noexcept;
};
...
{
    bool IsRemoteSystemConnection() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::AppService::AppServiceClosedStatus* value) = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceConnection>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RequestReceived(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RequestReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_ServiceClosed(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Message(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Status(Windows::ApplicationModel::AppService::AppServiceResponseStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall CheckCallerForCapabilityAsync(HSTRING capabilityName, ::IUnknown** operation) = 0;
};};
