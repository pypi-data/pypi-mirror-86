...
struct consume_Windows_UI_Xaml_Navigation_INavigatingCancelEventArgs
{
    ...
    Windows::UI::Xaml::Navigation::NavigationMode NavigationMode() const noexcept;
    Windows::UI::Xaml::Interop::TypeName SourcePageType() const noexcept;
};
...
{
    Windows::Foundation::IInspectable Parameter() const noexcept;
    Windows::UI::Xaml::Media::Animation::NavigationTransitionInfo NavigationTransitionInfo() const noexcept;
};
...
{
    Windows::Foundation::IInspectable Content() const noexcept;
    Windows::Foundation::IInspectable Parameter() const noexcept;
    Windows::UI::Xaml::Interop::TypeName SourcePageType() const noexcept;
    Windows::UI::Xaml::Navigation::NavigationMode NavigationMode() const noexcept;
...
{
    HRESULT Exception() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty SourcePageTypeProperty() const noexcept;
};
...
template <> struct abi<Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_NavigationMode(Windows::UI::Xaml::Navigation::NavigationMode* value) = 0;
    virtual HRESULT __stdcall get_SourcePageType(struct_of<8,16>* value) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateInstance(struct_of<8,16> sourcePageType, ::IUnknown* parameter, ::IUnknown* navigationTransitionInfo, ::IUnknown** instance) = 0;
};};
