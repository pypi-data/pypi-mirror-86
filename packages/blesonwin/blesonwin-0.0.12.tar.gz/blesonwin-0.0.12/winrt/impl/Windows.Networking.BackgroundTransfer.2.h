...
template <> struct is_struct<Windows::Networking::BackgroundTransfer::BackgroundDownloadProgress>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Networking::BackgroundTransfer::BackgroundTransferFileRange>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Windows::Networking::BackgroundTransfer::BackgroundUploadProgress>
{
    static constexpr bool value{ true };
};
...
struct WINRT_EBO DownloadOperation :
    ...
    impl::require<DownloadOperation, Windows::Networking::BackgroundTransfer::IBackgroundTransferOperationPriority, Windows::Networking::BackgroundTransfer::IDownloadOperation2, Windows::Networking::BackgroundTransfer::IDownloadOperation3>
{
