...
{
    Windows::UI::Xaml::DependencyProperty DataTemplateComponentProperty() const noexcept;
...
{
    Windows::UI::Xaml::Markup::IXamlType BaseType() const noexcept;
    ...
    bool IsConstructible() const noexcept;
    ...
    Windows::UI::Xaml::Interop::TypeName UnderlyingType() const noexcept;
...
{
    virtual HRESULT __stdcall ProvideValue(::IUnknown** returnValue) = 0;
};};
...
{
    virtual HRESULT __stdcall Write(::IUnknown* inputStreams, ::IUnknown* outputStreams, ::IUnknown* xamlMetadataProvider, struct_of<12>* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Markup::IXamlBindingHelperStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall ConvertValue(struct_of<8,16> type, ::IUnknown* value, ::IUnknown** returnValue) = 0;
    ...
    virtual HRESULT __stdcall SetPropertyFromDateTime(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, Windows::Foundation::DateTime value) = 0;
    ...
    virtual HRESULT __stdcall SetPropertyFromPoint(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, Windows::Foundation::Point value) = 0;
    virtual HRESULT __stdcall SetPropertyFromRect(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, Windows::Foundation::Rect value) = 0;
    virtual HRESULT __stdcall SetPropertyFromSize(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, Windows::Foundation::Size value) = 0;
    virtual HRESULT __stdcall SetPropertyFromTimeSpan(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, Windows::Foundation::TimeSpan value) = 0;
...
{
    virtual HRESULT __stdcall GetXamlType(struct_of<8,16> type, ::IUnknown** xamlType) = 0;
    virtual HRESULT __stdcall GetXamlTypeByFullName(HSTRING fullName, ::IUnknown** xamlType) = 0;
    virtual HRESULT __stdcall GetXmlnsDefinitions(uint32_t* __definitionsSize, struct_of<8,16>** definitions) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Markup::IXamlType>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_UnderlyingType(struct_of<8,16>* value) = 0;
