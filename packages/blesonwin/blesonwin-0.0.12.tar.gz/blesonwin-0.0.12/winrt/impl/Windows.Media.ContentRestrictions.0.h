...
struct consume_Windows_Media_ContentRestrictions_IContentRestrictionsBrowsePolicy
{
    ...
    Windows::Foundation::IReference<uint32_t> MaxBrowsableAgeRating() const noexcept;
    Windows::Foundation::IReference<uint32_t> PreferredAgeRating() const noexcept;
};
...
struct consume_Windows_Media_ContentRestrictions_IRatedContentDescription
{
    ...
    Windows::Media::ContentRestrictions::RatedContentCategory Category() const noexcept;
    void Category(Windows::Media::ContentRestrictions::RatedContentCategory const& value) const noexcept;
    Windows::Foundation::Collections::IVector<hstring> Ratings() const noexcept;
    void Ratings(param::vector<hstring> const& value) const noexcept;
};
...
template <> struct abi<Windows::Media::ContentRestrictions::IRatedContentDescription>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Category(Windows::Media::ContentRestrictions::RatedContentCategory* value) = 0;
    virtual HRESULT __stdcall put_Category(Windows::Media::ContentRestrictions::RatedContentCategory value) = 0;
...
{
    virtual HRESULT __stdcall Create(HSTRING id, HSTRING title, Windows::Media::ContentRestrictions::RatedContentCategory category, ::IUnknown** RatedContentDescription) = 0;
};};
...
template <> struct abi<Windows::Media::ContentRestrictions::IRatedContentRestrictions>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_RestrictionsChanged(::IUnknown* handler, event_token* token) = 0;
