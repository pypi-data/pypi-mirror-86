...
struct consume_Windows_Security_Authentication_OnlineId_IOnlineIdAuthenticator
{
    ...
    void ApplicationId(GUID const& value) const noexcept;
    GUID ApplicationId() const noexcept;
    bool CanSignOut() const noexcept;
    hstring AuthenticatedSafeCustomerId() const noexcept;
};
...
struct consume_Windows_Security_Authentication_OnlineId_IOnlineIdServiceTicket
{
    ...
    Windows::Security::Authentication::OnlineId::OnlineIdServiceTicketRequest Request() const noexcept;
...
{
    Windows::Security::Authentication::OnlineId::OnlineIdSystemAuthenticatorForUser Default() const noexcept;
...
{
    Windows::Security::Authentication::OnlineId::OnlineIdServiceTicket Ticket() const noexcept;
...
{
    Windows::Security::Authentication::OnlineId::OnlineIdSystemIdentity Identity() const noexcept;
    Windows::Security::Authentication::OnlineId::OnlineIdSystemTicketStatus Status() const noexcept;
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Security::Authentication::OnlineId::OnlineIdServiceTicket> Tickets() const noexcept;
    hstring Id() const noexcept;
    hstring SafeCustomerId() const noexcept;
    hstring SignInName() const noexcept;
    hstring FirstName() const noexcept;
    hstring LastName() const noexcept;
    bool IsBetaAccount() const noexcept;
    bool IsConfirmedPC() const noexcept;
};
...
template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdAuthenticator>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AuthenticateUserAsyncAdvanced(::IUnknown* requests, Windows::Security::Authentication::OnlineId::CredentialPromptType credentialPromptType, ::IUnknown** authenticationOperation) = 0;
...
template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdSystemTicketResult>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Status(Windows::Security::Authentication::OnlineId::OnlineIdSystemTicketStatus* value) = 0;
