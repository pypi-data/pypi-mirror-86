...
struct consume_Windows_Security_ExchangeActiveSyncProvisioning_IEasClientDeviceInformation
{
    ...
    hstring OperatingSystem() const noexcept;
    hstring FriendlyName() const noexcept;
    hstring SystemManufacturer() const noexcept;
    hstring SystemProductName() const noexcept;
    hstring SystemSku() const noexcept;
};
...
{
    hstring SystemHardwareVersion() const noexcept;
    hstring SystemFirmwareVersion() const noexcept;
};
...
{
    bool RequireEncryption() const noexcept;
    void RequireEncryption(bool value) const noexcept;
    uint8_t MinPasswordLength() const noexcept;
    void MinPasswordLength(uint8_t value) const noexcept;
    bool DisallowConvenienceLogon() const noexcept;
    void DisallowConvenienceLogon(bool value) const noexcept;
    uint8_t MinPasswordComplexCharacters() const noexcept;
    void MinPasswordComplexCharacters(uint8_t value) const noexcept;
    Windows::Foundation::TimeSpan PasswordExpiration() const noexcept;
    void PasswordExpiration(Windows::Foundation::TimeSpan const& value) const noexcept;
    uint32_t PasswordHistory() const noexcept;
    void PasswordHistory(uint32_t value) const noexcept;
    uint8_t MaxPasswordFailedAttempts() const noexcept;
    void MaxPasswordFailedAttempts(uint8_t value) const noexcept;
    Windows::Foundation::TimeSpan MaxInactivityTimeLock() const noexcept;
    void MaxInactivityTimeLock(Windows::Foundation::TimeSpan const& value) const noexcept;
...
struct consume_Windows_Security_ExchangeActiveSyncProvisioning_IEasComplianceResults
{
    ...
    Windows::Security::ExchangeActiveSyncProvisioning::EasRequireEncryptionResult RequireEncryptionResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordLengthResult MinPasswordLengthResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasDisallowConvenienceLogonResult DisallowConvenienceLogonResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordComplexCharactersResult MinPasswordComplexCharactersResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordExpirationResult PasswordExpirationResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordHistoryResult PasswordHistoryResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasMaxPasswordFailedAttemptsResult MaxPasswordFailedAttemptsResult() const noexcept;
    Windows::Security::ExchangeActiveSyncProvisioning::EasMaxInactivityTimeLockResult MaxInactivityTimeLockResult() const noexcept;
};
...
{
    Windows::Security::ExchangeActiveSyncProvisioning::EasEncryptionProviderType EncryptionProviderType() const noexcept;
};
...
template <> struct abi<Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RequireEncryptionResult(Windows::Security::ExchangeActiveSyncProvisioning::EasRequireEncryptionResult* value) = 0;
    virtual HRESULT __stdcall get_MinPasswordLengthResult(Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordLengthResult* value) = 0;
    virtual HRESULT __stdcall get_DisallowConvenienceLogonResult(Windows::Security::ExchangeActiveSyncProvisioning::EasDisallowConvenienceLogonResult* value) = 0;
    virtual HRESULT __stdcall get_MinPasswordComplexCharactersResult(Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordComplexCharactersResult* value) = 0;
    virtual HRESULT __stdcall get_PasswordExpirationResult(Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordExpirationResult* value) = 0;
    virtual HRESULT __stdcall get_PasswordHistoryResult(Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordHistoryResult* value) = 0;
    virtual HRESULT __stdcall get_MaxPasswordFailedAttemptsResult(Windows::Security::ExchangeActiveSyncProvisioning::EasMaxPasswordFailedAttemptsResult* value) = 0;
    virtual HRESULT __stdcall get_MaxInactivityTimeLockResult(Windows::Security::ExchangeActiveSyncProvisioning::EasMaxInactivityTimeLockResult* value) = 0;
};};

template <> struct abi<Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_EncryptionProviderType(Windows::Security::ExchangeActiveSyncProvisioning::EasEncryptionProviderType* value) = 0;
};};
