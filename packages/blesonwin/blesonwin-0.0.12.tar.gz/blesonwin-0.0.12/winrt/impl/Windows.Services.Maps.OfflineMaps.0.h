...
{
    Windows::Services::Maps::OfflineMaps::OfflineMapPackageStatus Status() const noexcept;
    hstring DisplayName() const noexcept;
    hstring EnclosingRegionName() const noexcept;
    uint64_t EstimatedSizeInBytes() const noexcept;
...
{
    Windows::Services::Maps::OfflineMaps::OfflineMapPackageQueryStatus Status() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Services::Maps::OfflineMaps::OfflineMapPackage> Packages() const noexcept;
};
...
{
    Windows::Services::Maps::OfflineMaps::OfflineMapPackageStartDownloadStatus Status() const noexcept;
};
...
{
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::OfflineMaps::OfflineMapPackageStatus* value) = 0;
    ...
    virtual HRESULT __stdcall add_StatusChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::OfflineMaps::OfflineMapPackageQueryStatus* value) = 0;
...
{
    virtual HRESULT __stdcall get_Status(Windows::Services::Maps::OfflineMaps::OfflineMapPackageStartDownloadStatus* value) = 0;
};};
