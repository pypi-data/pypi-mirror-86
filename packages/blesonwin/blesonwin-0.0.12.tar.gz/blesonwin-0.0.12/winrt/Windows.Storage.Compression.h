...
{
    HRESULT __stdcall CreateCompressor(::IUnknown* underlyingStream, ::IUnknown** createdCompressor) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall CreateCompressorEx(::IUnknown* underlyingStream, Windows::Storage::Compression::CompressAlgorithm algorithm, uint32_t blockSize, ::IUnknown** createdCompressor) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
{
    HRESULT __stdcall CreateDecompressor(::IUnknown* underlyingStream, ::IUnknown** createdDecompressor) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
