...
{
    HRESULT __stdcall Compare(::IUnknown* object1, ::IUnknown* object2, bool* isEqual) noexcept final
    {
        try
        {
    ...
    HRESULT __stdcall GenerateRandom(uint32_t length, ::IUnknown** buffer) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall CreateFromByteArray(uint32_t __valueSize, uint8_t* value, ::IUnknown** buffer) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall CopyToByteArray(::IUnknown* buffer, uint32_t* __valueSize, uint8_t** value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall DecodeFromHexString(HSTRING value, ::IUnknown** buffer) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall EncodeToHexString(::IUnknown* buffer, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall DecodeFromBase64String(HSTRING value, ::IUnknown** buffer) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall EncodeToBase64String(::IUnknown* buffer, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall ConvertStringToBinary(HSTRING value, Windows::Security::Cryptography::BinaryStringEncoding encoding, ::IUnknown** buffer) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall ConvertBinaryToString(Windows::Security::Cryptography::BinaryStringEncoding encoding, ::IUnknown* buffer, HSTRING* value) noexcept final
    {
        try
        {
            typename D::abi_guard guard(this->shim());
