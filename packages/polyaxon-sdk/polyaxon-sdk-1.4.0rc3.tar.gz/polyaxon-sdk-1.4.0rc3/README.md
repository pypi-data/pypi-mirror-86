...
- API version: 1.4.0-rc3
- Package version: 1.4.0-rc3
...
*ComponentHubV1Api* | [**patch_component_version**](docs/ComponentHubV1Api.md#patch_component_version) | **PUT** /api/v1/{owner}/hub/{component}/versions/{version.name} | Patch component version
...
*ModelRegistryV1Api* | [**patch_model_version**](docs/ModelRegistryV1Api.md#patch_model_version) | **PUT** /api/v1/{owner}/registry/{model}/versions/{version.name} | Patch model version
