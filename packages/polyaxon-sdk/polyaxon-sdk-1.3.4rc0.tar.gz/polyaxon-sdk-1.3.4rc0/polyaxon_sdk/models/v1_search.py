...
class V1Search(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, tags=None, disabled=None, spec=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
