...
class V1Project(object):
    ...
    def __init__(self, uuid=None, user=None, user_email=None, owner=None, name=None, description=None, tags=None, created_at=None, updated_at=None, is_public=None, bookmarked=None, readme=None, settings=None, teams=None, role=None, local_vars_configuration=None):  # noqa: E501
