...
class V1ComponentHub(object):
    ...
    def __init__(self, uuid=None, name=None, content=None, description=None, tags=None, disabled=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
