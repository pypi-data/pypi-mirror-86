...
class V1ConnectionResponse(object):
    ...
    def __init__(self, uuid=None, name=None, agent=None, description=None, tags=None, created_at=None, updated_at=None, disabled=None, kind=None, local_vars_configuration=None):  # noqa: E501
