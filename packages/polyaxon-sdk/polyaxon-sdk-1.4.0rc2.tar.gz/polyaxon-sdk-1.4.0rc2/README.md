...
- API version: 1.4.0-rc2
- Package version: 1.4.0-rc2
...
*ComponentHubV1Api* | [**archive_component_hub**](docs/ComponentHubV1Api.md#archive_component_hub) | **POST** /api/v1/{owner}/components/{name}/archive | Archive hub component
*ComponentHubV1Api* | [**create_component_hub**](docs/ComponentHubV1Api.md#create_component_hub) | **POST** /api/v1/{owner}/components/create | Create hub component
*ComponentHubV1Api* | [**create_component_version**](docs/ComponentHubV1Api.md#create_component_version) | **POST** /api/v1/{owner}/components/{component}/versions | Create component version
*ComponentHubV1Api* | [**delete_component_hub**](docs/ComponentHubV1Api.md#delete_component_hub) | **DELETE** /api/v1/{owner}/components/{name} | Delete hub component
*ComponentHubV1Api* | [**delete_component_version**](docs/ComponentHubV1Api.md#delete_component_version) | **DELETE** /api/v1/{owner}/components/{entity}/versions/{name} | Delete component version
*ComponentHubV1Api* | [**get_component_hub**](docs/ComponentHubV1Api.md#get_component_hub) | **GET** /api/v1/{owner}/components/{name} | Get hub component
*ComponentHubV1Api* | [**get_component_version**](docs/ComponentHubV1Api.md#get_component_version) | **GET** /api/v1/{owner}/components/{entity}/versions/{name} | Get component version
*ComponentHubV1Api* | [**list_component_hub_names**](docs/ComponentHubV1Api.md#list_component_hub_names) | **GET** /api/v1/{owner}/components/names | List hub component names
*ComponentHubV1Api* | [**list_component_hubs**](docs/ComponentHubV1Api.md#list_component_hubs) | **GET** /api/v1/{owner}/components/list | List hub components
*ComponentHubV1Api* | [**list_component_version_names**](docs/ComponentHubV1Api.md#list_component_version_names) | **GET** /api/v1/{owner}/components/{name}/versions/names | List component version names
*ComponentHubV1Api* | [**list_component_versions**](docs/ComponentHubV1Api.md#list_component_versions) | **GET** /api/v1/{owner}/components/{name}/versions | List component versions
*ComponentHubV1Api* | [**patch_component_hub**](docs/ComponentHubV1Api.md#patch_component_hub) | **PATCH** /api/v1/{owner}/components/{component.name} | Patch hub component
*ComponentHubV1Api* | [**patch_component_version**](docs/ComponentHubV1Api.md#patch_component_version) | **PUT** /api/v1/{owner}/components/{component}/versions/{version.name} | Patch component version
*ComponentHubV1Api* | [**restore_component_hub**](docs/ComponentHubV1Api.md#restore_component_hub) | **POST** /api/v1/{owner}/components/{name}/restore | Restore hub component
*ComponentHubV1Api* | [**update_component_hub**](docs/ComponentHubV1Api.md#update_component_hub) | **PUT** /api/v1/{owner}/components/{component.name} | Update hub component
...
*ModelRegistryV1Api* | [**archive_model_registry**](docs/ModelRegistryV1Api.md#archive_model_registry) | **POST** /api/v1/{owner}/models/{name}/archive | Archive registry model
*ModelRegistryV1Api* | [**create_model_registry**](docs/ModelRegistryV1Api.md#create_model_registry) | **POST** /api/v1/{owner}/models/create | Create registry model
*ModelRegistryV1Api* | [**create_model_version**](docs/ModelRegistryV1Api.md#create_model_version) | **POST** /api/v1/{owner}/models/{model}/versions | Create model version
*ModelRegistryV1Api* | [**delete_model_registry**](docs/ModelRegistryV1Api.md#delete_model_registry) | **DELETE** /api/v1/{owner}/models/{name} | Delete registry model
*ModelRegistryV1Api* | [**delete_model_version**](docs/ModelRegistryV1Api.md#delete_model_version) | **DELETE** /api/v1/{owner}/models/{entity}/versions/{name} | Delete model version
*ModelRegistryV1Api* | [**get_model_registry**](docs/ModelRegistryV1Api.md#get_model_registry) | **GET** /api/v1/{owner}/models/{name} | Get registry model
*ModelRegistryV1Api* | [**get_model_version**](docs/ModelRegistryV1Api.md#get_model_version) | **GET** /api/v1/{owner}/models/{entity}/versions/{name} | Get model version
*ModelRegistryV1Api* | [**list_model_registry**](docs/ModelRegistryV1Api.md#list_model_registry) | **GET** /api/v1/{owner}/models/list | List registry models
*ModelRegistryV1Api* | [**list_model_registry_names**](docs/ModelRegistryV1Api.md#list_model_registry_names) | **GET** /api/v1/{owner}/models/names | List registry model names
*ModelRegistryV1Api* | [**list_model_version_names**](docs/ModelRegistryV1Api.md#list_model_version_names) | **GET** /api/v1/{owner}/models/{name}/versions/names | List model versions names
*ModelRegistryV1Api* | [**list_model_versions**](docs/ModelRegistryV1Api.md#list_model_versions) | **GET** /api/v1/{owner}/models/{name}/versions | List model versions
*ModelRegistryV1Api* | [**patch_model_registry**](docs/ModelRegistryV1Api.md#patch_model_registry) | **PATCH** /api/v1/{owner}/models/{model.name} | Patch registry model
*ModelRegistryV1Api* | [**patch_model_version**](docs/ModelRegistryV1Api.md#patch_model_version) | **PUT** /api/v1/{owner}/models/{model}/versions/{version.name} | Patch model version
*ModelRegistryV1Api* | [**restore_model_registry**](docs/ModelRegistryV1Api.md#restore_model_registry) | **POST** /api/v1/{owner}/models/{name}/restore | Restore registry model
*ModelRegistryV1Api* | [**update_model_registry**](docs/ModelRegistryV1Api.md#update_model_registry) | **PUT** /api/v1/{owner}/models/{model.name} | Update registry model
...
*ProjectsV1Api* | [**fetch_project_teams**](docs/ProjectsV1Api.md#fetch_project_teams) | **GET** /api/v1/{owner}/{name}/teams | Get project teams
