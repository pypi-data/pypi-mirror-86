...
class ProjectsV1Api(object):
    ...
    def fetch_project_teams(self, owner, name, **kwargs):  # noqa: E501
        """Get project teams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fetch_project_teams(owner, name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_project_teams_with_http_info(owner, name, **kwargs)  # noqa: E501

    def fetch_project_teams_with_http_info(self, owner, name, **kwargs):  # noqa: E501
        """Get project teams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fetch_project_teams_with_http_info(owner, name, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `fetch_project_teams`")  # noqa: E501
