...
_ = pkg_resources.get_distribution('locative-ml-helpers')
...
def run_training():
    ...
    if ARGS.run_eval:
        ...
        logger.info("Data found at ENV VAR = {}".format(os.environ['SM_CHANNEL_LOOKUP']))
