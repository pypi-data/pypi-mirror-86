...
class Ui_TrackerWindow(object):
    def setupUi(self, TrackerWindow):
        ...
        self.location_box = QGroupBox(self.centralWidget)
        self.location_box.setObjectName(u"location_box")
        self.verticalLayout_2 = QVBoxLayout(self.location_box)
        self.verticalLayout_2.setSpacing(6)
        self.verticalLayout_2.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.resource_filter_check = QCheckBox(self.location_box)
        ...
        self.hide_collected_resources_check = QCheckBox(self.location_box)
        ...
        self.possible_locations_tree = QTreeWidget(self.location_box)
        ...
        self.gridLayout.addWidget(self.location_box, 2, 1, 1, 3)

        self.actions_box = QGroupBox(self.centralWidget)
        self.actions_box.setObjectName(u"actions_box")
        ...
        self.verticalLayout = QVBoxLayout(self.actions_box)
        self.verticalLayout.setSpacing(6)
        self.verticalLayout.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.actions_title_label = QLabel(self.actions_box)
        ...
        self.actions_list = QListWidget(self.actions_box)
        self.actions_list.setObjectName(u"actions_list")

        self.verticalLayout.addWidget(self.actions_list)


        self.gridLayout.addWidget(self.actions_box, 2, 4, 1, 1)
        ...
        self.tab_widget.setMaximumSize(QSize(290, 16777215))
        ...
        sizePolicy2.setHeightForWidth(self.pickups_scroll_area.sizePolicy().hasHeightForWidth())
        self.pickups_scroll_area.setSizePolicy(sizePolicy2)
        ...
        self.pickups_scroll_contents.setGeometry(QRect(0, 0, 285, 394))
        ...
        sizePolicy2.setHeightForWidth(self.elevators_scroll_area.sizePolicy().hasHeightForWidth())
        self.elevators_scroll_area.setSizePolicy(sizePolicy2)
        ...
        self.elevators_scroll_contents.setGeometry(QRect(0, 0, 285, 394))
        ...
        self.translator_gate_scroll_contents.setGeometry(QRect(0, 0, 284, 392))
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 932, 21))
    ...
    def retranslateUi(self, TrackerWindow):
        ...
        self.location_box.setTitle(QCoreApplication.translate("TrackerWindow", u"Current location: ", None))
