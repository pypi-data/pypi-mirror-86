...
class StorageObject(object):
    ...
    def id(self, id):
        ...
        if (id is not None and not re.search(r'[a-z0-9]\w+', id)):  # noqa: E501
            raise ValueError(r"Invalid value for `id`, must be a follow pattern or equal to `/[a-z0-9]\w+/`")  # noqa: E501
