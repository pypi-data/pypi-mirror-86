...
class spiderPools(pools):
    def __init__(self, rulesConfig, pool_length=10, cache_size=50, fingerprint=True, logging= None):
        ...
        for i in range(0, pool_length):
            m_spider = Analysis(rulesConfig,logging=self._log)
