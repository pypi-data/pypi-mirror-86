...
_TASKSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='placement_group_capture_child_tasks', full_name='ray.rpc.TaskSpec.placement_group_capture_child_tasks', index=18,
