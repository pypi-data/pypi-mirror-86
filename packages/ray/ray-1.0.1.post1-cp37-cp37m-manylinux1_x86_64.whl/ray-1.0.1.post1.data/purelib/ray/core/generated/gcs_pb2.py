...
_HEARTBEATTABLEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='resourcesAvailable', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resources_available_changed', full_name='ray.rpc.HeartbeatTableData.resources_available_changed', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='resources_total', full_name='ray.rpc.HeartbeatTableData.resources_total', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='resource_load', full_name='ray.rpc.HeartbeatTableData.resource_load', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='resource_load_changed', full_name='ray.rpc.HeartbeatTableData.resource_load_changed', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='resource_load_by_shape', full_name='ray.rpc.HeartbeatTableData.resource_load_by_shape', index=6,
...
_HEARTBEATBATCHTABLEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='resourceLoadByShape', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='placement_group_load', full_name='ray.rpc.HeartbeatBatchTableData.placement_group_load', index=2,
...
_HEARTBEATBATCHTABLEDATA.fields_by_name['placement_group_load'].message_type = _PLACEMENTGROUPLOAD
