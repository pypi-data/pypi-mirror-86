...
[boto3.CognitoIdentityProvider 1.16.25](https://boto3.amazonaws.com/v1/documentation/api/1.16.25/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
