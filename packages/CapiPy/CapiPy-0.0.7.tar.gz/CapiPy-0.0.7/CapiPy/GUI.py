            ...
            while True: 
                ...
                if event_m1 in (None, 'Exit'):
                    ...
                    if values_m1[7] is True:
                        ...
                        checks.append("Select if you want your results to be shown directly or not.")
                if len(checks) == 0:
                        ...
                        if output_programs == "YES":
                            if os.path.isfile(workdir + '/' + folder_name + '/Blast&Modeller/query_multimeric.pdb'):
                                subprocess.Popen([settings['Pymol_location'],
                                                  ...
                                                  currentdir + '/' + folder_name + '/Blast&Modeller/template.pdb'])
            ...
            while True: 
                ...
                if event_m2 in (None, 'Exit'):
                    ...
                    if values_m2[5] is True:
                        ...
                        checks.append("Select if you want to use UniProt preferentially or not.")

                    if values_m2[7] is True:
                        output_programs = "YES"
                    elif values_m2[8] is True:
                        output_programs = "NO"
                    else:
                        checks.append("Select if you want your results to be shown directly or not.")
                    ...
                    if len(checks) == 0:
                        ...
                        try:
                            ...
                            if output_programs == 'YES':
                                ...
                                time.sleep(3)
                                subprocess.Popen([settings['text_exe'], workdir + '/' +
                ...
                if event_set in (None, 'Exit'):
                    ...
                    for key in key_win:  
                        try:
                            ...
                            print(f'Problem updating settings from window values. Key = {key}' + str(e))
