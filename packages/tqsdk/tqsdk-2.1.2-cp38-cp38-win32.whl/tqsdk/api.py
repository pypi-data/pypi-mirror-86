...
class TqApi(object):
    ...
    def query_options(self, underlying_symbol: str, option_class=None, exercise_year=None, exercise_month=None, strike_price=None, exchange_id:str=None, expired:bool=None, has_A=None, **kwargs):
        """
        ...
        Args:
            ...
            exercise_year (str): [可选] 最后行权日年份

            exercise_month (str): [可选] 最后行权日月份
