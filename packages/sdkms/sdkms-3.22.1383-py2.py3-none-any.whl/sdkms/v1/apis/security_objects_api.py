...
class SecurityObjectsApi(object):
    ...
    def get_security_objects(self, name=None, group_id=None, creator=None, sort=None, compliant_with_policies=None, start=None, limit=None, offset=None, async_call=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async_call:
            return self.get_security_objects_with_http_info(name=name, group_id=group_id, creator=creator, sort=sort, compliant_with_policies=compliant_with_policies, start=start, limit=limit, offset=offset, async_call=async_call, **kwargs)
        else:
            (data) = self.get_security_objects_with_http_info(name=name, group_id=group_id, creator=creator, sort=sort, compliant_with_policies=compliant_with_policies, start=start, limit=limit, offset=offset, async_call=async_call, **kwargs)
            return data

    def get_security_objects_with_http_info(self, name=None, group_id=None, creator=None, sort=None, compliant_with_policies=None, start=None, limit=None, offset=None, async_call=False, **kwargs):
        """
        Return detailed information about the security objects stored in Fortanix SDKMS. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True::
        ...
        all_params = ['name', 'group_id', 'creator', 'sort', 'compliant_with_policies', 'start', 'limit', 'offset']
        all_params.append('async_call')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
