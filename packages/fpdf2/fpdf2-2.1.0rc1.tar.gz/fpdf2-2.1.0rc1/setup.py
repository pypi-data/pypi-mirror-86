...
# fpdf2 versions are major.minor.patch(?:(?:alpha|beta|rc)\d+)? see pep440
version_mmp_pre_release = r"FPDF_VERSION = '(\d+.\d+.\d+(?:(?:a|b|rc)\d+)?)'"
version = re.findall(version_mmp_pre_release, read('./fpdf/fpdf.py'))[0]
