...
class LongLongVector(object):
    ...
    def __init__(self):
        _swigfaiss.LongLongVector_swiginit(self, _swigfaiss.new_LongLongVector())
...
# Register LongLongVector in _swigfaiss:
_swigfaiss.LongLongVector_swigregister(LongLongVector)
...
class AllocInfo(object):
    ...
    type = property(_swigfaiss.AllocInfo_type_get, _swigfaiss.AllocInfo_type_set)
    device = property(_swigfaiss.AllocInfo_device_get, _swigfaiss.AllocInfo_device_set)
    space = property(_swigfaiss.AllocInfo_space_get, _swigfaiss.AllocInfo_space_set)
    stream = property(_swigfaiss.AllocInfo_stream_get, _swigfaiss.AllocInfo_stream_set)
...
class AllocRequest(AllocInfo):
    ...
    size = property(_swigfaiss.AllocRequest_size_get, _swigfaiss.AllocRequest_size_set)
...
class GpuClonerOptions(object):
    ...
    indicesOptions = property(_swigfaiss.GpuClonerOptions_indicesOptions_get, _swigfaiss.GpuClonerOptions_indicesOptions_set)
    useFloat16CoarseQuantizer = property(_swigfaiss.GpuClonerOptions_useFloat16CoarseQuantizer_get, _swigfaiss.GpuClonerOptions_useFloat16CoarseQuantizer_set)
    useFloat16 = property(_swigfaiss.GpuClonerOptions_useFloat16_get, _swigfaiss.GpuClonerOptions_useFloat16_set)
    usePrecomputed = property(_swigfaiss.GpuClonerOptions_usePrecomputed_get, _swigfaiss.GpuClonerOptions_usePrecomputed_set)
    reserveVecs = property(_swigfaiss.GpuClonerOptions_reserveVecs_get, _swigfaiss.GpuClonerOptions_reserveVecs_set)
    storeTransposed = property(_swigfaiss.GpuClonerOptions_storeTransposed_get, _swigfaiss.GpuClonerOptions_storeTransposed_set)
    verbose = property(_swigfaiss.GpuClonerOptions_verbose_get, _swigfaiss.GpuClonerOptions_verbose_set)
...
class GpuMultipleClonerOptions(GpuClonerOptions):
    ...
    shard = property(_swigfaiss.GpuMultipleClonerOptions_shard_get, _swigfaiss.GpuMultipleClonerOptions_shard_set)
    shard_type = property(_swigfaiss.GpuMultipleClonerOptions_shard_type_get, _swigfaiss.GpuMultipleClonerOptions_shard_type_set)
...
class GpuIndexConfig(object):
    ...
    device = property(_swigfaiss.GpuIndexConfig_device_get, _swigfaiss.GpuIndexConfig_device_set)
    memorySpace = property(_swigfaiss.GpuIndexConfig_memorySpace_get, _swigfaiss.GpuIndexConfig_memorySpace_set)
...
class GpuIndexFlatConfig(GpuIndexConfig):
    ...
    useFloat16 = property(_swigfaiss.GpuIndexFlatConfig_useFloat16_get, _swigfaiss.GpuIndexFlatConfig_useFloat16_set)
    storeTransposed = property(_swigfaiss.GpuIndexFlatConfig_storeTransposed_get, _swigfaiss.GpuIndexFlatConfig_storeTransposed_set)
...
class GpuIndexIVFConfig(GpuIndexConfig):
    ...
    indicesOptions = property(_swigfaiss.GpuIndexIVFConfig_indicesOptions_get, _swigfaiss.GpuIndexIVFConfig_indicesOptions_set)
    flatConfig = property(_swigfaiss.GpuIndexIVFConfig_flatConfig_get, _swigfaiss.GpuIndexIVFConfig_flatConfig_set)
...
class GpuIndexIVF(GpuIndex):
    ...
    cp = property(_swigfaiss.GpuIndexIVF_cp_get, _swigfaiss.GpuIndexIVF_cp_set)
    nlist = property(_swigfaiss.GpuIndexIVF_nlist_get, _swigfaiss.GpuIndexIVF_nlist_set)
    nprobe = property(_swigfaiss.GpuIndexIVF_nprobe_get, _swigfaiss.GpuIndexIVF_nprobe_set)
    quantizer = property(_swigfaiss.GpuIndexIVF_quantizer_get, _swigfaiss.GpuIndexIVF_quantizer_set)
...
class GpuIndexIVFPQConfig(GpuIndexIVFConfig):
    ...
    useFloat16LookupTables = property(_swigfaiss.GpuIndexIVFPQConfig_useFloat16LookupTables_get, _swigfaiss.GpuIndexIVFPQConfig_useFloat16LookupTables_set)
    usePrecomputedTables = property(_swigfaiss.GpuIndexIVFPQConfig_usePrecomputedTables_get, _swigfaiss.GpuIndexIVFPQConfig_usePrecomputedTables_set)
    alternativeLayout = property(_swigfaiss.GpuIndexIVFPQConfig_alternativeLayout_get, _swigfaiss.GpuIndexIVFPQConfig_alternativeLayout_set)
    useMMCodeDistance = property(_swigfaiss.GpuIndexIVFPQConfig_useMMCodeDistance_get, _swigfaiss.GpuIndexIVFPQConfig_useMMCodeDistance_set)
...
class GpuIndexIVFScalarQuantizer(GpuIndexIVF):
    ...
    sq = property(_swigfaiss.GpuIndexIVFScalarQuantizer_sq_get, _swigfaiss.GpuIndexIVFScalarQuantizer_sq_set)
    by_residual = property(_swigfaiss.GpuIndexIVFScalarQuantizer_by_residual_get, _swigfaiss.GpuIndexIVFScalarQuantizer_by_residual_set)
...
class GpuDistanceParams(object):
    ...
    metric = property(_swigfaiss.GpuDistanceParams_metric_get, _swigfaiss.GpuDistanceParams_metric_set)
    metricArg = property(_swigfaiss.GpuDistanceParams_metricArg_get, _swigfaiss.GpuDistanceParams_metricArg_set)
    k = property(_swigfaiss.GpuDistanceParams_k_get, _swigfaiss.GpuDistanceParams_k_set)
    dims = property(_swigfaiss.GpuDistanceParams_dims_get, _swigfaiss.GpuDistanceParams_dims_set)
    vectors = property(_swigfaiss.GpuDistanceParams_vectors_get, _swigfaiss.GpuDistanceParams_vectors_set)
    ...
    vectorNorms = property(_swigfaiss.GpuDistanceParams_vectorNorms_get, _swigfaiss.GpuDistanceParams_vectorNorms_set)
    queries = property(_swigfaiss.GpuDistanceParams_queries_get, _swigfaiss.GpuDistanceParams_queries_set)
    ...
    outDistances = property(_swigfaiss.GpuDistanceParams_outDistances_get, _swigfaiss.GpuDistanceParams_outDistances_set)
    ignoreOutDistances = property(_swigfaiss.GpuDistanceParams_ignoreOutDistances_get, _swigfaiss.GpuDistanceParams_ignoreOutDistances_set)
    outIndicesType = property(_swigfaiss.GpuDistanceParams_outIndicesType_get, _swigfaiss.GpuDistanceParams_outIndicesType_set)
