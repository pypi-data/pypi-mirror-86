...
class BackupGranuleCell(DbbsNeuronModel):
    @staticmethod
    def builder(model):
    ...
    synapse_types = {
        "AMPA": {
            ...
            "attributes": {
                "tau_facil": 5, "tau_rec": 8, "tau_1": 1, "gmax": 1500, "U": 0.43
            }
        },
        "NMDA": {
    ...
    section_types = {
        ...
        "ascending_axon": {
            ...
            "attributes": {
                "Ra": 100, "cm": 1,
                "ena": 87.39, "ek": -88, ("e","Leak"): -58.65, "eca": 137.5,
        ...
        "axon_initial_segment": {
            ...
            "attributes": {
                "Ra": 100, "cm": 1,
                "ena": 87.39, "ek": -88, "eca": 137.5, ("e","Leak"): -58.65,
        ...
        "axon_hillock": {
            ...
            "attributes": {
                "Ra": 100, "cm": 2,
                ("e","Leak"): -58.65, "ena": 87.39, "ek": -88, "eca": 137.5,
...
class GranuleCell(BackupGranuleCell):
    def build_parallel_fiber(self):
        self.fiber_section_length = 7
        super().build_parallel_fiber()
    ...
    def build_ascending_axon(self):
        ...
        for i in range(n):
            aa = p.Section()
            aa.labels = ["ascending_axon"]
            aa.nseg = int(n)
            aa.L = seg_length
            aa.diam = 0.3
            self.axon.append(aa)
            self.ascending_axon.append(aa)
            aa.connect(previous_section)
            aa.add_3d([[0., y, 0.], [0., (y + i * self.ascending_axon_length), 0.]])
            y += i * self.ascending_axon_length
            previous_section = aa
        # Store the last used y position as the start for the parallel fiber
        self.y_pf = y
