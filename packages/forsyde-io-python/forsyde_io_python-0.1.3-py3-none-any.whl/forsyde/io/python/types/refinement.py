...
@dataclass(eq=True, repr=True, frozen=True)
class FixedPriorityScheduler(core.Type):
    """
    This class has been automatically generated from forsyde-io.
    Any modifications therein are likely going to be overwritten.
    """

    type_name: str = 'FixedPriorityScheduler'
    required_ports: Set[str] = field(
        default_factory=lambda: set(
          'preemptive'
        ),
...
@dataclass(eq=True, repr=True, frozen=True)
class CustomScheduler(core.Type):
    """
    This class has been automatically generated from forsyde-io.
    Any modifications therein are likely going to be overwritten.
    """

    type_name: str = 'CustomScheduler'
    required_ports: Set[str] = field(
        default_factory=lambda: set(
        ),
        repr=False
...
@dataclass(eq=True, repr=True, frozen=True)
class RoundRobinScheduler(core.Type):
    """
    This class has been automatically generated from forsyde-io.
    Any modifications therein are likely going to be overwritten.
    """

    type_name: str = 'RoundRobinScheduler'
    required_ports: Set[str] = field(
        default_factory=lambda: set(
        ),
        repr=False
