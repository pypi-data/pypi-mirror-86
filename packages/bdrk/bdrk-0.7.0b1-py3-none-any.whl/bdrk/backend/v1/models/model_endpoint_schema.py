...
class ModelEndpointSchema(object):
    ...
    def __init__(self, created_at=None, created_by=None, environment_id=None, expose_method='PRIVATE', fqdn=None, hostname=None, id=None, ingress_protocol=None, object='endpoint', project_id=None, service_weights=None, updated_at=None, **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, created_at=None, created_by=None, environment_id=None, expose_method='PRIVATE', fqdn=None, hostname=None, id=None, ingress_protocol=None, object='endpoint', project_id=None, service_weights=None, updated_at=None, **kwargs):  # noqa: E501
    ...
    def hostname(self, hostname):
        ...
        if hostname is not None and not re.search(r'^(?!bdrk-)[a-z]([-a-z0-9]{3,61}[a-z0-9])$', hostname):  # noqa: E501
            raise ValueError(r"Invalid value for `hostname`, must be a follow pattern or equal to `/^(?!bdrk-)[a-z]([-a-z0-9]{3,61}[a-z0-9])$/`")  # noqa: E501
