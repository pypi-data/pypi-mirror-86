...
class ModelServerSchema(object):
    ...
    def __init__(self, created_at=None, deployed_by=None, endpoint_id=None, id=None, image_path=None, model_version_id=None, object='server', parameters=None, resources=None, secrets=None, source=None, status=None, undeployed_at=None, undeployed_by=None, updated_at=None, **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, created_at=None, deployed_by=None, endpoint_id=None, id=None, image_path=None, model_version_id=None, object='server', parameters=None, resources=None, secrets=None, source=None, status=None, undeployed_at=None, undeployed_by=None, updated_at=None, **kwargs):  # noqa: E501
