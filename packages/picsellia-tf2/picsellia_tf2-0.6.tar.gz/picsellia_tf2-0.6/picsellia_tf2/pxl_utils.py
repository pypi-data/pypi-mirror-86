...
def train(ckpt_dir='', config_path='', train_steps=1000, use_tpu=False, checkpoint_every_n=100,
...
def evaluate(metrics_dir='', config_path='', ckpt_dir=''):
    '''
...
def run_inference(path, exported_model_dir, label_map_path, results_dir, disp=True, num_infer=5, min_score_thresh=0.7, from_tfrecords=False):
