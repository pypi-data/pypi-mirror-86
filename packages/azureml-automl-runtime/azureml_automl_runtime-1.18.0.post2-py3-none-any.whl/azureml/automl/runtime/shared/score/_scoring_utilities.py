...
from azureml.automl.core.shared.exceptions import ClientException, DataErrorException, ResourceException
...
def pad_predictions(y_pred_probs: np.ndarray,
    ...
    try:
        ...
        for class_label in class_labels:
            found = False
            for trained_index, trained_label in enumerate(train_labels):
        ...
        # Work item to address high memory usage: 915945
