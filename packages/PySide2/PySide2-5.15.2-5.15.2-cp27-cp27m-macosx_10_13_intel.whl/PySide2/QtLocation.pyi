...
class QGeoCodingManagerEngine(PySide2.QtCore.QObject):
    ...
    def __init__(self, parameters: typing.Dict[str, typing.Any], parent: typing.Optional[PySide2.QtCore.QObject]=...) -> None: ...
...
class QGeoRouteReply(PySide2.QtCore.QObject):
    ...
    def abort(self) -> None: ...
    def addRoutes(self, routes: typing.Sequence[PySide2.QtLocation.QGeoRoute]) -> None: ...
    def error(self) -> PySide2.QtLocation.QGeoRouteReply.Error: ...
    def errorString(self) -> str: ...
    def isFinished(self) -> bool: ...
    def request(self) -> PySide2.QtLocation.QGeoRouteRequest: ...
    def routes(self) -> typing.List[PySide2.QtLocation.QGeoRoute]: ...
    def setError(self, error: PySide2.QtLocation.QGeoRouteReply.Error, errorString: str) -> None: ...
    def setFinished(self, finished: bool) -> None: ...
    def setRoutes(self, routes: typing.Sequence[PySide2.QtLocation.QGeoRoute]) -> None: ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    def featureTypes(self) -> typing.List[PySide2.QtLocation.QGeoRouteRequest.FeatureType]: ...
    ...
    def setWaypointsMetadata(self, waypointMetadata: typing.Sequence[typing.Dict]) -> None: ...
    ...
    def waypointsMetadata(self) -> typing.List[typing.Dict]: ...
...
class QGeoServiceProviderFactory(Shiboken.Object):
    ...
    def createGeocodingManagerEngine(self, parameters: typing.Dict[str, typing.Any], error: PySide2.QtLocation.QGeoServiceProvider.Error) -> typing.Tuple[PySide2.QtLocation.QGeoCodingManagerEngine, str]: ...
    def createPlaceManagerEngine(self, parameters: typing.Dict[str, typing.Any], error: PySide2.QtLocation.QGeoServiceProvider.Error) -> typing.Tuple[PySide2.QtLocation.QPlaceManagerEngine, str]: ...
    def createRoutingManagerEngine(self, parameters: typing.Dict[str, typing.Any], error: PySide2.QtLocation.QGeoServiceProvider.Error) -> typing.Tuple[PySide2.QtLocation.QGeoRoutingManagerEngine, str]: ...
...
class QPlace(Shiboken.Object):
    ...
    def categories(self) -> typing.List[PySide2.QtLocation.QPlaceCategory]: ...
    def contactDetails(self, contactType: str) -> typing.List[PySide2.QtLocation.QPlaceContactDetail]: ...
    def contactTypes(self) -> typing.List[str]: ...
    def content(self, type: PySide2.QtLocation.QPlaceContent.Type) -> typing.Dict[int, PySide2.QtLocation.QPlaceContent]: ...
    ...
    def insertContent(self, type: PySide2.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]) -> None: ...
    ...
    def setCategories(self, categories: typing.Sequence[PySide2.QtLocation.QPlaceCategory]) -> None: ...
    def setCategory(self, category: PySide2.QtLocation.QPlaceCategory) -> None: ...
    def setContactDetails(self, contactType: str, details: typing.Sequence[PySide2.QtLocation.QPlaceContactDetail]) -> None: ...
    def setContent(self, type: PySide2.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]) -> None: ...
...
class QPlaceContentReply(PySide2.QtLocation.QPlaceReply):
    ...
    def content(self) -> typing.Dict[int, PySide2.QtLocation.QPlaceContent]: ...
    ...
    def setContent(self, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]) -> None: ...
...
class QPlaceManager(PySide2.QtCore.QObject):
    ...
    def childCategories(self, parentId: str=...) -> typing.List[PySide2.QtLocation.QPlaceCategory]: ...
...
class QPlaceMatchReply(PySide2.QtLocation.QPlaceReply):
    ...
    def places(self) -> typing.List[PySide2.QtLocation.QPlace]: ...
    def request(self) -> PySide2.QtLocation.QPlaceMatchRequest: ...
    def setPlaces(self, results: typing.Sequence[PySide2.QtLocation.QPlace]) -> None: ...
...
class QPlaceMatchRequest(Shiboken.Object):
    ...
    def places(self) -> typing.List[PySide2.QtLocation.QPlace]: ...
    def setParameters(self, parameters: typing.Dict[str, typing.Any]) -> None: ...
    def setPlaces(self, places: typing.Sequence[PySide2.QtLocation.QPlace]) -> None: ...
    def setResults(self, results: typing.Sequence[PySide2.QtLocation.QPlaceSearchResult]) -> None: ...
...
class QPlaceSearchReply(PySide2.QtLocation.QPlaceReply):
    ...
    def results(self) -> typing.List[PySide2.QtLocation.QPlaceSearchResult]: ...
