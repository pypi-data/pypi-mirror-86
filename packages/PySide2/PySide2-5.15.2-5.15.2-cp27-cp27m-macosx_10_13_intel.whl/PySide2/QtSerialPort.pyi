...
class QSerialPort(PySide2.QtCore.QIODevice):
    ...
    def readData(self, data: str, maxSize: int) -> int: ...
    def readLineData(self, data: str, maxSize: int) -> int: ...
...
class QSerialPortInfo(Shiboken.Object):
    ...
    def __copy__() -> None: ...
    @staticmethod
    def availablePorts() -> typing.List[PySide2.QtSerialPort.QSerialPortInfo]: ...
