...
class QDomDocument(PySide2.QtXml.QDomNode):
    ...
    @typing.overload
    def setContent(self, source: PySide2.QtXml.QXmlInputSource, namespaceProcessing: bool) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, source: PySide2.QtXml.QXmlInputSource, reader: PySide2.QtXml.QXmlReader) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, text: PySide2.QtCore.QByteArray) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, text: PySide2.QtCore.QByteArray, namespaceProcessing: bool) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
