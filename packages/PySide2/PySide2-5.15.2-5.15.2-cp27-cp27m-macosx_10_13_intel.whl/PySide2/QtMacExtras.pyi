...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    def allowedItems(self) -> typing.List[PySide2.QtMacExtras.QMacToolBarItem]: ...
    def attachToWindow(self, window: PySide2.QtGui.QWindow) -> None: ...
    def detachFromWindow(self) -> None: ...
    def items(self) -> typing.List[PySide2.QtMacExtras.QMacToolBarItem]: ...
    def setAllowedItems(self, allowedItems: typing.Sequence[PySide2.QtMacExtras.QMacToolBarItem]) -> None: ...
    def setItems(self, items: typing.Sequence[PySide2.QtMacExtras.QMacToolBarItem]) -> None: ...
