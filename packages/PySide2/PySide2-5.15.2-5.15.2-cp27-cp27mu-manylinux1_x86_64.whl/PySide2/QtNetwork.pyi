...
class QDtls(PySide2.QtCore.QObject):
    ...
    def ignoreVerificationErrors(self, errorsToIgnore: typing.List[PySide2.QtNetwork.QSslError]) -> None: ...
...
class QHostAddress(Shiboken.Object):
    ...
    @typing.overload
    def isInSubnet(self, subnet: typing.Tuple[PySide2.QtNetwork.QHostAddress, int]) -> bool: ...
    ...
    @staticmethod
    def parseSubnet(subnet: str) -> typing.Tuple[PySide2.QtNetwork.QHostAddress, int]: ...
...
class QHostInfo(Shiboken.Object):
    ...
    def setAddresses(self, addresses: typing.Sequence[PySide2.QtNetwork.QHostAddress]) -> None: ...
...
class QNetworkAccessManager(PySide2.QtCore.QObject):
    ...
    def addStrictTransportSecurityHosts(self, knownHosts: typing.List[PySide2.QtNetwork.QHstsPolicy]) -> None: ...
...
class QNetworkCacheMetaData(Shiboken.Object):
    ...
    def __lshift__(self, arg__1: PySide2.QtCore.QDataStream) -> PySide2.QtCore.QDataStream: ...
    def __rshift__(self, arg__1: PySide2.QtCore.QDataStream) -> PySide2.QtCore.QDataStream: ...
    def attributes(self) -> typing.Dict[PySide2.QtNetwork.QNetworkRequest.Attribute, typing.Any]: ...
    ...
    def setAttributes(self, attributes: typing.Dict[PySide2.QtNetwork.QNetworkRequest.Attribute, typing.Any]) -> None: ...
    ...
    def setRawHeaders(self, headers: typing.Sequence[typing.Tuple]) -> None: ...
...
class QNetworkCookieJar(PySide2.QtCore.QObject):
    ...
    def setAllCookies(self, cookieList: typing.Sequence[PySide2.QtNetwork.QNetworkCookie]) -> None: ...
    def setCookiesFromUrl(self, cookieList: typing.Sequence[PySide2.QtNetwork.QNetworkCookie], url: PySide2.QtCore.QUrl) -> bool: ...
...
class QNetworkReply(PySide2.QtCore.QIODevice):
    ...
    @typing.overload
    def ignoreSslErrors(self, errors: typing.Sequence[PySide2.QtNetwork.QSslError]) -> None: ...
    def ignoreSslErrorsImplementation(self, arg__1: typing.Sequence[PySide2.QtNetwork.QSslError]) -> None: ...
    def isFinished(self) -> bool: ...
...
class QSslCertificate(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def fromPath(path: str, format: PySide2.QtNetwork.QSsl.EncodingFormat=..., syntax: PySide2.QtNetwork.QSslCertificate.PatternSyntax=...) -> typing.List[PySide2.QtNetwork.QSslCertificate]: ...
    def handle(self) -> int: ...
    @staticmethod
    ...
    def subjectAlternativeNames(self) -> typing.Dict[PySide2.QtNetwork.QSsl.AlternativeNameEntryType, typing.List[str]]: ...
    ...
    def toText(self) -> str: ...
    @staticmethod
    def verify(certificateChain: typing.Sequence[PySide2.QtNetwork.QSslCertificate], hostName: str=...) -> typing.List[PySide2.QtNetwork.QSslError]: ...
...
class QSslConfiguration(Shiboken.Object):
    ...
    @typing.overload
    def addCaCertificates(self, certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]) -> None: ...
    @typing.overload
    ...
    def setCaCertificates(self, certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]) -> None: ...
    def setCiphers(self, ciphers: typing.Sequence[PySide2.QtNetwork.QSslCipher]) -> None: ...
    @staticmethod
    ...
    def setLocalCertificateChain(self, localChain: typing.Sequence[PySide2.QtNetwork.QSslCertificate]) -> None: ...
...
class QSslSocket(PySide2.QtNetwork.QTcpSocket):
    ...
    @typing.overload
    @staticmethod
    def addDefaultCaCertificates(certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]) -> None: ...
    @typing.overload
    @staticmethod
    ...
    def ocspResponses(self) -> typing.List[PySide2.QtNetwork.QOcspResponse]: ...
    def peerCertificate(self) -> PySide2.QtNetwork.QSslCertificate: ...
    def peerCertificateChain(self) -> typing.List[PySide2.QtNetwork.QSslCertificate]: ...
    def peerVerifyDepth(self) -> int: ...
    def peerVerifyMode(self) -> PySide2.QtNetwork.QSslSocket.PeerVerifyMode: ...
    ...
    @staticmethod
    def setDefaultCaCertificates(certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]) -> None: ...
    @staticmethod
    def setDefaultCiphers(ciphers: typing.Sequence[PySide2.QtNetwork.QSslCipher]) -> None: ...
    @typing.overload
    def setLocalCertificate(self, certificate: PySide2.QtNetwork.QSslCertificate) -> None: ...
    @typing.overload
    ...
    def sslHandshakeErrors(self) -> typing.List[PySide2.QtNetwork.QSslError]: ...
    @staticmethod
...
class QUdpSocket(PySide2.QtNetwork.QAbstractSocket):
    ...
    def readDatagram(self, data: str, maxlen: int, host: PySide2.QtNetwork.QHostAddress) -> typing.Tuple[int, int]: ...
