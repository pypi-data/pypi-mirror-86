...
class QWebEngineHistory(Shiboken.Object):
    ...
    def backItems(self, maxItems: int) -> typing.List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
    ...
    def forwardItems(self, maxItems: int) -> typing.List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
    ...
    def items(self) -> typing.List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
...
class QWebEnginePage(PySide2.QtCore.QObject):
    ...
    def chooseFiles(self, mode: PySide2.QtWebEngineWidgets.QWebEnginePage.FileSelectionMode, oldFiles: typing.Sequence[str], acceptedMimeTypes: typing.Sequence[str]) -> typing.List[str]: ...
...
class QWebEngineScriptCollection(Shiboken.Object):
    ...
    def findScripts(self, name: str) -> typing.List[PySide2.QtWebEngineWidgets.QWebEngineScript]: ...
    @typing.overload
    def insert(self, arg__1: PySide2.QtWebEngineWidgets.QWebEngineScript) -> None: ...
    @typing.overload
    def insert(self, list: typing.Sequence[PySide2.QtWebEngineWidgets.QWebEngineScript]) -> None: ...
    def isEmpty(self) -> bool: ...
    def remove(self, arg__1: PySide2.QtWebEngineWidgets.QWebEngineScript) -> bool: ...
    def size(self) -> int: ...
    def toList(self) -> typing.List[PySide2.QtWebEngineWidgets.QWebEngineScript]: ...
