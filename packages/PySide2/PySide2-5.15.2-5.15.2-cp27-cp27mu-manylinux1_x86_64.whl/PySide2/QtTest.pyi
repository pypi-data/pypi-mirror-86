...
class QTest(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def ignoreMessage(type: PySide2.QtCore.QtMsgType, message: str) -> None: ...
    @typing.overload
    @staticmethod
    ...
    def qRun() -> int: ...
    @staticmethod
    def qSkip(message: str, file: str, line: int) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def setMainSourcePath(file: str, builddir: typing.Optional[str]=...) -> None: ...
    @typing.overload
    @staticmethod
