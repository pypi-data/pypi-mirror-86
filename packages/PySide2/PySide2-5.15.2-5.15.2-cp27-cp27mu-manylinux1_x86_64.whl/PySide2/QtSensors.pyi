...
class QSensor(PySide2.QtCore.QObject):
    ...
    def availableDataRates(self) -> typing.List[typing.Tuple]: ...
    ...
    def error(self) -> int: ...
    def filters(self) -> typing.List[PySide2.QtSensors.QSensorFilter]: ...
    ...
    def outputRanges(self) -> typing.List[PySide2.QtSensors.qoutputrange]: ...
    ...
    @staticmethod
    def sensorsForType(type: PySide2.QtCore.QByteArray) -> typing.List[PySide2.QtCore.QByteArray]: ...
...
class QSensorGesturePluginInterface(Shiboken.Object):
    ...
    def createRecognizers(self) -> typing.List[PySide2.QtSensors.QSensorGestureRecognizer]: ...
    def name(self) -> str: ...
