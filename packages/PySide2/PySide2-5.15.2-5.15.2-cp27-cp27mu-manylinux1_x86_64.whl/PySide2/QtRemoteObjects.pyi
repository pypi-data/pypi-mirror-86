...
class QRemoteObjectAbstractPersistedStore(PySide2.QtCore.QObject):
    ...
    def restoreProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray) -> typing.List[typing.Any]: ...
    def saveProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, values: typing.Sequence[typing.Any]) -> None: ...
...
class QRemoteObjectHostBase(PySide2.QtRemoteObjects.QRemoteObjectNode):
    ...
    @typing.overload
    def enableRemoting(self, model: PySide2.QtCore.QAbstractItemModel, name: str, roles: typing.List[int], selectionModel: typing.Optional[PySide2.QtCore.QItemSelectionModel]=...) -> bool: ...
    @typing.overload
...
class QRemoteObjectRegistry(PySide2.QtRemoteObjects.QRemoteObjectReplica):
    def addSource(self, entry: typing.Tuple[str, PySide2.QtRemoteObjects.QRemoteObjectSourceLocationInfo]) -> None: ...
    def initialize(self) -> None: ...
    def pushToRegistryIfNeeded(self) -> None: ...
    @staticmethod
    def registerMetatypes() -> None: ...
    def removeSource(self, entry: typing.Tuple[str, PySide2.QtRemoteObjects.QRemoteObjectSourceLocationInfo]) -> None: ...
    def sourceLocations(self) -> typing.Dict[str, PySide2.QtRemoteObjects.QRemoteObjectSourceLocationInfo]: ...
...
class QRemoteObjectReplica(PySide2.QtCore.QObject):
    ...
    def persistProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, props: typing.Sequence[typing.Any]) -> None: ...
    def propAsVariant(self, i: int) -> typing.Any: ...
    def retrieveProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray) -> typing.List[typing.Any]: ...
    def send(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.Sequence[typing.Any]) -> None: ...
    def sendWithReply(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.Sequence[typing.Any]) -> PySide2.QtRemoteObjects.QRemoteObjectPendingCall: ...
