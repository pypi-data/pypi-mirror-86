...
class _OptionsKeywords(object):
    ...
    def set_proxies(self, *protocol_url_pairs):
        ...
        | `Set Proxies` | http | localhost:5000 | https | 10.0.4.23:80 |
        """
    ...
    def set_return_xml(self, return_xml):
        ...
        The default value is `False`. If ``return_xml`` is `True`, then return
    ...
    def add_doctor_import(self, import_namespace, location=None, filters=None):
        ...
        Doctor imports are applied to the next client created with
    ...
    def bind_schema_to_location(self, namespace, location):
        ...
        Suds2Library. Schemas should be bound if necessary before `Add Doctor
    ...
    def _set_soap_timeout(self, timeout):
        timeout_in_secs = timestr_to_secs(timeout)
