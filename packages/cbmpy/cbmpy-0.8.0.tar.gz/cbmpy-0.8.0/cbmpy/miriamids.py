...
miriamids =\
    {'2D-PAGE protein': {'data_entry': 'http://2dbase.techfak.uni-bielefeld.de/cgi-bin/2d/2d.cgi?ac=$id',
     ...
     'BIND': {'data_entry': 'http://www.bind.ca/Action?identifier=bindid&amp;idsearch=$id',
              'example': None,
              'name': 'BIND',
              'pattern': '^\\d+$" obsolete="true" replacement="MIR:00000010',
     ...
     'BioAssay Ontology': {'data_entry': 'http://bioportal.bioontology.org/ontologies/BAO/bao:BAO_$id',
                           'example': '0002989',
     ...
     'COSMIC Gene': {'data_entry': 'http://cancer.sanger.ac.uk/cosmic/gene/overview?ln=$id',
                     'example': 'BRAF',
                     'name': 'COSMIC Gene',
                     'pattern': '^[A-Z0-9]+$',
                     'url': 'http://identifiers.org/cosmic/'},
     ...
     'Cellosaurus': {'data_entry': 'http://web.expasy.org/cellosaurus/$id',
                     'example': 'CVCL_0030',
                     'name': 'Cellosaurus',
                     'pattern': 'CVCL_[A-Z0-9]{4}',
                     'url': 'http://identifiers.org/cellosaurus/'},
     ...
     'FAIRsharing': {'data_entry': 'https://www.biosharing.org/$id',
                     'example': 'bsg-000052',
                     'name': 'FAIRsharing',
                     'pattern': '^bsg-\\d{6}$',
                     'url': 'http://identifiers.org/fairsharing/'},
     ...
     'GEO': {'data_entry': 'https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=$id',
             'example': 'GDS1234',
             'name': 'GEO',
     ...
     'INSDC CDS': {'data_entry': 'http://www.ebi.ac.uk/ena/data/view/$id',
                   'example': 'AAA35559',
                   'name': 'INSDC CDS',
                   'pattern': '^([A-Z]\\d{5}|[A-Z]{2}\\d{6}|[A-Z]{4}\\d{8}|[A-J][A-Z]{2}\\d{5})(\\.\\d+)?$',
                   'url': 'http://identifiers.org/insdc.cds/'},
     ...
     'Identifiers.org Registry': {'data_entry': 'http://identifiers.org/registry?query=&quot;$id&quot;',
                                  'example': 'MIR:00100037',
                                  'name': 'Identifiers.org Registry',
                                  'pattern': '^MIR:\\d{8}$',
                                  'url': 'http://identifiers.org/mir/'},
     ...
     'Information Artifact Ontology': {'data_entry': 'http://purl.obolibrary.org/obo/IAO_$id',
                                       'example': '0000030',
                                       'name': 'Information Artifact Ontology',
                                       'pattern': '^\\d{7}$',
                                       'url': 'http://identifiers.org/iao/'},
     ...
     'MetaNetX compartment': {'data_entry': 'http://www.metanetx.org/comp_info/$id',
                              'example': 'MNXC15',
                              'name': 'MetaNetX compartment',
                              'pattern': '^(MNX[CD]\\d+|BOUNDARY)$',
                              'url': 'http://identifiers.org/metanetx.compartment/'},
     'MetaNetX reaction': {'data_entry': 'http://www.metanetx.org/equa_info/$id',
                           'example': 'MNXR101574',
     ...
     'OMIT': {'data_entry': 'https://www.ebi.ac.uk/ols/ontologies/omit/terms?short_form=OMIT_$id',
              'example': '0005506',
              'name': 'OMIT',
              'pattern': '^\\d{7}$',
              'url': 'http://identifiers.org/omit/'},
     ...
     'PRINTS': {'data_entry': 'http://www.bioinf.manchester.ac.uk/cgi-bin/dbbrowser/sprint/searchprintss.cgi?prints_accn=$id&amp;display_opts=Prints&amp;category=None&amp;queryform=false&amp;regexpr=off',
                ...
                'name': 'PRINTS',
                'pattern': '^PR\\d{5}$',
                'url': 'http://identifiers.org/prints/'},
     ...
     'Progenetix': {'data_entry': 'http://progenetix.org/pgx:$id',
                    'example': 'icdom:8500_3',
                    'name': 'Progenetix',
                    'pattern': '^[\\w\\-:,]{3,64}$',
                    'url': 'http://identifiers.org/pgx/'},
     ...
     'Reactome': {'data_entry': 'http://reactome.org/content/detail/$id',
     ...
     'dbGaP': {'data_entry': 'https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=$id',
               'example': 'phs000768.v2.p1',
               'name': 'dbGaP',
               'pattern': '^phs[0-9]{6}.v\\d+.p\\d+$',
               'url': 'http://identifiers.org/dbgap/'},
