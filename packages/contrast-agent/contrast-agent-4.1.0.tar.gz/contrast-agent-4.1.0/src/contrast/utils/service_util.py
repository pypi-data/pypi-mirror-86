...
class ServiceUtil(object):
    ...
    def generate_service_path():
        ...
        if platform_directory == ServiceUtil.WINDOWS_SERVICE_DIRECTORY:
            exe_name += ServiceUtil.WINDOWS_SERVICE_EXTENSION
