...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n.intentionet/bfe/proto/assertions/filters.proto\x12\x1e\x63om.intentionet.bfe.assertions\x1a\x31intentionet/bfe/proto/assertions/parameters.proto\x1a\x31intentionet/bfe/proto/assertions/violations.proto\x1a,intentionet/bfe/proto/datamodel/device.proto\x1a*intentionet/bfe/proto/datamodel/flow.proto\"\x87\x03\n)CrossZonePolicyFiltersFlowsAssertionInput\x12\x43\n\tfirewalls\x18\x01 \x01(\x0b\x32\x30.com.intentionet.bfe.assertions.DeviceFilterExpr\x12=\n\x05\x66lows\x18\x02 \x01(\x0b\x32..com.intentionet.bfe.assertions.FlowFilterExpr\x12G\n\x04\x66rom\x18\x03 \x01(\x0b\x32\x39.com.intentionet.bfe.assertions.FirewallLocationMatchExpr\x12\x45\n\x02to\x18\x04 \x01(\x0b\x32\x39.com.intentionet.bfe.assertions.FirewallLocationMatchExpr\x12\x46\n\x06\x65xpect\x18\x05 \x01(\x0b\x32\x36.com.intentionet.bfe.assertions.FirewallBehaviorExpect\"\x95\x05\n*CrossZonePolicyFiltersFlowsAssertionResult\x12\x65\n\tviolators\x18\x01 \x03(\x0b\x32R.com.intentionet.bfe.assertions.CrossZonePolicyFiltersFlowsAssertionResult.Element\x12\x35\n\nconformers\x18\x02 \x03(\x0b\x32!.com.intentionet.datamodel.Device\x12\x1d\n\x15violator_descriptions\x18\x04 \x03(\t\x1a\xcf\x02\n\x07\x45lement\x12\x31\n\x06\x64\x65vice\x18\x01 \x01(\x0b\x32!.com.intentionet.datamodel.Device\x12-\n\x04\x66low\x18\x02 \x01(\x0b\x32\x1f.com.intentionet.datamodel.Flow\x12<\n\x06\x61\x63tion\x18\x03 \x01(\x0e\x32,.com.intentionet.bfe.assertions.FilterAction\x12\x0e\n\x06\x66ilter\x18\x04 \x01(\t\x12G\n\x0ctest_filters\x18\x05 \x01(\x0b\x32\x31.com.intentionet.bfe.assertions.TestFiltersResult\x12K\n\x11\x64\x65scription_index\x18\x06 \x01(\x0b\x32\x30.com.intentionet.bfe.assertions.DescriptionIndex\x1aR\n\rFailureResult\x12\x31\n\x06\x64\x65vice\x18\x01 \x01(\x0b\x32!.com.intentionet.datamodel.Device\x12\x0e\n\x06reason\x18\x02 \x01(\tJ\x04\x08\x03\x10\x04\"\xa8\x02\n\x1c\x46ilterBehaviorAssertionInput\x12\x41\n\x07\x64\x65vices\x18\x01 \x01(\x0b\x32\x30.com.intentionet.bfe.assertions.DeviceFilterExpr\x12@\n\x07\x66ilters\x18\x02 \x01(\x0b\x32/.com.intentionet.bfe.assertions.FilterMatchExpr\x12=\n\x05\x66lows\x18\x03 \x01(\x0b\x32..com.intentionet.bfe.assertions.FlowFilterExpr\x12\x44\n\x06\x65xpect\x18\x04 \x01(\x0b\x32\x34.com.intentionet.bfe.assertions.FilterBehaviorExpect\"\x93\x04\n\x1d\x46ilterBehaviorAssertionResult\x12Y\n\tviolators\x18\x01 \x03(\x0b\x32\x46.com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator\x12\x35\n\nconformers\x18\x02 \x03(\x0b\x32!.com.intentionet.datamodel.Filter\x12\x1d\n\x15violator_descriptions\x18\x03 \x03(\t\x1a\xc0\x02\n\x08Violator\x12\x31\n\x06\x66ilter\x18\x01 \x01(\x0b\x32!.com.intentionet.datamodel.Filter\x12-\n\x04\x66low\x18\x02 \x01(\x0b\x32\x1f.com.intentionet.datamodel.Flow\x12<\n\x06\x61\x63tion\x18\x03 \x01(\x0e\x32,.com.intentionet.bfe.assertions.FilterAction\x12G\n\x0ctest_filters\x18\x04 \x01(\x0b\x32\x31.com.intentionet.bfe.assertions.TestFiltersResult\x12K\n\x11\x64\x65scription_index\x18\x05 \x01(\x0b\x32\x30.com.intentionet.bfe.assertions.DescriptionIndex\"B\n\x11TestFiltersResult\x12\x14\n\x0cmatched_line\x18\x01 \x01(\t\x12\x17\n\x0ftrace_tree_json\x18\x02 \x03(\t*[\n\x0c\x46ilterAction\x12\x19\n\x15\x46ILTER_ACTION_UNKNOWN\x10\x00\x12\x18\n\x14\x46ILTER_ACTION_PERMIT\x10\x01\x12\x16\n\x12\x46ILTER_ACTION_DENY\x10\x02\x62\x06proto3'
  ,
...
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR = _descriptor.Descriptor(
  name='Violator',
  full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='filter', full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator.filter', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flow', full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator.flow', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='action', full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator.action', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_filters', full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator.test_filters', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description_index', full_name='com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator.description_index', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FILTERBEHAVIORASSERTIONRESULT = _descriptor.Descriptor(
  ...
  nested_types=[_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.fields_by_name['filter'].message_type = intentionet_dot_bfe_dot_proto_dot_datamodel_dot_device__pb2._FILTER
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.fields_by_name['flow'].message_type = intentionet_dot_bfe_dot_proto_dot_datamodel_dot_flow__pb2._FLOW
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.fields_by_name['action'].enum_type = _FILTERACTION
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.fields_by_name['test_filters'].message_type = _TESTFILTERSRESULT
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.fields_by_name['description_index'].message_type = intentionet_dot_bfe_dot_proto_dot_assertions_dot_violations__pb2._DESCRIPTIONINDEX
_FILTERBEHAVIORASSERTIONRESULT_VIOLATOR.containing_type = _FILTERBEHAVIORASSERTIONRESULT
_FILTERBEHAVIORASSERTIONRESULT.fields_by_name['violators'].message_type = _FILTERBEHAVIORASSERTIONRESULT_VIOLATOR
_FILTERBEHAVIORASSERTIONRESULT.fields_by_name['conformers'].message_type = intentionet_dot_bfe_dot_proto_dot_datamodel_dot_device__pb2._FILTER
...
FilterBehaviorAssertionResult = _reflection.GeneratedProtocolMessageType('FilterBehaviorAssertionResult', (_message.Message,), {
  ...
  'Violator' : _reflection.GeneratedProtocolMessageType('Violator', (_message.Message,), {
    'DESCRIPTOR' : _FILTERBEHAVIORASSERTIONRESULT_VIOLATOR,
    '__module__' : 'intentionet.bfe.proto.assertions.filters_pb2'
    # @@protoc_insertion_point(class_scope:com.intentionet.bfe.assertions.FilterBehaviorAssertionResult.Violator)
    })
  ,
...
_sym_db.RegisterMessage(FilterBehaviorAssertionResult.Violator)
