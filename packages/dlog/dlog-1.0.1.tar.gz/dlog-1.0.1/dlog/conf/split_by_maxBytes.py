...
def set_log_config(
        debug=False, log_level_info=logging.INFO, log_level_warning=logging.WARNING, log_level_error=logging.ERROR,
        info_log_path=None, warning_log_path=None, error_log_path=None, max_bytes=50, backup_count=7,
        encoding='utf-8'
):
    """暂时这样，更大自由度，请后续扩充。"""
    log_config_dict = {
