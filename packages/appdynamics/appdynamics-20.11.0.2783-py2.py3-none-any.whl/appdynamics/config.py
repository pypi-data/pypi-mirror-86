...
Advanced Attributes
-------------------
NODE_REUSE : bool, optional
    If the NODE_REUSE is set to true, node will be marked as historical during
    shutdown.

NODE_REUSE_PREFIX: str, optional
    The name of this AppDynamics node will be NODE_REUSE_PREFIX with some
    integer number as suffix, when NODE_REUSE is set.
...
_CONFIG_OPTIONS_BY_SECTION = {
    'agent': {
        ...
        'tier': ('TIER_NAME', None),
        'node': ('NODE_NAME', None),
        'uniquehostid': ('UNIQUE_HOST_ID', None),
        'dir': ('DIR', None),
        'nodereuse': ('NODE_REUSE', on_off),
        'nodereuseprefix': ('NODE_REUSE_PREFIX', None),
    },
