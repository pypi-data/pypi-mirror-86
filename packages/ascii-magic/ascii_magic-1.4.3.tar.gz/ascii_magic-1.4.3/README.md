...
ascii_magic.from_image_file(
    'images/moon.jpg',
    mode=ascii_magic.Modes.TERMINAL # default
)
```

Result:

![ASCII Magic HTML mode example](https://raw.githubusercontent.com/LeandroBarone/python-ascii_magic/master/example_moon.png)
