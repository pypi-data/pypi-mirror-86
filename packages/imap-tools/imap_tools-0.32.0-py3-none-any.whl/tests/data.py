...
YjNmYmE0MGNjZDk2MDMwODRiZS0tDQo=""".replace('\n', '\r\n'),
    ...
    'attachment_inline2': dict(
        ...
        from_values={'email': 'samgentlemankaka@foxmail.com', 'name': 'sh',
                     'full': 'sh <samgentlemankaka@foxmail.com>'},
        to_values=({'email': 'qmebi@mfk.app', 'name': 'qmebi', 'full': 'qmebi <qmebi@mfk.app>'},),
        cc_values=(),
        bcc_values=(),
        reply_to_values=(),
    ),
