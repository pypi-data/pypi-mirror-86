...
class Annotation:
    ...
    def _annotate(self):
        ...
        display_helper.define_custom_styles(self.labels_colors, self.char_params, out)
        ...
        display_helper.display_core(
            self.preloaded_displays.current["core_display"], out
        )
