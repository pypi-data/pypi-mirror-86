...
class PlatformApi(object):
    ...
    def model_dataset_controller_get_summary(self, id, **kwargs):  # noqa: E501
        """model_dataset_controller_get_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_dataset_controller_get_summary(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_dataset_controller_get_summary_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.model_dataset_controller_get_summary_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def model_dataset_controller_get_summary_with_http_info(self, id, **kwargs):  # noqa: E501
        """model_dataset_controller_get_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_dataset_controller_get_summary_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method model_dataset_controller_get_summary" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `model_dataset_controller_get_summary`")  # noqa: E501
