...
class CohortFilter(object):
    ...
    swagger_types = {
        ...
        'start_date': 'datetime',
        'end_date': 'datetime',
        'cohort_filter_conditions': 'CohortFilterCondition',
        'type': 'str'
    }
    ...
    def period_definition(self, period_definition):
        ...
        :type: str
        """
        if period_definition is None:
            raise ValueError("Invalid value for `period_definition`, must not be `None`")  # noqa: E501
    ...
    def period_preposition(self, period_preposition):
        ...
        :type: str
        """
        if period_preposition is None:
            raise ValueError("Invalid value for `period_preposition`, must not be `None`")  # noqa: E501
    ...
    def cohort_filter_conditions(self, cohort_filter_conditions):
        ...
        :type: CohortFilterCondition
        """
        if cohort_filter_conditions is None:
            raise ValueError("Invalid value for `cohort_filter_conditions`, must not be `None`")  # noqa: E501
