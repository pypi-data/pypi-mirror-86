...
class Model(object):
    ...
    swagger_types = {
        ...
        'project': 'AllOfModelProject',
        'cohorts': 'AllOfModelCohorts',
        'model_jobs': 'AllOfModelModelJobs',
    ...
    def __init__(self, id=None, name=None, type=None, outcome_type=None, feature_store=None, description=None, project_id=None, endpoints=None, project=None, cohorts=None, model_jobs=None, user_favorites=None, model_datasets=None, created_at=None, updated_at=None, version=None):  # noqa: E501
    ...
    def cohorts(self, cohorts):
        ...
        :type: AllOfModelCohorts
        """
        if cohorts is None:
            raise ValueError("Invalid value for `cohorts`, must not be `None`")  # noqa: E501
    ...
    def model_jobs(self, model_jobs):
        ...
        :type: AllOfModelModelJobs
        """
        if model_jobs is None:
            raise ValueError("Invalid value for `model_jobs`, must not be `None`")  # noqa: E501
    ...
    def user_favorites(self, user_favorites):
        ...
        if user_favorites is None:
            raise ValueError("Invalid value for `user_favorites`, must not be `None`")  # noqa: E501
    ...
    def model_datasets(self, model_datasets):
        ...
        if model_datasets is None:
            raise ValueError("Invalid value for `model_datasets`, must not be `None`")  # noqa: E501
