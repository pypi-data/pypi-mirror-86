...
def test_storage_example():
    ...
    # Changing parameters e.g., 'storage.use_inter_period_formulation = False'
    # might work sometimes, but aristopy is not designed for that right now!
    ...
    storage = ar.Storage(ensys=es, name='storage',
                         ...
                         opex_operation=1e-9, soc_initial=0.5,
                         self_discharge=0.0,
                         use_inter_period_formulation=False)  # FALSE!
