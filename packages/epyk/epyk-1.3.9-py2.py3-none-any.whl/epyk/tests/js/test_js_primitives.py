...
#
jsObj = Js.JsBase()
f = JsUtils.JsFile("Boolean", path=r"../outs")
f.writeJs([
...
# ------------------------------------------------------------------------------------------------------------------
#
f = JsUtils.JsFile("Date", path=r"../outs")

dt = JsDate.JsDate.new("2019-05-03")
f.writeJs([dt,
...
#
jsObj = Js.JsBase()
f = JsUtils.JsFile("Numbers2", path=r"../outs")
f.writeJs([
...
#
jsObj = Js.JsBase()
f = JsUtils.JsFile("Object", path=r"../outs")
f.writeJs([
...
#
jsObj = Js.JsBase()
f = JsUtils.JsFile("String", path=r"../outs")

string = JsString.JsString.new("te st", "testStr")
f.writeJs([
#print(string.length.toStr())
  ...
  string.charCodeAt(2),
  string.freeze(),
  JsString.JsString.new("2019-08-03", "testDate").toDate().setVar("MyDate"),
