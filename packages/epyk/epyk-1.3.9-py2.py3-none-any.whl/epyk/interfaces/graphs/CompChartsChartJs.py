...
class ChartJs(object):
  ...
  def line(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    options.update({'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'colors': self.parent.context.rptObj.theme.charts, 'attrs': {'fill': None}})
  ...
  def pie(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    options.update({'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'colors': self.parent.context.rptObj.theme.charts, 'attrs': {}})
  ...
  def donut(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    dflt_options = {'cutoutPercentage': 50, 'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'colors': self.parent.context.rptObj.theme.charts, 'attrs': {}}
  ...
  def area(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    options.update({'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'colors': self.parent.context.rptObj.theme.charts, 'attrs': {"opacity": 0.2}})
    data = self.parent.context.rptObj.data.chartJs.y(record, y_columns, x_axis)
    line_chart = graph.GraphChartJs.ChartLine(self.parent.context.rptObj, width, height, htmlCode, options, profile)
    line_chart.labels(data['labels'])
    for i, d in enumerate(data['datasets']):
  ...
  def scatter(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    options.update({'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'colors': self.parent.context.rptObj.theme.charts, 'rDim': None, 'attrs': {}})
  ...
  def bubble(self, record=None, y_columns=None, x_axis=None, r_values=None, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    options.update({'y_columns': y_columns, "bgColors": bgColors, 'x_axis': x_axis, 'z_columns': r_values, 'colors': self.parent.context.rptObj.theme.charts, 'rDim': None, 'attrs': {}})
  ...
  def fabric(self, profile=None, width=(100, "%"), height=(330, "px"), options=None, htmlCode=None):
    ...
    bgColors = ["rgba(%s, %s, %s, 0.6)" % (Colors.getHexToRgb(c)[0], Colors.getHexToRgb(c)[1], Colors.getHexToRgb(c)[2])
                for c in self.parent.context.rptObj.theme.charts]
    options.update({'y_columns': [], "bgColors": bgColors, 'x_axis': "", 'colors': self.parent.context.rptObj.theme.charts, 'attrs': {}})
