...
ddo_sample = {
    ...
    "service": [
        {
            "type": "Access",
            "purchaseEndpoint": "http://localhost:8030/api/v1/gateway/services/access/purchase?",
            "serviceEndpoint": "http://localhost:8030/api/v1/gateway/services/consume?pubKey"
