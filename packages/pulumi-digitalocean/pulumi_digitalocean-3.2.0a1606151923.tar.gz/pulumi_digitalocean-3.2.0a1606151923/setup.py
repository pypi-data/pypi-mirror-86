...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.2.0-alpha.1606151923+2e934430'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.2.0-alpha.1606151923+2e934430`
                """)
            else:
                raise
