...
from .tools import is_string_type, check_for_string_or_list_of_strings, check_for_string, DefaultSession
import pandas as pd
...
def get_symbology(symbol, from_symbol_type=None, to_symbol_type=None, raw_output=False, debug=False, best_match=True):
    """
    ...
    response = refinitiv.dataplatform.legacy.json_requests.send_json_request(Symbology_UDF_endpoint, payload, debug=debug)
