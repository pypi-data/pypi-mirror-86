...
from .tools import get_json_value, is_string_type, check_for_string_or_list_of_strings, \
    build_dictionary, build_list, DefaultSession
...
def get_data(instruments, fields, parameters=None, field_name=False, raw_output=False, debug=False, raw_response=False):
    """
    ...
    response = refinitiv.dataplatform.legacy.json_requests.send_json_request(_endpoint,
                                                                             payload,
                                                                             debug=debug,
