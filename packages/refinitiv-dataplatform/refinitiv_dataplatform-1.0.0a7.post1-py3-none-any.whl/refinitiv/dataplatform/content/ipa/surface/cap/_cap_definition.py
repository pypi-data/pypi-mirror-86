...
from ._cap_calculation_params import CalculationParams
...
class CapUnderlyingDefinition(ObjectDefinition):
...
class Definition(BaseDefinition):
    ...
    def __init__(self, *,
        ...
        self.underlying_definition = CapUnderlyingDefinition(instrument_code=instrument_code,
    ...
    def underlying_definition(self):
        ...
        """
        return self._get_object_parameter(CapUnderlyingDefinition, "underlyingDefinition")

    @underlying_definition.setter
    def underlying_definition(self, value):
        self._set_object_parameter(CapUnderlyingDefinition, "underlyingDefinition", value)
