# coding: utf8
# contract_gen 2020-06-15 10:07:47.560306
...
class SwapZcCurveParameters(ObjectDefinition):
    ...
    def use_multi_dimensional_solver(self):
        ...
        This solving method is required because the bootstrapping method sometimes creates a ZC curve which does not accurately reprice the input
        instruments used to build it.
        The multi-dimensional solver is recommended when cubic interpolation methods are used in building the curve (in other cases, performance
