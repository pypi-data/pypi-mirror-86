#*******************************************************************#
# Consultas Pendências Financeiras Completo SERASA                  #
# __  _______ _                                                     #
...
def ConsultConcentre(eMail, Password, Document, Additional=[ADD_NENHUM], Environment='producao'):
    """
    ...
    :param list   Adicionais (Nenhum, QuadroDeSocios, Participacoes, RiskScoring, LimiteCredito, ClassificacaoRiscoCredito)
