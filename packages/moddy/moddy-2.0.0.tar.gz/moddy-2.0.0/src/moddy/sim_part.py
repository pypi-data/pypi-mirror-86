...
class SimPart(SimBaseElement):
    ...
    def add_sub_part(self, sub_part):
        ...
        :param sub_part: part to add
        :raise: RuntimeError If subPart already in this part
        """
        add_elem_to_list(
            self._list_subparts, sub_part, self.__str__() + ":subparts"
        )
    ...
    def assertion_failed(self, assertion_str, frame_idx=1):
        ...
        :param assertion_str: error message to display
        :param frame_idx: traceback frame index \
