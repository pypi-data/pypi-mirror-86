...
def create_tse(numerical_columns, categorical_columns, units):
    ...
    Args:
        ...
        input_weight_quantization (int): sets weight quantization in the first layer.
...
def create_mlp(inputs,
    ...
    Args:
        ...
        weight_quantization (int): sets all weights in the model to have a
