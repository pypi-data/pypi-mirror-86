...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.7.0-alpha.1606220245+8884fc4d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.7.0-alpha.1606220245+8884fc4d`
                """)
            else:
                raise
