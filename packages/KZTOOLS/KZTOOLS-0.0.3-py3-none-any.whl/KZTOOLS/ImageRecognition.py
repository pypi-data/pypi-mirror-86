...
class Irecognition():
    ...
    def __init__(self, client_id='P0DVZvEnkdlRoqgGvY3EkZic', client_secret='YiExSSoyFs65QfKlHMjpoTGPtOgDoLdx'):
        ...
        self.request_url = self.request_url + "?access_token=" + self.get_token()
    ...
    def get_image(self, path):
        ...
        params = {"image": img}
        try:
            return self.result_process(params=params)
        except BaseException as e:
            raise BaseException(e)

    def result_process(self, params):
        response = requests.post(self.request_url, data=params, headers=self.headers).json()
