...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.12.0-alpha.1606239508+dfa34fed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.12.0-alpha.1606239508+dfa34fed`
                """)
            else:
                raise
