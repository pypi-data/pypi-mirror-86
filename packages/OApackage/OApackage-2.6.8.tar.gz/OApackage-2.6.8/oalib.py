...
class jstruct_t(object):
    ...
    def number_J_values(self, strength):
        r"""number_J_values(jstruct_t self, int strength) -> int"""
...
class arrayfile_t(object):
    ...
    def add_comment(self, comment):
        r"""add_comment(arrayfile_t self, std::string const & comment)"""
...
def compareJ54(lhs, rhs):
    r"""compareJ54(array_link lhs, array_link rhs) -> int"""
...
class conference_extend_t(object):
    r"""Proxy of C++ conference_extend_t class."""
    ...
    def combine(self, i, j):
        r"""combine(conference_extend_t self, int i, int j) -> charVector"""
        return _oalib.conference_extend_t_combine(self, i, j)

    def nExtensions(self):
        r"""nExtensions(conference_extend_t self) -> size_t"""
        return _oalib.conference_extend_t_nExtensions(self)

    def getarrays(self, al):
        r"""getarrays(conference_extend_t self, array_link al) -> arraylist_t"""
        return _oalib.conference_extend_t_getarrays(self, al)

    def __init__(self):
        r"""__init__(conference_extend_t self) -> conference_extend_t"""
...
def extend_conference_matrix(design, conference_type, extcol, verbose=1, maxzpos=-1):
    r"""extend_conference_matrix(array_link design, conference_t conference_type, int extcol, int verbose=1, int maxzpos=-1) -> conference_extend_t"""
