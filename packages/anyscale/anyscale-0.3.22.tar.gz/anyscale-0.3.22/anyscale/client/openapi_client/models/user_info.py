...
class UserInfo(object):
    ...
    def __init__(self, id=None, email=None, name=None, username=None, verified=None, organization_permission_level=None, organization_ids=None, ld_hash=None, ld_hash_fields=None, local_vars_configuration=None):  # noqa: E501
