...
class Cloud(object):
    ...
    def __init__(self, id=None, name=None, provider=None, region=None, credentials=None, creator_id=None, type=None, created_at=None, local_vars_configuration=None):  # noqa: E501
