...
class SessionCommand(object):
    ...
    def __init__(self, session_id=None, shell_command=None, id=None, created_at=None, finished_at=None, status_code=None, killed_at=None, local_vars_configuration=None):  # noqa: E501
    ...
    def killed_at(self, killed_at):
        ...
        :type: datetime
        """
        if self.local_vars_configuration.client_side_validation and killed_at is None:  # noqa: E501
            raise ValueError("Invalid value for `killed_at`, must not be `None`")  # noqa: E501
