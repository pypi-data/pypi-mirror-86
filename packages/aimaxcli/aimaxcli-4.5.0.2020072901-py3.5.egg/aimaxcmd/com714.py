...
class CommonAdd(Command,Yml):
    ...
    def _build_url(self,auth_info, parsed_args):
        ...
        if 'addbody' in self.restMap[parsed_args.p1[0]]:
            print('--------------------------------')
            body = self.restMap[parsed_args.p1[0]]['addbody']
            print(body)
            print('--------------------------------')
...
class CommonUpload(Command,Yml):
    ...
    def take_action(self, parsed_args):
        ...
        # print(body_data) {"isPublic": "3", "tagName": "123", "imageName": "qwe", "enctype": "multipart/form-data"}
