...
class TestMemory(unittest.TestCase):
    ...
    def test_evolution_memory(self):
        ...
        evolutions = [evogression.Evolution('y', parabola_data, num_creatures=t[0], num_cycles=t[1], optimize=False, use_multip=True, clear_creatures=True) for t in options]
