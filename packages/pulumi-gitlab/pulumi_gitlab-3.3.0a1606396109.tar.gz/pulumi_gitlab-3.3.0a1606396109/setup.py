...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '3.3.0-alpha.1606396109+21e84817'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 3.3.0-alpha.1606396109+21e84817`
                """)
            else:
                raise
