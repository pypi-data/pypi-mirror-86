...
class world():
    ...
    """
    name = 'esres'+str(np.random.randint(1,5000))
    def __init__(self, start_time = 0, stop_time = 1000, logging = False, t_macro = 60, res_filename=name):
...
#                self.record_data1(sim_name, np.array(tmp_var))
