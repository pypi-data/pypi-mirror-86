...
from .serializers import AnnouncementSerializer, AnnouncementStatusSerializer, AnnouncementUpdateSerializer, AnnouncementEmailPreConfigSerializer
...
class AnnouncementViewSet(ModelViewSet):
    ...
    filterset_class = filters.AnnouncementFilterSet
...
class AnnouncementStatusViewSet(ModelViewSet):
    ...
    filterset_class = filters.AnnouncementStatusFilterSet

class AnnouncementEmailPreConfigViewSet(ModelViewSet):
    queryset = AnnouncementEmailPreConfig.objects.all()
    serializer_class = AnnouncementEmailPreConfigSerializer
    filterset_class = filters.AnnouncementEmailPreConfigFilterSet
...
class AnnouncementUpdateViewSet(ModelViewSet):
    ...
    filterset_class = filters.AnnouncementUpdateFilterSet
    ...
    def create(self, request, *args, **kwargs):
        ...
        exist_mailed_field = True if "mailed" in data else False
