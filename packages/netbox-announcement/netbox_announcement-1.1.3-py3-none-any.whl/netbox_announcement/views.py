...
from .models import Announcement, AnnouncementUpdate, AnnouncementStatus, AnnouncementEmailPreConfig
from .choices import *
...
class AnnouncementTemplateView(ObjectEditView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if obj.pk is None:
            GET['content_preset'] = AnnouncementEmailPreConfig.objects.filter()[:1].get().pk
        initial_data = normalize_querydict(GET)
