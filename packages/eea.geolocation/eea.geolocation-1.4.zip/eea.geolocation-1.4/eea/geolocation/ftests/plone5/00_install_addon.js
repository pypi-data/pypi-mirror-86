...
casper.test.begin('Add-on Install', function(test) {
   ...
   casper.waitForSelector("form#add-plone-site input[type=submit][value='Create a new Plone site']",
       function success() {
           ...
           this.clickLabel("Advanced");
       },
       function fail() {
           test.assertExists("form#add-plone-site input[type=submit][value='Create a new Plone site']");
   });
   /* submit form */
   casper.waitForSelector("form input[value='eea.geolocation:default']",
       function success() {
           test.assertExists("form input[value='eea.geolocation:default']", "eea.geolocation check box is present");
           this.click("form input[value='eea.geolocation:default']");
       },
       function fail() {
           test.assertExists("form input[value='eea.geolocation:default']", "eea.geolocation check box is present");
   });
   ...
   casper.then(function() {
          this.captureSelector("plone5_install_addon.png", "html");
   });
