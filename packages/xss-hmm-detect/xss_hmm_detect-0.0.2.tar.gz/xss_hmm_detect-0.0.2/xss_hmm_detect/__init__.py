...
def detect_userinput(user_input):
    ...
    load_wordbag(father_path+'/xssfile.txt', 8000)
    with open(father_path+"/hmm-xss-train.pkl", 'rb') as file:
...
if __name__ == '__main__':
    ...
    # 1 indicates XSS payload
    print(detect_userinput("<script> alert(1) </script>"))
    print(detect_userinput("this is a normal input hi hi hi hi sad xic sjaildijlij script"))
    print(detect_userinput("i am from boston"))
