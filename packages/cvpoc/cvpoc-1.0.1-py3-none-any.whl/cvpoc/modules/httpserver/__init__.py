...
from cvpoc.lib.core.common import check_port
from cvpoc.lib.core.common import get_host_ip, get_host_ipv6
from cvpoc.lib.core.data import logger, paths
from cvpoc.lib.core.exception import PocsuiteSystemException


class PHTTPSingleton(type):
    '''
    HTTP server only allow one instance in cvpoc
    '''
    _instance = None
...
class PHTTPServer(threading.Thread, metaclass=PHTTPSingleton):
    ...
    def start(self, daemon=True):
        # Http server can only allow start once in cvpoc, avoid muti-threading start muti-times
