...
from cvpoc.lib.core.clear import remove_extra_log_message
from cvpoc.lib.core.common import boldify_message, check_file, get_file_items, parse_target, \
    get_public_type_members, data_to_stdout
from cvpoc.lib.core.common import check_path, extract_cookies
from cvpoc.lib.core.common import get_local_ip, desensitization
from cvpoc.lib.core.common import single_time_warn_message
from cvpoc.lib.core.convert import stdout_encode
from cvpoc.lib.core.data import conf, cmd_line_options
from cvpoc.lib.core.data import kb
from cvpoc.lib.core.data import logger
from cvpoc.lib.core.data import merged_options
from cvpoc.lib.core.data import paths
from cvpoc.lib.core.datatype import AttribDict
from cvpoc.lib.core.enums import HTTP_HEADER, CUSTOM_LOGGING, PROXY_TYPE
from cvpoc.lib.core.exception import PocsuiteSyntaxException, PocsuiteSystemException, PocsuiteHeaderTypeException
from cvpoc.lib.core.log import FORMATTER
from cvpoc.lib.core.register import load_file_to_module
from cvpoc.lib.core.settings import DEFAULT_USER_AGENT, DEFAULT_LISTENER_PORT, CMD_PARSE_WHITELIST
from cvpoc.lib.core.statistics_comparison import StatisticsComparison
from cvpoc.lib.parse.cmd import DIY_OPTIONS
from cvpoc.lib.parse.configfile import config_file_parser
from cvpoc.lib.request.patch import patch_all
from cvpoc.modules.listener import start_listener
from cvpoc.thirdparty.oset.orderedset import OrderedSet
from cvpoc.thirdparty.pysocks import socks


def _resolve_cross_references():
    import cvpoc
    cvpoc.lib.core.revision.stdout_encode = stdout_encode
    cvpoc.lib.core.convert.single_time_warn_message = single_time_warn_message
...
def _set_pocs_modules():
    if conf.poc:
        # step1. load system packed poc from cvpoc/cv_pocs folder
