...
from cvpoc.lib.core.common import data_to_stdout
from cvpoc.lib.core.settings import IS_WIN, CMD_PARSE_WHITELIST
...
def cmd_line_parser(argv=None):
    ...
    parser = argparse.ArgumentParser(prog='cvpoc', usage=usage)
    try:
        ...
        optimization.add_argument("--cv_pocs-path", dest="pocs_path", action="store", default=None,
