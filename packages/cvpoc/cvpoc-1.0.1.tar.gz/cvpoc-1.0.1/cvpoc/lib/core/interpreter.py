...
from cvpoc.lib.core.common import banner, index_modules, data_to_stdout, humanize_path, module_required, \
    get_poc_name, stop_after, get_local_ip, is_ipv6_address_format, rtrim, ltrim
from cvpoc.lib.core.data import logger, paths, kb, conf
from cvpoc.lib.core.enums import POC_CATEGORY, AUTOCOMPLETE_TYPE
from cvpoc.lib.core.exception import PocsuiteBaseException, PocsuiteShellQuitException
from cvpoc.lib.core.option import _set_listener, _set_http_referer, _set_http_user_agent, _set_network_proxy, \
    _set_network_timeout
from cvpoc.lib.core.register import load_file_to_module
from cvpoc.lib.core.settings import IS_WIN
from cvpoc.lib.core.shell import auto_completion, readline
from cvpoc.thirdparty.prettytable import prettytable
...
class PocsuiteInterpreter(BaseInterpreter):
    ...
    list|show all               Show all available cv_pocs
    exit                        Exit cvpoc"""
    ...
    def module_metadata(self):
        return getattr(self.current_module, "cvpoc_module_path")
    ...
    def command_use(self, module_path, *args, **kwargs):
        ...
        try:
            ...
            self.current_module.cvpoc_module_path = ltrim(rtrim(module_path, ".py"),
