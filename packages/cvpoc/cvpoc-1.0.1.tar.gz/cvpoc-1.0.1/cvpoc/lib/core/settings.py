...
from cvpoc.lib.core.revision import get_revision_number
...
POC_IMPORTDICT = {
    ...
    "from pocsuite.net import req": "from cvpoc.lib.request import requests as req",
    "from pocsuite.api.request import req": "from cvpoc.lib.request import requests as req",
    "from pocsuite.poc import": "from cvpoc.lib.core.poc import",
    "from pocsuite.api.poc import": "from cvpoc.lib.core.poc import",
    "from pocsuite.utils import register": "from cvpoc.lib.core.register import register_poc as register",
    "from pocsuite.lib.utils.funs import randomStr": "from cvpoc.lib.utils import random_str as randomStr",
    "from pocsuite.api.utils import randomStr": "from cvpoc.lib.utils import random_str as randomStr",
    "from pocsuite.lib.utils.funs import url2ip": "from cvpoc.lib.utils import url2ip",
    "from pocsuite.api.utils import url2ip": "from cvpoc.lib.utils import url2ip",
    ".content": ".text",

}
POC_IMPORTDICT['Exception,'] = 'Exception as '
POC_IMPORTDICT['print '] = 'pass \n #'
POC_IMPORTDICT["'.decode('utf-8')"] = "'.encode('utf-8').decode('utf-8')"
POC_IMPORTDICT["pocsuite.lib.core"] = "cvpoc.lib.core"
POC_IMPORTDICT['import httplib'] = 'import http.client as httplib'
POC_IMPORTDICT['import Queue'] = 'import queue as Queue'
POC_IMPORTDICT['from string import letters'] = 'from string import ascii_letters as letters'
POC_IMPORTDICT['import StringIO'] = 'import io as StringIO'
POC_IMPORTDICT['import cStringIO'] = 'import io as cStringIO'
POC_IMPORTDICT['reload(sys)'] = 'import importlib\nimportlib.reload(sys)'
POC_IMPORTDICT["sys.setdefaultencoding('utf-8')"] = ''
POC_IMPORTDICT["xrange"] = 'range'
...
CMD_PARSE_WHITELIST = ['version', 'update', 'url', 'file', 'verify', 'attack', 'shell', 'cookie', 'host', 'referer',
                       ...
                       'lhost', 'lport', 'plugins', 'cv_pocs-path', 'threads', 'batch', 'requires', 'quiet', 'poc',
