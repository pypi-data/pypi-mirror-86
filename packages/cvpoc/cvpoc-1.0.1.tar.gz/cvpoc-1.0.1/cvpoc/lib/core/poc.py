...
from cvpoc.lib.core.common import parse_target_url, desensitization
from cvpoc.lib.core.data import conf
from cvpoc.lib.core.data import logger
from cvpoc.lib.core.enums import OUTPUT_STATUS, CUSTOM_LOGGING, ERROR_TYPE_ID, POC_CATEGORY
from cvpoc.lib.core.exception import PocsuiteValidationException
from cvpoc.lib.core.interpreter_option import OptString, OptInteger, OptIP, OptPort, OptBool
from cvpoc.lib.utils import str_to_dict
from cvpoc.lib.core.register import register_poc as register
...
class Output(object):
    def __init__(self, poc=None):
        ...
        if poc:
            self.url = poc.url
            self.mode = poc.mode
            self.cv_id = poc.cv_id if hasattr(poc,'cv_id') else ''
