...
from cvpoc.lib.core.data import conf
from cvpoc.lib.core.data import kb
from cvpoc.lib.core.data import logger
from cvpoc.lib.core.data import paths
from cvpoc.lib.core.decorators import cachedmethod
from cvpoc.lib.core.enums import OS_ARCH, OS
from cvpoc.lib.core.exception import PocsuiteSystemException
from cvpoc.lib.core.log import LOGGER_HANDLER
from cvpoc.lib.core.settings import (
...
from cvpoc.lib.core.settings import IPV6_ADDRESS_REGEX
from cvpoc.lib.core.settings import IP_ADDRESS_REGEX
from cvpoc.lib.core.settings import OLD_VERSION_CHARACTER
from cvpoc.lib.core.settings import POCSUITE_VERSION_CHARACTER
from cvpoc.lib.core.settings import POC_NAME_REGEX
from cvpoc.lib.core.settings import POC_REQUIRES_REGEX
from cvpoc.lib.core.settings import UNICODE_ENCODING
from cvpoc.lib.core.settings import URL_ADDRESS_REGEX
from cvpoc.thirdparty.colorama.initialise import init as coloramainit
from cvpoc.thirdparty.ifcfg import ifcfg
from cvpoc.thirdparty.termcolor.termcolor import colored
...
def get_latest_revision():
    ...
    ret = None
    resp = requests.get(url="https://raw.githubusercontent.com/knownsec/cvpoc/master/cvpoc/__init__.py")
    try:
...
def is_cvpoc_poc(poc_string):
    return True if "cvpoc" in poc_string else False

def is_pocsuite3_poc(poc_string):
    return True if "pocsuite3" in poc_string else False

def multiple_replace(text, adict):
    if is_pocsuite3_poc(text):
        adict={"pocsuite3":"cvpoc"}
...
def index_modules() -> list:
    ...
    for root, dirs, files in os.walk(paths.POCSUITE_POCS_PATH):
        _, package, root = root.rpartition("cvpoc/cv_pocs/".replace("/", os.sep))
