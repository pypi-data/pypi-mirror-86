...
from cvpoc.lib.core.common import is_cvpoc_poc, single_time_warn_message
from cvpoc.lib.core.data import kb
from cvpoc.lib.core.data import logger
from cvpoc.lib.core.register import load_string_to_module, load_file_to_module
...
class PluginBase(object):
    ...
    def add_poc(self, poc, fullname=None):
        ...
        if self.check_poc(poc):
            ...
            err_msg = "[PLUGIN] invalid cvpoc PoC code"
            logger.error(err_msg)
        return ret
    ...
    def add_poc_from_file(self, filename):
        ...
        if os.path.exists(filename):
            ...
            err_msg = "[PLUGIN] invalid cvpoc PoC file {}".format(filename)
            logger.error(err_msg)
        return ret
