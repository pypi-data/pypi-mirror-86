...
from cvpoc.lib.core.enums import CUSTOM_LOGGING, OS, OS_ARCH, SHELLCODE_CONNECTION
# for pocsuite 2.x
from cvpoc.lib.core.exception import PocsuiteGenericException
from cvpoc.lib.core.register import register_poc as register
from cvpoc.shellcodes import OSShellcodes
