...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.20.1-alpha.1606308694+77addf2a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.20.1-alpha.1606308694+77addf2a`
                """)
            else:
                raise
