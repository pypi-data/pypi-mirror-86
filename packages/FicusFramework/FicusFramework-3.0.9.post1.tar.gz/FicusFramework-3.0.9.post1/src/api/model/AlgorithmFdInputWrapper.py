    ...
    def child(self, sub_path: str):
        ...
        if self.sub_path:
            ...
            if not os.path.isdir(absolute_path):
                ...
                #return self
                return AlgorithmFdInputWrapper(self.fd_code, directory + sub_path)
        else:
            #self.sub_path = sub_path
            #return self
            return AlgorithmFdInputWrapper(self.fd_code, sub_path)
    ...
    def list(self):
        ...
        if not os.path.isdir(abs_path):
            ...
            for file in files:
                ...
                #results.append(self)
                results.append(AlgorithmFdInputWrapper(self.fd_code, directory + file))
            return results
