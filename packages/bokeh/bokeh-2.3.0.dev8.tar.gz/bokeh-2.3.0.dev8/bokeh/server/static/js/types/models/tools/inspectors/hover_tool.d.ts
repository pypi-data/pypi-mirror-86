...
export declare function _nearest_line_hit(i: number, geometry: Geometry, sx: number, sy: number, dx: NumberArray, dy: NumberArray): [[number, number], number];
export declare function _line_hit(xs: NumberArray, ys: NumberArray, ind: number): [[number, number], number];
