...
* echo $(cat v2.5.4/ip) forumv2.5.4.example.com | sudo tee -a /etc/hosts
* firefox http://forumv2.5.4.example.com # user: api, password: BefShnygs33SwowCifViwag
* tox
...
* tests/build-discourse figure out which commit hash of discourse_docker matches
  a given version and add it using v2.5.4 as a model
