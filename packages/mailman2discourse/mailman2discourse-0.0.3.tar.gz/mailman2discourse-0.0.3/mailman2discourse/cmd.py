...
class Cmd(object):
    ...
    def parser(self):
        ...
        parser.add_argument('--list',
                            ...
                            required=True)
        parser.add_argument('--mailman-dir',
                            help='path to the directory containing */config.pck files',
                            required=True)
        parser.add_argument('--mailman-archive',
                            help='path to the directory containing mbox files',
                            required=True)
