...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images.append(pygame.image.load('PythonPals/Snake_start.png'))
        self.images.append(pygame.image.load('PythonPals/Snake_Firemid.png'))
        self.images.append(pygame.image.load('PythonPals/snake2.png'))
        self.images.append(pygame.image.load('PythonPals/Snake_fire_end.png'))
        self.images.append(pygame.image.load('PythonPals/snake4.png'))
        self.images.append(pygame.image.load('PythonPals/snake6.png'))
...
class Coffee(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images.append(pygame.image.load('PythonPals/coffee5.png'))
        self.images.append(pygame.image.load('PythonPals/coffee6.png'))
...
class Ruby(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.images = []
        self.images.append(pygame.image.load('PythonPals/Ruby_idle.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_left.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_prep.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_start.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_fire.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_start.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_prep.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_left.png'))
        self.images.append(pygame.image.load('PythonPals/Ruby_hurt.png'))
...
class Eye(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.images = []
        self.images.append(pygame.image.load('PythonPals/C1.png'))
        self.images.append(pygame.image.load('PythonPals/C2.png'))
        self.images.append(pygame.image.load('PythonPals/C3.png'))
        self.images.append(pygame.image.load('PythonPals/C4.png'))
...
class button():
    ...
    def draw(self, screen, fontSize, text_color, center=False, outline=None):
        ...
        if self.text != '':
            font = pygame.font.Font('PythonPals/JandaManateeSolid.ttf', fontSize)
...
ws = initialize("PythonPals/python_questions.xlsx")
...
def drawBackground(playerGroup, enemyGroup, width, height, level, correctOrWrong=""):
    ...
    #pygame.draw.rect(screen, (0, 0, 0), (0, 0, theScreen.width, theScreen.height * 0.07))
    if level == 1:
        bg = pygame.image.load("PythonPals/jungleBackground.jpg")
        bg = pygame.transform.rotozoom(bg, 0, theScreen.width / 1380)
    elif level == 2:
        bg = pygame.image.load("PythonPals/goldmine.jpg")
        bg = pygame.transform.rotozoom(bg, 0, theScreen.width / 1400)
    else:
        bg = pygame.image.load("PythonPals/ocean.jpg")
        bg = pygame.transform.rotozoom(bg, 0, theScreen.width / 1900)
    screen.blit(bg,(0,0))
    if correctOrWrong != "":
        if correctOrWrong == "Correct":
            pygame.mixer.Sound("PythonPals/correct.wav").play()
        ...
        if correctOrWrong == "Wrong":
            pygame.mixer.Sound("PythonPals/incorrect.wav").play()
            display = text(black, theScreen.width * 0.25, theScreen.height * 0.2, theScreen.width * 0.5,
...
def theBattle(level):
    ...
    if level == 1:
        ...
        myEnemy = Coffee()
        pygame.mixer.music.load('PythonPals/jazz.mp3')
        ...
        myEnemy = Ruby()
        pygame.mixer.music.load('PythonPals/funke.mp3')
        pygame.mixer.music.play(-1)
    else:
        ...
        myEnemy = Eye()
        pygame.mixer.music.load('PythonPals/bluth.wav')
        pygame.mixer.music.play(-1)
...
def win():
    pygame.mixer.music.load('PythonPals/victoire.mp3')
    pygame.mixer.music.play(-1)
...
def lose():
    pygame.mixer.music.load('PythonPals/defaite.mp3')
    pygame.mixer.music.play(-1)
        ...
        for ev in pygame.event.get():
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN:
                ...
                if changeCapitals.isOver(pos):
                    globals()['ws'] = changeQuestionDeck("PythonPals/python_questions_capitals.xlsx", ws)
                    options()
                    opt = False
                if changePython.isOver(pos):
                    globals()['ws'] = changeQuestionDeck("PythonPals/python_questions.xlsx", ws)
                    options()
                    opt = False
                if changeHistory.isOver(pos):
                    globals()['ws'] = changeQuestionDeck("PythonPals/python_questions_timeline.xlsx", ws)
                    options()
                    opt = False
            if ev.type == pygame.VIDEORESIZE:
                if (ev.w != theScreen.width):
...
def main():
    ...
    while enter_game:
        if(restart_music == True):
            pygame.mixer.music.load('PythonPals/idle.wav')
            pygame.mixer.music.play(-1)
        ...
        if menuOption == "start":
            ...
            levelChange(screen, 1, "Java", "PythonPals/coffee1.png")
            result = theBattle(1)
            restart_music = True
            if result == "win":
                levelChange(screen, 2, "Ruby", "PythonPals/Ruby_idle.png")
                damageStats.modify(25,25)
                result2 = theBattle(2)
                if result2 == "win":
                    levelChange(screen, 3, "Eye", "PythonPals/C1.png")
