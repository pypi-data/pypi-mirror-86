...
setup(
    ...
    data_files=[('PythonPals', ["PythonPals/python_questions.xlsx", "PythonPals/coffee1.png", "PythonPals/coffee2.png",
                                ...
                                "PythonPals/background_laundr.wav", "PythonPals/jungleBackground.jpg",
                                "PythonPals/requirements.txt", "PythonPals/questions.py", "PythonPals/Button.py",
                                "PythonPals/player.py"])],
