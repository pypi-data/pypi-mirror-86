...
setup(
    ...
    version='2.0.27',
    packages=['PythonPals'],
    data_files=[('src', ["PythonPals/python_questions.xlsx", "PythonPals/coffee1.png", "PythonPals/coffee2.png",
                                ...
                                , "PythonPals/JandaManateeSolid.ttf", "PythonPals/Snakeend.png", "PythonPals/victoire.mp3",
                                ...
                                "PythonPals/Button.py","PythonPals/main.py", "PythonPals/questions.py",
