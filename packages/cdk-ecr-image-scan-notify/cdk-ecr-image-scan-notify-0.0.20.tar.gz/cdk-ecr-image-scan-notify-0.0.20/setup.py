    ...
    """
{
    ...
    "package_data": {
        "cdk_ecr_image_scan_notify._jsii": [
            "cdk-ecr-image-scan-notify@0.0.20.jsii.tgz"
        ],
        "cdk_ecr_image_scan_notify": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ecr>=1.71.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.71.0, <2.0.0",
        "aws-cdk.aws-events>=1.71.0, <2.0.0",
        "aws-cdk.aws-iam>=1.71.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.71.0, <2.0.0",
