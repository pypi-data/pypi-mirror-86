...
from essentials_kit_management.constants.exception_messages \
    import INVALID_FORM_EXCEPTION


def test_raise_invalid_form_exception():
    #Arrange
    json_presenter = PresenterImplementation()
    expected_exception_message = INVALID_FORM_EXCEPTION[0]
    expected_exception_res_status = INVALID_FORM_EXCEPTION[1]

    #Act
    with pytest.raises(NotFound) as exception:
        json_presenter.raise_invalid_form_exception()
