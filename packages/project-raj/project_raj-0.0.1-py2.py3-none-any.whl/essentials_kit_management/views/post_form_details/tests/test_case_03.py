"""
post form details with invalid brand id raises invalid brand exception
"""
...
from essentials_kit_management.tests.factories.factories import \
    FormFactory, SectionFactory, ItemFactory
...
class TestCase03PostFormDetailsAPITestCase(CustomUtilsAPI):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03PostFormDetailsAPITestCase, self).setupUser(
