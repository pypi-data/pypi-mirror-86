"""
post form details with invalid item id raises invalid item exception
"""

import json
from essentials_kit_management.utils.custom_test_utils import CustomUtilsAPI
from essentials_kit_management.tests.factories.factories import FormFactory
...
class TestCase02PostFormDetailsAPITestCase(CustomUtilsAPI):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase02PostFormDetailsAPITestCase, self).setupUser(
