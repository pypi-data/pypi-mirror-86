...
class Portfolio:
    ...
    def shift_weight(self, from_ticker, to_ticker, weight):
        weight_before_subtract = self.get_weight(from_ticker)
        subtracted_weight = weight_before_subtract - weight
        weight_before_add = self.get_weight(to_ticker)

        assert subtracted_weight >= 0

        self.set_weight(from_ticker, subtracted_weight)
        self.set_weight(to_ticker, weight_before_add + weight)
