...
def duplicates_detection(data):
            ...
            data_group_duplicates = groups_duplicates_detection(group_duplicates,data)
            ...
            for i in range(len(group_duplicates)):
                ...
                for j in range(group_duplicate_tw_day_size): 
                    ...
                    for k in range(len(group_duplicates[i])):
                        label_tw_profile= group_duplicates[i][k]+" - Número de tweets"
                        first[label_tw_profile] = data[data["screen_name"]==group_duplicates[i][k]]["tw_per_day_list"].iloc[0][j]       
