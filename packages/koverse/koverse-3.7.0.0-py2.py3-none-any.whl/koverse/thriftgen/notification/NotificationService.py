...
class getNotifications_args(object):
    """
    Attributes:
     - authInfo
...
all_structs.append(getNotifications_args)
getNotifications_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authInfo', [koverse.thriftgen.security.ttypes.TAuthInfo, None], None, ),  # 1
)


class getNotifications_result(object):
    """
    Attributes:
     - success
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getNotifications_result)
getNotifications_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [TNotification, None], False), None, ),  # 0
)
