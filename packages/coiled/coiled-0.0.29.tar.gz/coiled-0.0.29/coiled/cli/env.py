...
from .utils import CONTEXT_SETTINGS, get_software_info, get_event_loop
from ..core import (
...
@click.option("-n", "--name", help="Name of software environment.")
...
def inspect(name: str):
    ...
    """
    results = get_event_loop().run_until_complete(get_software_info(name))
